...
$sqlitemkontrol="SELECT 
    ...
    z.id_expertise_radiologi
FROM
    simrs.expertise_radiologi z
        LEFT JOIN
...
WHERE
    a.userlevelid = 17 AND a.id_bill_detail_tarif = $id_bill_detail_tarif";
 $queryitemkontrol = mysql_query($sqlitemkontrol);
	...
	if(mysql_num_rows($queryitemkontrol)==0){
	  ...
	  echo "<td><a class=\"btn btn-block bg-teal btn-xs\" href=\"expertise_radiologi.php?id_expertise_radiologi=" . $data1['id_expertise_radiologi'] . "\">Lihat Expertise Lab</a></td>";
			echo '</tr>';
		}
	}
 ?>
