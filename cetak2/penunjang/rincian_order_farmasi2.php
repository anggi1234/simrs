...
<?php 
	while($isi=mysql_fetch_array($queryobatsignatureracik))
            {
  ...
  <tbody>
    <tr>
      <td width="33%">&nbsp;</td>
      <td width="20%">&nbsp;</td>
      <td width="47%" align="center">Pemberi Resep</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td align="center"><img src="../../uploads/'.$isi['signature'].'" width="40px" height="40px" /></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td align="center">'.$isi['pd_nickname'].'</td>
    </tr>
  </tbody>
</table>';
			}?>
