...
WHERE a.pasienbaru = 0 AND
      a.tglreg = '$tanggal_berobat' AND
      (a.kdpoly = 1 OR
      a.kdpoly = 2 OR
      a.kdpoly = 3 OR
      a.kdpoly = 4 OR
...
echo '<table width="100%" class="penulisan" border="0">';
    ...
    echo '<tr>';
      ...
      echo '<td width="1%">:</td>';
      echo '<td width="80%">'.$data['nomr'].' | ONLINE</td>';
    echo '</tr>';
