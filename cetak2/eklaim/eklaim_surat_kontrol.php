...
$sqlpoli="select userlevelid from bill_detail_tarif where id_bill_detail_tarif=$id_bill_detail_tarif";
 $querypoli = mysql_query($sqlpoli);
 $DATA_POLI = mysql_fetch_array($querypoli);


if ($DATA_POLI['userlevelid'] == '7' or $DATA_POLI['userlevelid'] == '44') {
  $sqlidentitas="
    SELECT 
...
WHERE
    a.id_bill_detail_tarif <> $id_bill_detail_tarif
        AND b.nomr = $nomr and b.userlevelid='".$DATA_POLI['userlevelid']."'
ORDER BY a.id_bill_detail_lain DESC";
}
