...
WHERE
    a.idxdaftar = $idxdaftar and a.userlevelid='40'";
...
FROM
 ...
 $sqltotal="select total_keseluruhan-biaya_obat as total from bill_detail_tarif where idxdaftar=$idxdaftar and userlevelid='40'";
...
FROM
    ...
    left join master_profesi d on b.id_profesi=d.id_profesi where a.idxdaftar=$idxdaftar and b.id_kategori_pelayanan = '5' and c.id_profesi=13 order by a.id_profesi asc";
...
FROM
    ...
    simrs.master_obat_detail b ON a.id_master_obat_detail = b.id_master_obat_detail
        LEFT JOIN
    simrs.master_obat c ON b.id_obat = c.id_obat where a.idxdaftar=$idxdaftar and a.userlevelid='40'";
...
FROM
    ...
    master_tindakan d ON a.id_tindakan = d.id_tindakan
WHERE
    a.idxdaftar=$idxdaftar and a.userlevelid='40' AND a.id_jenis_tindakan=7
group by a.id_tindakan
ORDER BY a.id_jenis_tindakan ASC , a.id_type_tindakan ASC";
...
$sqlrincian="SELECT
  ...
  (SELECT 
        ...
        WHERE
            idxdaftar=$idxdaftar and id_jenis_tindakan=2 group by id_bill_detail_tarif) AS qty_askep,
  (SELECT 
            tarif_pelayanan
        FROM
            bill_detail_tindakan_lain
        WHERE
            idxdaftar=$idxdaftar and id_jenis_tindakan=2 group by id_bill_detail_tarif) AS tarif_askep
FROM
    bill_detail_tarif a
        LEFT JOIN
    bill_detail_keterangan b ON a.idxdaftar=b.idxdaftar and a.userlevelid='40'
...
<!-- <center>
  <span style="font-size: 14px">RINCIAN BIAYA PELAYANAN IBS</span>
</center>
