...
header("Content-Disposition: attachment; filename=laporan_dekontaminasi_tahunan.xls");
...
$sqlitem="SELECT
  ...
  AND ( t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL )
  AND t_cssd.jenis != '2'
  AND t_cssd.jenis != '3') AS februari,
  (
  SELECT COALESCE
    ( sum( jumlah ), 0 ) AS jumlah 
  FROM
  ...
  AND ( t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL )
  AND t_cssd.jenis != '2'
  AND t_cssd.jenis != '3') AS september,
  (
  SELECT COALESCE
    ( sum( jumlah ), 0 ) AS jumlah 
  FROM
  ...
  AND ( t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL )
  AND t_cssd.jenis != '2'
  AND t_cssd.jenis != '3') AS november,
  (
  SELECT COALESCE
    ( sum( jumlah ), 0 ) AS jumlah 
  FROM
  ...
  AND ( t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL )
  AND t_cssd.jenis != '2'
  AND t_cssd.jenis != '3') AS desember,
  (
  SELECT COALESCE
    ( sum( jumlah ), 0 ) AS jumlah 
  FROM
...
<body>
  <table width="100%" style="border:0;" cellpadding="0">
                    <tbody>
                        <tr>
                            <td width="100%" align="center"><span class="header"><strong><b>REKAP DEKONTAMINASI BULANAN TAHUN : <?php echo $tahun; ?>
