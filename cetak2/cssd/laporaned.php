...
header("Content-Disposition: attachment; filename=laporan_ed.xls");
...
<body>
  <table width="100%" style="border:0;" cellpadding="0">
                    <tbody>
                        <tr>
                            <td width="100%" align="center"><span class="header"><strong><b>LAPORAN ED CSSD
                                        <br>RSUD AJIBARANG
                                    </b></strong></span></td>
                        </tr>
                        <tr>
