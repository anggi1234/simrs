...
$sqlitem="SELECT 
    b.nama_tindakan, a.qty, a.total, d.pd_nickname
FROM
    bill_detail_tindakan a
        LEFT JOIN
    master_tindakan b ON a.id_tindakan = b.id_tindakan
        LEFT JOIN
    bill_detail_tarif_detail c ON a.id_bill_detail_tarif_detail = c.id_bill_detail_tarif_detail
        LEFT JOIN
    master_login d ON c.username = d.username
where a.id_bill_detail_tarif_detail =$id_bill_detail_tarif_detail";
$queryitem = mysql_query($sqlitem);
$queryitem1 = mysql_query($sqlitem);
$DATA_PENUNJANG = mysql_fetch_array($queryitem1);
...
FROM
    ...
    simrs.userlevels e ON a.userlevelid = e.userlevelid
        LEFT JOIN
    simrs.userlevels f ON d.userlevelid = f.userlevelid
WHERE
...
<center>
  <span style="font-size: 14px">RINCIAN BIAYA PEMERIKSAAN <?php echo $DATA_IDENTITAS['penunjang']; ?></span>
</center>
...
<table width="100%" class="tabel" border="1">
    ...
    <tr>
      <td align="center"><?php echo $DATA_PENUNJANG['pd_nickname']; ?></td>
