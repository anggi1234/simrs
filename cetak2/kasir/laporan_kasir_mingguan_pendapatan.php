...
$sqlitem="SELECT 
    ...
    SUM(a.total_keseluruhan) AS total
FROM
...
<table width="100%" border="0" cellpadding="-3px" cellspacing="0px">
  ...
  <hr>
    ...
    <div align="center"><strong>SETORAN PENDAPATAN MINGGUAN</strong></div>
...
<table width="100%" border="1" class="tabel">
  <tbody>
    <tr>
      <td width="5%" align="center">Minggu</td>
	...
	?>
	 <tr>
      <td colspan="12" style="text-align: center">TOTAL PENDAPATAN</td>
