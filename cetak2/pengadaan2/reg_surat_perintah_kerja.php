...
FROM
	...
	LEFT JOIN master_login d ON b.ppk_uid = d.uid
	LEFT JOIN ( SELECT no_pesanan, sum( jumlah_total ) AS jumlah_total FROM pengadaan_pesanan_masuk_faktur WHERE no_pesanan = '$nomor_pesanan' GROUP BY no_pesanan ) e ON a.no_pesanan = e.no_pesanan
...
<?php
    ...
    <tr>
      <td colspan="4">&nbsp;</td>
      <td>TOTAL</td>
      <td align="right">Rp.<?php echo number_format($DATA_OBAT['jumlah_total'], 2,",","."); ?></td>
    </tr>
  </tbody>
</table>
<br>
Terbilang : <?php echo Terbilang($DATA_OBAT['jumlah_total']) ?> Rupiah
<hr>
