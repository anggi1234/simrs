...
$NOMR = $_GET['nomr'];
 ...
 $sqlitem="select * from a_riwayat_tindakan WHERE NOMR=$NOMR";
...
<table width="100%" height="52" border="0">
  <tr>
    <td width="100%" class="header"><div align="center"><strong>RIWAYAT TINDAKAN DI SIMRS BARU</strong></div></td>
  </tr>
</table>
...
<table width="100%" class="tabelfix" border="1">
    <tr>
      ...
      <td width="70%" class="a"><div align="center"><strong>TINDAKAN</strong></div></td>
  </tr>
	<?php
	if(mysql_num_rows($queryitem)==0){
      ...
      echo '<td class="a"><div align="center">'.$data['TINDAKAN']. '</div></td>';
			echo '</tr>';
			$no++;
		}
	}
