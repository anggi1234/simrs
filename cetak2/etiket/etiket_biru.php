...
FROM
    ...
    master_obat g ON f.id_obat = g.id_obat
        LEFT JOIN
    master_resep h ON a.id_master_resep = h.id_master_resep where a.id_bill_detail_permintaan_obat_master=$id_bill_detail_permintaan_obat_master and a.id_jenis_etiket=6";
...
<table class="penulisan" width="100%" border="0">
  <tbody>
    ...
    <tr>
      <td colspan="3" style="font-size:13px" align="center"><strong>'.$data['nama_resep'].'</strong><hr></td>
    </tr>
    <tr>
