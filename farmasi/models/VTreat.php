...
/**
 * Table class for V_TREAT
 */
class VTreat extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'V_TREAT';
        $this->TableName = 'V_TREAT';
        $this->TableType = 'CUSTOMVIEW';

        // Update Table
        $this->UpdateTable = "dbo.TREATMENT_BILL INNER JOIN dbo.TREATMENT_OBAT ON dbo.TREATMENT_BILL.BILL_ID = dbo.TREATMENT_OBAT.BILL_ID AND dbo.TREATMENT_BILL.VISIT_ID = dbo.TREATMENT_OBAT.VISIT_ID";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('V_TREAT', 'V_TREAT', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BILL_ID
        $this->BILL_ID = new DbField('V_TREAT', 'V_TREAT', 'x_BILL_ID', 'BILL_ID', '[BILL_ID]', '[BILL_ID]', 200, 50, -1, false, '[BILL_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NO_REGISTRATION
        $this->NO_REGISTRATION = new DbField('V_TREAT', 'V_TREAT', 'x_NO_REGISTRATION', 'NO_REGISTRATION', '[NO_REGISTRATION]', '[NO_REGISTRATION]', 200, 25, -1, false, '[NO_REGISTRATION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // VISIT_ID
        $this->VISIT_ID = new DbField('V_TREAT', 'V_TREAT', 'x_VISIT_ID', 'VISIT_ID', '[VISIT_ID]', '[VISIT_ID]', 200, 50, -1, false, '[VISIT_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TARIF_ID
        $this->TARIF_ID = new DbField('V_TREAT', 'V_TREAT', 'x_TARIF_ID', 'TARIF_ID', '[TARIF_ID]', '[TARIF_ID]', 200, 25, -1, false, '[TARIF_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLASS_ID
        $this->CLASS_ID = new DbField('V_TREAT', 'V_TREAT', 'x_CLASS_ID', 'CLASS_ID', '[CLASS_ID]', 'CAST([CLASS_ID] AS NVARCHAR)', 17, 1, -1, false, '[CLASS_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLINIC_ID
        $this->CLINIC_ID = new DbField('V_TREAT', 'V_TREAT', 'x_CLINIC_ID', 'CLINIC_ID', '[CLINIC_ID]', '[CLINIC_ID]', 200, 15, -1, false, '[CLINIC_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLINIC_ID_FROM
        $this->CLINIC_ID_FROM = new DbField('V_TREAT', 'V_TREAT', 'x_CLINIC_ID_FROM', 'CLINIC_ID_FROM', '[CLINIC_ID_FROM]', '[CLINIC_ID_FROM]', 200, 15, -1, false, '[CLINIC_ID_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TREATMENT
        $this->TREATMENT = new DbField('V_TREAT', 'V_TREAT', 'x_TREATMENT', 'TREATMENT', '[TREATMENT]', '[TREATMENT]', 200, 200, -1, false, '[TREATMENT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TREAT_DATE
        $this->TREAT_DATE = new DbField('V_TREAT', 'V_TREAT', 'x_TREAT_DATE', 'TREAT_DATE', '[TREAT_DATE]', CastDateFieldForLike("[TREAT_DATE]", 0, "DB"), 135, 8, 0, false, '[TREAT_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // QUANTITY
        $this->QUANTITY = new DbField('V_TREAT', 'V_TREAT', 'x_QUANTITY', 'QUANTITY', '[QUANTITY]', 'CAST([QUANTITY] AS NVARCHAR)', 131, 8, -1, false, '[QUANTITY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MEASURE_ID
        $this->MEASURE_ID = new DbField('V_TREAT', 'V_TREAT', 'x_MEASURE_ID', 'MEASURE_ID', '[MEASURE_ID]', 'CAST([MEASURE_ID] AS NVARCHAR)', 2, 2, -1, false, '[MEASURE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DESCRIPTION
        $this->DESCRIPTION = new DbField('V_TREAT', 'V_TREAT', 'x_DESCRIPTION', 'DESCRIPTION', '[DESCRIPTION]', '[DESCRIPTION]', 200, 200, -1, false, '[DESCRIPTION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DESCRIPTION->Sortable = true; // Allow sort
        $this->DESCRIPTION->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DESCRIPTION->Param, "CustomMsg");
        $this->Fields['DESCRIPTION'] = &$this->DESCRIPTION;

        // RESEP_NO
        $this->RESEP_NO = new DbField('V_TREAT', 'V_TREAT', 'x_RESEP_NO', 'RESEP_NO', '[RESEP_NO]', '[RESEP_NO]', 200, 50, -1, false, '[RESEP_NO]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DOSE_PRESC
        $this->DOSE_PRESC = new DbField('V_TREAT', 'V_TREAT', 'x_DOSE_PRESC', 'DOSE_PRESC', '[DOSE_PRESC]', 'CAST([DOSE_PRESC] AS NVARCHAR)', 131, 8, -1, false, '[DOSE_PRESC]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SOLD_STATUS
        $this->SOLD_STATUS = new DbField('V_TREAT', 'V_TREAT', 'x_SOLD_STATUS', 'SOLD_STATUS', '[SOLD_STATUS]', 'CAST([SOLD_STATUS] AS NVARCHAR)', 17, 1, -1, false, '[SOLD_STATUS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RACIKAN
        $this->RACIKAN = new DbField('V_TREAT', 'V_TREAT', 'x_RACIKAN', 'RACIKAN', '[RACIKAN]', 'CAST([RACIKAN] AS NVARCHAR)', 2, 2, -1, false, '[RACIKAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLASS_ROOM_ID
        $this->CLASS_ROOM_ID = new DbField('V_TREAT', 'V_TREAT', 'x_CLASS_ROOM_ID', 'CLASS_ROOM_ID', '[CLASS_ROOM_ID]', '[CLASS_ROOM_ID]', 200, 16, -1, false, '[CLASS_ROOM_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KELUAR_ID
        $this->KELUAR_ID = new DbField('V_TREAT', 'V_TREAT', 'x_KELUAR_ID', 'KELUAR_ID', '[KELUAR_ID]', 'CAST([KELUAR_ID] AS NVARCHAR)', 17, 1, -1, false, '[KELUAR_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BED_ID
        $this->BED_ID = new DbField('V_TREAT', 'V_TREAT', 'x_BED_ID', 'BED_ID', '[BED_ID]', 'CAST([BED_ID] AS NVARCHAR)', 17, 1, -1, false, '[BED_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EMPLOYEE_ID
        $this->EMPLOYEE_ID = new DbField('V_TREAT', 'V_TREAT', 'x_EMPLOYEE_ID', 'EMPLOYEE_ID', '[EMPLOYEE_ID]', '[EMPLOYEE_ID]', 200, 15, -1, false, '[EMPLOYEE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DESCRIPTION2
        $this->DESCRIPTION2 = new DbField('V_TREAT', 'V_TREAT', 'x_DESCRIPTION2', 'DESCRIPTION2', '[DESCRIPTION2]', '[DESCRIPTION2]', 200, 50, -1, false, '[DESCRIPTION2]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BRAND_ID
        $this->BRAND_ID = new DbField('V_TREAT', 'V_TREAT', 'x_BRAND_ID', 'BRAND_ID', '[BRAND_ID]', '[BRAND_ID]', 200, 50, -1, false, '[BRAND_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DOCTOR
        $this->DOCTOR = new DbField('V_TREAT', 'V_TREAT', 'x_DOCTOR', 'DOCTOR', '[DOCTOR]', '[DOCTOR]', 200, 100, -1, false, '[DOCTOR]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EXIT_DATE
        $this->EXIT_DATE = new DbField('V_TREAT', 'V_TREAT', 'x_EXIT_DATE', 'EXIT_DATE', '[EXIT_DATE]', CastDateFieldForLike("[EXIT_DATE]", 0, "DB"), 135, 8, 0, false, '[EXIT_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EMPLOYEE_ID_FROM
        $this->EMPLOYEE_ID_FROM = new DbField('V_TREAT', 'V_TREAT', 'x_EMPLOYEE_ID_FROM', 'EMPLOYEE_ID_FROM', '[EMPLOYEE_ID_FROM]', '[EMPLOYEE_ID_FROM]', 200, 50, -1, false, '[EMPLOYEE_ID_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DOCTOR_FROM
        $this->DOCTOR_FROM = new DbField('V_TREAT', 'V_TREAT', 'x_DOCTOR_FROM', 'DOCTOR_FROM', '[DOCTOR_FROM]', '[DOCTOR_FROM]', 200, 50, -1, false, '[DOCTOR_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status_pasien_id
        $this->status_pasien_id = new DbField('V_TREAT', 'V_TREAT', 'x_status_pasien_id', 'status_pasien_id', '[status_pasien_id]', 'CAST([status_pasien_id] AS NVARCHAR)', 17, 1, -1, false, '[status_pasien_id]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // THENAME
        $this->THENAME = new DbField('V_TREAT', 'V_TREAT', 'x_THENAME', 'THENAME', '[THENAME]', '[THENAME]', 200, 100, -1, false, '[THENAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // THEADDRESS
        $this->THEADDRESS = new DbField('V_TREAT', 'V_TREAT', 'x_THEADDRESS', 'THEADDRESS', '[THEADDRESS]', '[THEADDRESS]', 200, 150, -1, false, '[THEADDRESS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // THEID
        $this->THEID = new DbField('V_TREAT', 'V_TREAT', 'x_THEID', 'THEID', '[THEID]', '[THEID]', 200, 25, -1, false, '[THEID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SERIAL_NB
        $this->SERIAL_NB = new DbField('V_TREAT', 'V_TREAT', 'x_SERIAL_NB', 'SERIAL_NB', '[SERIAL_NB]', '[SERIAL_NB]', 200, 50, -1, false, '[SERIAL_NB]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISRJ
        $this->ISRJ = new DbField('V_TREAT', 'V_TREAT', 'x_ISRJ', 'ISRJ', '[ISRJ]', '[ISRJ]', 129, 1, -1, false, '[ISRJ]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AGEYEAR
        $this->AGEYEAR = new DbField('V_TREAT', 'V_TREAT', 'x_AGEYEAR', 'AGEYEAR', '[AGEYEAR]', 'CAST([AGEYEAR] AS NVARCHAR)', 17, 1, -1, false, '[AGEYEAR]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AGEMONTH
        $this->AGEMONTH = new DbField('V_TREAT', 'V_TREAT', 'x_AGEMONTH', 'AGEMONTH', '[AGEMONTH]', 'CAST([AGEMONTH] AS NVARCHAR)', 17, 1, -1, false, '[AGEMONTH]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AGEDAY
        $this->AGEDAY = new DbField('V_TREAT', 'V_TREAT', 'x_AGEDAY', 'AGEDAY', '[AGEDAY]', 'CAST([AGEDAY] AS NVARCHAR)', 17, 1, -1, false, '[AGEDAY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GENDER
        $this->GENDER = new DbField('V_TREAT', 'V_TREAT', 'x_GENDER', 'GENDER', '[GENDER]', '[GENDER]', 129, 1, -1, false, '[GENDER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->GENDER->Sortable = true; // Allow sort
        $this->GENDER->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->GENDER->Param, "CustomMsg");
        $this->Fields['GENDER'] = &$this->GENDER;

        // KARYAWAN
        $this->KARYAWAN = new DbField('V_TREAT', 'V_TREAT', 'x_KARYAWAN', 'KARYAWAN', '[KARYAWAN]', '[KARYAWAN]', 200, 50, -1, false, '[KARYAWAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('V_TREAT', 'V_TREAT', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 200, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MODIFIED_BY->Sortable = true; // Allow sort
        $this->MODIFIED_BY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MODIFIED_BY->Param, "CustomMsg");
        $this->Fields['MODIFIED_BY'] = &$this->MODIFIED_BY;

        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('V_TREAT', 'V_TREAT', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_FROM
        $this->MODIFIED_FROM = new DbField('V_TREAT', 'V_TREAT', 'x_MODIFIED_FROM', 'MODIFIED_FROM', '[MODIFIED_FROM]', '[MODIFIED_FROM]', 200, 50, -1, false, '[MODIFIED_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NUMER
        $this->NUMER = new DbField('V_TREAT', 'V_TREAT', 'x_NUMER', 'NUMER', '[NUMER]', '[NUMER]', 200, 15, -1, false, '[NUMER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NOTA_NO
        $this->NOTA_NO = new DbField('V_TREAT', 'V_TREAT', 'x_NOTA_NO', 'NOTA_NO', '[NOTA_NO]', '[NOTA_NO]', 200, 50, -1, false, '[NOTA_NO]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MEASURE_ID2
        $this->MEASURE_ID2 = new DbField('V_TREAT', 'V_TREAT', 'x_MEASURE_ID2', 'MEASURE_ID2', '[MEASURE_ID2]', 'CAST([MEASURE_ID2] AS NVARCHAR)', 2, 2, -1, false, '[MEASURE_ID2]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // POTONGAN
        $this->POTONGAN = new DbField('V_TREAT', 'V_TREAT', 'x_POTONGAN', 'POTONGAN', '[POTONGAN]', 'CAST([POTONGAN] AS NVARCHAR)', 6, 8, -1, false, '[POTONGAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BAYAR
        $this->BAYAR = new DbField('V_TREAT', 'V_TREAT', 'x_BAYAR', 'BAYAR', '[BAYAR]', 'CAST([BAYAR] AS NVARCHAR)', 6, 8, -1, false, '[BAYAR]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RETUR
        $this->RETUR = new DbField('V_TREAT', 'V_TREAT', 'x_RETUR', 'RETUR', '[RETUR]', 'CAST([RETUR] AS NVARCHAR)', 6, 8, -1, false, '[RETUR]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TARIF_TYPE
        $this->TARIF_TYPE = new DbField('V_TREAT', 'V_TREAT', 'x_TARIF_TYPE', 'TARIF_TYPE', '[TARIF_TYPE]', '[TARIF_TYPE]', 200, 50, -1, false, '[TARIF_TYPE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PPNVALUE
        $this->PPNVALUE = new DbField('V_TREAT', 'V_TREAT', 'x_PPNVALUE', 'PPNVALUE', '[PPNVALUE]', 'CAST([PPNVALUE] AS NVARCHAR)', 6, 8, -1, false, '[PPNVALUE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TAGIHAN
        $this->TAGIHAN = new DbField('V_TREAT', 'V_TREAT', 'x_TAGIHAN', 'TAGIHAN', '[TAGIHAN]', 'CAST([TAGIHAN] AS NVARCHAR)', 6, 8, -1, false, '[TAGIHAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KOREKSI
        $this->KOREKSI = new DbField('V_TREAT', 'V_TREAT', 'x_KOREKSI', 'KOREKSI', '[KOREKSI]', 'CAST([KOREKSI] AS NVARCHAR)', 6, 8, -1, false, '[KOREKSI]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AMOUNT_PAID
        $this->AMOUNT_PAID = new DbField('V_TREAT', 'V_TREAT', 'x_AMOUNT_PAID', 'AMOUNT_PAID', '[AMOUNT_PAID]', 'CAST([AMOUNT_PAID] AS NVARCHAR)', 6, 8, -1, false, '[AMOUNT_PAID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DISKON
        $this->DISKON = new DbField('V_TREAT', 'V_TREAT', 'x_DISKON', 'DISKON', '[DISKON]', 'CAST([DISKON] AS NVARCHAR)', 6, 8, -1, false, '[DISKON]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SELL_PRICE
        $this->SELL_PRICE = new DbField('V_TREAT', 'V_TREAT', 'x_SELL_PRICE', 'SELL_PRICE', '[SELL_PRICE]', 'CAST([SELL_PRICE] AS NVARCHAR)', 6, 8, -1, false, '[SELL_PRICE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ACCOUNT_ID
        $this->ACCOUNT_ID = new DbField('V_TREAT', 'V_TREAT', 'x_ACCOUNT_ID', 'ACCOUNT_ID', '[ACCOUNT_ID]', '[ACCOUNT_ID]', 200, 50, -1, false, '[ACCOUNT_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // subsidi
        $this->subsidi = new DbField('V_TREAT', 'V_TREAT', 'x_subsidi', 'subsidi', '[subsidi]', 'CAST([subsidi] AS NVARCHAR)', 6, 8, -1, false, '[subsidi]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PROFESI
        $this->PROFESI = new DbField('V_TREAT', 'V_TREAT', 'x_PROFESI', 'PROFESI', '[PROFESI]', 'CAST([PROFESI] AS NVARCHAR)', 6, 8, -1, false, '[PROFESI]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EMBALACE
        $this->EMBALACE = new DbField('V_TREAT', 'V_TREAT', 'x_EMBALACE', 'EMBALACE', '[EMBALACE]', 'CAST([EMBALACE] AS NVARCHAR)', 6, 8, -1, false, '[EMBALACE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DISCOUNT
        $this->DISCOUNT = new DbField('V_TREAT', 'V_TREAT', 'x_DISCOUNT', 'DISCOUNT', '[DISCOUNT]', 'CAST([DISCOUNT] AS NVARCHAR)', 131, 8, -1, false, '[DISCOUNT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AMOUNT
        $this->AMOUNT = new DbField('V_TREAT', 'V_TREAT', 'x_AMOUNT', 'AMOUNT', '[AMOUNT]', 'CAST([AMOUNT] AS NVARCHAR)', 6, 8, -1, false, '[AMOUNT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PPN
        $this->PPN = new DbField('V_TREAT', 'V_TREAT', 'x_PPN', 'PPN', '[PPN]', 'CAST([PPN] AS NVARCHAR)', 131, 8, -1, false, '[PPN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ITER
        $this->ITER = new DbField('V_TREAT', 'V_TREAT', 'x_ITER', 'ITER', '[ITER]', 'CAST([ITER] AS NVARCHAR)', 17, 1, -1, false, '[ITER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PAYOR_ID
        $this->PAYOR_ID = new DbField('V_TREAT', 'V_TREAT', 'x_PAYOR_ID', 'PAYOR_ID', '[PAYOR_ID]', '[PAYOR_ID]', 200, 50, -1, false, '[PAYOR_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STATUS_OBAT
        $this->STATUS_OBAT = new DbField('V_TREAT', 'V_TREAT', 'x_STATUS_OBAT', 'STATUS_OBAT', '[STATUS_OBAT]', 'CAST([STATUS_OBAT] AS NVARCHAR)', 2, 2, -1, false, '[STATUS_OBAT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SUBSIDISAT
        $this->SUBSIDISAT = new DbField('V_TREAT', 'V_TREAT', 'x_SUBSIDISAT', 'SUBSIDISAT', '[SUBSIDISAT]', 'CAST([SUBSIDISAT] AS NVARCHAR)', 6, 8, -1, false, '[SUBSIDISAT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MARGIN
        $this->MARGIN = new DbField('V_TREAT', 'V_TREAT', 'x_MARGIN', 'MARGIN', '[MARGIN]', 'CAST([MARGIN] AS NVARCHAR)', 131, 8, -1, false, '[MARGIN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // POKOK_JUAL
        $this->POKOK_JUAL = new DbField('V_TREAT', 'V_TREAT', 'x_POKOK_JUAL', 'POKOK_JUAL', '[POKOK_JUAL]', 'CAST([POKOK_JUAL] AS NVARCHAR)', 131, 8, -1, false, '[POKOK_JUAL]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRINTQ
        $this->PRINTQ = new DbField('V_TREAT', 'V_TREAT', 'x_PRINTQ', 'PRINTQ', '[PRINTQ]', 'CAST([PRINTQ] AS NVARCHAR)', 2, 2, -1, false, '[PRINTQ]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRINTED_BY
        $this->PRINTED_BY = new DbField('V_TREAT', 'V_TREAT', 'x_PRINTED_BY', 'PRINTED_BY', '[PRINTED_BY]', '[PRINTED_BY]', 200, 50, -1, false, '[PRINTED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STOCK_AVAILABLE
        $this->STOCK_AVAILABLE = new DbField('V_TREAT', 'V_TREAT', 'x_STOCK_AVAILABLE', 'STOCK_AVAILABLE', '[STOCK_AVAILABLE]', 'CAST([STOCK_AVAILABLE] AS NVARCHAR)', 131, 8, -1, false, '[STOCK_AVAILABLE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STATUS_TARIF
        $this->STATUS_TARIF = new DbField('V_TREAT', 'V_TREAT', 'x_STATUS_TARIF', 'STATUS_TARIF', '[STATUS_TARIF]', 'CAST([STATUS_TARIF] AS NVARCHAR)', 2, 2, -1, false, '[STATUS_TARIF]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PACKAGE_ID
        $this->PACKAGE_ID = new DbField('V_TREAT', 'V_TREAT', 'x_PACKAGE_ID', 'PACKAGE_ID', '[PACKAGE_ID]', '[PACKAGE_ID]', 200, 50, -1, false, '[PACKAGE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODULE_ID
        $this->MODULE_ID = new DbField('V_TREAT', 'V_TREAT', 'x_MODULE_ID', 'MODULE_ID', '[MODULE_ID]', '[MODULE_ID]', 200, 50, -1, false, '[MODULE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // profession
        $this->profession = new DbField('V_TREAT', 'V_TREAT', 'x_profession', 'profession', '[profession]', 'CAST([profession] AS NVARCHAR)', 131, 8, -1, false, '[profession]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // THEORDER
        $this->THEORDER = new DbField('V_TREAT', 'V_TREAT', 'x_THEORDER', 'THEORDER', '[THEORDER]', 'CAST([THEORDER] AS NVARCHAR)', 2, 2, -1, false, '[THEORDER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CORRECTION_ID
        $this->CORRECTION_ID = new DbField('V_TREAT', 'V_TREAT', 'x_CORRECTION_ID', 'CORRECTION_ID', '[CORRECTION_ID]', '[CORRECTION_ID]', 200, 50, -1, false, '[CORRECTION_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CORRECTION_BY
        $this->CORRECTION_BY = new DbField('V_TREAT', 'V_TREAT', 'x_CORRECTION_BY', 'CORRECTION_BY', '[CORRECTION_BY]', '[CORRECTION_BY]', 200, 50, -1, false, '[CORRECTION_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CASHIER
        $this->CASHIER = new DbField('V_TREAT', 'V_TREAT', 'x_CASHIER', 'CASHIER', '[CASHIER]', '[CASHIER]', 200, 50, -1, false, '[CASHIER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // islunas
        $this->islunas = new DbField('V_TREAT', 'V_TREAT', 'x_islunas', 'islunas', '[islunas]', '[islunas]', 129, 1, -1, false, '[islunas]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PAY_METHOD_ID
        $this->PAY_METHOD_ID = new DbField('V_TREAT', 'V_TREAT', 'x_PAY_METHOD_ID', 'PAY_METHOD_ID', '[PAY_METHOD_ID]', 'CAST([PAY_METHOD_ID] AS NVARCHAR)', 17, 1, -1, false, '[PAY_METHOD_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PAYMENT_DATE
        $this->PAYMENT_DATE = new DbField('V_TREAT', 'V_TREAT', 'x_PAYMENT_DATE', 'PAYMENT_DATE', '[PAYMENT_DATE]', CastDateFieldForLike("[PAYMENT_DATE]", 0, "DB"), 135, 8, 0, false, '[PAYMENT_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISCETAK
        $this->ISCETAK = new DbField('V_TREAT', 'V_TREAT', 'x_ISCETAK', 'ISCETAK', '[ISCETAK]', '[ISCETAK]', 129, 1, -1, false, '[ISCETAK]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // print_date
        $this->print_date = new DbField('V_TREAT', 'V_TREAT', 'x_print_date', 'print_date', '[print_date]', CastDateFieldForLike("[print_date]", 0, "DB"), 135, 8, 0, false, '[print_date]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DOSE
        $this->DOSE = new DbField('V_TREAT', 'V_TREAT', 'x_DOSE', 'DOSE', '[DOSE]', 'CAST([DOSE] AS NVARCHAR)', 131, 8, -1, false, '[DOSE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // JML_BKS
        $this->JML_BKS = new DbField('V_TREAT', 'V_TREAT', 'x_JML_BKS', 'JML_BKS', '[JML_BKS]', 'CAST([JML_BKS] AS NVARCHAR)', 17, 1, -1, false, '[JML_BKS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ORIG_DOSE
        $this->ORIG_DOSE = new DbField('V_TREAT', 'V_TREAT', 'x_ORIG_DOSE', 'ORIG_DOSE', '[ORIG_DOSE]', 'CAST([ORIG_DOSE] AS NVARCHAR)', 131, 8, -1, false, '[ORIG_DOSE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RESEP_KE
        $this->RESEP_KE = new DbField('V_TREAT', 'V_TREAT', 'x_RESEP_KE', 'RESEP_KE', '[RESEP_KE]', 'CAST([RESEP_KE] AS NVARCHAR)', 17, 1, -1, false, '[RESEP_KE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ITER_KE
        $this->ITER_KE = new DbField('V_TREAT', 'V_TREAT', 'x_ITER_KE', 'ITER_KE', '[ITER_KE]', 'CAST([ITER_KE] AS NVARCHAR)', 17, 1, -1, false, '[ITER_KE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KUITANSI_ID
        $this->KUITANSI_ID = new DbField('V_TREAT', 'V_TREAT', 'x_KUITANSI_ID', 'KUITANSI_ID', '[KUITANSI_ID]', '[KUITANSI_ID]', 200, 50, -1, false, '[KUITANSI_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PEMBULATAN
        $this->PEMBULATAN = new DbField('V_TREAT', 'V_TREAT', 'x_PEMBULATAN', 'PEMBULATAN', '[PEMBULATAN]', 'CAST([PEMBULATAN] AS NVARCHAR)', 6, 8, -1, false, '[PEMBULATAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KAL_ID
        $this->KAL_ID = new DbField('V_TREAT', 'V_TREAT', 'x_KAL_ID', 'KAL_ID', '[KAL_ID]', '[KAL_ID]', 200, 50, -1, false, '[KAL_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // INVOICE_ID
        $this->INVOICE_ID = new DbField('V_TREAT', 'V_TREAT', 'x_INVOICE_ID', 'INVOICE_ID', '[INVOICE_ID]', '[INVOICE_ID]', 200, 50, -1, false, '[INVOICE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SERVICE_TIME
        $this->SERVICE_TIME = new DbField('V_TREAT', 'V_TREAT', 'x_SERVICE_TIME', 'SERVICE_TIME', '[SERVICE_TIME]', CastDateFieldForLike("[SERVICE_TIME]", 0, "DB"), 135, 8, 0, false, '[SERVICE_TIME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TAKEN_TIME
        $this->TAKEN_TIME = new DbField('V_TREAT', 'V_TREAT', 'x_TAKEN_TIME', 'TAKEN_TIME', '[TAKEN_TIME]', CastDateFieldForLike("[TAKEN_TIME]", 0, "DB"), 135, 8, 0, false, '[TAKEN_TIME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modified_datesys
        $this->modified_datesys = new DbField('V_TREAT', 'V_TREAT', 'x_modified_datesys', 'modified_datesys', '[modified_datesys]', CastDateFieldForLike("[modified_datesys]", 0, "DB"), 135, 8, 0, false, '[modified_datesys]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TRANS_ID
        $this->TRANS_ID = new DbField('V_TREAT', 'V_TREAT', 'x_TRANS_ID', 'TRANS_ID', '[TRANS_ID]', '[TRANS_ID]', 200, 50, -1, false, '[TRANS_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SPPBILL
        $this->SPPBILL = new DbField('V_TREAT', 'V_TREAT', 'x_SPPBILL', 'SPPBILL', '[SPPBILL]', '[SPPBILL]', 200, 50, -1, false, '[SPPBILL]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SPPBILLDATE
        $this->SPPBILLDATE = new DbField('V_TREAT', 'V_TREAT', 'x_SPPBILLDATE', 'SPPBILLDATE', '[SPPBILLDATE]', CastDateFieldForLike("[SPPBILLDATE]", 0, "DB"), 135, 8, 0, false, '[SPPBILLDATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SPPBILLUSER
        $this->SPPBILLUSER = new DbField('V_TREAT', 'V_TREAT', 'x_SPPBILLUSER', 'SPPBILLUSER', '[SPPBILLUSER]', '[SPPBILLUSER]', 200, 50, -1, false, '[SPPBILLUSER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SPPKASIR
        $this->SPPKASIR = new DbField('V_TREAT', 'V_TREAT', 'x_SPPKASIR', 'SPPKASIR', '[SPPKASIR]', '[SPPKASIR]', 200, 50, -1, false, '[SPPKASIR]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SPPKASIRDATE
        $this->SPPKASIRDATE = new DbField('V_TREAT', 'V_TREAT', 'x_SPPKASIRDATE', 'SPPKASIRDATE', '[SPPKASIRDATE]', CastDateFieldForLike("[SPPKASIRDATE]", 0, "DB"), 135, 8, 0, false, '[SPPKASIRDATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SPPKASIRUSER
        $this->SPPKASIRUSER = new DbField('V_TREAT', 'V_TREAT', 'x_SPPKASIRUSER', 'SPPKASIRUSER', '[SPPKASIRUSER]', '[SPPKASIRUSER]', 200, 50, -1, false, '[SPPKASIRUSER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SPPPOLI
        $this->SPPPOLI = new DbField('V_TREAT', 'V_TREAT', 'x_SPPPOLI', 'SPPPOLI', '[SPPPOLI]', '[SPPPOLI]', 200, 50, -1, false, '[SPPPOLI]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SPPPOLIUSER
        $this->SPPPOLIUSER = new DbField('V_TREAT', 'V_TREAT', 'x_SPPPOLIUSER', 'SPPPOLIUSER', '[SPPPOLIUSER]', '[SPPPOLIUSER]', 200, 50, -1, false, '[SPPPOLIUSER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SPPPOLIDATE
        $this->SPPPOLIDATE = new DbField('V_TREAT', 'V_TREAT', 'x_SPPPOLIDATE', 'SPPPOLIDATE', '[SPPPOLIDATE]', CastDateFieldForLike("[SPPPOLIDATE]", 0, "DB"), 135, 8, 0, false, '[SPPPOLIDATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NOSEP
        $this->NOSEP = new DbField('V_TREAT', 'V_TREAT', 'x_NOSEP', 'NOSEP', '[NOSEP]', '[NOSEP]', 200, 50, -1, false, '[NOSEP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ID
        $this->ID = new DbField('V_TREAT', 'V_TREAT', 'x_ID', 'ID', '[ID]', 'CAST([ID] AS NVARCHAR)', 3, 4, -1, false, '[ID]', false, false, false, 'FORMATTED TEXT', 'NO');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "dbo.TREATMENT_BILL INNER JOIN dbo.TREATMENT_OBAT ON dbo.TREATMENT_BILL.BILL_ID = dbo.TREATMENT_OBAT.BILL_ID AND dbo.TREATMENT_BILL.VISIT_ID = dbo.TREATMENT_OBAT.VISIT_ID";
    }
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("dbo.TREATMENT_OBAT.*");
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VTreatList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "VTreatEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VTreatAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VTreatView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VTreatView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VTreatAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VTreatAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("VTreatEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VTreatAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VTreatDelete", $this->getUrlParm());
    }
