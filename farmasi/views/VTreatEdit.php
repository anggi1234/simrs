...
loadjs.ready("head", function () {
    ...
    fV_TREATedit = currentForm = new ew.Form("fV_TREATedit", "edit");
    ...
    // Validate form
    fV_TREATedit.validate = function () {
    ...
    // Form_CustomValidate
    fV_TREATedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fV_TREATedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fV_TREATedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fV_TREATedit" id="fV_TREATedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fV_TREATedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_TREATedit", "x_TREAT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fV_TREATedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_TREATedit", "x_EXIT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fV_TREATedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_TREATedit", "x_MODIFIED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fV_TREATedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_TREATedit", "x_PAYMENT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fV_TREATedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_TREATedit", "x_print_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fV_TREATedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_TREATedit", "x_SERVICE_TIME", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fV_TREATedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_TREATedit", "x_TAKEN_TIME", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fV_TREATedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_TREATedit", "x_modified_datesys", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fV_TREATedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_TREATedit", "x_SPPBILLDATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fV_TREATedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_TREATedit", "x_SPPKASIRDATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fV_TREATedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_TREATedit", "x_SPPPOLIDATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->ID->Visible) { // ID ?>
    <div id="r_ID" class="form-group row">
        <label id="elh_V_TREAT_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ID->caption() ?><?= $Page->ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ID->cellAttributes() ?>>
<span id="el_V_TREAT_ID">
<span<?= $Page->ID->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->ID->getDisplayValue($Page->ID->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="V_TREAT" data-field="x_ID" data-hidden="1" name="x_ID" id="x_ID" value="<?= HtmlEncode($Page->ID->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
</div><!-- /page* -->
