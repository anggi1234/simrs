...
<?php } ?>
<?php if ($V_RAWAT_INAP->EXIT_DATE->Visible) { // EXIT_DATE ?>
        <tr id="r_EXIT_DATE">
            <td class="<?= $V_RAWAT_INAP->TableLeftColumnClass ?>"><?= $V_RAWAT_INAP->EXIT_DATE->caption() ?></td>
            <td <?= $V_RAWAT_INAP->EXIT_DATE->cellAttributes() ?>>
<span id="el_V_RAWAT_INAP_EXIT_DATE">
<span<?= $V_RAWAT_INAP->EXIT_DATE->viewAttributes() ?>>
<?= $V_RAWAT_INAP->EXIT_DATE->getViewValue() ?></span>
</span>
</td>
        </tr>
<?php } ?>
<?php if ($V_RAWAT_INAP->ID->Visible) { // ID ?>
        <tr id="r_ID">
            <td class="<?= $V_RAWAT_INAP->TableLeftColumnClass ?>"><?= $V_RAWAT_INAP->ID->caption() ?></td>
            <td <?= $V_RAWAT_INAP->ID->cellAttributes() ?>>
<span id="el_V_RAWAT_INAP_ID">
<span<?= $V_RAWAT_INAP->ID->viewAttributes() ?>>
<?= $V_RAWAT_INAP->ID->getViewValue() ?></span>
</span>
</td>
        </tr>
<?php } ?>
<?php if ($V_RAWAT_INAP->IDXDAFTAR->Visible) { // IDXDAFTAR ?>
        <tr id="r_IDXDAFTAR">
            <td class="<?= $V_RAWAT_INAP->TableLeftColumnClass ?>"><?= $V_RAWAT_INAP->IDXDAFTAR->caption() ?></td>
            <td <?= $V_RAWAT_INAP->IDXDAFTAR->cellAttributes() ?>>
<span id="el_V_RAWAT_INAP_IDXDAFTAR">
<span<?= $V_RAWAT_INAP->IDXDAFTAR->viewAttributes() ?>>
<?= $V_RAWAT_INAP->IDXDAFTAR->getViewValue() ?></span>
</span>
</td>
        </tr>
<?php } ?>
