...
<?php if ($Page->IDXDAFTAR->Visible) { // IDXDAFTAR ?>
    <div id="r_IDXDAFTAR" class="form-group row">
        <label for="x_IDXDAFTAR" class="<?= $Page->LeftColumnClass ?>"><span id="elh_TREATMENT_BILL_IDXDAFTAR"><?= $Page->IDXDAFTAR->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_IDXDAFTAR" id="z_IDXDAFTAR" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->IDXDAFTAR->cellAttributes() ?>>
            <span id="el_TREATMENT_BILL_IDXDAFTAR" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->IDXDAFTAR->getInputTextType() ?>" data-table="TREATMENT_BILL" data-field="x_IDXDAFTAR" name="x_IDXDAFTAR" id="x_IDXDAFTAR" size="30" placeholder="<?= HtmlEncode($Page->IDXDAFTAR->getPlaceHolder()) ?>" value="<?= $Page->IDXDAFTAR->EditValue ?>"<?= $Page->IDXDAFTAR->editAttributes() ?>>
