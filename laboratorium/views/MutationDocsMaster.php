...
<?php } ?>
<?php if ($MUTATION_DOCS->DISTRIBUTION_TYPE->Visible) { // DISTRIBUTION_TYPE ?>
        <tr id="r_DISTRIBUTION_TYPE">
            <td class="<?= $MUTATION_DOCS->TableLeftColumnClass ?>"><?= $MUTATION_DOCS->DISTRIBUTION_TYPE->caption() ?></td>
            <td <?= $MUTATION_DOCS->DISTRIBUTION_TYPE->cellAttributes() ?>>
<span id="el_MUTATION_DOCS_DISTRIBUTION_TYPE">
<span<?= $MUTATION_DOCS->DISTRIBUTION_TYPE->viewAttributes() ?>>
<?= $MUTATION_DOCS->DISTRIBUTION_TYPE->getViewValue() ?></span>
</span>
</td>
        </tr>
<?php } ?>
<?php if ($MUTATION_DOCS->ID->Visible) { // ID ?>
        <tr id="r_ID">
            <td class="<?= $MUTATION_DOCS->TableLeftColumnClass ?>"><?= $MUTATION_DOCS->ID->caption() ?></td>
            <td <?= $MUTATION_DOCS->ID->cellAttributes() ?>>
<span id="el_MUTATION_DOCS_ID">
<span<?= $MUTATION_DOCS->ID->viewAttributes() ?>>
<?= $MUTATION_DOCS->ID->getViewValue() ?></span>
</span>
</td>
        </tr>
<?php } ?>
