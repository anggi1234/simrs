...
<form name="fV_RADIOLOGIlistsrch" id="fV_RADIOLOGIlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= HtmlEncode(GetUrl(CurrentPageName())) ?>">
...
<?php } ?>
<form name="fV_RADIOLOGIlist" id="fV_RADIOLOGIlist" class="form-inline ew-form ew-list-form" action="<?= HtmlEncode(GetUrl(CurrentPageName())) ?>" method="post">
