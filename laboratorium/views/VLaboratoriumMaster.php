...
<?php } ?>
<?php if ($V_LABORATORIUM->BOOKED_DATE->Visible) { // BOOKED_DATE ?>
        <tr id="r_BOOKED_DATE">
            <td class="<?= $V_LABORATORIUM->TableLeftColumnClass ?>"><?= $V_LABORATORIUM->BOOKED_DATE->caption() ?></td>
            <td <?= $V_LABORATORIUM->BOOKED_DATE->cellAttributes() ?>>
<span id="el_V_LABORATORIUM_BOOKED_DATE">
<span<?= $V_LABORATORIUM->BOOKED_DATE->viewAttributes() ?>>
<?= $V_LABORATORIUM->BOOKED_DATE->getViewValue() ?></span>
</span>
</td>
        </tr>
<?php } ?>
