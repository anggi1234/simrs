...
<?php if ($Page->NO_SURAT_KET->Visible) { // NO_SURAT_KET ?>
        <th data-name="NO_SURAT_KET" class="<?= $Page->NO_SURAT_KET->headerCellClass() ?>"><div id="elh_V_RAWAT_INAP_NO_SURAT_KET" class="V_RAWAT_INAP_NO_SURAT_KET"><?= $Page->renderSort($Page->NO_SURAT_KET) ?></div></th>
<?php } ?>
