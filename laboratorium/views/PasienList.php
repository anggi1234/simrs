...
<?php if ($Page->newapp->Visible) { // newapp ?>
        <th data-name="newapp" class="<?= $Page->newapp->headerCellClass() ?>"><div id="elh_PASIEN_newapp" class="PASIEN_newapp"><?= $Page->renderSort($Page->newapp) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_PASIEN_newapp">
