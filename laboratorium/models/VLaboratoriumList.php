...
class VLaboratoriumList extends VLaboratorium
{
    ...
    public function renderListOptions()
    {
        ...
        if ($Security->allowList(CurrentProjectID() . 'TREATMENT_BILL')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("TreatmentBillList?" . Config("TABLE_SHOW_MASTER") . "=V_LABORATORIUM&" . GetForeignKeyUrl("fk_VISIT_ID", $this->VISIT_ID->CurrentValue) . "&" . GetForeignKeyUrl("fk_TRANS_ID", $this->TRANS_ID->CurrentValue) . "&" . GetForeignKeyUrl("fk_NO_REGISTRATION", $this->NO_REGISTRATION->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
