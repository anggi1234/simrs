...
class VLaboratoriumAdd extends VLaboratorium
{
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    $returnUrl = "VLaboratoriumList";
                    if (GetPageName($returnUrl) == "VLaboratoriumList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "VLaboratoriumView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // SERVED_DATE
        $this->SERVED_DATE->CurrentValue = CurrentDateTime();
        $this->SERVED_DATE->setDbValueDef($rsnew, $this->SERVED_DATE->CurrentValue, null);
