...
class VRadiologi extends DbTable
{
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($cascadeUpdate) {
            $rswrk = Container("TREATMENT_BILL")->loadRs("[VISIT_ID] = " . QuotedValue($rsold['VISIT_ID'], DATATYPE_STRING, 'DB'))->fetchAll(\PDO::FETCH_ASSOC);
    ...
    public function delete(&$rs, $where = "", $curfilter = false)
    {
        ...
        $dtlrows = Container("TREATMENT_BILL")->loadRs("[VISIT_ID] = " . QuotedValue($rs['VISIT_ID'], DATATYPE_STRING, "DB"))->fetchAll(\PDO::FETCH_ASSOC);
