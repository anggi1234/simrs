...
class VLaboratorium extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // VISIT_ID
        $this->VISIT_ID = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_VISIT_ID', 'VISIT_ID', '[VISIT_ID]', '[VISIT_ID]', 200, 50, -1, false, '[VISIT_ID]', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
