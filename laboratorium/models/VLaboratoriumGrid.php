...
class VLaboratoriumGrid extends VLaboratorium
{
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_DIANTAR_OLEH") && $CurrentForm->hasValue("o_DIANTAR_OLEH") && $this->DIANTAR_OLEH->CurrentValue != $this->DIANTAR_OLEH->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_GENDER") && $CurrentForm->hasValue("o_GENDER") && $this->GENDER->CurrentValue != $this->GENDER->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_VISITOR_ADDRESS") && $CurrentForm->hasValue("o_VISITOR_ADDRESS") && $this->VISITOR_ADDRESS->CurrentValue != $this->VISITOR_ADDRESS->OldValue) {
            return false;
        }
    ...
    public function resetFormError()
    {
        ...
        $this->DIANTAR_OLEH->clearErrorMessage();
        $this->GENDER->clearErrorMessage();
        $this->VISITOR_ADDRESS->clearErrorMessage();
        $this->BOOKED_DATE->clearErrorMessage();
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_DIANTAR_OLEH")) {
            $this->DIANTAR_OLEH->setOldValue($CurrentForm->getValue("o_DIANTAR_OLEH"));
        }
        ...
        if ($CurrentForm->hasValue("o_VISITOR_ADDRESS")) {
            $this->VISITOR_ADDRESS->setOldValue($CurrentForm->getValue("o_VISITOR_ADDRESS"));
        }
        ...
        if ($CurrentForm->hasValue("o_BOOKED_DATE")) {
            $this->BOOKED_DATE->setOldValue($CurrentForm->getValue("o_BOOKED_DATE"));
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if ($this->DIANTAR_OLEH->getSessionValue() != "") {
                $this->DIANTAR_OLEH->CurrentValue = GetForeignKeyValue($this->DIANTAR_OLEH->getSessionValue());
                $this->DIANTAR_OLEH->OldValue = $this->DIANTAR_OLEH->CurrentValue;
                $this->DIANTAR_OLEH->ViewValue = $this->DIANTAR_OLEH->CurrentValue;
                $this->DIANTAR_OLEH->ViewCustomAttributes = "";
            } else {
            ...
            if ($this->VISITOR_ADDRESS->getSessionValue() != "") {
                $this->VISITOR_ADDRESS->CurrentValue = GetForeignKeyValue($this->VISITOR_ADDRESS->getSessionValue());
                $this->VISITOR_ADDRESS->OldValue = $this->VISITOR_ADDRESS->CurrentValue;
                $this->VISITOR_ADDRESS->ViewValue = $this->VISITOR_ADDRESS->CurrentValue;
                $this->VISITOR_ADDRESS->ViewCustomAttributes = "";
            } else {
