...
class MutationDocsView extends MutationDocs
{
    ...
    protected function setupOtherOptions()
    {
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("GoodGfList?" . Config("TABLE_SHOW_MASTER") . "=MUTATION_DOCS&" . GetForeignKeyUrl("fk_DOC_NO", $this->DOC_NO->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
