...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "SIMRSSQLSERVERLABORATORIUM"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{E22A4E7A-D23E-4448-8232-AE224A7C4EA2}"); // Project ID
