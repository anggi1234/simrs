...
$DATA_DPA = mysqli_fetch_assoc($querydpa);
...
<body>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>OPD</td>
      <td>1.02.03.001</td>
      <td>Rumah Sakit Umum Daerah Besemah</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>c.</td>
...
$querytotal   = "SELECT SUM(anggaran_terpakai) AS 'totaldpa' FROM v_keu_anggaran_terpakai";
$getquertotal = mysqli_query($mysqli, $querytotal);
$DATA_DPA     = mysqli_fetch_array($getquertotal);
...
$dompdf->render();
$dompdf->stream('Laporan_SPPLS.pdf', ['Attachment' => 0]);
?>