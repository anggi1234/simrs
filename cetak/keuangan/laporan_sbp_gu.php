...
ob_start();
include '../connect.php';
// $id_bukti_pengeluaran = $_GET['id_bukti_pengeluaran_gu'];
$id_bukti_pengeluaran = 40;
...
$sqlidentitas = "SELECT
    ...
    c.nip AS 'nip_pptk',
    d.no_identitas AS 'nip_pengguna_anggaran',
    e.no_identitas AS 'nip_bendahara',
    a.uraian
FROM
    keu_bukti_pengeluaran_gu a
        LEFT JOIN
...
WHERE
    a.id_bukti_pengeluaran_gu = $id_bukti_pengeluaran";
...
<head>
<meta charset="utf-8">
<title>Surat Bukti Pengeluaran LS</title>
<style type="text/css">
	@page {
            margin-top: 0.5 cm;
            margin-left: 0.5 cm;
      ...
      <td width="64%"><table width="100%" border="0">
        <tbody>
          ...
          <tr>
            ...
            <td>:</td>
            <td><?php echo $DATA_IDENTITAS['nama_rekening']; ?> pada RSUD Besemah</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td>:</td>
            <td colspan="2">Pembayaran <?php echo $DATA_IDENTITAS['nama_rekening']; ?> <?php echo $DATA_IDENTITAS['uraian']; ?></td>
            </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
...
$paper_size = [0, 0, 8.26 * 72, 12.69 * 72];
$dompdf->set_paper($paper_size, 'portrait');
$dompdf->load_html($html);
$dompdf->render();
$dompdf->stream('laporan_sbp_ls.pdf', ['Attachment' => 0]);
?>