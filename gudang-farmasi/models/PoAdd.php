...
class PoAdd extends Po
{
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PoView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->PROCURE_METHOD->CurrentValue = null;
        $this->PROCURE_METHOD->OldValue = $this->PROCURE_METHOD->CurrentValue;
        ...
        $this->FUND_NO->CurrentValue = null;
        $this->FUND_NO->OldValue = $this->FUND_NO->CurrentValue;
        ...
        $this->SENT_TO->CurrentValue = null;
        $this->SENT_TO->OldValue = $this->SENT_TO->CurrentValue;
        $this->ISVALID->CurrentValue = null;
        $this->ISVALID->OldValue = $this->ISVALID->CurrentValue;
        $this->START_VALID->CurrentValue = null;
        $this->START_VALID->OldValue = $this->START_VALID->CurrentValue;
        $this->END_VALID->CurrentValue = null;
        $this->END_VALID->OldValue = $this->END_VALID->CurrentValue;
        ...
        $this->TAGIHAN_VALUE->CurrentValue = null;
        $this->TAGIHAN_VALUE->OldValue = $this->TAGIHAN_VALUE->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row['PROCURE_METHOD'] = $this->PROCURE_METHOD->CurrentValue;
        $row['COMPANY_ID'] = $this->COMPANY_ID->CurrentValue;
        $row['FUND_ID'] = $this->FUND_ID->CurrentValue;
        $row['FUND_NO'] = $this->FUND_NO->CurrentValue;
        ...
        $row['SENT_TO'] = $this->SENT_TO->CurrentValue;
        $row['ISVALID'] = $this->ISVALID->CurrentValue;
        $row['START_VALID'] = $this->START_VALID->CurrentValue;
        $row['END_VALID'] = $this->END_VALID->CurrentValue;
        ...
        $row['TAGIHAN_VALUE'] = $this->TAGIHAN_VALUE->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // PROCURE_METHOD
        $this->PROCURE_METHOD->setDbValueDef($rsnew, $this->PROCURE_METHOD->CurrentValue, null, false);
        ...
        // FUND_NO
        $this->FUND_NO->setDbValueDef($rsnew, $this->FUND_NO->CurrentValue, null, false);
        ...
        // SENT_TO
        $this->SENT_TO->setDbValueDef($rsnew, $this->SENT_TO->CurrentValue, null, false);

        // ISVALID
        $this->ISVALID->setDbValueDef($rsnew, $this->ISVALID->CurrentValue, null, false);

        // START_VALID
        $this->START_VALID->setDbValueDef($rsnew, UnFormatDateTime($this->START_VALID->CurrentValue, 0), null, false);

        // END_VALID
        $this->END_VALID->setDbValueDef($rsnew, UnFormatDateTime($this->END_VALID->CurrentValue, 0), null, false);
        ...
        // TAGIHAN_VALUE
        $this->TAGIHAN_VALUE->setDbValueDef($rsnew, $this->TAGIHAN_VALUE->CurrentValue, null, false);
