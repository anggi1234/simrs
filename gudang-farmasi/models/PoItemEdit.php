 ...
 * Page class
 */
class PoItemEdit extends PoItem
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            ...
            if (($keyValue = Get("PO") ?? Key(1) ?? Route(3)) !== null) {
            ...
            if (($keyValue = Get("BRAND_ID") ?? Key(2) ?? Route(4)) !== null) {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // PURCHASE_PRICE
            $this->PURCHASE_PRICE->setDbValueDef($rsnew, $this->PURCHASE_PRICE->CurrentValue, null, $this->PURCHASE_PRICE->ReadOnly);
            ...
            // ATP_DATE
            $this->ATP_DATE->setDbValueDef($rsnew, UnFormatDateTime($this->ATP_DATE->CurrentValue, 0), null, $this->ATP_DATE->ReadOnly);
            ...
            // QUANTITY0
            $this->QUANTITY0->setDbValueDef($rsnew, $this->QUANTITY0->CurrentValue, null, $this->QUANTITY0->ReadOnly);

            // PROPOSEDQ
            $this->PROPOSEDQ->setDbValueDef($rsnew, $this->PROPOSEDQ->CurrentValue, null, $this->PROPOSEDQ->ReadOnly);

            // STOCKQ
            $this->STOCKQ->setDbValueDef($rsnew, $this->STOCKQ->CurrentValue, null, $this->STOCKQ->ReadOnly);
