 ...
 * Page class
 */
class PoVerificationAdd extends PoVerification
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PoVerificationAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PoVerificationView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->ISVALID->OldValue = $this->ISVALID->CurrentValue;
        ...
        $this->VERIFICATION_DESC->CurrentValue = null;
        $this->VERIFICATION_DESC->OldValue = $this->VERIFICATION_DESC->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row['ISVALID'] = $this->ISVALID->CurrentValue;
        $row['VERIFIED_DATE'] = $this->VERIFIED_DATE->CurrentValue;
        $row['VERIFIED_BY'] = $this->VERIFIED_BY->CurrentValue;
        $row['VERIFICATION_DESC'] = $this->VERIFICATION_DESC->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // ISVALID
        $this->ISVALID->setDbValueDef($rsnew, $this->ISVALID->CurrentValue, "", false);

        // VERIFIED_DATE
        $this->VERIFIED_DATE->setDbValueDef($rsnew, UnFormatDateTime($this->VERIFIED_DATE->CurrentValue, 0), CurrentDate(), false);

        // VERIFIED_BY
        $this->VERIFIED_BY->setDbValueDef($rsnew, $this->VERIFIED_BY->CurrentValue, null, false);

        // VERIFICATION_DESC
        $this->VERIFICATION_DESC->setDbValueDef($rsnew, $this->VERIFICATION_DESC->CurrentValue, null, false);
        ...
        // Check if key value entered
        if ($insertRow && $this->ValidateKey && strval($rsnew['ISVALID']) == "") {
            $this->setFailureMessage($Language->phrase("InvalidKeyValue"));
            $insertRow = false;
        }

        // Check if key value entered
        if ($insertRow && $this->ValidateKey && strval($rsnew['VERIFIED_DATE']) == "") {
            $this->setFailureMessage($Language->phrase("InvalidKeyValue"));
            $insertRow = false;
        }
