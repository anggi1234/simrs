...
class VLaboratorium extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // EXIT_DATE
        $this->EXIT_DATE = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_EXIT_DATE', 'EXIT_DATE', '[EXIT_DATE]', CastDateFieldForLike("[EXIT_DATE]", 11, "DB"), 135, 8, 11, false, '[EXIT_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 17, "DB"), 135, 8, 17, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
