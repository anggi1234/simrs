...
class GoodGf extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // ORG_ID
        $this->ORG_ID = new DbField('GOOD_GF', 'GOOD_GF', 'x_ORG_ID', 'ORG_ID', '[ORG_ID]', '[ORG_ID]', 200, 50, -1, false, '[ORG_ID]', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->BRAND_ID->Lookup = new Lookup('BRAND_ID', 'GOODS', false, 'BRAND_ID', ["NAME","STOCK","HET",""], [], [], [], [], ["NAME"], ["x_BRAND_NAME"], '', '');
                break;
            default:
                $this->BRAND_ID->Lookup = new Lookup('BRAND_ID', 'GOODS', false, 'BRAND_ID', ["NAME","STOCK","HET",""], [], [], [], [], ["NAME"], ["x_BRAND_NAME"], '', '');
                break;
