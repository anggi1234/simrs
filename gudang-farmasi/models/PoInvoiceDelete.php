 ...
 * Page class
 */
class PoInvoiceDelete extends PoInvoice
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PoInvoiceDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PoInvoiceList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PoInvoiceList"); // Return to list
                return;
            }
        }
