 ...
 * Page class
 */
class PoInvoiceEdit extends PoInvoice
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PoInvoiceEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // RECEIVED_DATE
            $this->RECEIVED_DATE->setDbValueDef($rsnew, UnFormatDateTime($this->RECEIVED_DATE->CurrentValue, 0), null, $this->RECEIVED_DATE->ReadOnly);

            // AMOUNT
            $this->AMOUNT->setDbValueDef($rsnew, $this->AMOUNT->CurrentValue, null, $this->AMOUNT->ReadOnly);

            // PAYMENT_DUE
            $this->PAYMENT_DUE->setDbValueDef($rsnew, UnFormatDateTime($this->PAYMENT_DUE->CurrentValue, 0), null, $this->PAYMENT_DUE->ReadOnly);
            ...
            // CREDIT_NOTE
            $this->CREDIT_NOTE->setDbValueDef($rsnew, $this->CREDIT_NOTE->CurrentValue, null, $this->CREDIT_NOTE->ReadOnly);

            // CREDIT_AMOUNT
            $this->CREDIT_AMOUNT->setDbValueDef($rsnew, $this->CREDIT_AMOUNT->CurrentValue, null, $this->CREDIT_AMOUNT->ReadOnly);
            ...
            // SENT_BY
            $this->SENT_BY->setDbValueDef($rsnew, $this->SENT_BY->CurrentValue, null, $this->SENT_BY->ReadOnly);

            // ACCOUNT_ID
            $this->ACCOUNT_ID->setDbValueDef($rsnew, $this->ACCOUNT_ID->CurrentValue, null, $this->ACCOUNT_ID->ReadOnly);

            // FINANCE_ID
            $this->FINANCE_ID->setDbValueDef($rsnew, $this->FINANCE_ID->CurrentValue, null, $this->FINANCE_ID->ReadOnly);
            ...
            // FAKTUR_DATE
            $this->FAKTUR_DATE->setDbValueDef($rsnew, UnFormatDateTime($this->FAKTUR_DATE->CurrentValue, 0), null, $this->FAKTUR_DATE->ReadOnly);

            // DISTRIBUTION_TYPE
            $this->DISTRIBUTION_TYPE->setDbValueDef($rsnew, $this->DISTRIBUTION_TYPE->CurrentValue, null, $this->DISTRIBUTION_TYPE->ReadOnly);

            // DISCOUNTOFF_VALUE
            $this->DISCOUNTOFF_VALUE->setDbValueDef($rsnew, $this->DISCOUNTOFF_VALUE->CurrentValue, null, $this->DISCOUNTOFF_VALUE->ReadOnly);

            // THECOUNTER
            $this->THECOUNTER->setDbValueDef($rsnew, $this->THECOUNTER->CurrentValue, null, $this->THECOUNTER->ReadOnly);
            ...
            // ISPO
            $this->ISPO->setDbValueDef($rsnew, $this->ISPO->CurrentValue, null, $this->ISPO->ReadOnly);

            // DOCS_TYPE
            $this->DOCS_TYPE->setDbValueDef($rsnew, $this->DOCS_TYPE->CurrentValue, null, $this->DOCS_TYPE->ReadOnly);

            // PO_DATE
            $this->PO_DATE->setDbValueDef($rsnew, UnFormatDateTime($this->PO_DATE->CurrentValue, 0), null, $this->PO_DATE->ReadOnly);

            // PO_VALUE
            $this->PO_VALUE->setDbValueDef($rsnew, $this->PO_VALUE->CurrentValue, null, $this->PO_VALUE->ReadOnly);
