 ...
 * Page class
 */
class PrescDelete extends Presc
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PrescDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PrescList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PrescList"); // Return to list
                return;
            }
        }
