 ...
 * Page class
 */
class PoVerificationList extends PoVerification
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PoVerificationList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fPO_VERIFICATIONlist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "PoVerificationAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "PoVerificationDelete";
        $this->MultiUpdateUrl = "PoVerificationUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fPO_VERIFICATIONlistsrch";
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->VERIFIED_DATE->AdvancedSearch->toJson(), ","); // Field VERIFIED_DATE
        $filterList = Concat($filterList, $this->VERIFIED_BY->AdvancedSearch->toJson(), ","); // Field VERIFIED_BY
        $filterList = Concat($filterList, $this->VERIFICATION_DESC->AdvancedSearch->toJson(), ","); // Field VERIFICATION_DESC
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fPO_VERIFICATIONlistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field VERIFICATION_DESC
        $this->VERIFICATION_DESC->AdvancedSearch->SearchValue = @$filter["x_VERIFICATION_DESC"];
        $this->VERIFICATION_DESC->AdvancedSearch->SearchOperator = @$filter["z_VERIFICATION_DESC"];
        $this->VERIFICATION_DESC->AdvancedSearch->SearchCondition = @$filter["v_VERIFICATION_DESC"];
        $this->VERIFICATION_DESC->AdvancedSearch->SearchValue2 = @$filter["y_VERIFICATION_DESC"];
        $this->VERIFICATION_DESC->AdvancedSearch->SearchOperator2 = @$filter["w_VERIFICATION_DESC"];
        $this->VERIFICATION_DESC->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->VERIFIED_BY, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->VERIFICATION_DESC, $arKeywords, $type);
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->VERIFICATION_DESC); // VERIFICATION_DESC
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->VERIFICATION_DESC->setSort("");
    ...
    public function renderListOptions()
    {
        ...
        $opt->Body = "<div class=\"custom-control custom-checkbox d-inline-block\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"custom-control-input ew-multi-select\" value=\"" . HtmlEncode($this->PO->CurrentValue . Config("COMPOSITE_KEY_SEPARATOR") . $this->ISVALID->CurrentValue . Config("COMPOSITE_KEY_SEPARATOR") . $this->VERIFIED_DATE->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\"><label class=\"custom-control-label\" for=\"key_m_" . $this->RowCount . "\"></label></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fPO_VERIFICATIONlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fPO_VERIFICATIONlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fPO_VERIFICATIONlist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fPO_VERIFICATIONlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
