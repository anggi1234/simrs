...
loadjs.ready("head", function () {
    ...
    fPO_INVOICEadd = currentForm = new ew.Form("fPO_INVOICEadd", "add");
    ...
    // Validate form
    fPO_INVOICEadd.validate = function () {
    ...
    // Form_CustomValidate
    fPO_INVOICEadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fPO_INVOICEadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fPO_INVOICEadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fPO_INVOICEadd" id="fPO_INVOICEadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fPO_INVOICEadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fPO_INVOICEadd", "x_INVOICE_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fPO_INVOICEadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fPO_INVOICEadd", "x_RECEIVED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fPO_INVOICEadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fPO_INVOICEadd", "x_PAYMENT_DUE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fPO_INVOICEadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fPO_INVOICEadd", "x_MODIFIED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fPO_INVOICEadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fPO_INVOICEadd", "x_PRINT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fPO_INVOICEadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fPO_INVOICEadd", "x_FAKTUR_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fPO_INVOICEadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fPO_INVOICEadd", "x_PO_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
