...
<?php if ($Page->GENDER->Visible) { // GENDER ?>
        <th data-name="GENDER" class="<?= $Page->GENDER->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_TREATMENT_BILL_GENDER" class="TREATMENT_BILL_GENDER"><?= $Page->renderSort($Page->GENDER) ?></div></th>
<?php } ?>
<?php if ($Page->ID->Visible) { // ID ?>
        <th data-name="ID" class="<?= $Page->ID->headerCellClass() ?>"><div id="elh_TREATMENT_BILL_ID" class="TREATMENT_BILL_ID"><?= $Page->renderSort($Page->ID) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_TREATMENT_BILL_GENDER">
...
<span id="el<?= $Page->RowCount ?>_TREATMENT_BILL_ID">
