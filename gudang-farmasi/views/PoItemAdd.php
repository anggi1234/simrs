...
loadjs.ready("head", function () {
    ...
    fPO_ITEMadd = currentForm = new ew.Form("fPO_ITEMadd", "add");
    ...
    // Form_CustomValidate
    fPO_ITEMadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fPO_ITEMadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fPO_ITEMadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fPO_ITEMadd" id="fPO_ITEMadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fPO_ITEMadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fPO_ITEMadd", "x_ORDER_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fPO_ITEMadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fPO_ITEMadd", "x_ATP_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fPO_ITEMadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fPO_ITEMadd", "x_DELIVERY_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fPO_ITEMadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fPO_ITEMadd", "x_MODIFIED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fPO_ITEMadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fPO_ITEMadd", "x_PRINT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
