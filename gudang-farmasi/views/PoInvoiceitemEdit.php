...
<input type="<?= $Page->ORDER_DATE->getInputTextType() ?>" data-table="PO_INVOICEITEM" data-field="x_ORDER_DATE" name="x_ORDER_DATE" id="x_ORDER_DATE" placeholder="<?= HtmlEncode($Page->ORDER_DATE->getPlaceHolder()) ?>" value="<?= $Page->ORDER_DATE->EditValue ?>"<?= $Page->ORDER_DATE->editAttributes() ?> aria-describedby="x_ORDER_DATE_help">
...
loadjs.ready(["fPO_INVOICEITEMedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fPO_INVOICEITEMedit", "x_ORDER_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<input type="<?= $Page->ATP_DATE->getInputTextType() ?>" data-table="PO_INVOICEITEM" data-field="x_ATP_DATE" name="x_ATP_DATE" id="x_ATP_DATE" placeholder="<?= HtmlEncode($Page->ATP_DATE->getPlaceHolder()) ?>" value="<?= $Page->ATP_DATE->EditValue ?>"<?= $Page->ATP_DATE->editAttributes() ?> aria-describedby="x_ATP_DATE_help">
...
<script>
loadjs.ready(["fPO_INVOICEITEMedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fPO_INVOICEITEMedit", "x_ATP_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fPO_INVOICEITEMedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fPO_INVOICEITEMedit", "x_DELIVERY_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fPO_INVOICEITEMedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fPO_INVOICEITEMedit", "x_MODIFIED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->MODIFIED_BY->Visible) { // MODIFIED_BY ?>
    <div id="r_MODIFIED_BY" class="form-group row">
        <label id="elh_PO_INVOICEITEM_MODIFIED_BY" for="x_MODIFIED_BY" class="<?= $Page->LeftColumnClass ?>"><?= $Page->MODIFIED_BY->caption() ?><?= $Page->MODIFIED_BY->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<input type="hidden" data-table="PO_INVOICEITEM" data-field="x_IDX" data-hidden="1" name="x_IDX" id="x_IDX" value="<?= HtmlEncode($Page->IDX->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
