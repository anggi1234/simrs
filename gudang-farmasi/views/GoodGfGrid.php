...
<input type="hidden" data-table="GOOD_GF" data-field="x_ORG_ID" data-hidden="1" name="x<?= $Grid->RowIndex ?>_ORG_ID" id="x<?= $Grid->RowIndex ?>_ORG_ID" value="<?= HtmlEncode($Grid->ORG_ID->CurrentValue) ?>">
</span>
