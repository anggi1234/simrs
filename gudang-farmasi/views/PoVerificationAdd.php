...
// Page object
$PoVerificationAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fPO_VERIFICATIONadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fPO_VERIFICATIONadd = currentForm = new ew.Form("fPO_VERIFICATIONadd", "add");
    ...
    // Validate form
    fPO_VERIFICATIONadd.validate = function () {
    ...
    // Form_CustomValidate
    fPO_VERIFICATIONadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fPO_VERIFICATIONadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fPO_VERIFICATIONadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fPO_VERIFICATIONadd" id="fPO_VERIFICATIONadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fPO_VERIFICATIONadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fPO_VERIFICATIONadd", "x_VERIFIED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fPO_VERIFICATIONadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fPO_VERIFICATIONadd", "x_MODIFIED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
