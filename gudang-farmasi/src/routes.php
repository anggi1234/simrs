...
return function (App $app) {
    ...
    // INVOICE
    $app->any('/InvoiceList[/{ORG_UNIT_CODE}/{INVOICE_ID}]', InvoiceController::class . ':list')->add(PermissionMiddleware::class)->setName('InvoiceList-INVOICE-list'); // list
    $app->any('/InvoiceAdd[/{ORG_UNIT_CODE}/{INVOICE_ID}]', InvoiceController::class . ':add')->add(PermissionMiddleware::class)->setName('InvoiceAdd-INVOICE-add'); // add
    $app->any('/InvoiceView[/{ORG_UNIT_CODE}/{INVOICE_ID}]', InvoiceController::class . ':view')->add(PermissionMiddleware::class)->setName('InvoiceView-INVOICE-view'); // view
    $app->any('/InvoiceEdit[/{ORG_UNIT_CODE}/{INVOICE_ID}]', InvoiceController::class . ':edit')->add(PermissionMiddleware::class)->setName('InvoiceEdit-INVOICE-edit'); // edit
    $app->any('/InvoiceDelete[/{ORG_UNIT_CODE}/{INVOICE_ID}]', InvoiceController::class . ':delete')->add(PermissionMiddleware::class)->setName('InvoiceDelete-INVOICE-delete'); // delete
    $app->group(
        '/INVOICE',
        function (RouteCollectorProxy $group) {
            $group->any('/' . Config("LIST_ACTION") . '[/{ORG_UNIT_CODE}/{INVOICE_ID}]', InvoiceController::class . ':list')->add(PermissionMiddleware::class)->setName('INVOICE/list-INVOICE-list-2'); // list
            $group->any('/' . Config("ADD_ACTION") . '[/{ORG_UNIT_CODE}/{INVOICE_ID}]', InvoiceController::class . ':add')->add(PermissionMiddleware::class)->setName('INVOICE/add-INVOICE-add-2'); // add
            $group->any('/' . Config("VIEW_ACTION") . '[/{ORG_UNIT_CODE}/{INVOICE_ID}]', InvoiceController::class . ':view')->add(PermissionMiddleware::class)->setName('INVOICE/view-INVOICE-view-2'); // view
            $group->any('/' . Config("EDIT_ACTION") . '[/{ORG_UNIT_CODE}/{INVOICE_ID}]', InvoiceController::class . ':edit')->add(PermissionMiddleware::class)->setName('INVOICE/edit-INVOICE-edit-2'); // edit
            $group->any('/' . Config("DELETE_ACTION") . '[/{ORG_UNIT_CODE}/{INVOICE_ID}]', InvoiceController::class . ':delete')->add(PermissionMiddleware::class)->setName('INVOICE/delete-INVOICE-delete-2'); // delete
        }
    );
    ...
    $app->any('/VKunjunganPasienAdd[/{VISIT_ID}]', VKunjunganPasienController::class . ':add')->add(PermissionMiddleware::class)->setName('VKunjunganPasienAdd-V_KUNJUNGAN_PASIEN-add'); // add
    ...
    $app->group(
        ...
        function (RouteCollectorProxy $group) {
            ...
            $group->any('/' . Config("ADD_ACTION") . '[/{VISIT_ID}]', VKunjunganPasienController::class . ':add')->add(PermissionMiddleware::class)->setName('V_KUNJUNGAN_PASIEN/add-V_KUNJUNGAN_PASIEN-add-2'); // add
