...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "SIMRSSQLSERVERGUDANGFARMASI"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{F5F64568-84AE-4AA8-802C-F4AD3C678B89}"); // Project ID
