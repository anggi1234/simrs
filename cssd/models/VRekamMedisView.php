...
class VRekamMedisView extends VRekamMedis
{
    ...
    protected function setupOtherOptions()
    {
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("PasienDiagnosaList?" . Config("TABLE_SHOW_MASTER") . "=V_REKAM_MEDIS&" . GetForeignKeyUrl("fk_IDXDAFTAR", $this->IDXDAFTAR->CurrentValue) . "&" . GetForeignKeyUrl("fk_NO_REGISTRATION", $this->NO_REGISTRATION->CurrentValue) . "&" . GetForeignKeyUrl("fk_VISIT_ID", $this->VISIT_ID->CurrentValue) . "&" . GetForeignKeyUrl("fk_DIANTAR_OLEH", $this->DIANTAR_OLEH->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
