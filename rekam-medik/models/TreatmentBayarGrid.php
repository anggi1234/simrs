 ...
 * Page class
 */
class TreatmentBayarGrid extends TreatmentBayar
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TreatmentBayarGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fTREATMENT_BAYARgrid";
    ...
    protected function clearInlineMode()
    {
        ...
        $this->AMOUNT_PLAFOND->FormValue = ""; // Clear form value
        $this->AMOUNT_PAID_PLAFOND->FormValue = ""; // Clear form value
        ...
        $this->PERUJUKFEE->FormValue = ""; // Clear form value
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_DUEDATE_ANGSURAN") && $CurrentForm->hasValue("o_DUEDATE_ANGSURAN") && $this->DUEDATE_ANGSURAN->CurrentValue != $this->DUEDATE_ANGSURAN->OldValue) {
            return false;
        }
        ...
        if ($CurrentForm->hasValue("x_PERDA_ID") && $CurrentForm->hasValue("o_PERDA_ID") && $this->PERDA_ID->CurrentValue != $this->PERDA_ID->OldValue) {
            return false;
        }
        ...
        if ($CurrentForm->hasValue("x_FA_V") && $CurrentForm->hasValue("o_FA_V") && $this->FA_V->CurrentValue != $this->FA_V->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_TASK_ID") && $CurrentForm->hasValue("o_TASK_ID") && $this->TASK_ID->CurrentValue != $this->TASK_ID->OldValue) {
            return false;
        }
        ...
        if ($CurrentForm->hasValue("x_TREATMENT_PLAFOND") && $CurrentForm->hasValue("o_TREATMENT_PLAFOND") && $this->TREATMENT_PLAFOND->CurrentValue != $this->TREATMENT_PLAFOND->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_AMOUNT_PLAFOND") && $CurrentForm->hasValue("o_AMOUNT_PLAFOND") && $this->AMOUNT_PLAFOND->CurrentValue != $this->AMOUNT_PLAFOND->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_AMOUNT_PAID_PLAFOND") && $CurrentForm->hasValue("o_AMOUNT_PAID_PLAFOND") && $this->AMOUNT_PAID_PLAFOND->CurrentValue != $this->AMOUNT_PAID_PLAFOND->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_CLASS_ID_PLAFOND") && $CurrentForm->hasValue("o_CLASS_ID_PLAFOND") && $this->CLASS_ID_PLAFOND->CurrentValue != $this->CLASS_ID_PLAFOND->OldValue) {
            return false;
        }
        ...
        if ($CurrentForm->hasValue("x_SPPFEE") && $CurrentForm->hasValue("o_SPPFEE") && $this->SPPFEE->CurrentValue != $this->SPPFEE->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_SPPBILL") && $CurrentForm->hasValue("o_SPPBILL") && $this->SPPBILL->CurrentValue != $this->SPPBILL->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_SPPRJK") && $CurrentForm->hasValue("o_SPPRJK") && $this->SPPRJK->CurrentValue != $this->SPPRJK->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_SPPJMN") && $CurrentForm->hasValue("o_SPPJMN") && $this->SPPJMN->CurrentValue != $this->SPPJMN->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_SPPKASIR") && $CurrentForm->hasValue("o_SPPKASIR") && $this->SPPKASIR->CurrentValue != $this->SPPKASIR->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_PERUJUK") && $CurrentForm->hasValue("o_PERUJUK") && $this->PERUJUK->CurrentValue != $this->PERUJUK->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_PERUJUKFEE") && $CurrentForm->hasValue("o_PERUJUKFEE") && $this->PERUJUKFEE->CurrentValue != $this->PERUJUKFEE->OldValue) {
            return false;
        }
    ...
    public function resetFormError()
    {
        ...
        $this->DUEDATE_ANGSURAN->clearErrorMessage();
        ...
        $this->PERDA_ID->clearErrorMessage();
        ...
        $this->FA_V->clearErrorMessage();
        $this->TASK_ID->clearErrorMessage();
        ...
        $this->TREATMENT_PLAFOND->clearErrorMessage();
        $this->AMOUNT_PLAFOND->clearErrorMessage();
        $this->AMOUNT_PAID_PLAFOND->clearErrorMessage();
        $this->CLASS_ID_PLAFOND->clearErrorMessage();
        ...
        $this->SPPFEE->clearErrorMessage();
        $this->SPPBILL->clearErrorMessage();
        $this->SPPRJK->clearErrorMessage();
        $this->SPPJMN->clearErrorMessage();
        $this->SPPKASIR->clearErrorMessage();
        $this->PERUJUK->clearErrorMessage();
        $this->PERUJUKFEE->clearErrorMessage();
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_DUEDATE_ANGSURAN")) {
            $this->DUEDATE_ANGSURAN->setOldValue($CurrentForm->getValue("o_DUEDATE_ANGSURAN"));
        }
        ...
        if ($CurrentForm->hasValue("o_PERDA_ID")) {
            $this->PERDA_ID->setOldValue($CurrentForm->getValue("o_PERDA_ID"));
        }
        ...
        if ($CurrentForm->hasValue("o_FA_V")) {
            $this->FA_V->setOldValue($CurrentForm->getValue("o_FA_V"));
        }
        ...
        if ($CurrentForm->hasValue("o_TASK_ID")) {
            $this->TASK_ID->setOldValue($CurrentForm->getValue("o_TASK_ID"));
        }
        ...
        if ($CurrentForm->hasValue("o_TREATMENT_PLAFOND")) {
            $this->TREATMENT_PLAFOND->setOldValue($CurrentForm->getValue("o_TREATMENT_PLAFOND"));
        }
        ...
        if ($CurrentForm->hasValue("o_AMOUNT_PLAFOND")) {
            $this->AMOUNT_PLAFOND->setOldValue($CurrentForm->getValue("o_AMOUNT_PLAFOND"));
        }
        ...
        if ($CurrentForm->hasValue("o_AMOUNT_PAID_PLAFOND")) {
            $this->AMOUNT_PAID_PLAFOND->setOldValue($CurrentForm->getValue("o_AMOUNT_PAID_PLAFOND"));
        }
        ...
        if ($CurrentForm->hasValue("o_CLASS_ID_PLAFOND")) {
            $this->CLASS_ID_PLAFOND->setOldValue($CurrentForm->getValue("o_CLASS_ID_PLAFOND"));
        }
        ...
        if ($CurrentForm->hasValue("o_SPPFEE")) {
            $this->SPPFEE->setOldValue($CurrentForm->getValue("o_SPPFEE"));
        }
        ...
        if ($CurrentForm->hasValue("o_SPPRJK")) {
            $this->SPPRJK->setOldValue($CurrentForm->getValue("o_SPPRJK"));
        }
        ...
        if ($CurrentForm->hasValue("o_SPPJMN")) {
            $this->SPPJMN->setOldValue($CurrentForm->getValue("o_SPPJMN"));
        }
        ...
        if ($CurrentForm->hasValue("o_PERUJUK")) {
            $this->PERUJUK->setOldValue($CurrentForm->getValue("o_PERUJUK"));
        }
        ...
        if ($CurrentForm->hasValue("o_PERUJUKFEE")) {
            $this->PERUJUKFEE->setOldValue($CurrentForm->getValue("o_PERUJUKFEE"));
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if (strval($this->AMOUNT_PLAFOND->EditValue) != "" && is_numeric($this->AMOUNT_PLAFOND->EditValue)) {
                ...
                $this->AMOUNT_PLAFOND->OldValue = $this->AMOUNT_PLAFOND->EditValue;
            }
            ...
            if (strval($this->AMOUNT_PAID_PLAFOND->EditValue) != "" && is_numeric($this->AMOUNT_PAID_PLAFOND->EditValue)) {
                ...
                $this->AMOUNT_PAID_PLAFOND->OldValue = $this->AMOUNT_PAID_PLAFOND->EditValue;
            }
            ...
            if (strval($this->PERUJUKFEE->EditValue) != "" && is_numeric($this->PERUJUKFEE->EditValue)) {
                ...
                $this->PERUJUKFEE->OldValue = $this->PERUJUKFEE->EditValue;
            }
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // SPPFEE
            $this->SPPFEE->setDbValueDef($rsnew, $this->SPPFEE->CurrentValue, null, $this->SPPFEE->ReadOnly);

            // SPPBILL
            $this->SPPBILL->setDbValueDef($rsnew, $this->SPPBILL->CurrentValue, null, $this->SPPBILL->ReadOnly);

            // SPPRJK
            $this->SPPRJK->setDbValueDef($rsnew, $this->SPPRJK->CurrentValue, null, $this->SPPRJK->ReadOnly);

            // SPPJMN
            $this->SPPJMN->setDbValueDef($rsnew, $this->SPPJMN->CurrentValue, null, $this->SPPJMN->ReadOnly);

            // SPPKASIR
            $this->SPPKASIR->setDbValueDef($rsnew, $this->SPPKASIR->CurrentValue, null, $this->SPPKASIR->ReadOnly);

            // PERUJUK
            $this->PERUJUK->setDbValueDef($rsnew, $this->PERUJUK->CurrentValue, null, $this->PERUJUK->ReadOnly);

            // PERUJUKFEE
            $this->PERUJUKFEE->setDbValueDef($rsnew, $this->PERUJUKFEE->CurrentValue, null, $this->PERUJUKFEE->ReadOnly);
            ...
            // Check referential integrity for master table 'V_RAWAT_INAP'
            $validMasterRecord = true;
            $masterFilter = $this->sqlMasterFilter_V_RAWAT_INAP();
            ...
            if ($validMasterRecord) {
                $rsmaster = Container("V_RAWAT_INAP")->loadRs($masterFilter)->fetch();
                $validMasterRecord = $rsmaster !== false;
            }
            if (!$validMasterRecord) {
                $relatedRecordMsg = str_replace("%t", "V_RAWAT_INAP", $Language->phrase("RelatedRecordRequired"));
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Check referential integrity for master table 'TREATMENT_BAYAR'
        $validMasterRecord = true;
        $masterFilter = $this->sqlMasterFilter_V_RAWAT_INAP();
