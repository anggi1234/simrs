...
class VRekamMedis extends DbTable
{
    ...
    public function __construct()
    {
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->NO_REGISTRATION->Lookup = new Lookup('NO_REGISTRATION', 'PASIEN', false, 'NO_REGISTRATION', ["NO_REGISTRATION","","",""], [], [], [], [], ["NAME_OF_PASIEN"], ["x_DIANTAR_OLEH"], '', '');
                break;
            default:
                $this->NO_REGISTRATION->Lookup = new Lookup('NO_REGISTRATION', 'PASIEN', false, 'NO_REGISTRATION', ["NO_REGISTRATION","","",""], [], [], [], [], ["NAME_OF_PASIEN"], ["x_DIANTAR_OLEH"], '', '');
                break;
        ...
        // tgl_kontrol
        $this->tgl_kontrol = new DbField('V_REKAM_MEDIS', 'V_REKAM_MEDIS', 'x_tgl_kontrol', 'tgl_kontrol', '[tgl_kontrol]', CastDateFieldForLike("[tgl_kontrol]", 11, "DB"), 135, 8, 11, false, '[tgl_kontrol]', false, false, false, 'FORMATTED TEXT', 'TEXT');
...
SORTHTML;
    ...
    public function renderListRow()
    {
        ...
        $this->tgl_kontrol->ViewValue = FormatDateTime($this->tgl_kontrol->ViewValue, 11);
    ...
    public function renderEditRow()
    {
        ...
        $this->BOOKED_DATE->EditValue = $this->BOOKED_DATE->CurrentValue;
        $this->BOOKED_DATE->EditValue = FormatDateTime($this->BOOKED_DATE->EditValue, 0);
        $this->BOOKED_DATE->ViewCustomAttributes = "";
        ...
        if (strval($this->COB->CurrentValue) != "") {
            $this->COB->EditValue = $this->COB->optionCaption($this->COB->CurrentValue);
        } else {
        ...
        $this->tgl_kontrol->EditValue = FormatDateTime($this->tgl_kontrol->EditValue, 11);
        $this->tgl_kontrol->ViewCustomAttributes = "";
