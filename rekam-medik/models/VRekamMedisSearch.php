...
class VRekamMedisSearch extends VRekamMedis
{
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->tgl_kontrol->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->tgl_kontrol->AdvancedSearch->SearchValue, 11), 11));
    ...
    protected function validateSearch()
    {
        ...
        if (!CheckEuroDate($this->tgl_kontrol->AdvancedSearch->SearchValue)) {
