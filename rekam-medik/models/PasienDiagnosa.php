...
class PasienDiagnosa extends DbTable
{
    ...
    public function getMasterFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "PASIEN_VISITATION") {
            ...
            if ($this->THEID->getSessionValue() != "") {
                $masterFilter .= " AND " . GetForeignKeySql("[PASIEN_ID]", $this->THEID->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
        }
        if ($this->getCurrentMasterTable() == "V_RAWAT_INAP") {
            ...
            if ($this->THEID->getSessionValue() != "") {
                $masterFilter .= " AND " . GetForeignKeySql("[THEID]", $this->THEID->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
        }
    ...
    public function getDetailFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "PASIEN_VISITATION") {
            ...
            if ($this->THEID->getSessionValue() != "") {
                $detailFilter .= " AND " . GetForeignKeySql("[THEID]", $this->THEID->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
        }
    ...
    {
        return "[VISIT_ID]='@VISIT_ID@' AND [NO_REGISTRATION]='@NO_REGISTRATION@' AND [DIANTAR_OLEH]='@DIANTAR_OLEH@' AND [VISITOR_ADDRESS]='@VISITOR_ADDRESS@' AND [PASIEN_ID]='@PASIEN_ID@'";
    }
    // Detail filter
    public function sqlDetailFilter_PASIEN_VISITATION()
    {
        return "[VISIT_ID]='@VISIT_ID@' AND [NO_REGISTRATION]='@NO_REGISTRATION@' AND [THENAME]='@THENAME@' AND [THEADDRESS]='@THEADDRESS@' AND [THEID]='@THEID@'";
    }

    // Master filter
    public function sqlMasterFilter_V_RAWAT_INAP()
    {
        return "[NO_REGISTRATION]='@NO_REGISTRATION@' AND [VISIT_ID]='@VISIT_ID@' AND [THENAME]='@THENAME@' AND [THEID]='@THEID@'";
    }
    // Detail filter
    ...
    public function addMasterUrl($url)
    {
        ...
        if ($this->getCurrentMasterTable() == "PASIEN_VISITATION" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            ...
            $url .= "&" . GetForeignKeyUrl("fk_PASIEN_ID", $this->THEID->CurrentValue ?? $this->THEID->getSessionValue());
        }
        if ($this->getCurrentMasterTable() == "V_RAWAT_INAP" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            ...
            $url .= "&" . GetForeignKeyUrl("fk_THEID", $this->THEID->CurrentValue ?? $this->THEID->getSessionValue());
        }
        return $url;
    }
