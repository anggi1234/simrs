...
class PasienDiagnosaEdit extends PasienDiagnosa
{
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            if (strval($keyValue) != "") {
                $masterFilter = str_replace("@THENAME@", AdjustSql($keyValue), $masterFilter);
            } else {
                $validMasterRecord = false;
            }
            $keyValue = $rsnew['THEID'] ?? $rsold['THEID'];
            if (strval($keyValue) != "") {
                $masterFilter = str_replace("@THEID@", AdjustSql($keyValue), $masterFilter);
            } else {
                $validMasterRecord = false;
            }
