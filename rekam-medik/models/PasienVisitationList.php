...
class PasienVisitationList extends PasienVisitation
{
    ...
    public function renderListOptions()
    {
        ...
        if ($Security->allowList(CurrentProjectID() . 'PASIEN_DIAGNOSA')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("PasienDiagnosaList?" . Config("TABLE_SHOW_MASTER") . "=PASIEN_VISITATION&" . GetForeignKeyUrl("fk_VISIT_ID", $this->VISIT_ID->CurrentValue) . "&" . GetForeignKeyUrl("fk_NO_REGISTRATION", $this->NO_REGISTRATION->CurrentValue) . "&" . GetForeignKeyUrl("fk_DIANTAR_OLEH", $this->DIANTAR_OLEH->CurrentValue) . "&" . GetForeignKeyUrl("fk_VISITOR_ADDRESS", $this->VISITOR_ADDRESS->CurrentValue) . "&" . GetForeignKeyUrl("fk_PASIEN_ID", $this->PASIEN_ID->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
