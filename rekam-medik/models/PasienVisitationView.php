...
class PasienVisitationView extends PasienVisitation
{
    ...
    protected function setupOtherOptions()
    {
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("PasienDiagnosaList?" . Config("TABLE_SHOW_MASTER") . "=PASIEN_VISITATION&" . GetForeignKeyUrl("fk_VISIT_ID", $this->VISIT_ID->CurrentValue) . "&" . GetForeignKeyUrl("fk_NO_REGISTRATION", $this->NO_REGISTRATION->CurrentValue) . "&" . GetForeignKeyUrl("fk_DIANTAR_OLEH", $this->DIANTAR_OLEH->CurrentValue) . "&" . GetForeignKeyUrl("fk_VISITOR_ADDRESS", $this->VISITOR_ADDRESS->CurrentValue) . "&" . GetForeignKeyUrl("fk_PASIEN_ID", $this->PASIEN_ID->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        ...
        if ($detailTblVar != "") {
            ...
            if (in_array("PASIEN_DIAGNOSA", $detailTblVar)) {
                ...
                if ($detailPageObj->DetailView) {
                    ...
                    $detailPageObj->THEID->CurrentValue = $this->PASIEN_ID->CurrentValue;
