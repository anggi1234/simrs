...
class PasienDiagnosaAdd extends PasienDiagnosa
{
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Check referential integrity for master table 'PASIEN_DIAGNOSA'
        ...
        if (strval($this->THENAME->CurrentValue) != "") {
            $masterFilter = str_replace("@THENAME@", AdjustSql($this->THENAME->CurrentValue, "DB"), $masterFilter);
        } else {
            $validMasterRecord = false;
        }
        if ($this->THEID->getSessionValue() != "") {
        $masterFilter = str_replace("@THEID@", AdjustSql($this->THEID->getSessionValue(), "DB"), $masterFilter);
        } else {
            $validMasterRecord = false;
        }
        ...
        // THEID
        if ($this->THEID->getSessionValue() != "") {
            $rsnew['THEID'] = $this->THEID->getSessionValue();
        }
    ...
    protected function setupMasterParms()
    {
        ...
        if (($master = Get(Config("TABLE_SHOW_MASTER"), Get(Config("TABLE_MASTER")))) !== null) {
            ...
            if ($masterTblVar == "PASIEN_VISITATION") {
                ...
                if (($parm = Get("fk_PASIEN_ID", Get("THEID"))) !== null) {
                    $masterTbl->PASIEN_ID->setQueryStringValue($parm);
                    $this->THEID->setQueryStringValue($masterTbl->PASIEN_ID->QueryStringValue);
                    $this->THEID->setSessionValue($this->THEID->QueryStringValue);
                } else {
                    $validMaster = false;
                }
            }
            if ($masterTblVar == "V_RAWAT_INAP") {
                ...
                if (($parm = Get("fk_THEID", Get("THEID"))) !== null) {
                    $masterTbl->THEID->setQueryStringValue($parm);
                    $this->THEID->setQueryStringValue($masterTbl->THEID->QueryStringValue);
                    $this->THEID->setSessionValue($this->THEID->QueryStringValue);
                } else {
                    $validMaster = false;
                }
            ...
            if ($masterTblVar == "PASIEN_VISITATION") {
                ...
                if (($parm = Post("fk_PASIEN_ID", Post("THEID"))) !== null) {
                    $masterTbl->PASIEN_ID->setFormValue($parm);
                    $this->THEID->setFormValue($masterTbl->PASIEN_ID->FormValue);
                    $this->THEID->setSessionValue($this->THEID->FormValue);
                } else {
                    $validMaster = false;
                }
            }
            if ($masterTblVar == "V_RAWAT_INAP") {
                ...
                if (($parm = Post("fk_THEID", Post("THEID"))) !== null) {
                    $masterTbl->THEID->setFormValue($parm);
                    $this->THEID->setFormValue($masterTbl->THEID->FormValue);
                    $this->THEID->setSessionValue($this->THEID->FormValue);
                } else {
                    $validMaster = false;
                }
