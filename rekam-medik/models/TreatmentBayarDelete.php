 ...
 * Page class
 */
class TreatmentBayarDelete extends TreatmentBayar
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TreatmentBayarDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TreatmentBayarList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("TreatmentBayarList"); // Return to list
                return;
            }
        }
