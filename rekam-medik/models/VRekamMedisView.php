...
class VRekamMedisView extends VRekamMedis
{
    ...
    protected function setupOtherOptions()
    {
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("PasienDiagnosaList?" . Config("TABLE_SHOW_MASTER") . "=V_REKAM_MEDIS&" . GetForeignKeyUrl("fk_VISIT_ID", $this->VISIT_ID->CurrentValue) . "&" . GetForeignKeyUrl("fk_NO_REGISTRATION", $this->NO_REGISTRATION->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("TreatmentAkomodasiList?" . Config("TABLE_SHOW_MASTER") . "=V_REKAM_MEDIS&" . GetForeignKeyUrl("fk_NO_REGISTRATION", $this->NO_REGISTRATION->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        ...
        if ($detailTblVar != "") {
            ...
            if (in_array("PASIEN_DIAGNOSA", $detailTblVar)) {
                ...
                if ($detailPageObj->DetailView) {
                    ...
                    $detailPageObj->THEID->setSessionValue(""); // Clear session key
                }
            }
