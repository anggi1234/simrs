...
loadjs.ready("head", function () {
    ...
    fV_REKAM_MEDISsearch.addFields([
        ...
        ["tgl_kontrol", [ew.Validators.datetime(11)], fields.tgl_kontrol.isInvalid]
    ]);
...
<input type="<?= $Page->tgl_kontrol->getInputTextType() ?>" data-table="V_REKAM_MEDIS" data-field="x_tgl_kontrol" data-format="11" name="x_tgl_kontrol" id="x_tgl_kontrol" placeholder="<?= HtmlEncode($Page->tgl_kontrol->getPlaceHolder()) ?>" value="<?= $Page->tgl_kontrol->EditValue ?>"<?= $Page->tgl_kontrol->editAttributes() ?>>
...
<script>
loadjs.ready(["fV_REKAM_MEDISsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_REKAM_MEDISsearch", "x_tgl_kontrol", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
