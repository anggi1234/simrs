...
<?php } ?>
<?php if ($V_RAWAT_INAP->AGEYEAR->Visible) { // AGEYEAR ?>
        <tr id="r_AGEYEAR">
            <td class="<?= $V_RAWAT_INAP->TableLeftColumnClass ?>"><?= $V_RAWAT_INAP->AGEYEAR->caption() ?></td>
            <td <?= $V_RAWAT_INAP->AGEYEAR->cellAttributes() ?>>
<span id="el_V_RAWAT_INAP_AGEYEAR">
<span<?= $V_RAWAT_INAP->AGEYEAR->viewAttributes() ?>>
<?= $V_RAWAT_INAP->AGEYEAR->getViewValue() ?></span>
</span>
</td>
        </tr>
<?php } ?>
