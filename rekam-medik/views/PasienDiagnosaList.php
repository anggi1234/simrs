...
<input type="hidden" name="fk_PASIEN_ID" value="<?= HtmlEncode($Page->THEID->getSessionValue()) ?>">
<?php } ?>
...
<input type="hidden" name="fk_THEID" value="<?= HtmlEncode($Page->THEID->getSessionValue()) ?>">
<?php } ?>
