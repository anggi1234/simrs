...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "SIMRSSQLSERVERREKAMMEDIK"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{466D279F-BD0E-4321-97E5-89249311DFE2}"); // Project ID
