...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "SIMRSSQLSERVERRAJALALTER"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{ACCE0969-50F9-4C6B-9976-A4C7782C1B6D}"); // Project ID
