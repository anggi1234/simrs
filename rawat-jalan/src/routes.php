...
return function (App $app) {
    ...
    // V_RAWAT_INAP
    $app->any('/VRawatInapList[/{BILL_ID}]', VRawatInapController::class . ':list')->add(PermissionMiddleware::class)->setName('VRawatInapList-V_RAWAT_INAP-list'); // list
    $app->any('/VRawatInapView[/{BILL_ID}]', VRawatInapController::class . ':view')->add(PermissionMiddleware::class)->setName('VRawatInapView-V_RAWAT_INAP-view'); // view
    $app->any('/VRawatInapEdit[/{BILL_ID}]', VRawatInapController::class . ':edit')->add(PermissionMiddleware::class)->setName('VRawatInapEdit-V_RAWAT_INAP-edit'); // edit
    $app->group(
        '/V_RAWAT_INAP',
        function (RouteCollectorProxy $group) {
            $group->any('/' . Config("LIST_ACTION") . '[/{BILL_ID}]', VRawatInapController::class . ':list')->add(PermissionMiddleware::class)->setName('V_RAWAT_INAP/list-V_RAWAT_INAP-list-2'); // list
            $group->any('/' . Config("VIEW_ACTION") . '[/{BILL_ID}]', VRawatInapController::class . ':view')->add(PermissionMiddleware::class)->setName('V_RAWAT_INAP/view-V_RAWAT_INAP-view-2'); // view
            $group->any('/' . Config("EDIT_ACTION") . '[/{BILL_ID}]', VRawatInapController::class . ':edit')->add(PermissionMiddleware::class)->setName('V_RAWAT_INAP/edit-V_RAWAT_INAP-edit-2'); // edit
        }
    );
