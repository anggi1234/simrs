...
class TreatmentBill extends DbTable
{
    ...
    public function __construct()
    {
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->TARIF_ID->Lookup = new Lookup('TARIF_ID', 'TREAT_TARIF', false, 'TARIF_ID', ["TARIF_NAME","AMOUNT_PAID","",""], [], [], [], [], ["TARIF_NAME","AMOUNT_PAID","AMOUNT_PAID","AMOUNT_PAID"], ["x_TREATMENT","x_AMOUNT","x_amount_paid","x_TAGIHAN"], '[TARIF_NAME] ASC', '');
                break;
            default:
                $this->TARIF_ID->Lookup = new Lookup('TARIF_ID', 'TREAT_TARIF', false, 'TARIF_ID', ["TARIF_NAME","AMOUNT_PAID","",""], [], [], [], [], ["TARIF_NAME","AMOUNT_PAID","AMOUNT_PAID","AMOUNT_PAID"], ["x_TREATMENT","x_AMOUNT","x_amount_paid","x_TAGIHAN"], '[TARIF_NAME] ASC', '');
                break;
        ...
        // ISLUNAS
        $this->ISLUNAS = new DbField('TREATMENT_BILL', 'TREATMENT_BILL', 'x_ISLUNAS', 'ISLUNAS', '[ISLUNAS]', '[ISLUNAS]', 129, 1, -1, false, '[ISLUNAS]', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        $this->ISLUNAS->Sortable = false; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->ISLUNAS->Lookup = new Lookup('ISLUNAS', 'TREATMENT_BILL', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->ISLUNAS->Lookup = new Lookup('ISLUNAS', 'TREATMENT_BILL', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        }
        $this->ISLUNAS->OptionCount = 1;
        $this->ISLUNAS->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ISLUNAS->Param, "CustomMsg");
        $this->Fields['ISLUNAS'] = &$this->ISLUNAS;

        // DUEDATE_ANGSURAN
        $this->DUEDATE_ANGSURAN = new DbField('TREATMENT_BILL', 'TREATMENT_BILL', 'x_DUEDATE_ANGSURAN', 'DUEDATE_ANGSURAN', '[DUEDATE_ANGSURAN]', CastDateFieldForLike("[DUEDATE_ANGSURAN]", 11, "DB"), 135, 8, 11, false, '[DUEDATE_ANGSURAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DUEDATE_ANGSURAN->Sortable = false; // Allow sort
        $this->DUEDATE_ANGSURAN->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_SEPARATOR"], $Language->phrase("IncorrectDateDMY"));
        ...
        // PRINT_DATE
        $this->PRINT_DATE = new DbField('TREATMENT_BILL', 'TREATMENT_BILL', 'x_PRINT_DATE', 'PRINT_DATE', '[PRINT_DATE]', CastDateFieldForLike("[PRINT_DATE]", 11, "DB"), 135, 8, 11, false, '[PRINT_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PRINT_DATE->Sortable = false; // Allow sort
        $this->PRINT_DATE->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_SEPARATOR"], $Language->phrase("IncorrectDateDMY"));
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->EMPLOYEE_ID->Lookup = new Lookup('EMPLOYEE_ID', 'EMPLOYEE_ALL', false, 'EMPLOYEE_ID', ["FULLNAME","EMPLOYEE_ID","",""], [], [], [], [], ["FULLNAME"], ["x_DOCTOR"], '', '');
                break;
            default:
                $this->EMPLOYEE_ID->Lookup = new Lookup('EMPLOYEE_ID', 'EMPLOYEE_ALL', false, 'EMPLOYEE_ID', ["FULLNAME","EMPLOYEE_ID","",""], [], [], [], [], ["FULLNAME"], ["x_DOCTOR"], '', '');
                break;
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('TREATMENT_BILL', 'TREATMENT_BILL', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 11, "DB"), 135, 8, 11, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EXIT_DATE
        $this->EXIT_DATE = new DbField('TREATMENT_BILL', 'TREATMENT_BILL', 'x_EXIT_DATE', 'EXIT_DATE', '[EXIT_DATE]', CastDateFieldForLike("[EXIT_DATE]", 11, "DB"), 135, 8, 11, false, '[EXIT_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SPPBILLDATE
        $this->SPPBILLDATE = new DbField('TREATMENT_BILL', 'TREATMENT_BILL', 'x_SPPBILLDATE', 'SPPBILLDATE', '[SPPBILLDATE]', CastDateFieldForLike("[SPPBILLDATE]", 11, "DB"), 135, 8, 11, false, '[SPPBILLDATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SPPBILLDATE->Sortable = false; // Allow sort
        $this->SPPBILLDATE->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_SEPARATOR"], $Language->phrase("IncorrectDateDMY"));
        ...
        // SPPKASIRDATE
        $this->SPPKASIRDATE = new DbField('TREATMENT_BILL', 'TREATMENT_BILL', 'x_SPPKASIRDATE', 'SPPKASIRDATE', '[SPPKASIRDATE]', CastDateFieldForLike("[SPPKASIRDATE]", 11, "DB"), 135, 8, 11, false, '[SPPKASIRDATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SPPKASIRDATE->Sortable = false; // Allow sort
        $this->SPPKASIRDATE->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_SEPARATOR"], $Language->phrase("IncorrectDateDMY"));
        ...
        // SPPPOLIDATE
        $this->SPPPOLIDATE = new DbField('TREATMENT_BILL', 'TREATMENT_BILL', 'x_SPPPOLIDATE', 'SPPPOLIDATE', '[SPPPOLIDATE]', CastDateFieldForLike("[SPPPOLIDATE]", 11, "DB"), 135, 8, 11, false, '[SPPPOLIDATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SPPPOLIDATE->Sortable = false; // Allow sort
        $this->SPPPOLIDATE->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_SEPARATOR"], $Language->phrase("IncorrectDateDMY"));
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->DUEDATE_ANGSURAN->EditValue = FormatDateTime($this->DUEDATE_ANGSURAN->CurrentValue, 11);
        ...
        $this->PRINT_DATE->EditValue = FormatDateTime($this->PRINT_DATE->CurrentValue, 11);
        ...
        $this->SPPBILLDATE->EditValue = FormatDateTime($this->SPPBILLDATE->CurrentValue, 11);
        ...
        $this->SPPKASIRDATE->EditValue = FormatDateTime($this->SPPKASIRDATE->CurrentValue, 11);
        ...
        $this->SPPPOLIDATE->EditValue = FormatDateTime($this->SPPPOLIDATE->CurrentValue, 11);
