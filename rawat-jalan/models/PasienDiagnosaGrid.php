...
class PasienDiagnosaGrid extends PasienDiagnosa
{
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_DIAGNOSA_DESC") && $CurrentForm->hasValue("o_DIAGNOSA_DESC") && $this->DIAGNOSA_DESC->CurrentValue != $this->DIAGNOSA_DESC->OldValue) {
            return false;
        }
        ...
        if ($CurrentForm->hasValue("x_INSTRUCTION") && $CurrentForm->hasValue("o_INSTRUCTION") && $this->INSTRUCTION->CurrentValue != $this->INSTRUCTION->OldValue) {
            return false;
        }
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_DIAGNOSA_DESC")) {
            $this->DIAGNOSA_DESC->setOldValue($CurrentForm->getValue("o_DIAGNOSA_DESC"));
        }
        ...
        if ($CurrentForm->hasValue("o_INSTRUCTION")) {
            $this->INSTRUCTION->setOldValue($CurrentForm->getValue("o_INSTRUCTION"));
        }
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // DIAGNOSA_DESC
            $this->DIAGNOSA_DESC->setDbValueDef($rsnew, $this->DIAGNOSA_DESC->CurrentValue, null, $this->DIAGNOSA_DESC->ReadOnly);
