...
class VRekamMedisSearch extends VRekamMedis
{
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->REASON_ID->EditValue = HtmlEncode($this->REASON_ID->AdvancedSearch->SearchValue);
            ...
            $this->WAY_ID->EditValue = HtmlEncode($this->WAY_ID->AdvancedSearch->SearchValue);
            ...
            if (!$this->CLINIC_ID->Raw) {
                $this->CLINIC_ID->AdvancedSearch->SearchValue = HtmlDecode($this->CLINIC_ID->AdvancedSearch->SearchValue);
            }
            $this->CLINIC_ID->EditValue = HtmlEncode($this->CLINIC_ID->AdvancedSearch->SearchValue);
            ...
            $this->KODE_AGAMA->EditValue = HtmlEncode($this->KODE_AGAMA->AdvancedSearch->SearchValue);
            ...
            if (!$this->COB->Raw) {
                $this->COB->AdvancedSearch->SearchValue = HtmlDecode($this->COB->AdvancedSearch->SearchValue);
            }
            $this->COB->EditValue = HtmlEncode($this->COB->AdvancedSearch->SearchValue);
            ...
            if (!$this->RESPONSEP->Raw) {
                $this->RESPONSEP->AdvancedSearch->SearchValue = HtmlDecode($this->RESPONSEP->AdvancedSearch->SearchValue);
            }
            ...
            if (!$this->RESPONPOST_VKLAIM->Raw) {
                $this->RESPONPOST_VKLAIM->AdvancedSearch->SearchValue = HtmlDecode($this->RESPONPOST_VKLAIM->AdvancedSearch->SearchValue);
            }
            ...
            if (!$this->RESPONPUT_VKLAIM->Raw) {
                $this->RESPONPUT_VKLAIM->AdvancedSearch->SearchValue = HtmlDecode($this->RESPONPUT_VKLAIM->AdvancedSearch->SearchValue);
            }
            ...
            if (!$this->RESPONDEL_VKLAIM->Raw) {
                $this->RESPONDEL_VKLAIM->AdvancedSearch->SearchValue = HtmlDecode($this->RESPONDEL_VKLAIM->AdvancedSearch->SearchValue);
            }
    ...
    protected function validateSearch()
    {
        ...
        if (!CheckInteger($this->RUJUKAN_ID->AdvancedSearch->SearchValue)) {
            $this->RUJUKAN_ID->addErrorMessage($this->RUJUKAN_ID->getErrorMessage(false));
        }
        if (!CheckInteger($this->REASON_ID->AdvancedSearch->SearchValue)) {
            $this->REASON_ID->addErrorMessage($this->REASON_ID->getErrorMessage(false));
        }
        if (!CheckInteger($this->WAY_ID->AdvancedSearch->SearchValue)) {
            $this->WAY_ID->addErrorMessage($this->WAY_ID->getErrorMessage(false));
        }
        if (!CheckInteger($this->PATIENT_CATEGORY_ID->AdvancedSearch->SearchValue)) {
        ...
        if (!CheckInteger($this->KODE_AGAMA->AdvancedSearch->SearchValue)) {
