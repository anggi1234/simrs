...
class TreatmentBillSearch extends TreatmentBill
{
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->DUEDATE_ANGSURAN->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->DUEDATE_ANGSURAN->AdvancedSearch->SearchValue, 11), 11));
            ...
            $this->PRINT_DATE->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->PRINT_DATE->AdvancedSearch->SearchValue, 11), 11));
            ...
            $this->modified_datesys->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->modified_datesys->AdvancedSearch->SearchValue, 11), 11));
            ...
            $this->SPPBILLDATE->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->SPPBILLDATE->AdvancedSearch->SearchValue, 11), 11));
            ...
            $this->SPPKASIRDATE->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->SPPKASIRDATE->AdvancedSearch->SearchValue, 11), 11));
            ...
            $this->SPPPOLIDATE->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->SPPPOLIDATE->AdvancedSearch->SearchValue, 11), 11));
    ...
    protected function validateSearch()
    {
        ...
        if (!CheckEuroDate($this->DUEDATE_ANGSURAN->AdvancedSearch->SearchValue)) {
            $this->DUEDATE_ANGSURAN->addErrorMessage($this->DUEDATE_ANGSURAN->getErrorMessage(false));
        }
        if (!CheckEuroDate($this->PRINT_DATE->AdvancedSearch->SearchValue)) {
        ...
        if (!CheckEuroDate($this->modified_datesys->AdvancedSearch->SearchValue)) {
            $this->modified_datesys->addErrorMessage($this->modified_datesys->getErrorMessage(false));
        }
        if (!CheckEuroDate($this->SPPBILLDATE->AdvancedSearch->SearchValue)) {
            $this->SPPBILLDATE->addErrorMessage($this->SPPBILLDATE->getErrorMessage(false));
        }
        if (!CheckEuroDate($this->SPPKASIRDATE->AdvancedSearch->SearchValue)) {
            $this->SPPKASIRDATE->addErrorMessage($this->SPPKASIRDATE->getErrorMessage(false));
        }
        if (!CheckEuroDate($this->SPPPOLIDATE->AdvancedSearch->SearchValue)) {
