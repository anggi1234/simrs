...
class PasienVisitationSearch extends PasienVisitation
{
    ...
    protected function loadSearchValues()
    {
        ...
        if (is_array($this->ISATTENDED->AdvancedSearch->SearchValue)) {
            $this->ISATTENDED->AdvancedSearch->SearchValue = implode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->ISATTENDED->AdvancedSearch->SearchValue);
        }
        if (is_array($this->ISATTENDED->AdvancedSearch->SearchValue2)) {
            $this->ISATTENDED->AdvancedSearch->SearchValue2 = implode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->ISATTENDED->AdvancedSearch->SearchValue2);
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->RM_OUT_DATE->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->RM_OUT_DATE->AdvancedSearch->SearchValue, 11), 11));
            ...
            $this->RM_IN_DATE->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->RM_IN_DATE->AdvancedSearch->SearchValue, 11), 11));
            ...
            $this->RESEND_RM_DATE->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->RESEND_RM_DATE->AdvancedSearch->SearchValue, 11), 11));
            ...
            $this->BACK_RM_DATE->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->BACK_RM_DATE->AdvancedSearch->SearchValue, 11), 11));
            ...
            $this->VALID_RM_DATE->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->VALID_RM_DATE->AdvancedSearch->SearchValue, 11), 11));
            ...
            $this->tanggal_rujukan->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->tanggal_rujukan->AdvancedSearch->SearchValue, 11), 11));
            ...
            $this->SEP_PRINTDATE->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->SEP_PRINTDATE->AdvancedSearch->SearchValue, 11), 11));
            ...
            $this->CALL_DATE->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->CALL_DATE->AdvancedSearch->SearchValue, 17), 17));
            ...
            $this->CALL_DATES->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->CALL_DATES->AdvancedSearch->SearchValue, 11), 11));
            ...
            $this->SERVED_DATE->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->SERVED_DATE->AdvancedSearch->SearchValue, 11), 11));
            ...
            $this->SERVED_INAP->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->SERVED_INAP->AdvancedSearch->SearchValue, 11), 11));
    ...
    protected function validateSearch()
    {
        ...
        if (!CheckEuroDate($this->RM_OUT_DATE->AdvancedSearch->SearchValue)) {
            $this->RM_OUT_DATE->addErrorMessage($this->RM_OUT_DATE->getErrorMessage(false));
        }
        if (!CheckEuroDate($this->RM_IN_DATE->AdvancedSearch->SearchValue)) {
        ...
        if (!CheckEuroDate($this->RESEND_RM_DATE->AdvancedSearch->SearchValue)) {
            $this->RESEND_RM_DATE->addErrorMessage($this->RESEND_RM_DATE->getErrorMessage(false));
        }
        if (!CheckEuroDate($this->BACK_RM_DATE->AdvancedSearch->SearchValue)) {
            $this->BACK_RM_DATE->addErrorMessage($this->BACK_RM_DATE->getErrorMessage(false));
        }
        if (!CheckEuroDate($this->VALID_RM_DATE->AdvancedSearch->SearchValue)) {
        ...
        if (!CheckEuroDate($this->tanggal_rujukan->AdvancedSearch->SearchValue)) {
            $this->tanggal_rujukan->addErrorMessage($this->tanggal_rujukan->getErrorMessage(false));
        }
        if (!CheckEuroDate($this->SEP_PRINTDATE->AdvancedSearch->SearchValue)) {
        ...
        if (!CheckShortEuroDate($this->CALL_DATE->AdvancedSearch->SearchValue)) {
            $this->CALL_DATE->addErrorMessage($this->CALL_DATE->getErrorMessage(false));
        }
        if (!CheckEuroDate($this->CALL_DATES->AdvancedSearch->SearchValue)) {
            $this->CALL_DATES->addErrorMessage($this->CALL_DATES->getErrorMessage(false));
        }
        if (!CheckEuroDate($this->SERVED_DATE->AdvancedSearch->SearchValue)) {
            $this->SERVED_DATE->addErrorMessage($this->SERVED_DATE->getErrorMessage(false));
        }
        if (!CheckEuroDate($this->SERVED_INAP->AdvancedSearch->SearchValue)) {
