...
class PasienVisitation extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISATTENDED
        $this->ISATTENDED = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_ISATTENDED', 'ISATTENDED', '[ISATTENDED]', '[ISATTENDED]', 129, 1, -1, false, '[ISATTENDED]', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        ...
        // RM_OUT_DATE
        $this->RM_OUT_DATE = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_RM_OUT_DATE', 'RM_OUT_DATE', '[RM_OUT_DATE]', CastDateFieldForLike("[RM_OUT_DATE]", 11, "DB"), 135, 8, 11, false, '[RM_OUT_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->RM_OUT_DATE->Sortable = true; // Allow sort
        $this->RM_OUT_DATE->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_SEPARATOR"], $Language->phrase("IncorrectDateDMY"));
        ...
        // RM_IN_DATE
        $this->RM_IN_DATE = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_RM_IN_DATE', 'RM_IN_DATE', '[RM_IN_DATE]', CastDateFieldForLike("[RM_IN_DATE]", 11, "DB"), 135, 8, 11, false, '[RM_IN_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->RM_IN_DATE->Sortable = true; // Allow sort
        $this->RM_IN_DATE->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_SEPARATOR"], $Language->phrase("IncorrectDateDMY"));
        ...
        // RESEND_RM_DATE
        $this->RESEND_RM_DATE = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_RESEND_RM_DATE', 'RESEND_RM_DATE', '[RESEND_RM_DATE]', CastDateFieldForLike("[RESEND_RM_DATE]", 11, "DB"), 135, 8, 11, false, '[RESEND_RM_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->RESEND_RM_DATE->Sortable = true; // Allow sort
        $this->RESEND_RM_DATE->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_SEPARATOR"], $Language->phrase("IncorrectDateDMY"));
        ...
        // BACK_RM_DATE
        $this->BACK_RM_DATE = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_BACK_RM_DATE', 'BACK_RM_DATE', '[BACK_RM_DATE]', CastDateFieldForLike("[BACK_RM_DATE]", 11, "DB"), 135, 8, 11, false, '[BACK_RM_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->BACK_RM_DATE->Sortable = true; // Allow sort
        $this->BACK_RM_DATE->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_SEPARATOR"], $Language->phrase("IncorrectDateDMY"));
        ...
        // VALID_RM_DATE
        $this->VALID_RM_DATE = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_VALID_RM_DATE', 'VALID_RM_DATE', '[VALID_RM_DATE]', CastDateFieldForLike("[VALID_RM_DATE]", 11, "DB"), 135, 8, 11, false, '[VALID_RM_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->VALID_RM_DATE->Sortable = true; // Allow sort
        $this->VALID_RM_DATE->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_SEPARATOR"], $Language->phrase("IncorrectDateDMY"));
        ...
        // tanggal_rujukan
        $this->tanggal_rujukan = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_tanggal_rujukan', 'tanggal_rujukan', '[tanggal_rujukan]', CastDateFieldForLike("[tanggal_rujukan]", 11, "DB"), 135, 8, 11, false, '[tanggal_rujukan]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->tanggal_rujukan->Sortable = true; // Allow sort
        $this->tanggal_rujukan->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_SEPARATOR"], $Language->phrase("IncorrectDateDMY"));
        ...
        // ISRJ
        $this->ISRJ = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_ISRJ', 'ISRJ', '[ISRJ]', '[ISRJ]', 129, 1, -1, false, '[ISRJ]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // SEP_PRINTDATE
        $this->SEP_PRINTDATE = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_SEP_PRINTDATE', 'SEP_PRINTDATE', '[SEP_PRINTDATE]', CastDateFieldForLike("[SEP_PRINTDATE]", 11, "DB"), 135, 8, 11, false, '[SEP_PRINTDATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SEP_PRINTDATE->Sortable = true; // Allow sort
        $this->SEP_PRINTDATE->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_SEPARATOR"], $Language->phrase("IncorrectDateDMY"));
        ...
        // TRANS_ID
        $this->TRANS_ID = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_TRANS_ID', 'TRANS_ID', '[TRANS_ID]', '[TRANS_ID]', 200, 50, -1, false, '[TRANS_ID]', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // CALL_DATE
        $this->CALL_DATE = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_CALL_DATE', 'CALL_DATE', '[CALL_DATE]', CastDateFieldForLike("[CALL_DATE]", 17, "DB"), 135, 8, 17, false, '[CALL_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->CALL_DATE->Sortable = true; // Allow sort
        $this->CALL_DATE->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_SEPARATOR"], $Language->phrase("IncorrectShortDateDMY"));
        ...
        // CALL_DATES
        $this->CALL_DATES = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_CALL_DATES', 'CALL_DATES', '[CALL_DATES]', CastDateFieldForLike("[CALL_DATES]", 11, "DB"), 135, 8, 11, false, '[CALL_DATES]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->CALL_DATES->Sortable = true; // Allow sort
        $this->CALL_DATES->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_SEPARATOR"], $Language->phrase("IncorrectDateDMY"));
        ...
        // SERVED_DATE
        $this->SERVED_DATE = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_SERVED_DATE', 'SERVED_DATE', '[SERVED_DATE]', CastDateFieldForLike("[SERVED_DATE]", 11, "DB"), 135, 8, 11, false, '[SERVED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SERVED_DATE->Sortable = true; // Allow sort
        $this->SERVED_DATE->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_SEPARATOR"], $Language->phrase("IncorrectDateDMY"));
        ...
        // SERVED_INAP
        $this->SERVED_INAP = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_SERVED_INAP', 'SERVED_INAP', '[SERVED_INAP]', CastDateFieldForLike("[SERVED_INAP]", 11, "DB"), 135, 8, 11, false, '[SERVED_INAP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
...
SORTHTML;
    ...
    public function renderListRow()
    {
        ...
        if (strval($this->ISATTENDED->CurrentValue) != "") {
            $this->ISATTENDED->ViewValue = new OptionValues();
            $arwrk = explode(",", strval($this->ISATTENDED->CurrentValue));
            $cnt = count($arwrk);
            for ($ari = 0; $ari < $cnt; $ari++)
                $this->ISATTENDED->ViewValue->add($this->ISATTENDED->optionCaption(trim($arwrk[$ari])));
        } else {
        ...
        $this->RM_OUT_DATE->ViewValue = FormatDateTime($this->RM_OUT_DATE->ViewValue, 11);
        $this->RM_OUT_DATE->ViewCustomAttributes = "";

        // RM_IN_DATE
        $this->RM_IN_DATE->ViewValue = $this->RM_IN_DATE->CurrentValue;
        $this->RM_IN_DATE->ViewValue = FormatDateTime($this->RM_IN_DATE->ViewValue, 11);
        ...
        $this->RESEND_RM_DATE->ViewValue = FormatDateTime($this->RESEND_RM_DATE->ViewValue, 11);
        ...
        $this->BACK_RM_DATE->ViewValue = FormatDateTime($this->BACK_RM_DATE->ViewValue, 11);
        $this->BACK_RM_DATE->ViewCustomAttributes = "";

        // VALID_RM_DATE
        $this->VALID_RM_DATE->ViewValue = $this->VALID_RM_DATE->CurrentValue;
        $this->VALID_RM_DATE->ViewValue = FormatDateTime($this->VALID_RM_DATE->ViewValue, 11);
        ...
        $this->tanggal_rujukan->ViewValue = FormatDateTime($this->tanggal_rujukan->ViewValue, 11);
        ...
        $this->CALL_DATE->ViewValue = FormatDateTime($this->CALL_DATE->ViewValue, 17);
    ...
    public function renderEditRow()
    {
        ...
        if (strval($this->ISATTENDED->CurrentValue) != "") {
            $this->ISATTENDED->EditValue = new OptionValues();
            $arwrk = explode(",", strval($this->ISATTENDED->CurrentValue));
            $cnt = count($arwrk);
            for ($ari = 0; $ari < $cnt; $ari++)
                $this->ISATTENDED->EditValue->add($this->ISATTENDED->optionCaption(trim($arwrk[$ari])));
        } else {
            $this->ISATTENDED->EditValue = null;
        }
        $this->ISATTENDED->ViewCustomAttributes = "";
        ...
        $this->RESEND_RM_DATE->EditValue = FormatDateTime($this->RESEND_RM_DATE->EditValue, 11);
        $this->RESEND_RM_DATE->ViewCustomAttributes = "";
        ...
        $this->BACK_RM_DATE->EditValue = FormatDateTime($this->BACK_RM_DATE->EditValue, 11);
        $this->BACK_RM_DATE->ViewCustomAttributes = "";
        ...
        $this->VALID_RM_DATE->EditValue = FormatDateTime($this->VALID_RM_DATE->EditValue, 11);
        $this->VALID_RM_DATE->ViewCustomAttributes = "";
        ...
        $this->tanggal_rujukan->EditValue = FormatDateTime($this->tanggal_rujukan->EditValue, 11);
        $this->tanggal_rujukan->ViewCustomAttributes = "";
