...
class VKasir extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // NO_REGISTRATION
        $this->NO_REGISTRATION = new DbField('V_KASIR', 'V_KASIR', 'x_NO_REGISTRATION', 'NO_REGISTRATION', '[NO_REGISTRATION]', '[NO_REGISTRATION]', 200, 50, -1, false, '[NO_REGISTRATION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STATUS_PASIEN_ID
        $this->STATUS_PASIEN_ID = new DbField('V_KASIR', 'V_KASIR', 'x_STATUS_PASIEN_ID', 'STATUS_PASIEN_ID', '[STATUS_PASIEN_ID]', 'CAST([STATUS_PASIEN_ID] AS NVARCHAR)', 17, 1, -1, false, '[STATUS_PASIEN_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RUJUKAN_ID
        $this->RUJUKAN_ID = new DbField('V_KASIR', 'V_KASIR', 'x_RUJUKAN_ID', 'RUJUKAN_ID', '[RUJUKAN_ID]', 'CAST([RUJUKAN_ID] AS NVARCHAR)', 20, 8, -1, false, '[RUJUKAN_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // REASON_ID
        $this->REASON_ID = new DbField('V_KASIR', 'V_KASIR', 'x_REASON_ID', 'REASON_ID', '[REASON_ID]', 'CAST([REASON_ID] AS NVARCHAR)', 17, 1, -1, false, '[REASON_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // WAY_ID
        $this->WAY_ID = new DbField('V_KASIR', 'V_KASIR', 'x_WAY_ID', 'WAY_ID', '[WAY_ID]', 'CAST([WAY_ID] AS NVARCHAR)', 17, 1, -1, false, '[WAY_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PATIENT_CATEGORY_ID
        $this->PATIENT_CATEGORY_ID = new DbField('V_KASIR', 'V_KASIR', 'x_PATIENT_CATEGORY_ID', 'PATIENT_CATEGORY_ID', '[PATIENT_CATEGORY_ID]', 'CAST([PATIENT_CATEGORY_ID] AS NVARCHAR)', 17, 1, -1, false, '[PATIENT_CATEGORY_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISNEW
        $this->ISNEW = new DbField('V_KASIR', 'V_KASIR', 'x_ISNEW', 'ISNEW', '[ISNEW]', '[ISNEW]', 129, 1, -1, false, '[ISNEW]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLINIC_ID
        $this->CLINIC_ID = new DbField('V_KASIR', 'V_KASIR', 'x_CLINIC_ID', 'CLINIC_ID', '[CLINIC_ID]', '[CLINIC_ID]', 200, 8, -1, false, '[CLINIC_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLINIC_ID_FROM
        $this->CLINIC_ID_FROM = new DbField('V_KASIR', 'V_KASIR', 'x_CLINIC_ID_FROM', 'CLINIC_ID_FROM', '[CLINIC_ID_FROM]', '[CLINIC_ID_FROM]', 200, 8, -1, false, '[CLINIC_ID_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KELUAR_ID
        $this->KELUAR_ID = new DbField('V_KASIR', 'V_KASIR', 'x_KELUAR_ID', 'KELUAR_ID', '[KELUAR_ID]', 'CAST([KELUAR_ID] AS NVARCHAR)', 17, 1, -1, false, '[KELUAR_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GENDER
        $this->GENDER = new DbField('V_KASIR', 'V_KASIR', 'x_GENDER', 'GENDER', '[GENDER]', '[GENDER]', 129, 1, -1, false, '[GENDER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PAYOR_ID
        $this->PAYOR_ID = new DbField('V_KASIR', 'V_KASIR', 'x_PAYOR_ID', 'PAYOR_ID', '[PAYOR_ID]', '[PAYOR_ID]', 200, 50, -1, false, '[PAYOR_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLASS_ID
        $this->CLASS_ID = new DbField('V_KASIR', 'V_KASIR', 'x_CLASS_ID', 'CLASS_ID', '[CLASS_ID]', 'CAST([CLASS_ID] AS NVARCHAR)', 17, 1, -1, false, '[CLASS_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KAL_ID
        $this->KAL_ID = new DbField('V_KASIR', 'V_KASIR', 'x_KAL_ID', 'KAL_ID', '[KAL_ID]', '[KAL_ID]', 200, 50, -1, false, '[KAL_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // COVERAGE_ID
        $this->COVERAGE_ID = new DbField('V_KASIR', 'V_KASIR', 'x_COVERAGE_ID', 'COVERAGE_ID', '[COVERAGE_ID]', 'CAST([COVERAGE_ID] AS NVARCHAR)', 17, 1, -1, false, '[COVERAGE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DIAGNOSA_ID
        $this->DIAGNOSA_ID = new DbField('V_KASIR', 'V_KASIR', 'x_DIAGNOSA_ID', 'DIAGNOSA_ID', '[DIAGNOSA_ID]', '[DIAGNOSA_ID]', 200, 10, -1, false, '[DIAGNOSA_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISRJ
        $this->ISRJ = new DbField('V_KASIR', 'V_KASIR', 'x_ISRJ', 'ISRJ', '[ISRJ]', '[ISRJ]', 129, 1, -1, false, '[ISRJ]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PPKRUJUKAN
        $this->PPKRUJUKAN = new DbField('V_KASIR', 'V_KASIR', 'x_PPKRUJUKAN', 'PPKRUJUKAN', '[PPKRUJUKAN]', '[PPKRUJUKAN]', 200, 50, -1, false, '[PPKRUJUKAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KODE_AGAMA
        $this->KODE_AGAMA = new DbField('V_KASIR', 'V_KASIR', 'x_KODE_AGAMA', 'KODE_AGAMA', '[KODE_AGAMA]', 'CAST([KODE_AGAMA] AS NVARCHAR)', 17, 1, -1, false, '[KODE_AGAMA]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // COB
        $this->COB = new DbField('V_KASIR', 'V_KASIR', 'x_COB', 'COB', '[COB]', '[COB]', 129, 1, -1, false, '[COB]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RESPONSEP
        $this->RESPONSEP = new DbField('V_KASIR', 'V_KASIR', 'x_RESPONSEP', 'RESPONSEP', '[RESPONSEP]', '[RESPONSEP]', 200, 0, -1, false, '[RESPONSEP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RESPONPOST_VKLAIM
        $this->RESPONPOST_VKLAIM = new DbField('V_KASIR', 'V_KASIR', 'x_RESPONPOST_VKLAIM', 'RESPONPOST_VKLAIM', '[RESPONPOST_VKLAIM]', '[RESPONPOST_VKLAIM]', 200, 0, -1, false, '[RESPONPOST_VKLAIM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RESPONPUT_VKLAIM
        $this->RESPONPUT_VKLAIM = new DbField('V_KASIR', 'V_KASIR', 'x_RESPONPUT_VKLAIM', 'RESPONPUT_VKLAIM', '[RESPONPUT_VKLAIM]', '[RESPONPUT_VKLAIM]', 200, 0, -1, false, '[RESPONPUT_VKLAIM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RESPONDEL_VKLAIM
        $this->RESPONDEL_VKLAIM = new DbField('V_KASIR', 'V_KASIR', 'x_RESPONDEL_VKLAIM', 'RESPONDEL_VKLAIM', '[RESPONDEL_VKLAIM]', '[RESPONDEL_VKLAIM]', 200, 0, -1, false, '[RESPONDEL_VKLAIM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
