...
class PasienDiagnosa extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // GENDER
        $this->GENDER = new DbField('PASIEN_DIAGNOSA', 'PASIEN_DIAGNOSA', 'x_GENDER', 'GENDER', '[GENDER]', '[GENDER]', 129, 1, -1, false, '[GENDER]', false, false, false, 'FORMATTED TEXT', 'SELECT');
    ...
    {
        return "[VISIT_ID]='@VISIT_ID@' AND [NO_REGISTRATION]='@NO_REGISTRATION@' AND [DIANTAR_OLEH]='@DIANTAR_OLEH@' AND [VISITOR_ADDRESS]='@VISITOR_ADDRESS@'";
    }
    // Detail filter
    public function sqlDetailFilter_PASIEN_VISITATION()
    {
        return "[VISIT_ID]='@VISIT_ID@' AND [NO_REGISTRATION]='@NO_REGISTRATION@' AND [THENAME]='@THENAME@' AND [THEADDRESS]='@THEADDRESS@'";
    }
