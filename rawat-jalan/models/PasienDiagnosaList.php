...
class PasienDiagnosaList extends PasienDiagnosa
{
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->DIAGNOSA_DESC); // DIAGNOSA_DESC
            ...
            $this->updateSort($this->INSTRUCTION); // INSTRUCTION
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if (!$this->DIAGNOSA_DESC->Raw) {
                $this->DIAGNOSA_DESC->AdvancedSearch->SearchValue = HtmlDecode($this->DIAGNOSA_DESC->AdvancedSearch->SearchValue);
            }
            $this->DIAGNOSA_DESC->EditValue = HtmlEncode($this->DIAGNOSA_DESC->AdvancedSearch->SearchValue);
            ...
            if (!$this->INSTRUCTION->Raw) {
                $this->INSTRUCTION->AdvancedSearch->SearchValue = HtmlDecode($this->INSTRUCTION->AdvancedSearch->SearchValue);
            }
            $this->INSTRUCTION->EditValue = HtmlEncode($this->INSTRUCTION->AdvancedSearch->SearchValue);
