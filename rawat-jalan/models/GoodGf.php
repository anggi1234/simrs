...
class GoodGf extends DbTable
{
    ...
    public function __construct()
    {
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->BRAND_ID->Lookup = new Lookup('BRAND_ID', 'GOODS', false, 'BRAND_ID', ["NAME","STOCK","NET_PRICE",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->BRAND_ID->Lookup = new Lookup('BRAND_ID', 'GOODS', false, 'BRAND_ID', ["NAME","STOCK","NET_PRICE",""], [], [], [], [], [], [], '', '');
                break;
        ...
        $this->BRAND_NAME->Sortable = false; // Allow sort
        ...
        $this->ROOMS_ID->Sortable = false; // Allow sort
        ...
        $this->SHELF_NO->Sortable = false; // Allow sort
        ...
        $this->EXPIRY_DATE->Sortable = false; // Allow sort
        ...
        $this->FROM_ROOMS_ID->Sortable = false; // Allow sort
        ...
        $this->ISOUTLET->Sortable = false; // Allow sort
        ...
        $this->CONDITION->Sortable = false; // Allow sort
        ...
        $this->ALLOCATED_DATE->Sortable = false; // Allow sort
        ...
        $this->STOCKOPNAME_DATE->Sortable = false; // Allow sort
        ...
        $this->ALLOCATED_FROM->Sortable = false; // Allow sort
        ...
        $this->DISCOUNT2->Sortable = false; // Allow sort
        ...
        $this->DISCOUNTOFF->Sortable = false; // Allow sort
        ...
        $this->ITEM_ID_FROM->Sortable = false; // Allow sort
        ...
        $this->STOCK_OPNAME->Sortable = false; // Allow sort
        ...
        $this->STOK_AWAL->Sortable = false; // Allow sort
        ...
        $this->STOCK_LALU->Sortable = false; // Allow sort
        ...
        $this->STOCK_KOREKSI->Sortable = false; // Allow sort
        ...
        $this->DITERIMA->Sortable = false; // Allow sort
        ...
        $this->DISTRIBUSI->Sortable = false; // Allow sort
        ...
        $this->DIJUAL->Sortable = false; // Allow sort
        ...
        $this->DIHAPUS->Sortable = false; // Allow sort
        ...
        $this->DIMINTA->Sortable = false; // Allow sort
        ...
        $this->DIRETUR->Sortable = false; // Allow sort
        ...
        $this->FUND_ID->Sortable = false; // Allow sort
        ...
        $this->INVOICE_ID2->Sortable = false; // Allow sort
        ...
        $this->MEASURE_ID3->Sortable = false; // Allow sort
        ...
        $this->SIZE_KEMASAN->Sortable = false; // Allow sort
        ...
        $this->RETUR_ID->Sortable = false; // Allow sort
        ...
        $this->SIZE_GOODS->Sortable = false; // Allow sort
        ...
        $this->MEASURE_DOSIS->Sortable = false; // Allow sort
        ...
        $this->ORDER_PRICE->Sortable = false; // Allow sort
        ...
        $this->MONTH_ID->Sortable = false; // Allow sort
        ...
        $this->CORRECTION_DOC->Sortable = false; // Allow sort
        ...
        $this->CORRECTIONS->Sortable = false; // Allow sort
        ...
        $this->CORRECTION_DATE->Sortable = false; // Allow sort
        ...
        $this->avgprice->Sortable = false; // Allow sort
        ...
        $this->idx->Sortable = false; // Allow sort
    ...
    public function getMasterFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "MUTATION_DOCS") {
            if ($this->DOC_NO->getSessionValue() != "") {
                $masterFilter .= "" . GetForeignKeySql("[DOC_NO]", $this->DOC_NO->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
        }
    ...
    public function getDetailFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "MUTATION_DOCS") {
            if ($this->DOC_NO->getSessionValue() != "") {
                $detailFilter .= "" . GetForeignKeySql("[DOC_NO]", $this->DOC_NO->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
        }
