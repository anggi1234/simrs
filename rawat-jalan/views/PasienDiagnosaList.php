...
loadjs.ready("head", function () {
    ...
    fPASIEN_DIAGNOSAlistsrch.lists.NO_REGISTRATION = <?= $Page->NO_REGISTRATION->toClientList($Page) ?>;
...
<input type="hidden" name="z_NO_REGISTRATION" id="z_NO_REGISTRATION" value="LIKE">
        ...
        <span id="el_PASIEN_DIAGNOSA_NO_REGISTRATION" class="ew-search-field">
...
?>
<?php if ($Page->NO_REGISTRATION->Visible) { // NO_REGISTRATION ?>
        <th data-name="NO_REGISTRATION" class="<?= $Page->NO_REGISTRATION->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_PASIEN_DIAGNOSA_NO_REGISTRATION" class="PASIEN_DIAGNOSA_NO_REGISTRATION"><?= $Page->renderSort($Page->NO_REGISTRATION) ?></div></th>
<?php } ?>
<?php if ($Page->THENAME->Visible) { // THENAME ?>
        <th data-name="THENAME" class="<?= $Page->THENAME->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_PASIEN_DIAGNOSA_THENAME" class="PASIEN_DIAGNOSA_THENAME"><?= $Page->renderSort($Page->THENAME) ?></div></th>
<?php } ?>
...
<?php if ($Page->DIAGNOSA_DESC->Visible) { // DIAGNOSA_DESC ?>
        <th data-name="DIAGNOSA_DESC" class="<?= $Page->DIAGNOSA_DESC->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_PASIEN_DIAGNOSA_DIAGNOSA_DESC" class="PASIEN_DIAGNOSA_DIAGNOSA_DESC"><?= $Page->renderSort($Page->DIAGNOSA_DESC) ?></div></th>
<?php } ?>
...
<?php if ($Page->INSTRUCTION->Visible) { // INSTRUCTION ?>
        <th data-name="INSTRUCTION" class="<?= $Page->INSTRUCTION->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_PASIEN_DIAGNOSA_INSTRUCTION" class="PASIEN_DIAGNOSA_INSTRUCTION"><?= $Page->renderSort($Page->INSTRUCTION) ?></div></th>
<?php } ?>
<?php if ($Page->THEADDRESS->Visible) { // THEADDRESS ?>
        <th data-name="THEADDRESS" class="<?= $Page->THEADDRESS->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_PASIEN_DIAGNOSA_THEADDRESS" class="PASIEN_DIAGNOSA_THEADDRESS"><?= $Page->renderSort($Page->THEADDRESS) ?></div></th>
<?php } ?>
<?php if ($Page->THEID->Visible) { // THEID ?>
        <th data-name="THEID" class="<?= $Page->THEID->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_PASIEN_DIAGNOSA_THEID" class="PASIEN_DIAGNOSA_THEID"><?= $Page->renderSort($Page->THEID) ?></div></th>
<?php } ?>
<?php if ($Page->GENDER->Visible) { // GENDER ?>
        <th data-name="GENDER" class="<?= $Page->GENDER->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_PASIEN_DIAGNOSA_GENDER" class="PASIEN_DIAGNOSA_GENDER"><?= $Page->renderSort($Page->GENDER) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_PASIEN_DIAGNOSA_NO_REGISTRATION">
...
<span id="el<?= $Page->RowCount ?>_PASIEN_DIAGNOSA_THENAME">
...
<span id="el<?= $Page->RowCount ?>_PASIEN_DIAGNOSA_DIAGNOSA_DESC">
...
<span id="el<?= $Page->RowCount ?>_PASIEN_DIAGNOSA_INSTRUCTION">
...
<span id="el<?= $Page->RowCount ?>_PASIEN_DIAGNOSA_THEADDRESS">
...
<span id="el<?= $Page->RowCount ?>_PASIEN_DIAGNOSA_THEID">
...
<span id="el<?= $Page->RowCount ?>_PASIEN_DIAGNOSA_GENDER">
