...
<input type="hidden" data-table="PASIEN_DIAGNOSA" data-field="x_THENAME" data-hidden="1" data-page="1" name="x_THENAME" id="x_THENAME" value="<?= HtmlEncode($Page->THENAME->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
