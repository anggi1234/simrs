...
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->ACKNOWLEDGEBY->getDisplayValue($Page->ACKNOWLEDGEBY->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="MUTATION_DOCS" data-field="x_ACKNOWLEDGEBY" data-hidden="1" name="x_ACKNOWLEDGEBY" id="x_ACKNOWLEDGEBY" value="<?= HtmlEncode($Page->ACKNOWLEDGEBY->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
</div><!-- /page* -->
