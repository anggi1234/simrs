...
loadjs.ready("head", function () {
    ...
    fTREATMENT_BILLsearch.addFields([
        ...
        ["DUEDATE_ANGSURAN", [ew.Validators.datetime(11)], fields.DUEDATE_ANGSURAN.isInvalid],
        ...
        ["PRINT_DATE", [ew.Validators.datetime(11)], fields.PRINT_DATE.isInvalid],
        ...
        ["modified_datesys", [ew.Validators.datetime(11)], fields.modified_datesys.isInvalid],
        ["TRANS_ID", [], fields.TRANS_ID.isInvalid],
        ["SPPBILLDATE", [ew.Validators.datetime(11)], fields.SPPBILLDATE.isInvalid],
        ["SPPBILLUSER", [], fields.SPPBILLUSER.isInvalid],
        ["SPPKASIRDATE", [ew.Validators.datetime(11)], fields.SPPKASIRDATE.isInvalid],
        ["SPPKASIRUSER", [], fields.SPPKASIRUSER.isInvalid],
        ["SPPPOLI", [], fields.SPPPOLI.isInvalid],
        ["SPPPOLIUSER", [], fields.SPPPOLIUSER.isInvalid],
        ["SPPPOLIDATE", [ew.Validators.datetime(11)], fields.SPPPOLIDATE.isInvalid],
    ...
    fTREATMENT_BILLsearch.lists.ISLUNAS = <?= $Page->ISLUNAS->toClientList($Page) ?>;
    fTREATMENT_BILLsearch.lists.EMPLOYEE_ID = <?= $Page->EMPLOYEE_ID->toClientList($Page) ?>;
    fTREATMENT_BILLsearch.lists.ISRJ = <?= $Page->ISRJ->toClientList($Page) ?>;
...
<?php if ($Page->ORG_UNIT_CODE->Visible) { // ORG_UNIT_CODE ?>
    <div id="r_ORG_UNIT_CODE" class="form-group row">
        <label class="<?= $Page->LeftColumnClass ?>"><span id="elh_TREATMENT_BILL_ORG_UNIT_CODE"><?= $Page->ORG_UNIT_CODE->caption() ?></span>
...
<?php if ($Page->ISLUNAS->Visible) { // ISLUNAS ?>
    <div id="r_ISLUNAS" class="form-group row">
        <label class="<?= $Page->LeftColumnClass ?>"><span id="elh_TREATMENT_BILL_ISLUNAS"><?= $Page->ISLUNAS->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
...
<input type="hidden"
    ...
    id="x_ISLUNAS[]"
    name="x_ISLUNAS[]"
    value="<?= HtmlEncode($Page->ISLUNAS->AdvancedSearch->SearchValue) ?>"
...
<input type="<?= $Page->DUEDATE_ANGSURAN->getInputTextType() ?>" data-table="TREATMENT_BILL" data-field="x_DUEDATE_ANGSURAN" data-format="11" name="x_DUEDATE_ANGSURAN" id="x_DUEDATE_ANGSURAN" placeholder="<?= HtmlEncode($Page->DUEDATE_ANGSURAN->getPlaceHolder()) ?>" value="<?= $Page->DUEDATE_ANGSURAN->EditValue ?>"<?= $Page->DUEDATE_ANGSURAN->editAttributes() ?>>
...
<script>
loadjs.ready(["fTREATMENT_BILLsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fTREATMENT_BILLsearch", "x_DUEDATE_ANGSURAN", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
...
<input type="<?= $Page->PRINT_DATE->getInputTextType() ?>" data-table="TREATMENT_BILL" data-field="x_PRINT_DATE" data-format="11" name="x_PRINT_DATE" id="x_PRINT_DATE" placeholder="<?= HtmlEncode($Page->PRINT_DATE->getPlaceHolder()) ?>" value="<?= $Page->PRINT_DATE->EditValue ?>"<?= $Page->PRINT_DATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fTREATMENT_BILLsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fTREATMENT_BILLsearch", "x_PRINT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
...
<input type="<?= $Page->MODIFIED_DATE->getInputTextType() ?>" data-table="TREATMENT_BILL" data-field="x_MODIFIED_DATE" data-format="11" name="x_MODIFIED_DATE" id="x_MODIFIED_DATE" placeholder="<?= HtmlEncode($Page->MODIFIED_DATE->getPlaceHolder()) ?>" value="<?= $Page->MODIFIED_DATE->EditValue ?>"<?= $Page->MODIFIED_DATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fTREATMENT_BILLsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fTREATMENT_BILLsearch", "x_MODIFIED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
...
<input type="<?= $Page->EXIT_DATE->getInputTextType() ?>" data-table="TREATMENT_BILL" data-field="x_EXIT_DATE" data-format="11" name="x_EXIT_DATE" id="x_EXIT_DATE" placeholder="<?= HtmlEncode($Page->EXIT_DATE->getPlaceHolder()) ?>" value="<?= $Page->EXIT_DATE->EditValue ?>"<?= $Page->EXIT_DATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fTREATMENT_BILLsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fTREATMENT_BILLsearch", "x_EXIT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->ISRJ->Visible) { // ISRJ ?>
    <div id="r_ISRJ" class="form-group row">
        <label class="<?= $Page->LeftColumnClass ?>"><span id="elh_TREATMENT_BILL_ISRJ"><?= $Page->ISRJ->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
...
<input type="<?= $Page->modified_datesys->getInputTextType() ?>" data-table="TREATMENT_BILL" data-field="x_modified_datesys" data-format="11" name="x_modified_datesys" id="x_modified_datesys" placeholder="<?= HtmlEncode($Page->modified_datesys->getPlaceHolder()) ?>" value="<?= $Page->modified_datesys->EditValue ?>"<?= $Page->modified_datesys->editAttributes() ?>>
...
<script>
loadjs.ready(["fTREATMENT_BILLsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fTREATMENT_BILLsearch", "x_modified_datesys", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
...
<input type="<?= $Page->SPPBILLDATE->getInputTextType() ?>" data-table="TREATMENT_BILL" data-field="x_SPPBILLDATE" data-format="11" name="x_SPPBILLDATE" id="x_SPPBILLDATE" placeholder="<?= HtmlEncode($Page->SPPBILLDATE->getPlaceHolder()) ?>" value="<?= $Page->SPPBILLDATE->EditValue ?>"<?= $Page->SPPBILLDATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fTREATMENT_BILLsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fTREATMENT_BILLsearch", "x_SPPBILLDATE", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
...
<input type="<?= $Page->SPPKASIRDATE->getInputTextType() ?>" data-table="TREATMENT_BILL" data-field="x_SPPKASIRDATE" data-format="11" name="x_SPPKASIRDATE" id="x_SPPKASIRDATE" placeholder="<?= HtmlEncode($Page->SPPKASIRDATE->getPlaceHolder()) ?>" value="<?= $Page->SPPKASIRDATE->EditValue ?>"<?= $Page->SPPKASIRDATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fTREATMENT_BILLsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fTREATMENT_BILLsearch", "x_SPPKASIRDATE", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
...
<input type="<?= $Page->SPPPOLIDATE->getInputTextType() ?>" data-table="TREATMENT_BILL" data-field="x_SPPPOLIDATE" data-format="11" name="x_SPPPOLIDATE" id="x_SPPPOLIDATE" placeholder="<?= HtmlEncode($Page->SPPPOLIDATE->getPlaceHolder()) ?>" value="<?= $Page->SPPPOLIDATE->EditValue ?>"<?= $Page->SPPPOLIDATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fTREATMENT_BILLsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fTREATMENT_BILLsearch", "x_SPPPOLIDATE", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
