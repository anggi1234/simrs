...
<input type="<?= $Page->NO_REGISTRATION->getInputTextType() ?>" data-table="V_RADIOLOGI" data-field="x_NO_REGISTRATION" name="x_NO_REGISTRATION" id="x_NO_REGISTRATION" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->NO_REGISTRATION->getPlaceHolder()) ?>" value="<?= $Page->NO_REGISTRATION->EditValue ?>"<?= $Page->NO_REGISTRATION->editAttributes() ?>>
...
<input type="<?= $Page->STATUS_PASIEN_ID->getInputTextType() ?>" data-table="V_RADIOLOGI" data-field="x_STATUS_PASIEN_ID" name="x_STATUS_PASIEN_ID" id="x_STATUS_PASIEN_ID" size="30" placeholder="<?= HtmlEncode($Page->STATUS_PASIEN_ID->getPlaceHolder()) ?>" value="<?= $Page->STATUS_PASIEN_ID->EditValue ?>"<?= $Page->STATUS_PASIEN_ID->editAttributes() ?>>
...
<input type="<?= $Page->RUJUKAN_ID->getInputTextType() ?>" data-table="V_RADIOLOGI" data-field="x_RUJUKAN_ID" name="x_RUJUKAN_ID" id="x_RUJUKAN_ID" size="30" placeholder="<?= HtmlEncode($Page->RUJUKAN_ID->getPlaceHolder()) ?>" value="<?= $Page->RUJUKAN_ID->EditValue ?>"<?= $Page->RUJUKAN_ID->editAttributes() ?>>
...
<input type="<?= $Page->REASON_ID->getInputTextType() ?>" data-table="V_RADIOLOGI" data-field="x_REASON_ID" name="x_REASON_ID" id="x_REASON_ID" size="30" placeholder="<?= HtmlEncode($Page->REASON_ID->getPlaceHolder()) ?>" value="<?= $Page->REASON_ID->EditValue ?>"<?= $Page->REASON_ID->editAttributes() ?>>
...
<input type="<?= $Page->WAY_ID->getInputTextType() ?>" data-table="V_RADIOLOGI" data-field="x_WAY_ID" name="x_WAY_ID" id="x_WAY_ID" size="30" placeholder="<?= HtmlEncode($Page->WAY_ID->getPlaceHolder()) ?>" value="<?= $Page->WAY_ID->EditValue ?>"<?= $Page->WAY_ID->editAttributes() ?>>
...
<?php if ($Page->ISNEW->Visible) { // ISNEW ?>
    <div id="r_ISNEW" class="form-group row">
        <label for="x_ISNEW" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_RADIOLOGI_ISNEW"><?= $Page->ISNEW->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
...
<input type="<?= $Page->ISNEW->getInputTextType() ?>" data-table="V_RADIOLOGI" data-field="x_ISNEW" name="x_ISNEW" id="x_ISNEW" size="30" maxlength="1" placeholder="<?= HtmlEncode($Page->ISNEW->getPlaceHolder()) ?>" value="<?= $Page->ISNEW->EditValue ?>"<?= $Page->ISNEW->editAttributes() ?>>
...
<input type="<?= $Page->CLINIC_ID->getInputTextType() ?>" data-table="V_RADIOLOGI" data-field="x_CLINIC_ID" name="x_CLINIC_ID" id="x_CLINIC_ID" size="30" maxlength="8" placeholder="<?= HtmlEncode($Page->CLINIC_ID->getPlaceHolder()) ?>" value="<?= $Page->CLINIC_ID->EditValue ?>"<?= $Page->CLINIC_ID->editAttributes() ?>>
...
<input type="<?= $Page->CLINIC_ID_FROM->getInputTextType() ?>" data-table="V_RADIOLOGI" data-field="x_CLINIC_ID_FROM" name="x_CLINIC_ID_FROM" id="x_CLINIC_ID_FROM" size="30" maxlength="8" placeholder="<?= HtmlEncode($Page->CLINIC_ID_FROM->getPlaceHolder()) ?>" value="<?= $Page->CLINIC_ID_FROM->EditValue ?>"<?= $Page->CLINIC_ID_FROM->editAttributes() ?>>
...
<input type="<?= $Page->KELUAR_ID->getInputTextType() ?>" data-table="V_RADIOLOGI" data-field="x_KELUAR_ID" name="x_KELUAR_ID" id="x_KELUAR_ID" size="30" placeholder="<?= HtmlEncode($Page->KELUAR_ID->getPlaceHolder()) ?>" value="<?= $Page->KELUAR_ID->EditValue ?>"<?= $Page->KELUAR_ID->editAttributes() ?>>
...
<input type="<?= $Page->GENDER->getInputTextType() ?>" data-table="V_RADIOLOGI" data-field="x_GENDER" name="x_GENDER" id="x_GENDER" size="30" maxlength="1" placeholder="<?= HtmlEncode($Page->GENDER->getPlaceHolder()) ?>" value="<?= $Page->GENDER->EditValue ?>"<?= $Page->GENDER->editAttributes() ?>>
...
<?php if ($Page->EMPLOYEE_ID->Visible) { // EMPLOYEE_ID ?>
    <div id="r_EMPLOYEE_ID" class="form-group row">
        <label for="x_EMPLOYEE_ID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_RADIOLOGI_EMPLOYEE_ID"><?= $Page->EMPLOYEE_ID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
...
<input type="<?= $Page->EMPLOYEE_ID->getInputTextType() ?>" data-table="V_RADIOLOGI" data-field="x_EMPLOYEE_ID" name="x_EMPLOYEE_ID" id="x_EMPLOYEE_ID" size="30" maxlength="15" placeholder="<?= HtmlEncode($Page->EMPLOYEE_ID->getPlaceHolder()) ?>" value="<?= $Page->EMPLOYEE_ID->EditValue ?>"<?= $Page->EMPLOYEE_ID->editAttributes() ?>>
...
<input type="<?= $Page->PAYOR_ID->getInputTextType() ?>" data-table="V_RADIOLOGI" data-field="x_PAYOR_ID" name="x_PAYOR_ID" id="x_PAYOR_ID" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->PAYOR_ID->getPlaceHolder()) ?>" value="<?= $Page->PAYOR_ID->EditValue ?>"<?= $Page->PAYOR_ID->editAttributes() ?>>
...
<input type="<?= $Page->CLASS_ID->getInputTextType() ?>" data-table="V_RADIOLOGI" data-field="x_CLASS_ID" name="x_CLASS_ID" id="x_CLASS_ID" size="30" placeholder="<?= HtmlEncode($Page->CLASS_ID->getPlaceHolder()) ?>" value="<?= $Page->CLASS_ID->EditValue ?>"<?= $Page->CLASS_ID->editAttributes() ?>>
...
<input type="<?= $Page->KAL_ID->getInputTextType() ?>" data-table="V_RADIOLOGI" data-field="x_KAL_ID" name="x_KAL_ID" id="x_KAL_ID" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->KAL_ID->getPlaceHolder()) ?>" value="<?= $Page->KAL_ID->EditValue ?>"<?= $Page->KAL_ID->editAttributes() ?>>
...
<input type="<?= $Page->COVERAGE_ID->getInputTextType() ?>" data-table="V_RADIOLOGI" data-field="x_COVERAGE_ID" name="x_COVERAGE_ID" id="x_COVERAGE_ID" size="30" placeholder="<?= HtmlEncode($Page->COVERAGE_ID->getPlaceHolder()) ?>" value="<?= $Page->COVERAGE_ID->EditValue ?>"<?= $Page->COVERAGE_ID->editAttributes() ?>>
...
<input type="<?= $Page->DIAGNOSA_ID->getInputTextType() ?>" data-table="V_RADIOLOGI" data-field="x_DIAGNOSA_ID" name="x_DIAGNOSA_ID" id="x_DIAGNOSA_ID" size="30" maxlength="10" placeholder="<?= HtmlEncode($Page->DIAGNOSA_ID->getPlaceHolder()) ?>" value="<?= $Page->DIAGNOSA_ID->EditValue ?>"<?= $Page->DIAGNOSA_ID->editAttributes() ?>>
...
<input type="<?= $Page->ISRJ->getInputTextType() ?>" data-table="V_RADIOLOGI" data-field="x_ISRJ" name="x_ISRJ" id="x_ISRJ" size="30" maxlength="1" placeholder="<?= HtmlEncode($Page->ISRJ->getPlaceHolder()) ?>" value="<?= $Page->ISRJ->EditValue ?>"<?= $Page->ISRJ->editAttributes() ?>>
...
<input type="<?= $Page->PPKRUJUKAN->getInputTextType() ?>" data-table="V_RADIOLOGI" data-field="x_PPKRUJUKAN" name="x_PPKRUJUKAN" id="x_PPKRUJUKAN" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->PPKRUJUKAN->getPlaceHolder()) ?>" value="<?= $Page->PPKRUJUKAN->EditValue ?>"<?= $Page->PPKRUJUKAN->editAttributes() ?>>
...
<?php if ($Page->KODE_AGAMA->Visible) { // KODE_AGAMA ?>
    <div id="r_KODE_AGAMA" class="form-group row">
        <label for="x_KODE_AGAMA" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_RADIOLOGI_KODE_AGAMA"><?= $Page->KODE_AGAMA->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
...
<input type="<?= $Page->KODE_AGAMA->getInputTextType() ?>" data-table="V_RADIOLOGI" data-field="x_KODE_AGAMA" name="x_KODE_AGAMA" id="x_KODE_AGAMA" size="30" placeholder="<?= HtmlEncode($Page->KODE_AGAMA->getPlaceHolder()) ?>" value="<?= $Page->KODE_AGAMA->EditValue ?>"<?= $Page->KODE_AGAMA->editAttributes() ?>>
...
<?php if ($Page->COB->Visible) { // COB ?>
    <div id="r_COB" class="form-group row">
        <label for="x_COB" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_RADIOLOGI_COB"><?= $Page->COB->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
...
<input type="<?= $Page->COB->getInputTextType() ?>" data-table="V_RADIOLOGI" data-field="x_COB" name="x_COB" id="x_COB" size="30" maxlength="1" placeholder="<?= HtmlEncode($Page->COB->getPlaceHolder()) ?>" value="<?= $Page->COB->EditValue ?>"<?= $Page->COB->editAttributes() ?>>
...
<input type="<?= $Page->RESPONSEP->getInputTextType() ?>" data-table="V_RADIOLOGI" data-field="x_RESPONSEP" name="x_RESPONSEP" id="x_RESPONSEP" size="30" placeholder="<?= HtmlEncode($Page->RESPONSEP->getPlaceHolder()) ?>" value="<?= $Page->RESPONSEP->EditValue ?>"<?= $Page->RESPONSEP->editAttributes() ?>>
...
<input type="<?= $Page->RESPONPOST_VKLAIM->getInputTextType() ?>" data-table="V_RADIOLOGI" data-field="x_RESPONPOST_VKLAIM" name="x_RESPONPOST_VKLAIM" id="x_RESPONPOST_VKLAIM" size="30" placeholder="<?= HtmlEncode($Page->RESPONPOST_VKLAIM->getPlaceHolder()) ?>" value="<?= $Page->RESPONPOST_VKLAIM->EditValue ?>"<?= $Page->RESPONPOST_VKLAIM->editAttributes() ?>>
...
<input type="<?= $Page->RESPONPUT_VKLAIM->getInputTextType() ?>" data-table="V_RADIOLOGI" data-field="x_RESPONPUT_VKLAIM" name="x_RESPONPUT_VKLAIM" id="x_RESPONPUT_VKLAIM" size="30" placeholder="<?= HtmlEncode($Page->RESPONPUT_VKLAIM->getPlaceHolder()) ?>" value="<?= $Page->RESPONPUT_VKLAIM->EditValue ?>"<?= $Page->RESPONPUT_VKLAIM->editAttributes() ?>>
...
<input type="<?= $Page->RESPONDEL_VKLAIM->getInputTextType() ?>" data-table="V_RADIOLOGI" data-field="x_RESPONDEL_VKLAIM" name="x_RESPONDEL_VKLAIM" id="x_RESPONDEL_VKLAIM" size="30" placeholder="<?= HtmlEncode($Page->RESPONDEL_VKLAIM->getPlaceHolder()) ?>" value="<?= $Page->RESPONDEL_VKLAIM->EditValue ?>"<?= $Page->RESPONDEL_VKLAIM->editAttributes() ?>>
...
<input type="<?= $Page->IDXDAFTAR->getInputTextType() ?>" data-table="V_RADIOLOGI" data-field="x_IDXDAFTAR" name="x_IDXDAFTAR" id="x_IDXDAFTAR" placeholder="<?= HtmlEncode($Page->IDXDAFTAR->getPlaceHolder()) ?>" value="<?= $Page->IDXDAFTAR->EditValue ?>"<?= $Page->IDXDAFTAR->editAttributes() ?>>
