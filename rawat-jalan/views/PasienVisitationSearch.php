...
loadjs.ready("head", function () {
    ...
    fPASIEN_VISITATIONsearch.addFields([
        ...
        ["RM_OUT_DATE", [ew.Validators.datetime(11)], fields.RM_OUT_DATE.isInvalid],
        ["RM_IN_DATE", [ew.Validators.datetime(11)], fields.RM_IN_DATE.isInvalid],
        ...
        ["RESEND_RM_DATE", [ew.Validators.datetime(11)], fields.RESEND_RM_DATE.isInvalid],
        ...
        ["BACK_RM_DATE", [ew.Validators.datetime(11)], fields.BACK_RM_DATE.isInvalid],
        ["VALID_RM_DATE", [ew.Validators.datetime(11)], fields.VALID_RM_DATE.isInvalid],
        ...
        ["tanggal_rujukan", [ew.Validators.datetime(11)], fields.tanggal_rujukan.isInvalid],
        ...
        ["SEP_PRINTDATE", [ew.Validators.datetime(11)], fields.SEP_PRINTDATE.isInvalid],
        ...
        ["CALL_DATE", [ew.Validators.datetime(17)], fields.CALL_DATE.isInvalid],
        ["CALL_DATES", [ew.Validators.datetime(11)], fields.CALL_DATES.isInvalid],
        ["SERVED_DATE", [ew.Validators.datetime(11)], fields.SERVED_DATE.isInvalid],
        ["SERVED_INAP", [ew.Validators.datetime(11)], fields.SERVED_INAP.isInvalid],
...
<template id="tp_x_ISATTENDED">
    <div class="custom-control custom-checkbox">
        <input type="checkbox" class="custom-control-input" data-table="PASIEN_VISITATION" data-field="x_ISATTENDED" name="x_ISATTENDED" id="x_ISATTENDED"<?= $Page->ISATTENDED->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<input type="<?= $Page->RM_OUT_DATE->getInputTextType() ?>" data-table="PASIEN_VISITATION" data-field="x_RM_OUT_DATE" data-format="11" name="x_RM_OUT_DATE" id="x_RM_OUT_DATE" placeholder="<?= HtmlEncode($Page->RM_OUT_DATE->getPlaceHolder()) ?>" value="<?= $Page->RM_OUT_DATE->EditValue ?>"<?= $Page->RM_OUT_DATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fPASIEN_VISITATIONsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fPASIEN_VISITATIONsearch", "x_RM_OUT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
...
<input type="<?= $Page->RM_IN_DATE->getInputTextType() ?>" data-table="PASIEN_VISITATION" data-field="x_RM_IN_DATE" data-format="11" name="x_RM_IN_DATE" id="x_RM_IN_DATE" placeholder="<?= HtmlEncode($Page->RM_IN_DATE->getPlaceHolder()) ?>" value="<?= $Page->RM_IN_DATE->EditValue ?>"<?= $Page->RM_IN_DATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fPASIEN_VISITATIONsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fPASIEN_VISITATIONsearch", "x_RM_IN_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
...
<input type="<?= $Page->RESEND_RM_DATE->getInputTextType() ?>" data-table="PASIEN_VISITATION" data-field="x_RESEND_RM_DATE" data-format="11" name="x_RESEND_RM_DATE" id="x_RESEND_RM_DATE" placeholder="<?= HtmlEncode($Page->RESEND_RM_DATE->getPlaceHolder()) ?>" value="<?= $Page->RESEND_RM_DATE->EditValue ?>"<?= $Page->RESEND_RM_DATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fPASIEN_VISITATIONsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fPASIEN_VISITATIONsearch", "x_RESEND_RM_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
...
<input type="<?= $Page->BACK_RM_DATE->getInputTextType() ?>" data-table="PASIEN_VISITATION" data-field="x_BACK_RM_DATE" data-format="11" name="x_BACK_RM_DATE" id="x_BACK_RM_DATE" placeholder="<?= HtmlEncode($Page->BACK_RM_DATE->getPlaceHolder()) ?>" value="<?= $Page->BACK_RM_DATE->EditValue ?>"<?= $Page->BACK_RM_DATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fPASIEN_VISITATIONsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fPASIEN_VISITATIONsearch", "x_BACK_RM_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
...
<input type="<?= $Page->VALID_RM_DATE->getInputTextType() ?>" data-table="PASIEN_VISITATION" data-field="x_VALID_RM_DATE" data-format="11" name="x_VALID_RM_DATE" id="x_VALID_RM_DATE" placeholder="<?= HtmlEncode($Page->VALID_RM_DATE->getPlaceHolder()) ?>" value="<?= $Page->VALID_RM_DATE->EditValue ?>"<?= $Page->VALID_RM_DATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fPASIEN_VISITATIONsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fPASIEN_VISITATIONsearch", "x_VALID_RM_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
...
<input type="<?= $Page->tanggal_rujukan->getInputTextType() ?>" data-table="PASIEN_VISITATION" data-field="x_tanggal_rujukan" data-format="11" name="x_tanggal_rujukan" id="x_tanggal_rujukan" placeholder="<?= HtmlEncode($Page->tanggal_rujukan->getPlaceHolder()) ?>" value="<?= $Page->tanggal_rujukan->EditValue ?>"<?= $Page->tanggal_rujukan->editAttributes() ?>>
...
<script>
loadjs.ready(["fPASIEN_VISITATIONsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fPASIEN_VISITATIONsearch", "x_tanggal_rujukan", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->ISRJ->Visible) { // ISRJ ?>
    <div id="r_ISRJ" class="form-group row">
        <label for="x_ISRJ" class="<?= $Page->LeftColumnClass ?>"><span id="elh_PASIEN_VISITATION_ISRJ"><?= $Page->ISRJ->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
...
<input type="<?= $Page->SEP_PRINTDATE->getInputTextType() ?>" data-table="PASIEN_VISITATION" data-field="x_SEP_PRINTDATE" data-format="11" name="x_SEP_PRINTDATE" id="x_SEP_PRINTDATE" placeholder="<?= HtmlEncode($Page->SEP_PRINTDATE->getPlaceHolder()) ?>" value="<?= $Page->SEP_PRINTDATE->EditValue ?>"<?= $Page->SEP_PRINTDATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fPASIEN_VISITATIONsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fPASIEN_VISITATIONsearch", "x_SEP_PRINTDATE", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->TRANS_ID->Visible) { // TRANS_ID ?>
    <div id="r_TRANS_ID" class="form-group row">
        <label class="<?= $Page->LeftColumnClass ?>"><span id="elh_PASIEN_VISITATION_TRANS_ID"><?= $Page->TRANS_ID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
...
<input type="<?= $Page->CALL_DATE->getInputTextType() ?>" data-table="PASIEN_VISITATION" data-field="x_CALL_DATE" data-format="17" name="x_CALL_DATE" id="x_CALL_DATE" placeholder="<?= HtmlEncode($Page->CALL_DATE->getPlaceHolder()) ?>" value="<?= $Page->CALL_DATE->EditValue ?>"<?= $Page->CALL_DATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fPASIEN_VISITATIONsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fPASIEN_VISITATIONsearch", "x_CALL_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":17});
});
</script>
<?php } ?>
</span>
...
<input type="<?= $Page->CALL_DATES->getInputTextType() ?>" data-table="PASIEN_VISITATION" data-field="x_CALL_DATES" data-format="11" name="x_CALL_DATES" id="x_CALL_DATES" placeholder="<?= HtmlEncode($Page->CALL_DATES->getPlaceHolder()) ?>" value="<?= $Page->CALL_DATES->EditValue ?>"<?= $Page->CALL_DATES->editAttributes() ?>>
...
<script>
loadjs.ready(["fPASIEN_VISITATIONsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fPASIEN_VISITATIONsearch", "x_CALL_DATES", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
...
<input type="<?= $Page->SERVED_DATE->getInputTextType() ?>" data-table="PASIEN_VISITATION" data-field="x_SERVED_DATE" data-format="11" name="x_SERVED_DATE" id="x_SERVED_DATE" placeholder="<?= HtmlEncode($Page->SERVED_DATE->getPlaceHolder()) ?>" value="<?= $Page->SERVED_DATE->EditValue ?>"<?= $Page->SERVED_DATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fPASIEN_VISITATIONsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fPASIEN_VISITATIONsearch", "x_SERVED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
...
<input type="<?= $Page->SERVED_INAP->getInputTextType() ?>" data-table="PASIEN_VISITATION" data-field="x_SERVED_INAP" data-format="11" name="x_SERVED_INAP" id="x_SERVED_INAP" placeholder="<?= HtmlEncode($Page->SERVED_INAP->getPlaceHolder()) ?>" value="<?= $Page->SERVED_INAP->EditValue ?>"<?= $Page->SERVED_INAP->editAttributes() ?>>
...
<script>
loadjs.ready(["fPASIEN_VISITATIONsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fPASIEN_VISITATIONsearch", "x_SERVED_INAP", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
