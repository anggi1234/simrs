...
if (isset($id)) {
    ...
    $url = "https://new-api.bpjs-kesehatan.go.id:8080/new-vclaim-rest/RencanaKontrol/insert";
    //
    $url = "https://apijkn-dev.bpjs-kesehatan.go.id/vclaim-rest-dev/RencanaKontrol/insert";
