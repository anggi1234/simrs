...
class PasienVisitation extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // COVERAGE_ID
        $this->COVERAGE_ID = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_COVERAGE_ID', 'COVERAGE_ID', '[COVERAGE_ID]', 'CAST([COVERAGE_ID] AS NVARCHAR)', 17, 1, -1, false, '[COVERAGE_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
