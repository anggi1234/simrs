 ...
 * Page class
 */
class UsersMenuView extends UsersMenu
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UsersMenuView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("MENU_ID") ?? Route("MENU_ID")) !== null) {
            $this->RecKey["MENU_ID"] = $keyValue;
        }
        if (($keyValue = Get("STYPE_ID") ?? Route("STYPE_ID")) !== null) {
            $this->RecKey["STYPE_ID"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("ORG_UNIT_CODE") ?? Route("ORG_UNIT_CODE")) !== null) {
                ...
                $returnUrl = "UsersMenuList"; // Return to list
            }
            if (($keyValue = Get("_USERNAME") ?? Route("_USERNAME")) !== null) {
            ...
            if (($keyValue = Get("STYPE_ID") ?? Route("STYPE_ID")) !== null) {
                ...
                $this->RecKey["STYPE_ID"] = $this->STYPE_ID->QueryStringValue;
            } elseif (Post("STYPE_ID") !== null) {
                $this->STYPE_ID->setFormValue(Post("STYPE_ID"));
                $this->RecKey["STYPE_ID"] = $this->STYPE_ID->FormValue;
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "UsersMenuList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "UsersMenuList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
