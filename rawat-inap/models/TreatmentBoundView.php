 ...
 * Page class
 */
class TreatmentBoundView extends TreatmentBound
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TreatmentBoundView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("REAGENT_ID") ?? Route("REAGENT_ID")) !== null) {
            $this->RecKey["REAGENT_ID"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("ORG_UNIT_CODE") ?? Route("ORG_UNIT_CODE")) !== null) {
                ...
                $returnUrl = "TreatmentBoundList"; // Return to list
            }
            if (($keyValue = Get("REAGENT_ID") ?? Route("REAGENT_ID")) !== null) {
                $this->REAGENT_ID->setQueryStringValue($keyValue);
                $this->RecKey["REAGENT_ID"] = $this->REAGENT_ID->QueryStringValue;
            } elseif (Post("REAGENT_ID") !== null) {
                $this->REAGENT_ID->setFormValue(Post("REAGENT_ID"));
                $this->RecKey["REAGENT_ID"] = $this->REAGENT_ID->FormValue;
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "TreatmentBoundList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "TreatmentBoundList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
