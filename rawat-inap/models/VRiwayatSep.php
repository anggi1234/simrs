...
class VRiwayatSep extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // STATUS_PASIEN_ID
        $this->STATUS_PASIEN_ID = new DbField('v_riwayat_sep', 'v_riwayat_sep', 'x_STATUS_PASIEN_ID', 'STATUS_PASIEN_ID', 'dbo.PASIEN_VISITATION.STATUS_PASIEN_ID', 'CAST(dbo.PASIEN_VISITATION.STATUS_PASIEN_ID AS NVARCHAR)', 17, 1, -1, false, 'dbo.PASIEN_VISITATION.STATUS_PASIEN_ID', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // VISIT_DATE
        $this->VISIT_DATE = new DbField('v_riwayat_sep', 'v_riwayat_sep', 'x_VISIT_DATE', 'VISIT_DATE', 'dbo.PASIEN_VISITATION.VISIT_DATE', CastDateFieldForLike("dbo.PASIEN_VISITATION.VISIT_DATE", 0, "DB"), 135, 8, 0, false, 'dbo.PASIEN_VISITATION.VISIT_DATE', false, false, false, 'FORMATTED TEXT', 'TEXT');
