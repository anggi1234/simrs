 ...
 * Page class
 */
class TreatmentBilltrans1Add extends TreatmentBilltrans1
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TreatmentBilltrans1Add";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "TreatmentBilltrans1View") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // RESEP_KE
        $this->RESEP_KE->setDbValueDef($rsnew, $this->RESEP_KE->CurrentValue, null, strval($this->RESEP_KE->CurrentValue) == "");
