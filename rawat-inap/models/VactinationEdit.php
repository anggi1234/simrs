 ...
 * Page class
 */
class VactinationEdit extends Vactination
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VactinationEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            ...
            if (($keyValue = Get("VACTINATION_ID") ?? Key(1) ?? Route(3)) !== null) {
                $this->VACTINATION_ID->setQueryStringValue($keyValue);
                $this->VACTINATION_ID->setOldValue($this->VACTINATION_ID->QueryStringValue);
            } elseif (Post("VACTINATION_ID") !== null) {
                $this->VACTINATION_ID->setFormValue(Post("VACTINATION_ID"));
                $this->VACTINATION_ID->setOldValue($this->VACTINATION_ID->FormValue);
            } else {
                $loaded = false; // Unable to load key
            }
            ...
            if (Post("action") !== null) {
                ...
                if (($keyValue = Get("VACTINATION_ID") ?? Route("VACTINATION_ID")) !== null) {
                    ...
                    $this->VACTINATION_ID->CurrentValue = null;
                }
            }
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_VACTINATION_ID")) {
            $this->VACTINATION_ID->setOldValue($CurrentForm->getValue("o_VACTINATION_ID"));
        }
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // VACTINATION_ID
            $this->VACTINATION_ID->setDbValueDef($rsnew, $this->VACTINATION_ID->CurrentValue, "", $this->VACTINATION_ID->ReadOnly);
            ...
            // BILL_ID
            $this->BILL_ID->setDbValueDef($rsnew, $this->BILL_ID->CurrentValue, null, $this->BILL_ID->ReadOnly);

            // CLINIC_ID
            $this->CLINIC_ID->setDbValueDef($rsnew, $this->CLINIC_ID->CurrentValue, null, $this->CLINIC_ID->ReadOnly);

            // VACTINATION_TYPE
            $this->VACTINATION_TYPE->setDbValueDef($rsnew, $this->VACTINATION_TYPE->CurrentValue, null, $this->VACTINATION_TYPE->ReadOnly);
            ...
            // PATIENT_CATEGORY_ID
            $this->PATIENT_CATEGORY_ID->setDbValueDef($rsnew, $this->PATIENT_CATEGORY_ID->CurrentValue, null, $this->PATIENT_CATEGORY_ID->ReadOnly);

            // VACTINATION_DATE
            $this->VACTINATION_DATE->setDbValueDef($rsnew, UnFormatDateTime($this->VACTINATION_DATE->CurrentValue, 0), null, $this->VACTINATION_DATE->ReadOnly);
