...
class GoodGf extends DbTable
{
    ...
    public function __construct()
    {
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->BRAND_ID->Lookup = new Lookup('BRAND_ID', 'GOODS', false, 'BRAND_ID', ["NAME","STOCK","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->BRAND_ID->Lookup = new Lookup('BRAND_ID', 'GOODS', false, 'BRAND_ID', ["NAME","STOCK","",""], [], [], [], [], [], [], '', '');
                break;
    ...
    public function getMasterFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "MUTATION_DOCS") {
            ...
            if ($this->ROOMS_ID->getSessionValue() != "") {
                $masterFilter .= " AND " . GetForeignKeySql("[CLINIC_ID_TO]", $this->ROOMS_ID->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
    ...
    public function getDetailFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "MUTATION_DOCS") {
            ...
            if ($this->ROOMS_ID->getSessionValue() != "") {
                $detailFilter .= " AND " . GetForeignKeySql("[ROOMS_ID]", $this->ROOMS_ID->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
            if ($this->FROM_ROOMS_ID->getSessionValue() != "") {
    ...
    {
        return "[DOC_NO]='@DOC_NO@' AND [CLINIC_ID_TO]='@CLINIC_ID_TO@' AND [CLINIC_ID]='@CLINIC_ID@'";
    }
    // Detail filter
    public function sqlDetailFilter_MUTATION_DOCS()
    {
        return "[DOC_NO]='@DOC_NO@' AND [ROOMS_ID]='@ROOMS_ID@' AND [FROM_ROOMS_ID]='@FROM_ROOMS_ID@'";
    }
