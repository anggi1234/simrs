 ...
 * Page class
 */
class WebsiteMenuDelete extends WebsiteMenu
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WebsiteMenuDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("WebsiteMenuList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("WebsiteMenuList"); // Return to list
                return;
            }
        }
