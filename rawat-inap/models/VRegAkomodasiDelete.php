 ...
 * Page class
 */
class VRegAkomodasiDelete extends VRegAkomodasi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VRegAkomodasiDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("VRegAkomodasiList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("VRegAkomodasiList"); // Return to list
                return;
            }
        }
