 ...
 * Page class
 */
class TreatmentBookingView extends TreatmentBooking
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TreatmentBookingView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("ORG_UNIT_CODE") ?? Route("ORG_UNIT_CODE")) !== null) {
                ...
                $returnUrl = "TreatmentBookingList"; // Return to list
            }
            if (($keyValue = Get("BILL_ID") ?? Route("BILL_ID")) !== null) {
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "TreatmentBookingList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "TreatmentBookingList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("TreatmentBookingList"), "", $this->TableVar, true);
        $pageId = "view";
