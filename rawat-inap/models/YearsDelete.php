 ...
 * Page class
 */
class YearsDelete extends Years
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "YearsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("YearsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("YearsList"); // Return to list
                return;
            }
        }
