...
class UserLoginAdd extends UserLogin
{
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->ORG_UNIT_CODE->EditCustomAttributes = "1604031";
            $this->ORG_UNIT_CODE->CurrentValue = '1604031';
    ...
    protected function addRow($rsold = null)
    {
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE->setDbValueDef($rsnew, $this->ORG_UNIT_CODE->CurrentValue, "", strval($this->ORG_UNIT_CODE->CurrentValue) == "");
