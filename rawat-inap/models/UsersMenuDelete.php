 ...
 * Page class
 */
class UsersMenuDelete extends UsersMenu
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UsersMenuDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("UsersMenuList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("UsersMenuList"); // Return to list
                return;
            }
        }
