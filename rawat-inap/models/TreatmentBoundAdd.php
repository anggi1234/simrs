 ...
 * Page class
 */
class TreatmentBoundAdd extends TreatmentBound
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TreatmentBoundAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "TreatmentBoundView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->REAGENT_NAME->CurrentValue = null;
        $this->REAGENT_NAME->OldValue = $this->REAGENT_NAME->CurrentValue;
    }
    ...
    protected function newRow()
    {
        ...
        $row['REAGENT_ID'] = $this->REAGENT_ID->CurrentValue;
        $row['CLINIC_ID'] = $this->CLINIC_ID->CurrentValue;
        $row['TREAT_ID'] = $this->TREAT_ID->CurrentValue;
        $row['REAGENT_NAME'] = $this->REAGENT_NAME->CurrentValue;
        return $row;
    }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // REAGENT_ID
        $this->REAGENT_ID->setDbValueDef($rsnew, $this->REAGENT_ID->CurrentValue, "", strval($this->REAGENT_ID->CurrentValue) == "");
        ...
        // REAGENT_NAME
        $this->REAGENT_NAME->setDbValueDef($rsnew, $this->REAGENT_NAME->CurrentValue, null, false);
        ...
        // Check if key value entered
        if ($insertRow && $this->ValidateKey && strval($rsnew['REAGENT_ID']) == "") {
            $this->setFailureMessage($Language->phrase("InvalidKeyValue"));
            $insertRow = false;
        }
