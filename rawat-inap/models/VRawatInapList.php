...
class VRawatInapList extends VRawatInap
{
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "VRawatInapAdd?" . Config("TABLE_SHOW_DETAIL") . "=";
    ...
    protected function setupListOptions()
    {
        ...
        // "detail_OBSTETRI"
        $item = &$this->ListOptions->add("detail_OBSTETRI");
        $item->CssClass = "text-nowrap";
        $item->Visible = $Security->allowList(CurrentProjectID() . 'OBSTETRI') && !$this->ShowMultipleDetails;
        $item->OnLeft = true;
        $item->ShowInButtonGroup = false;
    ...
    public function renderListOptions()
    {
        ...
        if ($Security->allowList(CurrentProjectID() . 'TREATMENT_BILL')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("TreatmentBillList?" . Config("TABLE_SHOW_MASTER") . "=V_RAWAT_INAP&" . GetForeignKeyUrl("fk_VISIT_ID", $this->VISIT_ID->CurrentValue) . "&" . GetForeignKeyUrl("fk_NO_REGISTRATION", $this->NO_REGISTRATION->CurrentValue) . "&" . GetForeignKeyUrl("fk_TRANS_ID", $this->TRANS_ID->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
            $detailPage = Container("TreatmentBillGrid");
            if ($detailPage->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'V_RAWAT_INAP')) {
            ...
            if ($detailPage->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'V_RAWAT_INAP')) {
        ...
        if ($Security->allowList(CurrentProjectID() . 'PASIEN_DIAGNOSA')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("PasienDiagnosaList?" . Config("TABLE_SHOW_MASTER") . "=V_RAWAT_INAP&" . GetForeignKeyUrl("fk_VISIT_ID", $this->VISIT_ID->CurrentValue) . "&" . GetForeignKeyUrl("fk_THENAME", $this->THENAME->CurrentValue) . "&" . GetForeignKeyUrl("fk_NO_REGISTRATION", $this->NO_REGISTRATION->CurrentValue) . "&" . GetForeignKeyUrl("fk_THEADDRESS", $this->THEADDRESS->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
        ...
        // "detail_OBSTETRI"
        $opt = $this->ListOptions["detail_OBSTETRI"];
        if ($Security->allowList(CurrentProjectID() . 'OBSTETRI')) {
            $body = $Language->phrase("DetailLink") . $Language->TablePhrase("OBSTETRI", "TblCaption");
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("ObstetriList?" . Config("TABLE_SHOW_MASTER") . "=V_RAWAT_INAP&" . GetForeignKeyUrl("fk_VISIT_ID", $this->VISIT_ID->CurrentValue) . "&" . GetForeignKeyUrl("fk_NO_REGISTRATION", $this->NO_REGISTRATION->CurrentValue) . "&" . GetForeignKeyUrl("fk_THENAME", $this->THENAME->CurrentValue) . "&" . GetForeignKeyUrl("fk_THEADDRESS", $this->THEADDRESS->CurrentValue) . "&" . GetForeignKeyUrl("fk_GENDER", $this->GENDER->CurrentValue) . "&" . GetForeignKeyUrl("fk_ORG_UNIT_CODE", $this->ORG_UNIT_CODE->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
            $detailPage = Container("ObstetriGrid");
            if ($detailPage->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'V_RAWAT_INAP')) {
                $caption = $Language->phrase("MasterDetailViewLink");
                $url = $this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=OBSTETRI");
                $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
                if ($detailViewTblVar != "") {
                    $detailViewTblVar .= ",";
                }
            ...
            if ($detailPage->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'V_RAWAT_INAP')) {
                $caption = $Language->phrase("MasterDetailEditLink");
                $url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=OBSTETRI");
                $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
                if ($detailEditTblVar != "") {
                    $detailEditTblVar .= ",";
                }
    ...
    protected function setupOtherOptions()
    {
        ...
        $detailTableLink = "";
                ...
                $item->Visible = ($detailPage->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'V_RAWAT_INAP') && $Security->canAdd());
                if ($item->Visible) {
                    if ($detailTableLink != "") {
                        $detailTableLink .= ",";
                    }
                ...
                $item = &$option->add("detailadd_OBSTETRI");
                $url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=OBSTETRI");
                $detailPage = Container("ObstetriGrid");
                $caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $detailPage->tableCaption();
                $item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode(GetUrl($url)) . "\">" . $caption . "</a>";
                $item->Visible = ($detailPage->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'V_RAWAT_INAP') && $Security->canAdd());
