 ...
 * Page class
 */
class TreatmentNosokomialDelete extends TreatmentNosokomial
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TreatmentNosokomialDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TreatmentNosokomialList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("TreatmentNosokomialList"); // Return to list
                return;
            }
        }
