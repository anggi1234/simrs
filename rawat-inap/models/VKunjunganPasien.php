...
class VKunjunganPasien extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // NO_REGISTRATION
        $this->NO_REGISTRATION = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_NO_REGISTRATION', 'NO_REGISTRATION', '[NO_REGISTRATION]', '[NO_REGISTRATION]', 200, 50, -1, false, '[NO_REGISTRATION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DIANTAR_OLEH
        $this->DIANTAR_OLEH = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_DIANTAR_OLEH', 'DIANTAR_OLEH', '[DIANTAR_OLEH]', '[DIANTAR_OLEH]', 200, 255, -1, false, '[DIANTAR_OLEH]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GENDER
        $this->GENDER = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_GENDER', 'GENDER', '[GENDER]', '[GENDER]', 129, 1, -1, false, '[GENDER]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // STATUS_PASIEN_ID
        $this->STATUS_PASIEN_ID = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_STATUS_PASIEN_ID', 'STATUS_PASIEN_ID', '[STATUS_PASIEN_ID]', 'CAST([STATUS_PASIEN_ID] AS NVARCHAR)', 17, 1, -1, false, '[STATUS_PASIEN_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // CLINIC_ID
        $this->CLINIC_ID = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_CLINIC_ID', 'CLINIC_ID', '[CLINIC_ID]', '[CLINIC_ID]', 200, 8, -1, false, '[CLINIC_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // CLINIC_ID_FROM
        $this->CLINIC_ID_FROM = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_CLINIC_ID_FROM', 'CLINIC_ID_FROM', '[CLINIC_ID_FROM]', '[CLINIC_ID_FROM]', 200, 8, -1, false, '[CLINIC_ID_FROM]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // VISIT_DATE
        $this->VISIT_DATE = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_VISIT_DATE', 'VISIT_DATE', 'dbo.PASIEN_VISITATION.VISIT_DATE', CastDateFieldForLike("dbo.PASIEN_VISITATION.VISIT_DATE", 11, "DB"), 135, 8, 11, false, 'dbo.PASIEN_VISITATION.VISIT_DATE', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLASS_ROOM_ID
        $this->CLASS_ROOM_ID = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_CLASS_ROOM_ID', 'CLASS_ROOM_ID', '[CLASS_ROOM_ID]', '[CLASS_ROOM_ID]', 200, 16, -1, false, '[CLASS_ROOM_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // BED_ID
        $this->BED_ID = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_BED_ID', 'BED_ID', '[BED_ID]', 'CAST([BED_ID] AS NVARCHAR)', 17, 1, -1, false, '[BED_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SERVED_INAP
        $this->SERVED_INAP = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_SERVED_INAP', 'SERVED_INAP', '[SERVED_INAP]', CastDateFieldForLike("[SERVED_INAP]", 11, "DB"), 135, 8, 11, false, '[SERVED_INAP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EXIT_DATE
        $this->EXIT_DATE = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_EXIT_DATE', 'EXIT_DATE', '[EXIT_DATE]', CastDateFieldForLike("[EXIT_DATE]", 11, "DB"), 135, 8, 11, false, '[EXIT_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISRJ
        $this->ISRJ = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_ISRJ', 'ISRJ', '[ISRJ]', '[ISRJ]', 129, 1, -1, false, '[ISRJ]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // VISIT_ID
        $this->VISIT_ID = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_VISIT_ID', 'VISIT_ID', '[VISIT_ID]', '[VISIT_ID]', 200, 50, -1, false, '[VISIT_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // IDXDAFTAR
        $this->IDXDAFTAR = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_IDXDAFTAR', 'IDXDAFTAR', '[IDXDAFTAR]', 'CAST([IDXDAFTAR] AS NVARCHAR)', 3, 4, -1, false, '[IDXDAFTAR]', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // KELUAR_ID
        $this->KELUAR_ID = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_KELUAR_ID', 'KELUAR_ID', '[KELUAR_ID]', 'CAST([KELUAR_ID] AS NVARCHAR)', 17, 1, -1, false, '[KELUAR_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // AGEYEAR
        $this->AGEYEAR = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_AGEYEAR', 'AGEYEAR', '[AGEYEAR]', 'CAST([AGEYEAR] AS NVARCHAR)', 2, 2, -1, false, '[AGEYEAR]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ORG_UNIT_CODE->Sortable = true; // Allow sort
        $this->ORG_UNIT_CODE->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ORG_UNIT_CODE->Param, "CustomMsg");
        $this->Fields['ORG_UNIT_CODE'] = &$this->ORG_UNIT_CODE;

        // RUJUKAN_ID
        $this->RUJUKAN_ID = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_RUJUKAN_ID', 'RUJUKAN_ID', '[RUJUKAN_ID]', 'CAST([RUJUKAN_ID] AS NVARCHAR)', 20, 8, -1, false, '[RUJUKAN_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ADDRESS_OF_RUJUKAN
        $this->ADDRESS_OF_RUJUKAN = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_ADDRESS_OF_RUJUKAN', 'ADDRESS_OF_RUJUKAN', '[ADDRESS_OF_RUJUKAN]', '[ADDRESS_OF_RUJUKAN]', 200, 100, -1, false, '[ADDRESS_OF_RUJUKAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // REASON_ID
        $this->REASON_ID = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_REASON_ID', 'REASON_ID', '[REASON_ID]', 'CAST([REASON_ID] AS NVARCHAR)', 17, 1, -1, false, '[REASON_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // WAY_ID
        $this->WAY_ID = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_WAY_ID', 'WAY_ID', '[WAY_ID]', 'CAST([WAY_ID] AS NVARCHAR)', 17, 1, -1, false, '[WAY_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PATIENT_CATEGORY_ID
        $this->PATIENT_CATEGORY_ID = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_PATIENT_CATEGORY_ID', 'PATIENT_CATEGORY_ID', '[PATIENT_CATEGORY_ID]', 'CAST([PATIENT_CATEGORY_ID] AS NVARCHAR)', 17, 1, -1, false, '[PATIENT_CATEGORY_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BOOKED_DATE
        $this->BOOKED_DATE = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_BOOKED_DATE', 'BOOKED_DATE', '[BOOKED_DATE]', CastDateFieldForLike("[BOOKED_DATE]", 0, "DB"), 135, 8, 0, false, '[BOOKED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISNEW
        $this->ISNEW = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_ISNEW', 'ISNEW', '[ISNEW]', '[ISNEW]', 129, 1, -1, false, '[ISNEW]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // FOLLOW_UP
        $this->FOLLOW_UP = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_FOLLOW_UP', 'FOLLOW_UP', '[FOLLOW_UP]', 'CAST([FOLLOW_UP] AS NVARCHAR)', 17, 1, -1, false, '[FOLLOW_UP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PLACE_TYPE
        $this->PLACE_TYPE = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_PLACE_TYPE', 'PLACE_TYPE', '[PLACE_TYPE]', 'CAST([PLACE_TYPE] AS NVARCHAR)', 17, 1, -1, false, '[PLACE_TYPE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // IN_DATE
        $this->IN_DATE = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_IN_DATE', 'IN_DATE', '[IN_DATE]', CastDateFieldForLike("[IN_DATE]", 0, "DB"), 135, 8, 0, false, '[IN_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DESCRIPTION
        $this->DESCRIPTION = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_DESCRIPTION', 'DESCRIPTION', '[DESCRIPTION]', '[DESCRIPTION]', 200, 200, -1, false, '[DESCRIPTION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DESCRIPTION->Sortable = true; // Allow sort
        $this->DESCRIPTION->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DESCRIPTION->Param, "CustomMsg");
        $this->Fields['DESCRIPTION'] = &$this->DESCRIPTION;

        // VISITOR_ADDRESS
        $this->VISITOR_ADDRESS = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_VISITOR_ADDRESS', 'VISITOR_ADDRESS', '[VISITOR_ADDRESS]', '[VISITOR_ADDRESS]', 200, 150, -1, false, '[VISITOR_ADDRESS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 100, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MODIFIED_BY->Sortable = true; // Allow sort
        $this->MODIFIED_BY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MODIFIED_BY->Param, "CustomMsg");
        $this->Fields['MODIFIED_BY'] = &$this->MODIFIED_BY;

        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 11, "DB"), 135, 8, 11, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_FROM
        $this->MODIFIED_FROM = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_MODIFIED_FROM', 'MODIFIED_FROM', '[MODIFIED_FROM]', '[MODIFIED_FROM]', 200, 50, -1, false, '[MODIFIED_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EMPLOYEE_ID
        $this->EMPLOYEE_ID = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_EMPLOYEE_ID', 'EMPLOYEE_ID', '[EMPLOYEE_ID]', '[EMPLOYEE_ID]', 200, 15, -1, false, '[EMPLOYEE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EMPLOYEE_ID_FROM
        $this->EMPLOYEE_ID_FROM = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_EMPLOYEE_ID_FROM', 'EMPLOYEE_ID_FROM', '[EMPLOYEE_ID_FROM]', '[EMPLOYEE_ID_FROM]', 200, 50, -1, false, '[EMPLOYEE_ID_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RESPONSIBLE_ID
        $this->RESPONSIBLE_ID = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_RESPONSIBLE_ID', 'RESPONSIBLE_ID', '[RESPONSIBLE_ID]', 'CAST([RESPONSIBLE_ID] AS NVARCHAR)', 17, 1, -1, false, '[RESPONSIBLE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RESPONSIBLE
        $this->RESPONSIBLE = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_RESPONSIBLE', 'RESPONSIBLE', '[RESPONSIBLE]', '[RESPONSIBLE]', 200, 150, -1, false, '[RESPONSIBLE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // FAMILY_STATUS_ID
        $this->FAMILY_STATUS_ID = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_FAMILY_STATUS_ID', 'FAMILY_STATUS_ID', '[FAMILY_STATUS_ID]', 'CAST([FAMILY_STATUS_ID] AS NVARCHAR)', 17, 1, -1, false, '[FAMILY_STATUS_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TICKET_NO
        $this->TICKET_NO = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_TICKET_NO', 'TICKET_NO', '[TICKET_NO]', 'CAST([TICKET_NO] AS NVARCHAR)', 2, 2, -1, false, '[TICKET_NO]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISATTENDED
        $this->ISATTENDED = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_ISATTENDED', 'ISATTENDED', '[ISATTENDED]', '[ISATTENDED]', 129, 1, -1, false, '[ISATTENDED]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PAYOR_ID
        $this->PAYOR_ID = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_PAYOR_ID', 'PAYOR_ID', '[PAYOR_ID]', '[PAYOR_ID]', 200, 50, -1, false, '[PAYOR_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLASS_ID
        $this->CLASS_ID = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_CLASS_ID', 'CLASS_ID', '[CLASS_ID]', 'CAST([CLASS_ID] AS NVARCHAR)', 17, 1, -1, false, '[CLASS_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISPERTARIF
        $this->ISPERTARIF = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_ISPERTARIF', 'ISPERTARIF', '[ISPERTARIF]', '[ISPERTARIF]', 129, 1, -1, false, '[ISPERTARIF]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KAL_ID
        $this->KAL_ID = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_KAL_ID', 'KAL_ID', '[KAL_ID]', '[KAL_ID]', 200, 50, -1, false, '[KAL_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EMPLOYEE_INAP
        $this->EMPLOYEE_INAP = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_EMPLOYEE_INAP', 'EMPLOYEE_INAP', '[EMPLOYEE_INAP]', '[EMPLOYEE_INAP]', 200, 50, -1, false, '[EMPLOYEE_INAP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PASIEN_ID
        $this->PASIEN_ID = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_PASIEN_ID', 'PASIEN_ID', '[PASIEN_ID]', '[PASIEN_ID]', 200, 30, -1, false, '[PASIEN_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KARYAWAN
        $this->KARYAWAN = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_KARYAWAN', 'KARYAWAN', '[KARYAWAN]', '[KARYAWAN]', 200, 50, -1, false, '[KARYAWAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ACCOUNT_ID
        $this->ACCOUNT_ID = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_ACCOUNT_ID', 'ACCOUNT_ID', '[ACCOUNT_ID]', '[ACCOUNT_ID]', 200, 50, -1, false, '[ACCOUNT_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLASS_ID_PLAFOND
        $this->CLASS_ID_PLAFOND = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_CLASS_ID_PLAFOND', 'CLASS_ID_PLAFOND', '[CLASS_ID_PLAFOND]', 'CAST([CLASS_ID_PLAFOND] AS NVARCHAR)', 17, 1, -1, false, '[CLASS_ID_PLAFOND]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BACKCHARGE
        $this->BACKCHARGE = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_BACKCHARGE', 'BACKCHARGE', '[BACKCHARGE]', '[BACKCHARGE]', 129, 1, -1, false, '[BACKCHARGE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // COVERAGE_ID
        $this->COVERAGE_ID = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_COVERAGE_ID', 'COVERAGE_ID', '[COVERAGE_ID]', 'CAST([COVERAGE_ID] AS NVARCHAR)', 17, 1, -1, false, '[COVERAGE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AGEMONTH
        $this->AGEMONTH = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_AGEMONTH', 'AGEMONTH', '[AGEMONTH]', 'CAST([AGEMONTH] AS NVARCHAR)', 2, 2, -1, false, '[AGEMONTH]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AGEDAY
        $this->AGEDAY = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_AGEDAY', 'AGEDAY', '[AGEDAY]', 'CAST([AGEDAY] AS NVARCHAR)', 2, 2, -1, false, '[AGEDAY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RECOMENDATION
        $this->RECOMENDATION = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_RECOMENDATION', 'RECOMENDATION', '[RECOMENDATION]', '[RECOMENDATION]', 200, 8000, -1, false, '[RECOMENDATION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CONCLUSION
        $this->CONCLUSION = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_CONCLUSION', 'CONCLUSION', '[CONCLUSION]', '[CONCLUSION]', 200, 8000, -1, false, '[CONCLUSION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SPECIMENNO
        $this->SPECIMENNO = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_SPECIMENNO', 'SPECIMENNO', '[SPECIMENNO]', '[SPECIMENNO]', 200, 50, -1, false, '[SPECIMENNO]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LOCKED
        $this->LOCKED = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_LOCKED', 'LOCKED', '[LOCKED]', '[LOCKED]', 200, 1, -1, false, '[LOCKED]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RM_OUT_DATE
        $this->RM_OUT_DATE = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_RM_OUT_DATE', 'RM_OUT_DATE', '[RM_OUT_DATE]', CastDateFieldForLike("[RM_OUT_DATE]", 0, "DB"), 135, 8, 0, false, '[RM_OUT_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RM_IN_DATE
        $this->RM_IN_DATE = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_RM_IN_DATE', 'RM_IN_DATE', '[RM_IN_DATE]', CastDateFieldForLike("[RM_IN_DATE]", 0, "DB"), 135, 8, 0, false, '[RM_IN_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LAMA_PINJAM
        $this->LAMA_PINJAM = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_LAMA_PINJAM', 'LAMA_PINJAM', '[LAMA_PINJAM]', CastDateFieldForLike("[LAMA_PINJAM]", 0, "DB"), 135, 8, 0, false, '[LAMA_PINJAM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STANDAR_RJ
        $this->STANDAR_RJ = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_STANDAR_RJ', 'STANDAR_RJ', '[STANDAR_RJ]', '[STANDAR_RJ]', 129, 1, -1, false, '[STANDAR_RJ]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LENGKAP_RJ
        $this->LENGKAP_RJ = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_LENGKAP_RJ', 'LENGKAP_RJ', '[LENGKAP_RJ]', '[LENGKAP_RJ]', 129, 1, -1, false, '[LENGKAP_RJ]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LENGKAP_RI
        $this->LENGKAP_RI = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_LENGKAP_RI', 'LENGKAP_RI', '[LENGKAP_RI]', '[LENGKAP_RI]', 129, 1, -1, false, '[LENGKAP_RI]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RESEND_RM_DATE
        $this->RESEND_RM_DATE = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_RESEND_RM_DATE', 'RESEND_RM_DATE', '[RESEND_RM_DATE]', CastDateFieldForLike("[RESEND_RM_DATE]", 0, "DB"), 135, 8, 0, false, '[RESEND_RM_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LENGKAP_RM1
        $this->LENGKAP_RM1 = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_LENGKAP_RM1', 'LENGKAP_RM1', '[LENGKAP_RM1]', '[LENGKAP_RM1]', 129, 1, -1, false, '[LENGKAP_RM1]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LENGKAP_RESUME
        $this->LENGKAP_RESUME = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_LENGKAP_RESUME', 'LENGKAP_RESUME', '[LENGKAP_RESUME]', '[LENGKAP_RESUME]', 129, 1, -1, false, '[LENGKAP_RESUME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LENGKAP_ANAMNESIS
        $this->LENGKAP_ANAMNESIS = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_LENGKAP_ANAMNESIS', 'LENGKAP_ANAMNESIS', '[LENGKAP_ANAMNESIS]', '[LENGKAP_ANAMNESIS]', 129, 1, -1, false, '[LENGKAP_ANAMNESIS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LENGKAP_CONSENT
        $this->LENGKAP_CONSENT = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_LENGKAP_CONSENT', 'LENGKAP_CONSENT', '[LENGKAP_CONSENT]', '[LENGKAP_CONSENT]', 129, 1, -1, false, '[LENGKAP_CONSENT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LENGKAP_ANESTESI
        $this->LENGKAP_ANESTESI = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_LENGKAP_ANESTESI', 'LENGKAP_ANESTESI', '[LENGKAP_ANESTESI]', '[LENGKAP_ANESTESI]', 129, 1, -1, false, '[LENGKAP_ANESTESI]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LENGKAP_OP
        $this->LENGKAP_OP = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_LENGKAP_OP', 'LENGKAP_OP', '[LENGKAP_OP]', '[LENGKAP_OP]', 129, 1, -1, false, '[LENGKAP_OP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BACK_RM_DATE
        $this->BACK_RM_DATE = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_BACK_RM_DATE', 'BACK_RM_DATE', '[BACK_RM_DATE]', CastDateFieldForLike("[BACK_RM_DATE]", 0, "DB"), 135, 8, 0, false, '[BACK_RM_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // VALID_RM_DATE
        $this->VALID_RM_DATE = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_VALID_RM_DATE', 'VALID_RM_DATE', '[VALID_RM_DATE]', CastDateFieldForLike("[VALID_RM_DATE]", 0, "DB"), 135, 8, 0, false, '[VALID_RM_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NO_SKP
        $this->NO_SKP = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_NO_SKP', 'NO_SKP', '[NO_SKP]', '[NO_SKP]', 200, 50, -1, false, '[NO_SKP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NO_SKPINAP
        $this->NO_SKPINAP = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_NO_SKPINAP', 'NO_SKPINAP', '[NO_SKPINAP]', '[NO_SKPINAP]', 200, 50, -1, false, '[NO_SKPINAP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DIAGNOSA_ID
        $this->DIAGNOSA_ID = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_DIAGNOSA_ID', 'DIAGNOSA_ID', '[DIAGNOSA_ID]', '[DIAGNOSA_ID]', 200, 10, -1, false, '[DIAGNOSA_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ticket_all
        $this->ticket_all = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_ticket_all', 'ticket_all', '[ticket_all]', 'CAST([ticket_all] AS NVARCHAR)', 20, 8, -1, false, '[ticket_all]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tanggal_rujukan
        $this->tanggal_rujukan = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_tanggal_rujukan', 'tanggal_rujukan', '[tanggal_rujukan]', CastDateFieldForLike("[tanggal_rujukan]", 0, "DB"), 135, 8, 0, false, '[tanggal_rujukan]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NORUJUKAN
        $this->NORUJUKAN = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_NORUJUKAN', 'NORUJUKAN', '[NORUJUKAN]', '[NORUJUKAN]', 200, 50, -1, false, '[NORUJUKAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PPKRUJUKAN
        $this->PPKRUJUKAN = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_PPKRUJUKAN', 'PPKRUJUKAN', '[PPKRUJUKAN]', '[PPKRUJUKAN]', 200, 50, -1, false, '[PPKRUJUKAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LOKASILAKA
        $this->LOKASILAKA = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_LOKASILAKA', 'LOKASILAKA', '[LOKASILAKA]', '[LOKASILAKA]', 200, 50, -1, false, '[LOKASILAKA]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KDPOLI
        $this->KDPOLI = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_KDPOLI', 'KDPOLI', '[KDPOLI]', '[KDPOLI]', 200, 3, -1, false, '[KDPOLI]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EDIT_SEP
        $this->EDIT_SEP = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_EDIT_SEP', 'EDIT_SEP', '[EDIT_SEP]', '[EDIT_SEP]', 200, 250, -1, false, '[EDIT_SEP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DELETE_SEP
        $this->DELETE_SEP = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_DELETE_SEP', 'DELETE_SEP', '[DELETE_SEP]', '[DELETE_SEP]', 200, 250, -1, false, '[DELETE_SEP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KODE_AGAMA
        $this->KODE_AGAMA = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_KODE_AGAMA', 'KODE_AGAMA', '[KODE_AGAMA]', 'CAST([KODE_AGAMA] AS NVARCHAR)', 17, 1, -1, false, '[KODE_AGAMA]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DIAG_AWAL
        $this->DIAG_AWAL = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_DIAG_AWAL', 'DIAG_AWAL', '[DIAG_AWAL]', '[DIAG_AWAL]', 200, 10, -1, false, '[DIAG_AWAL]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AKTIF
        $this->AKTIF = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_AKTIF', 'AKTIF', '[AKTIF]', '[AKTIF]', 200, 2, -1, false, '[AKTIF]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BILL_INAP
        $this->BILL_INAP = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_BILL_INAP', 'BILL_INAP', '[BILL_INAP]', '[BILL_INAP]', 200, 50, -1, false, '[BILL_INAP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SEP_PRINTDATE
        $this->SEP_PRINTDATE = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_SEP_PRINTDATE', 'SEP_PRINTDATE', '[SEP_PRINTDATE]', CastDateFieldForLike("[SEP_PRINTDATE]", 0, "DB"), 135, 8, 0, false, '[SEP_PRINTDATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MAPPING_SEP
        $this->MAPPING_SEP = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_MAPPING_SEP', 'MAPPING_SEP', '[MAPPING_SEP]', '[MAPPING_SEP]', 200, 250, -1, false, '[MAPPING_SEP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TRANS_ID
        $this->TRANS_ID = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_TRANS_ID', 'TRANS_ID', '[TRANS_ID]', '[TRANS_ID]', 200, 50, -1, false, '[TRANS_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KDPOLI_EKS
        $this->KDPOLI_EKS = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_KDPOLI_EKS', 'KDPOLI_EKS', '[KDPOLI_EKS]', '[KDPOLI_EKS]', 129, 1, -1, false, '[KDPOLI_EKS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // COB
        $this->COB = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_COB', 'COB', '[COB]', '[COB]', 129, 1, -1, false, '[COB]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PENJAMIN
        $this->PENJAMIN = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_PENJAMIN', 'PENJAMIN', '[PENJAMIN]', '[PENJAMIN]', 200, 25, -1, false, '[PENJAMIN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ASALRUJUKAN
        $this->ASALRUJUKAN = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_ASALRUJUKAN', 'ASALRUJUKAN', '[ASALRUJUKAN]', '[ASALRUJUKAN]', 129, 1, -1, false, '[ASALRUJUKAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RESPONSEP
        $this->RESPONSEP = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_RESPONSEP', 'RESPONSEP', '[RESPONSEP]', '[RESPONSEP]', 200, 0, -1, false, '[RESPONSEP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // APPROVAL_DESC
        $this->APPROVAL_DESC = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_APPROVAL_DESC', 'APPROVAL_DESC', '[APPROVAL_DESC]', '[APPROVAL_DESC]', 200, 250, -1, false, '[APPROVAL_DESC]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->APPROVAL_RESPONAJUKAN = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_APPROVAL_RESPONAJUKAN', 'APPROVAL_RESPONAJUKAN', '[APPROVAL_RESPONAJUKAN]', '[APPROVAL_RESPONAJUKAN]', 200, 250, -1, false, '[APPROVAL_RESPONAJUKAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->APPROVAL_RESPONAPPROV = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_APPROVAL_RESPONAPPROV', 'APPROVAL_RESPONAPPROV', '[APPROVAL_RESPONAPPROV]', '[APPROVAL_RESPONAPPROV]', 200, 250, -1, false, '[APPROVAL_RESPONAPPROV]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RESPONTGLPLG_DESC
        $this->RESPONTGLPLG_DESC = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_RESPONTGLPLG_DESC', 'RESPONTGLPLG_DESC', '[RESPONTGLPLG_DESC]', '[RESPONTGLPLG_DESC]', 200, 250, -1, false, '[RESPONTGLPLG_DESC]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RESPONPOST_VKLAIM
        $this->RESPONPOST_VKLAIM = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_RESPONPOST_VKLAIM', 'RESPONPOST_VKLAIM', '[RESPONPOST_VKLAIM]', '[RESPONPOST_VKLAIM]', 200, 0, -1, false, '[RESPONPOST_VKLAIM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RESPONPUT_VKLAIM
        $this->RESPONPUT_VKLAIM = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_RESPONPUT_VKLAIM', 'RESPONPUT_VKLAIM', '[RESPONPUT_VKLAIM]', '[RESPONPUT_VKLAIM]', 200, 0, -1, false, '[RESPONPUT_VKLAIM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RESPONDEL_VKLAIM
        $this->RESPONDEL_VKLAIM = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_RESPONDEL_VKLAIM', 'RESPONDEL_VKLAIM', '[RESPONDEL_VKLAIM]', '[RESPONDEL_VKLAIM]', 200, 0, -1, false, '[RESPONDEL_VKLAIM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CALL_TIMES
        $this->CALL_TIMES = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_CALL_TIMES', 'CALL_TIMES', '[CALL_TIMES]', 'CAST([CALL_TIMES] AS NVARCHAR)', 3, 4, -1, false, '[CALL_TIMES]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CALL_DATE
        $this->CALL_DATE = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_CALL_DATE', 'CALL_DATE', '[CALL_DATE]', CastDateFieldForLike("[CALL_DATE]", 0, "DB"), 135, 8, 0, false, '[CALL_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CALL_DATES
        $this->CALL_DATES = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_CALL_DATES', 'CALL_DATES', '[CALL_DATES]', CastDateFieldForLike("[CALL_DATES]", 0, "DB"), 135, 8, 0, false, '[CALL_DATES]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SERVED_DATE
        $this->SERVED_DATE = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_SERVED_DATE', 'SERVED_DATE', '[SERVED_DATE]', CastDateFieldForLike("[SERVED_DATE]", 0, "DB"), 135, 8, 0, false, '[SERVED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KDDPJP1
        $this->KDDPJP1 = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_KDDPJP1', 'KDDPJP1', '[KDDPJP1]', '[KDDPJP1]', 200, 25, -1, false, '[KDDPJP1]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KDDPJP
        $this->KDDPJP = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_KDDPJP', 'KDDPJP', '[KDDPJP]', '[KDDPJP]', 200, 25, -1, false, '[KDDPJP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tgl_kontrol
        $this->tgl_kontrol = new DbField('V_KUNJUNGAN_PASIEN', 'V_KUNJUNGAN_PASIEN', 'x_tgl_kontrol', 'tgl_kontrol', '[tgl_kontrol]', CastDateFieldForLike("[tgl_kontrol]", 0, "DB"), 135, 8, 0, false, '[tgl_kontrol]', false, false, false, 'FORMATTED TEXT', 'TEXT');
