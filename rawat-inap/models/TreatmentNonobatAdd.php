 ...
 * Page class
 */
class TreatmentNonobatAdd extends TreatmentNonobat
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TreatmentNonobatAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("TreatmentNonobatList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "TreatmentNonobatList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "TreatmentNonobatView") {
