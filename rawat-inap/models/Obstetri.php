...
class Obstetri extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->ORG_UNIT_CODE->IsForeignKey = true; // Foreign key field
        ...
        $this->OBSTETRI_ID->Sortable = false; // Allow sort
        ...
        // GENDER
        $this->GENDER = new DbField('OBSTETRI', 'OBSTETRI', 'x_GENDER', 'GENDER', '[GENDER]', '[GENDER]', 129, 1, -1, false, '[GENDER]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->GENDER->IsForeignKey = true; // Foreign key field
        ...
        // CLINIC_ID
        $this->CLINIC_ID = new DbField('OBSTETRI', 'OBSTETRI', 'x_CLINIC_ID', 'CLINIC_ID', '[CLINIC_ID]', '[CLINIC_ID]', 200, 50, -1, false, '[CLINIC_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // EMPLOYEE_ID
        $this->EMPLOYEE_ID = new DbField('OBSTETRI', 'OBSTETRI', 'x_EMPLOYEE_ID', 'EMPLOYEE_ID', '[EMPLOYEE_ID]', '[EMPLOYEE_ID]', 200, 50, -1, false, '[EMPLOYEE_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->HPHT->Sortable = false; // Allow sort
        ...
        $this->HTP->Sortable = false; // Allow sort
        ...
        $this->KOHORT_NB->Sortable = false; // Allow sort
        ...
        // BIRTH_NB
        $this->BIRTH_NB = new DbField('OBSTETRI', 'OBSTETRI', 'x_BIRTH_NB', 'BIRTH_NB', '[BIRTH_NB]', 'CAST([BIRTH_NB] AS NVARCHAR)', 17, 1, -1, false, '[BIRTH_NB]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->BIRTH_NB->Sortable = false; // Allow sort
        $this->BIRTH_NB->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->BIRTH_NB->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        switch ($CurrentLanguage) {
            case "en":
                $this->BIRTH_NB->Lookup = new Lookup('BIRTH_NB', 'BIRTH_VISIT', false, 'BIRTH_NB', ["BIRTH_VISIT","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->BIRTH_NB->Lookup = new Lookup('BIRTH_NB', 'BIRTH_VISIT', false, 'BIRTH_NB', ["BIRTH_VISIT","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        $this->BIRTH_DURATION->Sortable = false; // Allow sort
        ...
        // BIRTH_PLACE
        $this->BIRTH_PLACE = new DbField('OBSTETRI', 'OBSTETRI', 'x_BIRTH_PLACE', 'BIRTH_PLACE', '[BIRTH_PLACE]', 'CAST([BIRTH_PLACE] AS NVARCHAR)', 17, 1, -1, false, '[BIRTH_PLACE]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->BIRTH_PLACE->Sortable = false; // Allow sort
        $this->BIRTH_PLACE->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->BIRTH_PLACE->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        switch ($CurrentLanguage) {
            case "en":
                $this->BIRTH_PLACE->Lookup = new Lookup('BIRTH_PLACE', 'BIRTH_PLACE', false, 'BIRTH_PLACE', ["BIRTHPLACE","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->BIRTH_PLACE->Lookup = new Lookup('BIRTH_PLACE', 'BIRTH_PLACE', false, 'BIRTH_PLACE', ["BIRTHPLACE","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // ANTE_NATAL
        $this->ANTE_NATAL = new DbField('OBSTETRI', 'OBSTETRI', 'x_ANTE_NATAL', 'ANTE_NATAL', '[ANTE_NATAL]', 'CAST([ANTE_NATAL] AS NVARCHAR)', 17, 1, -1, false, '[ANTE_NATAL]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->ANTE_NATAL->Sortable = false; // Allow sort
        $this->ANTE_NATAL->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->ANTE_NATAL->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        switch ($CurrentLanguage) {
            case "en":
                $this->ANTE_NATAL->Lookup = new Lookup('ANTE_NATAL', 'ANTE_NATAL', false, 'ANTE_NATAL', ["ANTENATAL","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->ANTE_NATAL->Lookup = new Lookup('ANTE_NATAL', 'ANTE_NATAL', false, 'ANTE_NATAL', ["ANTENATAL","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // BIRTH_WAY
        $this->BIRTH_WAY = new DbField('OBSTETRI', 'OBSTETRI', 'x_BIRTH_WAY', 'BIRTH_WAY', '[BIRTH_WAY]', '[BIRTH_WAY]', 200, 50, -1, false, '[BIRTH_WAY]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->BIRTH_WAY->Sortable = false; // Allow sort
        $this->BIRTH_WAY->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->BIRTH_WAY->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        switch ($CurrentLanguage) {
            case "en":
                $this->BIRTH_WAY->Lookup = new Lookup('BIRTH_WAY', 'BIRTH_WAY', false, 'BIRTHWAY', ["BIRTHWAY","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->BIRTH_WAY->Lookup = new Lookup('BIRTH_WAY', 'BIRTH_WAY', false, 'BIRTHWAY', ["BIRTHWAY","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // BIRTH_BY
        $this->BIRTH_BY = new DbField('OBSTETRI', 'OBSTETRI', 'x_BIRTH_BY', 'BIRTH_BY', '[BIRTH_BY]', 'CAST([BIRTH_BY] AS NVARCHAR)', 17, 1, -1, false, '[BIRTH_BY]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->BIRTH_BY->Sortable = false; // Allow sort
        $this->BIRTH_BY->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->BIRTH_BY->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        switch ($CurrentLanguage) {
            case "en":
                $this->BIRTH_BY->Lookup = new Lookup('BIRTH_BY', 'BIRTH_BY', false, 'BIRTH_BY', ["BIRTHBY","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->BIRTH_BY->Lookup = new Lookup('BIRTH_BY', 'BIRTH_BY', false, 'BIRTH_BY', ["BIRTHBY","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // BIRTH_DATE
        $this->BIRTH_DATE = new DbField('OBSTETRI', 'OBSTETRI', 'x_BIRTH_DATE', 'BIRTH_DATE', '[BIRTH_DATE]', CastDateFieldForLike("[BIRTH_DATE]", 7, "DB"), 135, 8, 7, false, '[BIRTH_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->BIRTH_DATE->Sortable = false; // Allow sort
        $this->BIRTH_DATE->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_SEPARATOR"], $Language->phrase("IncorrectDateDMY"));
        ...
        $this->GESTASI->Sortable = false; // Allow sort
        ...
        $this->PARITY->Sortable = false; // Allow sort
        ...
        $this->NB_BABY->Sortable = false; // Allow sort
        ...
        $this->BABY_DIE->Sortable = false; // Allow sort
        ...
        $this->ABORTUS_KE->Sortable = false; // Allow sort
        ...
        // ABORTUS_ID
        $this->ABORTUS_ID = new DbField('OBSTETRI', 'OBSTETRI', 'x_ABORTUS_ID', 'ABORTUS_ID', '[ABORTUS_ID]', '[ABORTUS_ID]', 200, 10, -1, false, '[ABORTUS_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->ABORTUS_ID->Sortable = false; // Allow sort
        $this->ABORTUS_ID->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->ABORTUS_ID->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        switch ($CurrentLanguage) {
            case "en":
                $this->ABORTUS_ID->Lookup = new Lookup('ABORTUS_ID', 'ABORTUS', false, 'ABORTUS_ID', ["ABORTUS_ID","ABORTUS","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->ABORTUS_ID->Lookup = new Lookup('ABORTUS_ID', 'ABORTUS', false, 'ABORTUS_ID', ["ABORTUS_ID","ABORTUS","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        $this->ABORTION_DATE->Sortable = false; // Allow sort
        ...
        $this->BIRTH_CAT->Sortable = false; // Allow sort
        ...
        // BIRTH_CON
        $this->BIRTH_CON = new DbField('OBSTETRI', 'OBSTETRI', 'x_BIRTH_CON', 'BIRTH_CON', '[BIRTH_CON]', 'CAST([BIRTH_CON] AS NVARCHAR)', 17, 1, -1, false, '[BIRTH_CON]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->BIRTH_CON->Sortable = false; // Allow sort
        $this->BIRTH_CON->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->BIRTH_CON->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        switch ($CurrentLanguage) {
            case "en":
                $this->BIRTH_CON->Lookup = new Lookup('BIRTH_CON', 'BIRTH_CONDITION', false, 'BIRTH_CON', ["BIRTH_CONDITION","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->BIRTH_CON->Lookup = new Lookup('BIRTH_CON', 'BIRTH_CONDITION', false, 'BIRTH_CON', ["BIRTH_CONDITION","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        $this->BIRTH_RISK->Sortable = false; // Allow sort
        ...
        $this->RISK_TYPE->Sortable = false; // Allow sort
        ...
        // FOLLOW_UP
        $this->FOLLOW_UP = new DbField('OBSTETRI', 'OBSTETRI', 'x_FOLLOW_UP', 'FOLLOW_UP', '[FOLLOW_UP]', 'CAST([FOLLOW_UP] AS NVARCHAR)', 17, 1, -1, false, '[FOLLOW_UP]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->FOLLOW_UP->Sortable = false; // Allow sort
        $this->FOLLOW_UP->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->FOLLOW_UP->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        switch ($CurrentLanguage) {
            case "en":
                $this->FOLLOW_UP->Lookup = new Lookup('FOLLOW_UP', 'FOLLOW_UP', false, 'FOLLOW_UP', ["FOLLOWUP","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->FOLLOW_UP->Lookup = new Lookup('FOLLOW_UP', 'FOLLOW_UP', false, 'FOLLOW_UP', ["FOLLOWUP","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // DIRUJUK_OLEH
        $this->DIRUJUK_OLEH = new DbField('OBSTETRI', 'OBSTETRI', 'x_DIRUJUK_OLEH', 'DIRUJUK_OLEH', '[DIRUJUK_OLEH]', '[DIRUJUK_OLEH]', 200, 100, -1, false, '[DIRUJUK_OLEH]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->DIRUJUK_OLEH->Sortable = false; // Allow sort
        $this->DIRUJUK_OLEH->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->DIRUJUK_OLEH->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        switch ($CurrentLanguage) {
            case "en":
                $this->DIRUJUK_OLEH->Lookup = new Lookup('DIRUJUK_OLEH', 'OBSTETRI', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->DIRUJUK_OLEH->Lookup = new Lookup('DIRUJUK_OLEH', 'OBSTETRI', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        }
        $this->DIRUJUK_OLEH->OptionCount = 6;
        ...
        // INSPECTION_DATE
        $this->INSPECTION_DATE = new DbField('OBSTETRI', 'OBSTETRI', 'x_INSPECTION_DATE', 'INSPECTION_DATE', '[INSPECTION_DATE]', CastDateFieldForLike("[INSPECTION_DATE]", 11, "DB"), 135, 8, 11, false, '[INSPECTION_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->INSPECTION_DATE->Sortable = false; // Allow sort
        $this->INSPECTION_DATE->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_SEPARATOR"], $Language->phrase("IncorrectDateDMY"));
        ...
        $this->PORSIO->Sortable = false; // Allow sort
        ...
        $this->PEMBUKAAN->Sortable = false; // Allow sort
        ...
        $this->KETUBAN->Sortable = false; // Allow sort
        ...
        $this->PRESENTASI->Sortable = false; // Allow sort
        ...
        $this->POSISI->Sortable = false; // Allow sort
        ...
        $this->PENURUNAN->Sortable = false; // Allow sort
        ...
        $this->HEART_ID->Sortable = false; // Allow sort
        ...
        $this->JANIN_ID->Sortable = false; // Allow sort
        ...
        $this->FREK_DJJ->Sortable = false; // Allow sort
        ...
        $this->PLACENTA->Sortable = false; // Allow sort
        ...
        $this->LOCHIA->Sortable = false; // Allow sort
        ...
        $this->BAB_TYPE->Sortable = false; // Allow sort
        ...
        $this->BAB_BAB_TYPE->Sortable = false; // Allow sort
        ...
        // RAHIM_ID
        $this->RAHIM_ID = new DbField('OBSTETRI', 'OBSTETRI', 'x_RAHIM_ID', 'RAHIM_ID', '[RAHIM_ID]', '[RAHIM_ID]', 129, 1, -1, false, '[RAHIM_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->RAHIM_ID->Sortable = false; // Allow sort
        $this->RAHIM_ID->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->RAHIM_ID->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        switch ($CurrentLanguage) {
            case "en":
                $this->RAHIM_ID->Lookup = new Lookup('RAHIM_ID', 'BIRTH_RAHIM', false, 'RAHIM_ID', ["RAHIM","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->RAHIM_ID->Lookup = new Lookup('RAHIM_ID', 'BIRTH_RAHIM', false, 'RAHIM_ID', ["RAHIM","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        $this->BIR_RAHIM_ID->Sortable = false; // Allow sort
        ...
        // BLOODING
        $this->BLOODING = new DbField('OBSTETRI', 'OBSTETRI', 'x_BLOODING', 'BLOODING', '[BLOODING]', '[BLOODING]', 129, 1, -1, false, '[BLOODING]', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->BLOODING->Sortable = false; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->BLOODING->Lookup = new Lookup('BLOODING', 'OBSTETRI', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->BLOODING->Lookup = new Lookup('BLOODING', 'OBSTETRI', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        }
        $this->BLOODING->OptionCount = 2;
        ...
        $this->RAHIM_SALIN->Sortable = false; // Allow sort
        ...
        $this->RAHIM_NIFAS->Sortable = false; // Allow sort
        ...
        $this->BAK_TYPE->Sortable = false; // Allow sort
        ...
        $this->NB_OBSTETRI->Sortable = false; // Allow sort
        ...
        $this->OBSTETRI_DIE->Sortable = false; // Allow sort
        ...
        $this->DIAGNOSA_ID2->Sortable = false; // Allow sort
        ...
        $this->APGAR_ID->Sortable = false; // Allow sort
        ...
        $this->BIRTH_LAST_ID->Sortable = false; // Allow sort
    ...
    public function getMasterFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "V_RAWAT_INAP") {
            ...
            if ($this->THENAME->getSessionValue() != "") {
                $masterFilter .= " AND " . GetForeignKeySql("[THENAME]", $this->THENAME->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
            if ($this->THEADDRESS->getSessionValue() != "") {
                $masterFilter .= " AND " . GetForeignKeySql("[THEADDRESS]", $this->THEADDRESS->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
            if ($this->GENDER->getSessionValue() != "") {
                $masterFilter .= " AND " . GetForeignKeySql("[GENDER]", $this->GENDER->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
            if ($this->ORG_UNIT_CODE->getSessionValue() != "") {
                $masterFilter .= " AND " . GetForeignKeySql("[ORG_UNIT_CODE]", $this->ORG_UNIT_CODE->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
        }
    ...
    public function getDetailFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "V_RAWAT_INAP") {
            ...
            if ($this->GENDER->getSessionValue() != "") {
                $detailFilter .= " AND " . GetForeignKeySql("[GENDER]", $this->GENDER->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
            if ($this->ORG_UNIT_CODE->getSessionValue() != "") {
                $detailFilter .= " AND " . GetForeignKeySql("[ORG_UNIT_CODE]", $this->ORG_UNIT_CODE->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
        }
    ...
    // Master filter
    public function sqlMasterFilter_V_RAWAT_INAP()
    {
        return "[VISIT_ID]='@VISIT_ID@' AND [NO_REGISTRATION]='@NO_REGISTRATION@' AND [THENAME]='@THENAME@' AND [THEADDRESS]='@THEADDRESS@' AND [GENDER]='@GENDER@' AND [ORG_UNIT_CODE]='@ORG_UNIT_CODE@'";
    }
    // Detail filter
    public function sqlDetailFilter_V_RAWAT_INAP()
    {
        return "[VISIT_ID]='@VISIT_ID@' AND [NO_REGISTRATION]='@NO_REGISTRATION@' AND [THENAME]='@THENAME@' AND [THEADDRESS]='@THEADDRESS@' AND [GENDER]='@GENDER@' AND [ORG_UNIT_CODE]='@ORG_UNIT_CODE@'";
    }
    ...
    {
        if ($this->getCurrentMasterTable() == "V_RAWAT_INAP" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            ...
            $url .= "&" . GetForeignKeyUrl("fk_THENAME", $this->THENAME->CurrentValue ?? $this->THENAME->getSessionValue());
            $url .= "&" . GetForeignKeyUrl("fk_THEADDRESS", $this->THEADDRESS->CurrentValue ?? $this->THEADDRESS->getSessionValue());
            $url .= "&" . GetForeignKeyUrl("fk_GENDER", $this->GENDER->CurrentValue ?? $this->GENDER->getSessionValue());
            $url .= "&" . GetForeignKeyUrl("fk_ORG_UNIT_CODE", $this->ORG_UNIT_CODE->CurrentValue ?? $this->ORG_UNIT_CODE->getSessionValue());
        }
        return $url;
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        if ($this->ORG_UNIT_CODE->getSessionValue() != "") {
            $this->ORG_UNIT_CODE->CurrentValue = GetForeignKeyValue($this->ORG_UNIT_CODE->getSessionValue());
            $this->ORG_UNIT_CODE->ViewValue = $this->ORG_UNIT_CODE->CurrentValue;
            $this->ORG_UNIT_CODE->ViewCustomAttributes = "";
        } else {
        ...
        $this->BIRTH_DATE->EditValue = FormatDateTime($this->BIRTH_DATE->CurrentValue, 7);
        ...
        $this->INSPECTION_DATE->EditValue = FormatDateTime($this->INSPECTION_DATE->CurrentValue, 11);
