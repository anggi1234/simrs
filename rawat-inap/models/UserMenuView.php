 ...
 * Page class
 */
class UserMenuView extends UserMenu
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UserMenuView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("ORG_UNIT_CODE") ?? Route("ORG_UNIT_CODE")) !== null) {
                ...
                $returnUrl = "UserMenuList"; // Return to list
            }
            if (($keyValue = Get("GROUP_ID") ?? Route("GROUP_ID")) !== null) {
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "UserMenuList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "UserMenuList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
