 ...
 * Page class
 */
class TreatmentBoundDelete extends TreatmentBound
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TreatmentBoundDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TreatmentBoundList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("TreatmentBoundList"); // Return to list
                return;
            }
        }
