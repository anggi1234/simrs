...
class TreatmentBillList extends TreatmentBill
{
    ...
    protected function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->ISLUNAS, $default, false); // ISLUNAS
    ...
    public function renderListOptions()
    {
        ...
        if ($Security->allowList(CurrentProjectID() . 'TREATMENT_AKOMODASI')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("TreatmentAkomodasiList?" . Config("TABLE_SHOW_MASTER") . "=TREATMENT_BILL&" . GetForeignKeyUrl("fk_BILL_ID", $this->BILL_ID->CurrentValue) . "&" . GetForeignKeyUrl("fk_VISIT_ID", $this->VISIT_ID->CurrentValue) . "&" . GetForeignKeyUrl("fk_NO_REGISTRATION", $this->NO_REGISTRATION->CurrentValue) . "&" . GetForeignKeyUrl("fk_TRANS_ID", $this->TRANS_ID->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
        ...
        if ($Security->allowList(CurrentProjectID() . 'V_AKOMODASI_KAMAR')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("VAkomodasiKamarList?" . Config("TABLE_SHOW_MASTER") . "=TREATMENT_BILL&" . GetForeignKeyUrl("fk_BILL_ID", $this->BILL_ID->CurrentValue) . "&" . GetForeignKeyUrl("fk_VISIT_ID", $this->VISIT_ID->CurrentValue) . "&" . GetForeignKeyUrl("fk_NO_REGISTRATION", $this->NO_REGISTRATION->CurrentValue) . "&" . GetForeignKeyUrl("fk_TRANS_ID", $this->TRANS_ID->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
