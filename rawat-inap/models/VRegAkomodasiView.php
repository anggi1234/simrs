 ...
 * Page class
 */
class VRegAkomodasiView extends VRegAkomodasi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VRegAkomodasiView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("ID") ?? Route("ID")) !== null) {
                ...
                $returnUrl = "VRegAkomodasiList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "VRegAkomodasiList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "VRegAkomodasiList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
