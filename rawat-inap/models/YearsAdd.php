...
class YearsAdd extends Years
{
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "YearsView") {
    ...
    {
        global $Language, $Security;
        if ($this->YEAR_ID->CurrentValue != "") { // Check field with unique index
            $filter = "([YEAR_ID] = " . AdjustSql($this->YEAR_ID->CurrentValue, $this->Dbid) . ")";
            $rsChk = $this->loadRs($filter)->fetch();
            if ($rsChk !== false) {
                $idxErrMsg = str_replace("%f", $this->YEAR_ID->caption(), $Language->phrase("DupIndex"));
                $idxErrMsg = str_replace("%v", $this->YEAR_ID->CurrentValue, $idxErrMsg);
        ...
        if ($insertRow && $this->ValidateKey && strval($rsnew['YEAR_ID']) == "") {
