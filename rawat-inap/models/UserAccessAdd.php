 ...
 * Page class
 */
class UserAccessAdd extends UserAccess
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UserAccessAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "UserAccessView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->USE_ORG_UNIT_CODE->OldValue = $this->USE_ORG_UNIT_CODE->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row['USE_ORG_UNIT_CODE'] = $this->USE_ORG_UNIT_CODE->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // USE_ORG_UNIT_CODE
        $this->USE_ORG_UNIT_CODE->setDbValueDef($rsnew, $this->USE_ORG_UNIT_CODE->CurrentValue, "", false);
        ...
        // Check if key value entered
        if ($insertRow && $this->ValidateKey && strval($rsnew['USE_ORG_UNIT_CODE']) == "") {
            $this->setFailureMessage($Language->phrase("InvalidKeyValue"));
            $insertRow = false;
        }
