 ...
 * Page class
 */
class GoodMutationEdit extends GoodMutation
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GoodMutationEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("GoodMutationList"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "GoodMutationList") {
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->idx->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->idx->Visible = false; // Disable update for API request
            } else {
    ...
    protected function validateForm()
    {
        ...
        if (!CheckInteger($this->idx->FormValue)) {
            $this->idx->addErrorMessage($this->idx->getErrorMessage(false));
        }
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // idx
            $this->idx->setDbValueDef($rsnew, $this->idx->CurrentValue, null, $this->idx->ReadOnly);
