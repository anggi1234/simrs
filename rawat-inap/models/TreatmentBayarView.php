 ...
 * Page class
 */
class TreatmentBayarView extends TreatmentBayar
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TreatmentBayarView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("ID") ?? Route("ID")) !== null) {
                ...
                $returnUrl = "TreatmentBayarList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "TreatmentBayarList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "TreatmentBayarList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
