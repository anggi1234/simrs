 ...
 * Page class
 */
class GoodMutationDelete extends GoodMutation
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GoodMutationDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("GoodMutationList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("GoodMutationList"); // Return to list
                return;
            }
        }
