 ...
 * Page class
 */
class VactinationList extends Vactination
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VactinationList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fVACTINATIONlist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "VactinationAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "VactinationDelete";
        $this->MultiUpdateUrl = "VactinationUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fVACTINATIONlistsrch";
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->VACTINATION_ID->AdvancedSearch->toJson(), ","); // Field VACTINATION_ID
        ...
        $filterList = Concat($filterList, $this->VACTINATION_TYPE->AdvancedSearch->toJson(), ","); // Field VACTINATION_TYPE
        ...
        $filterList = Concat($filterList, $this->VACTINATION_DATE->AdvancedSearch->toJson(), ","); // Field VACTINATION_DATE
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fVACTINATIONlistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field VACTINATION_ID
        $this->VACTINATION_ID->AdvancedSearch->SearchValue = @$filter["x_VACTINATION_ID"];
        $this->VACTINATION_ID->AdvancedSearch->SearchOperator = @$filter["z_VACTINATION_ID"];
        $this->VACTINATION_ID->AdvancedSearch->SearchCondition = @$filter["v_VACTINATION_ID"];
        $this->VACTINATION_ID->AdvancedSearch->SearchValue2 = @$filter["y_VACTINATION_ID"];
        $this->VACTINATION_ID->AdvancedSearch->SearchOperator2 = @$filter["w_VACTINATION_ID"];
        $this->VACTINATION_ID->AdvancedSearch->save();
        ...
        // Field VACTINATION_TYPE
        $this->VACTINATION_TYPE->AdvancedSearch->SearchValue = @$filter["x_VACTINATION_TYPE"];
        $this->VACTINATION_TYPE->AdvancedSearch->SearchOperator = @$filter["z_VACTINATION_TYPE"];
        $this->VACTINATION_TYPE->AdvancedSearch->SearchCondition = @$filter["v_VACTINATION_TYPE"];
        $this->VACTINATION_TYPE->AdvancedSearch->SearchValue2 = @$filter["y_VACTINATION_TYPE"];
        $this->VACTINATION_TYPE->AdvancedSearch->SearchOperator2 = @$filter["w_VACTINATION_TYPE"];
        $this->VACTINATION_TYPE->AdvancedSearch->save();
        ...
        // Field VACTINATION_DATE
        $this->VACTINATION_DATE->AdvancedSearch->SearchValue = @$filter["x_VACTINATION_DATE"];
        $this->VACTINATION_DATE->AdvancedSearch->SearchOperator = @$filter["z_VACTINATION_DATE"];
        $this->VACTINATION_DATE->AdvancedSearch->SearchCondition = @$filter["v_VACTINATION_DATE"];
        $this->VACTINATION_DATE->AdvancedSearch->SearchValue2 = @$filter["y_VACTINATION_DATE"];
        $this->VACTINATION_DATE->AdvancedSearch->SearchOperator2 = @$filter["w_VACTINATION_DATE"];
        $this->VACTINATION_DATE->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->VACTINATION_ID, $arKeywords, $type);
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->VACTINATION_ID); // VACTINATION_ID
            ...
            $this->updateSort($this->VACTINATION_TYPE); // VACTINATION_TYPE
            ...
            $this->updateSort($this->VACTINATION_DATE); // VACTINATION_DATE
    ...
    public function renderListOptions()
    {
        ...
        $opt->Body = "<div class=\"custom-control custom-checkbox d-inline-block\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"custom-control-input ew-multi-select\" value=\"" . HtmlEncode($this->ORG_UNIT_CODE->CurrentValue . Config("COMPOSITE_KEY_SEPARATOR") . $this->VACTINATION_ID->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\"><label class=\"custom-control-label\" for=\"key_m_" . $this->RowCount . "\"></label></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fVACTINATIONlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fVACTINATIONlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fVACTINATIONlist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function newRow()
    {
        ...
        $row['VACTINATION_ID'] = null;
        $row['NO_REGISTRATION'] = null;
        $row['VISIT_ID'] = null;
        $row['BILL_ID'] = null;
        $row['CLINIC_ID'] = null;
        $row['VACTINATION_TYPE'] = null;
        $row['LEVEL_ID'] = null;
        $row['EMPLOYEE_ID'] = null;
        $row['PATIENT_CATEGORY_ID'] = null;
        $row['VACTINATION_DATE'] = null;
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fVACTINATIONlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
