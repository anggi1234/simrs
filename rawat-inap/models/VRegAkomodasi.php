...
/**
 * Table class for V_REG_AKOMODASI
 */
class VRegAkomodasi extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'V_REG_AKOMODASI';
        $this->TableName = 'V_REG_AKOMODASI';
        ...
        // ID
        $this->ID = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_ID', 'ID', 'dbo.TREATMENT_BILL.ID', 'CAST(dbo.TREATMENT_BILL.ID AS NVARCHAR)', 3, 4, -1, false, 'dbo.TREATMENT_BILL.ID', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // BILL_ID
        $this->BILL_ID = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_BILL_ID', 'BILL_ID', 'dbo.TREATMENT_BILL.BILL_ID', 'dbo.TREATMENT_BILL.BILL_ID', 200, 50, -1, false, 'dbo.TREATMENT_BILL.BILL_ID', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NO_REGISTRATION
        $this->NO_REGISTRATION = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_NO_REGISTRATION', 'NO_REGISTRATION', 'dbo.TREATMENT_AKOMODASI.NO_REGISTRATION', 'dbo.TREATMENT_AKOMODASI.NO_REGISTRATION', 200, 25, -1, false, 'dbo.TREATMENT_AKOMODASI.NO_REGISTRATION', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // VISIT_ID
        $this->VISIT_ID = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_VISIT_ID', 'VISIT_ID', 'dbo.TREATMENT_AKOMODASI.VISIT_ID', 'dbo.TREATMENT_AKOMODASI.VISIT_ID', 200, 50, -1, false, 'dbo.TREATMENT_AKOMODASI.VISIT_ID', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TARIF_ID
        $this->TARIF_ID = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_TARIF_ID', 'TARIF_ID', 'dbo.TREATMENT_AKOMODASI.TARIF_ID', 'dbo.TREATMENT_AKOMODASI.TARIF_ID', 200, 25, -1, false, 'dbo.TREATMENT_AKOMODASI.TARIF_ID', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // CLASS_ID
        $this->CLASS_ID = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_CLASS_ID', 'CLASS_ID', 'dbo.TREATMENT_AKOMODASI.CLASS_ID', 'CAST(dbo.TREATMENT_AKOMODASI.CLASS_ID AS NVARCHAR)', 17, 1, -1, false, 'dbo.TREATMENT_AKOMODASI.CLASS_ID', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLINIC_ID
        $this->CLINIC_ID = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_CLINIC_ID', 'CLINIC_ID', 'dbo.TREATMENT_AKOMODASI.CLINIC_ID', 'dbo.TREATMENT_AKOMODASI.CLINIC_ID', 200, 15, -1, false, 'dbo.TREATMENT_AKOMODASI.CLINIC_ID', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // CLINIC_ID_FROM
        $this->CLINIC_ID_FROM = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_CLINIC_ID_FROM', 'CLINIC_ID_FROM', 'dbo.TREATMENT_AKOMODASI.CLINIC_ID_FROM', 'dbo.TREATMENT_AKOMODASI.CLINIC_ID_FROM', 200, 15, -1, false, 'dbo.TREATMENT_AKOMODASI.CLINIC_ID_FROM', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // TREATMENT
        $this->TREATMENT = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_TREATMENT', 'TREATMENT', 'dbo.TREATMENT_AKOMODASI.TREATMENT', 'dbo.TREATMENT_AKOMODASI.TREATMENT', 200, 200, -1, false, 'dbo.TREATMENT_AKOMODASI.TREATMENT', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TREAT_DATE
        $this->TREAT_DATE = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_TREAT_DATE', 'TREAT_DATE', 'dbo.TREATMENT_AKOMODASI.TREAT_DATE', CastDateFieldForLike("dbo.TREATMENT_AKOMODASI.TREAT_DATE", 0, "DB"), 135, 8, 0, false, 'dbo.TREATMENT_AKOMODASI.TREAT_DATE', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // QUANTITY
        $this->QUANTITY = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_QUANTITY', 'QUANTITY', 'dbo.TREATMENT_AKOMODASI.QUANTITY', 'CAST(dbo.TREATMENT_AKOMODASI.QUANTITY AS NVARCHAR)', 131, 8, -1, false, 'dbo.TREATMENT_AKOMODASI.QUANTITY', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // THENAME
        $this->THENAME = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_THENAME', 'THENAME', 'dbo.TREATMENT_AKOMODASI.THENAME', 'dbo.TREATMENT_AKOMODASI.THENAME', 200, 100, -1, false, 'dbo.TREATMENT_AKOMODASI.THENAME', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // THEADDRESS
        $this->THEADDRESS = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_THEADDRESS', 'THEADDRESS', 'dbo.TREATMENT_AKOMODASI.THEADDRESS', 'dbo.TREATMENT_AKOMODASI.THEADDRESS', 200, 150, -1, false, 'dbo.TREATMENT_AKOMODASI.THEADDRESS', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // THEID
        $this->THEID = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_THEID', 'THEID', 'dbo.TREATMENT_AKOMODASI.THEID', 'dbo.TREATMENT_AKOMODASI.THEID', 200, 25, -1, false, 'dbo.TREATMENT_AKOMODASI.THEID', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EXIT_DATE
        $this->EXIT_DATE = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_EXIT_DATE', 'EXIT_DATE', 'dbo.TREATMENT_AKOMODASI.EXIT_DATE', CastDateFieldForLike("dbo.TREATMENT_AKOMODASI.EXIT_DATE", 0, "DB"), 135, 8, 0, false, 'dbo.TREATMENT_AKOMODASI.EXIT_DATE', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BED_ID
        $this->BED_ID = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_BED_ID', 'BED_ID', 'dbo.TREATMENT_AKOMODASI.BED_ID', 'CAST(dbo.TREATMENT_AKOMODASI.BED_ID AS NVARCHAR)', 17, 1, -1, false, 'dbo.TREATMENT_AKOMODASI.BED_ID', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // KELUAR_ID
        $this->KELUAR_ID = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_KELUAR_ID', 'KELUAR_ID', 'dbo.TREATMENT_AKOMODASI.KELUAR_ID', 'CAST(dbo.TREATMENT_AKOMODASI.KELUAR_ID AS NVARCHAR)', 17, 1, -1, false, 'dbo.TREATMENT_AKOMODASI.KELUAR_ID', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // MEASURE_ID
        $this->MEASURE_ID = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_MEASURE_ID', 'MEASURE_ID', 'dbo.TREATMENT_AKOMODASI.MEASURE_ID', 'CAST(dbo.TREATMENT_AKOMODASI.MEASURE_ID AS NVARCHAR)', 2, 2, -1, false, 'dbo.TREATMENT_AKOMODASI.MEASURE_ID', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DESCRIPTION
        $this->DESCRIPTION = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_DESCRIPTION', 'DESCRIPTION', 'dbo.TREATMENT_AKOMODASI.DESCRIPTION', 'dbo.TREATMENT_AKOMODASI.DESCRIPTION', 200, 200, -1, false, 'dbo.TREATMENT_AKOMODASI.DESCRIPTION', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DESCRIPTION->Sortable = true; // Allow sort
        $this->DESCRIPTION->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DESCRIPTION->Param, "CustomMsg");
        $this->Fields['DESCRIPTION'] = &$this->DESCRIPTION;

        // CLASS_ROOM_ID
        $this->CLASS_ROOM_ID = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_CLASS_ROOM_ID', 'CLASS_ROOM_ID', 'dbo.TREATMENT_AKOMODASI.CLASS_ROOM_ID', 'dbo.TREATMENT_AKOMODASI.CLASS_ROOM_ID', 200, 16, -1, false, 'dbo.TREATMENT_AKOMODASI.CLASS_ROOM_ID', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // EMPLOYEE_ID
        $this->EMPLOYEE_ID = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_EMPLOYEE_ID', 'EMPLOYEE_ID', 'dbo.TREATMENT_AKOMODASI.EMPLOYEE_ID', 'dbo.TREATMENT_AKOMODASI.EMPLOYEE_ID', 200, 15, -1, false, 'dbo.TREATMENT_AKOMODASI.EMPLOYEE_ID', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // DOCTOR
        $this->DOCTOR = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_DOCTOR', 'DOCTOR', 'dbo.TREATMENT_AKOMODASI.DOCTOR', 'dbo.TREATMENT_AKOMODASI.DOCTOR', 200, 100, -1, false, 'dbo.TREATMENT_AKOMODASI.DOCTOR', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EMPLOYEE_ID_FROM
        $this->EMPLOYEE_ID_FROM = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_EMPLOYEE_ID_FROM', 'EMPLOYEE_ID_FROM', 'dbo.TREATMENT_AKOMODASI.EMPLOYEE_ID_FROM', 'dbo.TREATMENT_AKOMODASI.EMPLOYEE_ID_FROM', 200, 50, -1, false, 'dbo.TREATMENT_AKOMODASI.EMPLOYEE_ID_FROM', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DOCTOR_FROM
        $this->DOCTOR_FROM = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_DOCTOR_FROM', 'DOCTOR_FROM', 'dbo.TREATMENT_AKOMODASI.DOCTOR_FROM', 'dbo.TREATMENT_AKOMODASI.DOCTOR_FROM', 200, 50, -1, false, 'dbo.TREATMENT_AKOMODASI.DOCTOR_FROM', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STATUS_PASIEN_ID
        $this->STATUS_PASIEN_ID = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_STATUS_PASIEN_ID', 'STATUS_PASIEN_ID', 'dbo.TREATMENT_AKOMODASI.STATUS_PASIEN_ID', 'CAST(dbo.TREATMENT_AKOMODASI.STATUS_PASIEN_ID AS NVARCHAR)', 17, 1, -1, false, 'dbo.TREATMENT_AKOMODASI.STATUS_PASIEN_ID', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISRJ
        $this->ISRJ = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_ISRJ', 'ISRJ', 'dbo.TREATMENT_AKOMODASI.ISRJ', 'dbo.TREATMENT_AKOMODASI.ISRJ', 129, 1, -1, false, 'dbo.TREATMENT_AKOMODASI.ISRJ', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AGEYEAR
        $this->AGEYEAR = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_AGEYEAR', 'AGEYEAR', 'dbo.TREATMENT_AKOMODASI.AGEYEAR', 'CAST(dbo.TREATMENT_AKOMODASI.AGEYEAR AS NVARCHAR)', 17, 1, -1, false, 'dbo.TREATMENT_AKOMODASI.AGEYEAR', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AGEMONTH
        $this->AGEMONTH = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_AGEMONTH', 'AGEMONTH', 'dbo.TREATMENT_AKOMODASI.AGEMONTH', 'CAST(dbo.TREATMENT_AKOMODASI.AGEMONTH AS NVARCHAR)', 17, 1, -1, false, 'dbo.TREATMENT_AKOMODASI.AGEMONTH', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AGEDAY
        $this->AGEDAY = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_AGEDAY', 'AGEDAY', 'dbo.TREATMENT_AKOMODASI.AGEDAY', 'CAST(dbo.TREATMENT_AKOMODASI.AGEDAY AS NVARCHAR)', 17, 1, -1, false, 'dbo.TREATMENT_AKOMODASI.AGEDAY', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GENDER
        $this->GENDER = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_GENDER', 'GENDER', 'dbo.TREATMENT_AKOMODASI.GENDER', 'dbo.TREATMENT_AKOMODASI.GENDER', 129, 1, -1, false, 'dbo.TREATMENT_AKOMODASI.GENDER', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->GENDER->Sortable = true; // Allow sort
        $this->GENDER->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->GENDER->Param, "CustomMsg");
        $this->Fields['GENDER'] = &$this->GENDER;

        // KARYAWAN
        $this->KARYAWAN = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_KARYAWAN', 'KARYAWAN', 'dbo.TREATMENT_AKOMODASI.KARYAWAN', 'dbo.TREATMENT_AKOMODASI.KARYAWAN', 200, 50, -1, false, 'dbo.TREATMENT_AKOMODASI.KARYAWAN', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_MODIFIED_BY', 'MODIFIED_BY', 'dbo.TREATMENT_AKOMODASI.MODIFIED_BY', 'dbo.TREATMENT_AKOMODASI.MODIFIED_BY', 200, 200, -1, false, 'dbo.TREATMENT_AKOMODASI.MODIFIED_BY', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MODIFIED_BY->Sortable = true; // Allow sort
        $this->MODIFIED_BY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MODIFIED_BY->Param, "CustomMsg");
        $this->Fields['MODIFIED_BY'] = &$this->MODIFIED_BY;

        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_MODIFIED_DATE', 'MODIFIED_DATE', 'dbo.TREATMENT_AKOMODASI.MODIFIED_DATE', CastDateFieldForLike("dbo.TREATMENT_AKOMODASI.MODIFIED_DATE", 0, "DB"), 135, 8, 0, false, 'dbo.TREATMENT_AKOMODASI.MODIFIED_DATE', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_FROM
        $this->MODIFIED_FROM = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_MODIFIED_FROM', 'MODIFIED_FROM', 'dbo.TREATMENT_AKOMODASI.MODIFIED_FROM', 'dbo.TREATMENT_AKOMODASI.MODIFIED_FROM', 200, 50, -1, false, 'dbo.TREATMENT_AKOMODASI.MODIFIED_FROM', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TRANS_ID
        $this->TRANS_ID = new DbField('V_REG_AKOMODASI', 'V_REG_AKOMODASI', 'x_TRANS_ID', 'TRANS_ID', 'dbo.TREATMENT_AKOMODASI.TRANS_ID', 'dbo.TREATMENT_AKOMODASI.TRANS_ID', 200, 50, -1, false, 'dbo.TREATMENT_AKOMODASI.TRANS_ID', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getDetailFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "PASIEN_VISITATION") {
            if ($this->NO_REGISTRATION->getSessionValue() != "") {
                $detailFilter .= "" . GetForeignKeySql("dbo.TREATMENT_AKOMODASI.NO_REGISTRATION", $this->NO_REGISTRATION->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
            if ($this->VISIT_ID->getSessionValue() != "") {
    ...
    {
        return "[NO_REGISTRATION]='@NO_REGISTRATION@' AND [VISIT_ID]='@VISIT_ID@' AND [DIANTAR_OLEH]='@DIANTAR_OLEH@' AND [TRANS_ID]='@TRANS_ID@'";
    }
    // Detail filter
    public function sqlDetailFilter_PASIEN_VISITATION()
    {
        return "dbo.TREATMENT_AKOMODASI.NO_REGISTRATION='@NO_REGISTRATION@' AND dbo.TREATMENT_AKOMODASI.VISIT_ID='@VISIT_ID@' AND dbo.TREATMENT_AKOMODASI.THENAME='@THENAME@' AND dbo.TREATMENT_AKOMODASI.TRANS_ID='@TRANS_ID@'";
    }
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("dbo.TREATMENT_BILL.ID, dbo.TREATMENT_BILL.BILL_ID, dbo.TREATMENT_AKOMODASI.NO_REGISTRATION, dbo.TREATMENT_AKOMODASI.VISIT_ID, dbo.TREATMENT_AKOMODASI.TARIF_ID, dbo.TREATMENT_AKOMODASI.CLASS_ID, dbo.TREATMENT_AKOMODASI.CLINIC_ID, dbo.TREATMENT_AKOMODASI.CLINIC_ID_FROM, dbo.TREATMENT_AKOMODASI.TREATMENT, dbo.TREATMENT_AKOMODASI.TREAT_DATE, dbo.TREATMENT_AKOMODASI.QUANTITY, dbo.TREATMENT_AKOMODASI.MEASURE_ID, dbo.TREATMENT_AKOMODASI.DESCRIPTION, dbo.TREATMENT_AKOMODASI.CLASS_ROOM_ID, dbo.TREATMENT_AKOMODASI.KELUAR_ID, dbo.TREATMENT_AKOMODASI.BED_ID, dbo.TREATMENT_AKOMODASI.EMPLOYEE_ID, dbo.TREATMENT_AKOMODASI.DOCTOR, dbo.TREATMENT_AKOMODASI.EXIT_DATE, dbo.TREATMENT_AKOMODASI.EMPLOYEE_ID_FROM, dbo.TREATMENT_AKOMODASI.DOCTOR_FROM, dbo.TREATMENT_AKOMODASI.STATUS_PASIEN_ID, dbo.TREATMENT_AKOMODASI.THENAME, dbo.TREATMENT_AKOMODASI.THEADDRESS, dbo.TREATMENT_AKOMODASI.THEID, dbo.TREATMENT_AKOMODASI.ISRJ, dbo.TREATMENT_AKOMODASI.AGEYEAR, dbo.TREATMENT_AKOMODASI.AGEMONTH, dbo.TREATMENT_AKOMODASI.AGEDAY, dbo.TREATMENT_AKOMODASI.GENDER, dbo.TREATMENT_AKOMODASI.KARYAWAN, dbo.TREATMENT_AKOMODASI.MODIFIED_BY, dbo.TREATMENT_AKOMODASI.MODIFIED_DATE, dbo.TREATMENT_AKOMODASI.MODIFIED_FROM, dbo.TREATMENT_AKOMODASI.TRANS_ID");
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VRegAkomodasiList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "VRegAkomodasiEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VRegAkomodasiAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "VRegAkomodasiView";
            case Config("API_ADD_ACTION"):
                return "VRegAkomodasiAdd";
            case Config("API_EDIT_ACTION"):
                return "VRegAkomodasiEdit";
            case Config("API_DELETE_ACTION"):
                return "VRegAkomodasiDelete";
            case Config("API_LIST_ACTION"):
                return "VRegAkomodasiList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VRegAkomodasiView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VRegAkomodasiView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VRegAkomodasiAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VRegAkomodasiAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VRegAkomodasiEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VRegAkomodasiAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VRegAkomodasiDelete", $this->getUrlParm());
    }
