 ...
 * Page class
 */
class UsersMenuEdit extends UsersMenu
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UsersMenuEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // C_TIME
            $this->C_TIME->setDbValueDef($rsnew, $this->C_TIME->CurrentValue, null, $this->C_TIME->ReadOnly);

            // U_TIME
            $this->U_TIME->setDbValueDef($rsnew, $this->U_TIME->CurrentValue, null, $this->U_TIME->ReadOnly);

            // D_TIME
            $this->D_TIME->setDbValueDef($rsnew, $this->D_TIME->CurrentValue, null, $this->D_TIME->ReadOnly);
