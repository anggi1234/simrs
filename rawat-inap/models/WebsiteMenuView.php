 ...
 * Page class
 */
class WebsiteMenuView extends WebsiteMenu
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WebsiteMenuView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("MENU_ID") ?? Route("MENU_ID")) !== null) {
                ...
                $returnUrl = "WebsiteMenuList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "WebsiteMenuList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "WebsiteMenuList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
