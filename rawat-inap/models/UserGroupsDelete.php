 ...
 * Page class
 */
class UserGroupsDelete extends UserGroups
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UserGroupsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("UserGroupsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("UserGroupsList"); // Return to list
                return;
            }
        }
