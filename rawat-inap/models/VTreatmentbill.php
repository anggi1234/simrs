...
class VTreatmentbill extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // NO_REGISTRATION
        $this->NO_REGISTRATION = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_NO_REGISTRATION', 'NO_REGISTRATION', '[NO_REGISTRATION]', '[NO_REGISTRATION]', 200, 25, -1, false, '[NO_REGISTRATION]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
