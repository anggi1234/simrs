 ...
 * Page class
 */
class TreatmentBookingDelete extends TreatmentBooking
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TreatmentBookingDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TreatmentBookingList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("TreatmentBookingList"); // Return to list
                return;
            }
        }
