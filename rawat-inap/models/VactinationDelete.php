 ...
 * Page class
 */
class VactinationDelete extends Vactination
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VactinationDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("VactinationList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("VactinationList"); // Return to list
                return;
            }
        }
