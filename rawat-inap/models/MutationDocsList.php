...
class MutationDocsList extends MutationDocs
{
    ...
    public function renderListOptions()
    {
        ...
        if ($Security->allowList(CurrentProjectID() . 'GOOD_GF')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("GoodGfList?" . Config("TABLE_SHOW_MASTER") . "=MUTATION_DOCS&" . GetForeignKeyUrl("fk_DOC_NO", $this->DOC_NO->CurrentValue) . "&" . GetForeignKeyUrl("fk_CLINIC_ID_TO", $this->CLINIC_ID_TO->CurrentValue) . "&" . GetForeignKeyUrl("fk_CLINIC_ID", $this->CLINIC_ID->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
