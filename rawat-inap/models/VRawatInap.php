...
class VRawatInap extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // EXIT_DATE
        $this->EXIT_DATE = new DbField('V_RAWAT_INAP', 'V_RAWAT_INAP', 'x_EXIT_DATE', 'EXIT_DATE', '[EXIT_DATE]', CastDateFieldForLike("[EXIT_DATE]", 11, "DB"), 135, 8, 11, false, '[EXIT_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modified_datesys
        $this->modified_datesys = new DbField('V_RAWAT_INAP', 'V_RAWAT_INAP', 'x_modified_datesys', 'modified_datesys', '[modified_datesys]', CastDateFieldForLike("[modified_datesys]", 11, "DB"), 135, 8, 11, false, '[modified_datesys]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getDetailUrl()
    {
        ...
        if ($this->getCurrentDetailTable() == "PASIEN_DIAGNOSA") {
            ...
            $detailUrl .= "&" . GetForeignKeyUrl("fk_NO_REGISTRATION", $this->NO_REGISTRATION->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_THEADDRESS", $this->THEADDRESS->CurrentValue);
        }
        if ($this->getCurrentDetailTable() == "OBSTETRI") {
            $detailUrl = Container("OBSTETRI")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_VISIT_ID", $this->VISIT_ID->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_NO_REGISTRATION", $this->NO_REGISTRATION->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_THENAME", $this->THENAME->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_THEADDRESS", $this->THEADDRESS->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_GENDER", $this->GENDER->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_ORG_UNIT_CODE", $this->ORG_UNIT_CODE->CurrentValue);
        }
        if ($detailUrl == "") {
