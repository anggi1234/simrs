 ...
 * Page class
 */
class TreatmentBilltrans1Delete extends TreatmentBilltrans1
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TreatmentBilltrans1Delete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TreatmentBilltrans1List"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("TreatmentBilltrans1List"); // Return to list
                return;
            }
        }
