 ...
 * Page class
 */
class VAkomodasiKamarView extends VAkomodasiKamar
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VAkomodasiKamarView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("ID") ?? Route("ID")) !== null) {
                ...
                $returnUrl = "VAkomodasiKamarList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "VAkomodasiKamarList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "VAkomodasiKamarList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
