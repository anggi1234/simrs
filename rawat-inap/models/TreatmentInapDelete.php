 ...
 * Page class
 */
class TreatmentInapDelete extends TreatmentInap
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TreatmentInapDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TreatmentInapList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("TreatmentInapList"); // Return to list
                return;
            }
        }
