...
class VRawatInapEdit extends VRawatInap
{
    ...
    public function run()
    {
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                ...
                break;
            case "update": // Update
                $returnUrl = 'VRawatInapView/'.urlencode(CurrentPage()->ID->CurrentValue).'?showdetail=TREATMENT_BILL,PASIEN_DIAGNOSA,OBSTETRI';
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->EXIT_DATE->EditValue = HtmlEncode(FormatDateTime($this->EXIT_DATE->CurrentValue, 11));
    ...
    protected function validateForm()
    {
        ...
        if (!CheckEuroDate($this->EXIT_DATE->FormValue)) {
        ...
        if (in_array("OBSTETRI", $detailTblVar) && $detailPage->DetailEdit) {
            $detailPage->validateGridForm();
        }
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // EXIT_DATE
            $this->EXIT_DATE->setDbValueDef($rsnew, UnFormatDateTime($this->EXIT_DATE->CurrentValue, 11), null, $this->EXIT_DATE->ReadOnly);
