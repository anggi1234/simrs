...
class MutationDocs extends DbTable
{
    ...
    public function __construct()
    {
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->CLINIC_ID->Lookup = new Lookup('CLINIC_ID', 'CLINIC', false, 'CLINIC_ID', ["NAME_OF_CLINIC","","",""], [], [], [], [], ["CLINIC_ID"], ["x_MUTATION_BY"], '', '');
                break;
            default:
                $this->CLINIC_ID->Lookup = new Lookup('CLINIC_ID', 'CLINIC', false, 'CLINIC_ID', ["NAME_OF_CLINIC","","",""], [], [], [], [], ["CLINIC_ID"], ["x_MUTATION_BY"], '', '');
                break;
        ...
        $this->MUTATION_DATE->Sortable = false; // Allow sort
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('MUTATION_DOCS', 'MUTATION_DOCS', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 11, "DB"), 135, 8, 11, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
