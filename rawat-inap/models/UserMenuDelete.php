 ...
 * Page class
 */
class UserMenuDelete extends UserMenu
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UserMenuDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("UserMenuList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("UserMenuList"); // Return to list
                return;
            }
        }
