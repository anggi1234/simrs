 ...
 * Page class
 */
class TreatmentNonobatView extends TreatmentNonobat
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TreatmentNonobatView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("ORG_UNIT_CODE") ?? Route("ORG_UNIT_CODE")) !== null) {
                ...
                $returnUrl = "TreatmentNonobatList"; // Return to list
            }
            if (($keyValue = Get("BILL_ID") ?? Route("BILL_ID")) !== null) {
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "TreatmentNonobatList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "TreatmentNonobatList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
