 ...
 * Page class
 */
class TreatmentBilltrans1View extends TreatmentBilltrans1
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TreatmentBilltrans1View";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("ORG_UNIT_CODE") ?? Route("ORG_UNIT_CODE")) !== null) {
                ...
                $returnUrl = "TreatmentBilltrans1List"; // Return to list
            }
            if (($keyValue = Get("BILL_ID") ?? Route("BILL_ID")) !== null) {
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "TreatmentBilltrans1List"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "TreatmentBilltrans1List"; // Not page request, return to list
        }
        if ($returnUrl != "") {
