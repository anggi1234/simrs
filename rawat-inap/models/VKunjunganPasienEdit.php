...
class VKunjunganPasienEdit extends VKunjunganPasien
{
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->SERVED_INAP->EditValue = HtmlEncode(FormatDateTime($this->SERVED_INAP->CurrentValue, 11));
    ...
    protected function validateForm()
    {
        ...
        if (!CheckEuroDate($this->SERVED_INAP->FormValue)) {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // SERVED_INAP
            $this->SERVED_INAP->setDbValueDef($rsnew, UnFormatDateTime($this->SERVED_INAP->CurrentValue, 11), null, $this->SERVED_INAP->ReadOnly);
