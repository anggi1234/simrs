...
class PasienDiagnosa extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('PASIEN_DIAGNOSA', 'PASIEN_DIAGNOSA', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // VISIT_ID
        $this->VISIT_ID = new DbField('PASIEN_DIAGNOSA', 'PASIEN_DIAGNOSA', 'x_VISIT_ID', 'VISIT_ID', '[VISIT_ID]', '[VISIT_ID]', 200, 50, -1, false, '[VISIT_ID]', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
    ...
    {
        return "[VISIT_ID]='@VISIT_ID@' AND [THENAME]='@THENAME@' AND [NO_REGISTRATION]='@NO_REGISTRATION@' AND [THEADDRESS]='@THEADDRESS@'";
    }
    // Detail filter
