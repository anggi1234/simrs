...
// Page object
$TreatmentBilltrans1Edit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fTREATMENT_BILLTRANS1edit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fTREATMENT_BILLTRANS1edit = currentForm = new ew.Form("fTREATMENT_BILLTRANS1edit", "edit");

    // Add fields
    var currentTable = <?= JsonEncode(GetClientVar("tables", "TREATMENT_BILLTRANS1")) ?>,
        fields = currentTable.fields;
    if (!ew.vars.tables.TREATMENT_BILLTRANS1)
        ew.vars.tables.TREATMENT_BILLTRANS1 = currentTable;
    fTREATMENT_BILLTRANS1edit.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fTREATMENT_BILLTRANS1edit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fTREATMENT_BILLTRANS1edit.validate = function () {
    ...
    // Form_CustomValidate
    fTREATMENT_BILLTRANS1edit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fTREATMENT_BILLTRANS1edit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fTREATMENT_BILLTRANS1edit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fTREATMENT_BILLTRANS1edit" id="fTREATMENT_BILLTRANS1edit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->ORG_UNIT_CODE->Visible) { // ORG_UNIT_CODE ?>
    <div id="r_ORG_UNIT_CODE" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_ORG_UNIT_CODE" for="x_ORG_UNIT_CODE" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ORG_UNIT_CODE->caption() ?><?= $Page->ORG_UNIT_CODE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ORG_UNIT_CODE->cellAttributes() ?>>
<input type="<?= $Page->ORG_UNIT_CODE->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_ORG_UNIT_CODE" name="x_ORG_UNIT_CODE" id="x_ORG_UNIT_CODE" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->ORG_UNIT_CODE->getPlaceHolder()) ?>" value="<?= $Page->ORG_UNIT_CODE->EditValue ?>"<?= $Page->ORG_UNIT_CODE->editAttributes() ?> aria-describedby="x_ORG_UNIT_CODE_help">
<?= $Page->ORG_UNIT_CODE->getCustomMessage() ?>
<div class="invalid-feedback"><?= $Page->ORG_UNIT_CODE->getErrorMessage() ?></div>
<input type="hidden" data-table="TREATMENT_BILLTRANS1" data-field="x_ORG_UNIT_CODE" data-hidden="1" name="o_ORG_UNIT_CODE" id="o_ORG_UNIT_CODE" value="<?= HtmlEncode($Page->ORG_UNIT_CODE->OldValue ?? $Page->ORG_UNIT_CODE->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->BILL_ID->Visible) { // BILL_ID ?>
    <div id="r_BILL_ID" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_BILL_ID" for="x_BILL_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->BILL_ID->caption() ?><?= $Page->BILL_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->BILL_ID->cellAttributes() ?>>
<input type="<?= $Page->BILL_ID->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_BILL_ID" name="x_BILL_ID" id="x_BILL_ID" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->BILL_ID->getPlaceHolder()) ?>" value="<?= $Page->BILL_ID->EditValue ?>"<?= $Page->BILL_ID->editAttributes() ?> aria-describedby="x_BILL_ID_help">
<?= $Page->BILL_ID->getCustomMessage() ?>
<div class="invalid-feedback"><?= $Page->BILL_ID->getErrorMessage() ?></div>
<input type="hidden" data-table="TREATMENT_BILLTRANS1" data-field="x_BILL_ID" data-hidden="1" name="o_BILL_ID" id="o_BILL_ID" value="<?= HtmlEncode($Page->BILL_ID->OldValue ?? $Page->BILL_ID->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->NO_REGISTRATION->Visible) { // NO_REGISTRATION ?>
    <div id="r_NO_REGISTRATION" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_NO_REGISTRATION" for="x_NO_REGISTRATION" class="<?= $Page->LeftColumnClass ?>"><?= $Page->NO_REGISTRATION->caption() ?><?= $Page->NO_REGISTRATION->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->NO_REGISTRATION->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_NO_REGISTRATION">
<input type="<?= $Page->NO_REGISTRATION->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_NO_REGISTRATION" name="x_NO_REGISTRATION" id="x_NO_REGISTRATION" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->NO_REGISTRATION->getPlaceHolder()) ?>" value="<?= $Page->NO_REGISTRATION->EditValue ?>"<?= $Page->NO_REGISTRATION->editAttributes() ?> aria-describedby="x_NO_REGISTRATION_help">
...
<?php if ($Page->VISIT_ID->Visible) { // VISIT_ID ?>
    <div id="r_VISIT_ID" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_VISIT_ID" for="x_VISIT_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->VISIT_ID->caption() ?><?= $Page->VISIT_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->VISIT_ID->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_VISIT_ID">
<input type="<?= $Page->VISIT_ID->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_VISIT_ID" name="x_VISIT_ID" id="x_VISIT_ID" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->VISIT_ID->getPlaceHolder()) ?>" value="<?= $Page->VISIT_ID->EditValue ?>"<?= $Page->VISIT_ID->editAttributes() ?> aria-describedby="x_VISIT_ID_help">
...
<?php if ($Page->TARIF_ID->Visible) { // TARIF_ID ?>
    <div id="r_TARIF_ID" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_TARIF_ID" for="x_TARIF_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->TARIF_ID->caption() ?><?= $Page->TARIF_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->TARIF_ID->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_TARIF_ID">
<input type="<?= $Page->TARIF_ID->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_TARIF_ID" name="x_TARIF_ID" id="x_TARIF_ID" size="30" maxlength="25" placeholder="<?= HtmlEncode($Page->TARIF_ID->getPlaceHolder()) ?>" value="<?= $Page->TARIF_ID->EditValue ?>"<?= $Page->TARIF_ID->editAttributes() ?> aria-describedby="x_TARIF_ID_help">
...
<?php if ($Page->CLASS_ID->Visible) { // CLASS_ID ?>
    <div id="r_CLASS_ID" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_CLASS_ID" for="x_CLASS_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CLASS_ID->caption() ?><?= $Page->CLASS_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CLASS_ID->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_CLASS_ID">
<input type="<?= $Page->CLASS_ID->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_CLASS_ID" name="x_CLASS_ID" id="x_CLASS_ID" size="30" placeholder="<?= HtmlEncode($Page->CLASS_ID->getPlaceHolder()) ?>" value="<?= $Page->CLASS_ID->EditValue ?>"<?= $Page->CLASS_ID->editAttributes() ?> aria-describedby="x_CLASS_ID_help">
...
<?php if ($Page->CLINIC_ID->Visible) { // CLINIC_ID ?>
    <div id="r_CLINIC_ID" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_CLINIC_ID" for="x_CLINIC_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CLINIC_ID->caption() ?><?= $Page->CLINIC_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CLINIC_ID->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_CLINIC_ID">
<input type="<?= $Page->CLINIC_ID->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_CLINIC_ID" name="x_CLINIC_ID" id="x_CLINIC_ID" size="30" maxlength="15" placeholder="<?= HtmlEncode($Page->CLINIC_ID->getPlaceHolder()) ?>" value="<?= $Page->CLINIC_ID->EditValue ?>"<?= $Page->CLINIC_ID->editAttributes() ?> aria-describedby="x_CLINIC_ID_help">
...
<?php if ($Page->TREATMENT->Visible) { // TREATMENT ?>
    <div id="r_TREATMENT" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_TREATMENT" for="x_TREATMENT" class="<?= $Page->LeftColumnClass ?>"><?= $Page->TREATMENT->caption() ?><?= $Page->TREATMENT->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->TREATMENT->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_TREATMENT">
<input type="<?= $Page->TREATMENT->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_TREATMENT" name="x_TREATMENT" id="x_TREATMENT" size="30" maxlength="200" placeholder="<?= HtmlEncode($Page->TREATMENT->getPlaceHolder()) ?>" value="<?= $Page->TREATMENT->EditValue ?>"<?= $Page->TREATMENT->editAttributes() ?> aria-describedby="x_TREATMENT_help">
...
<?php if ($Page->TREAT_DATE->Visible) { // TREAT_DATE ?>
    <div id="r_TREAT_DATE" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_TREAT_DATE" for="x_TREAT_DATE" class="<?= $Page->LeftColumnClass ?>"><?= $Page->TREAT_DATE->caption() ?><?= $Page->TREAT_DATE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->TREAT_DATE->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_TREAT_DATE">
<input type="<?= $Page->TREAT_DATE->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_TREAT_DATE" name="x_TREAT_DATE" id="x_TREAT_DATE" placeholder="<?= HtmlEncode($Page->TREAT_DATE->getPlaceHolder()) ?>" value="<?= $Page->TREAT_DATE->EditValue ?>"<?= $Page->TREAT_DATE->editAttributes() ?> aria-describedby="x_TREAT_DATE_help">
...
<script>
loadjs.ready(["fTREATMENT_BILLTRANS1edit", "datetimepicker"], function() {
    ew.createDateTimePicker("fTREATMENT_BILLTRANS1edit", "x_TREAT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->AMOUNT->Visible) { // AMOUNT ?>
    <div id="r_AMOUNT" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_AMOUNT" for="x_AMOUNT" class="<?= $Page->LeftColumnClass ?>"><?= $Page->AMOUNT->caption() ?><?= $Page->AMOUNT->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->AMOUNT->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_AMOUNT">
<input type="<?= $Page->AMOUNT->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_AMOUNT" name="x_AMOUNT" id="x_AMOUNT" size="30" placeholder="<?= HtmlEncode($Page->AMOUNT->getPlaceHolder()) ?>" value="<?= $Page->AMOUNT->EditValue ?>"<?= $Page->AMOUNT->editAttributes() ?> aria-describedby="x_AMOUNT_help">
...
<?php if ($Page->QUANTITY->Visible) { // QUANTITY ?>
    <div id="r_QUANTITY" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_QUANTITY" for="x_QUANTITY" class="<?= $Page->LeftColumnClass ?>"><?= $Page->QUANTITY->caption() ?><?= $Page->QUANTITY->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->QUANTITY->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_QUANTITY">
<input type="<?= $Page->QUANTITY->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_QUANTITY" name="x_QUANTITY" id="x_QUANTITY" size="30" placeholder="<?= HtmlEncode($Page->QUANTITY->getPlaceHolder()) ?>" value="<?= $Page->QUANTITY->EditValue ?>"<?= $Page->QUANTITY->editAttributes() ?> aria-describedby="x_QUANTITY_help">
...
<?php if ($Page->MEASURE_ID->Visible) { // MEASURE_ID ?>
    <div id="r_MEASURE_ID" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_MEASURE_ID" for="x_MEASURE_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->MEASURE_ID->caption() ?><?= $Page->MEASURE_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->MEASURE_ID->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_MEASURE_ID">
<input type="<?= $Page->MEASURE_ID->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_MEASURE_ID" name="x_MEASURE_ID" id="x_MEASURE_ID" size="30" placeholder="<?= HtmlEncode($Page->MEASURE_ID->getPlaceHolder()) ?>" value="<?= $Page->MEASURE_ID->EditValue ?>"<?= $Page->MEASURE_ID->editAttributes() ?> aria-describedby="x_MEASURE_ID_help">
...
<?php if ($Page->POKOK_JUAL->Visible) { // POKOK_JUAL ?>
    <div id="r_POKOK_JUAL" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_POKOK_JUAL" for="x_POKOK_JUAL" class="<?= $Page->LeftColumnClass ?>"><?= $Page->POKOK_JUAL->caption() ?><?= $Page->POKOK_JUAL->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->POKOK_JUAL->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_POKOK_JUAL">
<input type="<?= $Page->POKOK_JUAL->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_POKOK_JUAL" name="x_POKOK_JUAL" id="x_POKOK_JUAL" size="30" placeholder="<?= HtmlEncode($Page->POKOK_JUAL->getPlaceHolder()) ?>" value="<?= $Page->POKOK_JUAL->EditValue ?>"<?= $Page->POKOK_JUAL->editAttributes() ?> aria-describedby="x_POKOK_JUAL_help">
...
<?php if ($Page->PPN->Visible) { // PPN ?>
    <div id="r_PPN" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_PPN" for="x_PPN" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PPN->caption() ?><?= $Page->PPN->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PPN->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_PPN">
<input type="<?= $Page->PPN->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_PPN" name="x_PPN" id="x_PPN" size="30" placeholder="<?= HtmlEncode($Page->PPN->getPlaceHolder()) ?>" value="<?= $Page->PPN->EditValue ?>"<?= $Page->PPN->editAttributes() ?> aria-describedby="x_PPN_help">
...
<?php if ($Page->MARGIN->Visible) { // MARGIN ?>
    <div id="r_MARGIN" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_MARGIN" for="x_MARGIN" class="<?= $Page->LeftColumnClass ?>"><?= $Page->MARGIN->caption() ?><?= $Page->MARGIN->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->MARGIN->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_MARGIN">
<input type="<?= $Page->MARGIN->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_MARGIN" name="x_MARGIN" id="x_MARGIN" size="30" placeholder="<?= HtmlEncode($Page->MARGIN->getPlaceHolder()) ?>" value="<?= $Page->MARGIN->EditValue ?>"<?= $Page->MARGIN->editAttributes() ?> aria-describedby="x_MARGIN_help">
...
<?php if ($Page->SUBSIDI->Visible) { // SUBSIDI ?>
    <div id="r_SUBSIDI" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_SUBSIDI" for="x_SUBSIDI" class="<?= $Page->LeftColumnClass ?>"><?= $Page->SUBSIDI->caption() ?><?= $Page->SUBSIDI->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->SUBSIDI->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_SUBSIDI">
<input type="<?= $Page->SUBSIDI->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_SUBSIDI" name="x_SUBSIDI" id="x_SUBSIDI" size="30" placeholder="<?= HtmlEncode($Page->SUBSIDI->getPlaceHolder()) ?>" value="<?= $Page->SUBSIDI->EditValue ?>"<?= $Page->SUBSIDI->editAttributes() ?> aria-describedby="x_SUBSIDI_help">
...
<?php if ($Page->EMBALACE->Visible) { // EMBALACE ?>
    <div id="r_EMBALACE" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_EMBALACE" for="x_EMBALACE" class="<?= $Page->LeftColumnClass ?>"><?= $Page->EMBALACE->caption() ?><?= $Page->EMBALACE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->EMBALACE->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_EMBALACE">
<input type="<?= $Page->EMBALACE->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_EMBALACE" name="x_EMBALACE" id="x_EMBALACE" size="30" placeholder="<?= HtmlEncode($Page->EMBALACE->getPlaceHolder()) ?>" value="<?= $Page->EMBALACE->EditValue ?>"<?= $Page->EMBALACE->editAttributes() ?> aria-describedby="x_EMBALACE_help">
...
<?php if ($Page->PROFESI->Visible) { // PROFESI ?>
    <div id="r_PROFESI" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_PROFESI" for="x_PROFESI" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PROFESI->caption() ?><?= $Page->PROFESI->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PROFESI->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_PROFESI">
<input type="<?= $Page->PROFESI->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_PROFESI" name="x_PROFESI" id="x_PROFESI" size="30" placeholder="<?= HtmlEncode($Page->PROFESI->getPlaceHolder()) ?>" value="<?= $Page->PROFESI->EditValue ?>"<?= $Page->PROFESI->editAttributes() ?> aria-describedby="x_PROFESI_help">
...
<?php if ($Page->DISCOUNT->Visible) { // DISCOUNT ?>
    <div id="r_DISCOUNT" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_DISCOUNT" for="x_DISCOUNT" class="<?= $Page->LeftColumnClass ?>"><?= $Page->DISCOUNT->caption() ?><?= $Page->DISCOUNT->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->DISCOUNT->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_DISCOUNT">
<input type="<?= $Page->DISCOUNT->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_DISCOUNT" name="x_DISCOUNT" id="x_DISCOUNT" size="30" placeholder="<?= HtmlEncode($Page->DISCOUNT->getPlaceHolder()) ?>" value="<?= $Page->DISCOUNT->EditValue ?>"<?= $Page->DISCOUNT->editAttributes() ?> aria-describedby="x_DISCOUNT_help">
...
<?php if ($Page->PAYMENT_DATE->Visible) { // PAYMENT_DATE ?>
    <div id="r_PAYMENT_DATE" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_PAYMENT_DATE" for="x_PAYMENT_DATE" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PAYMENT_DATE->caption() ?><?= $Page->PAYMENT_DATE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PAYMENT_DATE->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_PAYMENT_DATE">
<input type="<?= $Page->PAYMENT_DATE->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_PAYMENT_DATE" name="x_PAYMENT_DATE" id="x_PAYMENT_DATE" placeholder="<?= HtmlEncode($Page->PAYMENT_DATE->getPlaceHolder()) ?>" value="<?= $Page->PAYMENT_DATE->EditValue ?>"<?= $Page->PAYMENT_DATE->editAttributes() ?> aria-describedby="x_PAYMENT_DATE_help">
...
<script>
loadjs.ready(["fTREATMENT_BILLTRANS1edit", "datetimepicker"], function() {
    ew.createDateTimePicker("fTREATMENT_BILLTRANS1edit", "x_PAYMENT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->ISLUNAS->Visible) { // ISLUNAS ?>
    <div id="r_ISLUNAS" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_ISLUNAS" for="x_ISLUNAS" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ISLUNAS->caption() ?><?= $Page->ISLUNAS->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ISLUNAS->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_ISLUNAS">
<input type="<?= $Page->ISLUNAS->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_ISLUNAS" name="x_ISLUNAS" id="x_ISLUNAS" size="30" maxlength="1" placeholder="<?= HtmlEncode($Page->ISLUNAS->getPlaceHolder()) ?>" value="<?= $Page->ISLUNAS->EditValue ?>"<?= $Page->ISLUNAS->editAttributes() ?> aria-describedby="x_ISLUNAS_help">
...
<script>
loadjs.ready(["fTREATMENT_BILLTRANS1edit", "datetimepicker"], function() {
    ew.createDateTimePicker("fTREATMENT_BILLTRANS1edit", "x_DUEDATE_ANGSURAN", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->KUITANSI_ID->Visible) { // KUITANSI_ID ?>
    <div id="r_KUITANSI_ID" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_KUITANSI_ID" for="x_KUITANSI_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->KUITANSI_ID->caption() ?><?= $Page->KUITANSI_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->NOTA_NO->Visible) { // NOTA_NO ?>
    <div id="r_NOTA_NO" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_NOTA_NO" for="x_NOTA_NO" class="<?= $Page->LeftColumnClass ?>"><?= $Page->NOTA_NO->caption() ?><?= $Page->NOTA_NO->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->NOTA_NO->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_NOTA_NO">
<input type="<?= $Page->NOTA_NO->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_NOTA_NO" name="x_NOTA_NO" id="x_NOTA_NO" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->NOTA_NO->getPlaceHolder()) ?>" value="<?= $Page->NOTA_NO->EditValue ?>"<?= $Page->NOTA_NO->editAttributes() ?> aria-describedby="x_NOTA_NO_help">
...
<?php if ($Page->ISCETAK->Visible) { // ISCETAK ?>
    <div id="r_ISCETAK" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_ISCETAK" for="x_ISCETAK" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ISCETAK->caption() ?><?= $Page->ISCETAK->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ISCETAK->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_ISCETAK">
<input type="<?= $Page->ISCETAK->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_ISCETAK" name="x_ISCETAK" id="x_ISCETAK" size="30" maxlength="1" placeholder="<?= HtmlEncode($Page->ISCETAK->getPlaceHolder()) ?>" value="<?= $Page->ISCETAK->EditValue ?>"<?= $Page->ISCETAK->editAttributes() ?> aria-describedby="x_ISCETAK_help">
...
<?php if ($Page->PRINT_DATE->Visible) { // PRINT_DATE ?>
    <div id="r_PRINT_DATE" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_PRINT_DATE" for="x_PRINT_DATE" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PRINT_DATE->caption() ?><?= $Page->PRINT_DATE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PRINT_DATE->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_PRINT_DATE">
<input type="<?= $Page->PRINT_DATE->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_PRINT_DATE" name="x_PRINT_DATE" id="x_PRINT_DATE" placeholder="<?= HtmlEncode($Page->PRINT_DATE->getPlaceHolder()) ?>" value="<?= $Page->PRINT_DATE->EditValue ?>"<?= $Page->PRINT_DATE->editAttributes() ?> aria-describedby="x_PRINT_DATE_help">
...
<script>
loadjs.ready(["fTREATMENT_BILLTRANS1edit", "datetimepicker"], function() {
    ew.createDateTimePicker("fTREATMENT_BILLTRANS1edit", "x_PRINT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->RESEP_NO->Visible) { // RESEP_NO ?>
    <div id="r_RESEP_NO" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_RESEP_NO" for="x_RESEP_NO" class="<?= $Page->LeftColumnClass ?>"><?= $Page->RESEP_NO->caption() ?><?= $Page->RESEP_NO->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->RESEP_NO->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_RESEP_NO">
<input type="<?= $Page->RESEP_NO->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_RESEP_NO" name="x_RESEP_NO" id="x_RESEP_NO" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->RESEP_NO->getPlaceHolder()) ?>" value="<?= $Page->RESEP_NO->EditValue ?>"<?= $Page->RESEP_NO->editAttributes() ?> aria-describedby="x_RESEP_NO_help">
...
<?php if ($Page->RESEP_KE->Visible) { // RESEP_KE ?>
    <div id="r_RESEP_KE" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_RESEP_KE" for="x_RESEP_KE" class="<?= $Page->LeftColumnClass ?>"><?= $Page->RESEP_KE->caption() ?><?= $Page->RESEP_KE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->RESEP_KE->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_RESEP_KE">
<input type="<?= $Page->RESEP_KE->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_RESEP_KE" name="x_RESEP_KE" id="x_RESEP_KE" size="30" placeholder="<?= HtmlEncode($Page->RESEP_KE->getPlaceHolder()) ?>" value="<?= $Page->RESEP_KE->EditValue ?>"<?= $Page->RESEP_KE->editAttributes() ?> aria-describedby="x_RESEP_KE_help">
...
<?php if ($Page->DOSE->Visible) { // DOSE ?>
    <div id="r_DOSE" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_DOSE" for="x_DOSE" class="<?= $Page->LeftColumnClass ?>"><?= $Page->DOSE->caption() ?><?= $Page->DOSE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->DOSE->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_DOSE">
<input type="<?= $Page->DOSE->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_DOSE" name="x_DOSE" id="x_DOSE" size="30" placeholder="<?= HtmlEncode($Page->DOSE->getPlaceHolder()) ?>" value="<?= $Page->DOSE->EditValue ?>"<?= $Page->DOSE->editAttributes() ?> aria-describedby="x_DOSE_help">
...
<?php if ($Page->ORIG_DOSE->Visible) { // ORIG_DOSE ?>
    <div id="r_ORIG_DOSE" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_ORIG_DOSE" for="x_ORIG_DOSE" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ORIG_DOSE->caption() ?><?= $Page->ORIG_DOSE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ORIG_DOSE->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_ORIG_DOSE">
<input type="<?= $Page->ORIG_DOSE->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_ORIG_DOSE" name="x_ORIG_DOSE" id="x_ORIG_DOSE" size="30" placeholder="<?= HtmlEncode($Page->ORIG_DOSE->getPlaceHolder()) ?>" value="<?= $Page->ORIG_DOSE->EditValue ?>"<?= $Page->ORIG_DOSE->editAttributes() ?> aria-describedby="x_ORIG_DOSE_help">
...
<?php if ($Page->DOSE_PRESC->Visible) { // DOSE_PRESC ?>
    <div id="r_DOSE_PRESC" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_DOSE_PRESC" for="x_DOSE_PRESC" class="<?= $Page->LeftColumnClass ?>"><?= $Page->DOSE_PRESC->caption() ?><?= $Page->DOSE_PRESC->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->DOSE_PRESC->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_DOSE_PRESC">
<input type="<?= $Page->DOSE_PRESC->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_DOSE_PRESC" name="x_DOSE_PRESC" id="x_DOSE_PRESC" size="30" placeholder="<?= HtmlEncode($Page->DOSE_PRESC->getPlaceHolder()) ?>" value="<?= $Page->DOSE_PRESC->EditValue ?>"<?= $Page->DOSE_PRESC->editAttributes() ?> aria-describedby="x_DOSE_PRESC_help">
...
<?php if ($Page->ITER->Visible) { // ITER ?>
    <div id="r_ITER" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_ITER" for="x_ITER" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ITER->caption() ?><?= $Page->ITER->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ITER->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_ITER">
<input type="<?= $Page->ITER->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_ITER" name="x_ITER" id="x_ITER" size="30" placeholder="<?= HtmlEncode($Page->ITER->getPlaceHolder()) ?>" value="<?= $Page->ITER->EditValue ?>"<?= $Page->ITER->editAttributes() ?> aria-describedby="x_ITER_help">
...
<?php if ($Page->ITER_KE->Visible) { // ITER_KE ?>
    <div id="r_ITER_KE" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_ITER_KE" for="x_ITER_KE" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ITER_KE->caption() ?><?= $Page->ITER_KE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ITER_KE->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_ITER_KE">
<input type="<?= $Page->ITER_KE->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_ITER_KE" name="x_ITER_KE" id="x_ITER_KE" size="30" placeholder="<?= HtmlEncode($Page->ITER_KE->getPlaceHolder()) ?>" value="<?= $Page->ITER_KE->EditValue ?>"<?= $Page->ITER_KE->editAttributes() ?> aria-describedby="x_ITER_KE_help">
...
<?php if ($Page->SOLD_STATUS->Visible) { // SOLD_STATUS ?>
    <div id="r_SOLD_STATUS" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_SOLD_STATUS" for="x_SOLD_STATUS" class="<?= $Page->LeftColumnClass ?>"><?= $Page->SOLD_STATUS->caption() ?><?= $Page->SOLD_STATUS->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->SOLD_STATUS->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_SOLD_STATUS">
<input type="<?= $Page->SOLD_STATUS->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_SOLD_STATUS" name="x_SOLD_STATUS" id="x_SOLD_STATUS" size="30" placeholder="<?= HtmlEncode($Page->SOLD_STATUS->getPlaceHolder()) ?>" value="<?= $Page->SOLD_STATUS->EditValue ?>"<?= $Page->SOLD_STATUS->editAttributes() ?> aria-describedby="x_SOLD_STATUS_help">
...
<?php if ($Page->RACIKAN->Visible) { // RACIKAN ?>
    <div id="r_RACIKAN" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_RACIKAN" for="x_RACIKAN" class="<?= $Page->LeftColumnClass ?>"><?= $Page->RACIKAN->caption() ?><?= $Page->RACIKAN->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->RACIKAN->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_RACIKAN">
<input type="<?= $Page->RACIKAN->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_RACIKAN" name="x_RACIKAN" id="x_RACIKAN" size="30" placeholder="<?= HtmlEncode($Page->RACIKAN->getPlaceHolder()) ?>" value="<?= $Page->RACIKAN->EditValue ?>"<?= $Page->RACIKAN->editAttributes() ?> aria-describedby="x_RACIKAN_help">
...
<?php if ($Page->KELUAR_ID->Visible) { // KELUAR_ID ?>
    <div id="r_KELUAR_ID" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_KELUAR_ID" for="x_KELUAR_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->KELUAR_ID->caption() ?><?= $Page->KELUAR_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->KELUAR_ID->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_KELUAR_ID">
<input type="<?= $Page->KELUAR_ID->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_KELUAR_ID" name="x_KELUAR_ID" id="x_KELUAR_ID" size="30" placeholder="<?= HtmlEncode($Page->KELUAR_ID->getPlaceHolder()) ?>" value="<?= $Page->KELUAR_ID->EditValue ?>"<?= $Page->KELUAR_ID->editAttributes() ?> aria-describedby="x_KELUAR_ID_help">
...
<?php if ($Page->BED_ID->Visible) { // BED_ID ?>
    <div id="r_BED_ID" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_BED_ID" for="x_BED_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->BED_ID->caption() ?><?= $Page->BED_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->BED_ID->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_BED_ID">
<input type="<?= $Page->BED_ID->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_BED_ID" name="x_BED_ID" id="x_BED_ID" size="30" placeholder="<?= HtmlEncode($Page->BED_ID->getPlaceHolder()) ?>" value="<?= $Page->BED_ID->EditValue ?>"<?= $Page->BED_ID->editAttributes() ?> aria-describedby="x_BED_ID_help">
...
<?php if ($Page->PERDA_ID->Visible) { // PERDA_ID ?>
    <div id="r_PERDA_ID" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_PERDA_ID" for="x_PERDA_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PERDA_ID->caption() ?><?= $Page->PERDA_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PERDA_ID->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_PERDA_ID">
<input type="<?= $Page->PERDA_ID->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_PERDA_ID" name="x_PERDA_ID" id="x_PERDA_ID" size="30" placeholder="<?= HtmlEncode($Page->PERDA_ID->getPlaceHolder()) ?>" value="<?= $Page->PERDA_ID->EditValue ?>"<?= $Page->PERDA_ID->editAttributes() ?> aria-describedby="x_PERDA_ID_help">
...
<?php if ($Page->MODIFIED_BY->Visible) { // MODIFIED_BY ?>
    <div id="r_MODIFIED_BY" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_MODIFIED_BY" for="x_MODIFIED_BY" class="<?= $Page->LeftColumnClass ?>"><?= $Page->MODIFIED_BY->caption() ?><?= $Page->MODIFIED_BY->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<script>
loadjs.ready(["fTREATMENT_BILLTRANS1edit", "datetimepicker"], function() {
    ew.createDateTimePicker("fTREATMENT_BILLTRANS1edit", "x_MODIFIED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->MODIFIED_FROM->Visible) { // MODIFIED_FROM ?>
    <div id="r_MODIFIED_FROM" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_MODIFIED_FROM" for="x_MODIFIED_FROM" class="<?= $Page->LeftColumnClass ?>"><?= $Page->MODIFIED_FROM->caption() ?><?= $Page->MODIFIED_FROM->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->BRAND_ID->Visible) { // BRAND_ID ?>
    <div id="r_BRAND_ID" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_BRAND_ID" for="x_BRAND_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->BRAND_ID->caption() ?><?= $Page->BRAND_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->BRAND_ID->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_BRAND_ID">
<input type="<?= $Page->BRAND_ID->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_BRAND_ID" name="x_BRAND_ID" id="x_BRAND_ID" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->BRAND_ID->getPlaceHolder()) ?>" value="<?= $Page->BRAND_ID->EditValue ?>"<?= $Page->BRAND_ID->editAttributes() ?> aria-describedby="x_BRAND_ID_help">
...
<?php if ($Page->DOCTOR->Visible) { // DOCTOR ?>
    <div id="r_DOCTOR" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_DOCTOR" for="x_DOCTOR" class="<?= $Page->LeftColumnClass ?>"><?= $Page->DOCTOR->caption() ?><?= $Page->DOCTOR->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->DOCTOR->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_DOCTOR">
<input type="<?= $Page->DOCTOR->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_DOCTOR" name="x_DOCTOR" id="x_DOCTOR" size="30" maxlength="100" placeholder="<?= HtmlEncode($Page->DOCTOR->getPlaceHolder()) ?>" value="<?= $Page->DOCTOR->EditValue ?>"<?= $Page->DOCTOR->editAttributes() ?> aria-describedby="x_DOCTOR_help">
...
<?php if ($Page->JML_BKS->Visible) { // JML_BKS ?>
    <div id="r_JML_BKS" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_JML_BKS" for="x_JML_BKS" class="<?= $Page->LeftColumnClass ?>"><?= $Page->JML_BKS->caption() ?><?= $Page->JML_BKS->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->JML_BKS->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_JML_BKS">
<input type="<?= $Page->JML_BKS->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_JML_BKS" name="x_JML_BKS" id="x_JML_BKS" size="30" placeholder="<?= HtmlEncode($Page->JML_BKS->getPlaceHolder()) ?>" value="<?= $Page->JML_BKS->EditValue ?>"<?= $Page->JML_BKS->editAttributes() ?> aria-describedby="x_JML_BKS_help">
...
<?php if ($Page->EXIT_DATE->Visible) { // EXIT_DATE ?>
    <div id="r_EXIT_DATE" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_EXIT_DATE" for="x_EXIT_DATE" class="<?= $Page->LeftColumnClass ?>"><?= $Page->EXIT_DATE->caption() ?><?= $Page->EXIT_DATE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->EXIT_DATE->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_EXIT_DATE">
<input type="<?= $Page->EXIT_DATE->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_EXIT_DATE" name="x_EXIT_DATE" id="x_EXIT_DATE" placeholder="<?= HtmlEncode($Page->EXIT_DATE->getPlaceHolder()) ?>" value="<?= $Page->EXIT_DATE->EditValue ?>"<?= $Page->EXIT_DATE->editAttributes() ?> aria-describedby="x_EXIT_DATE_help">
...
<script>
loadjs.ready(["fTREATMENT_BILLTRANS1edit", "datetimepicker"], function() {
    ew.createDateTimePicker("fTREATMENT_BILLTRANS1edit", "x_EXIT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->FA_V->Visible) { // FA_V ?>
    <div id="r_FA_V" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_FA_V" for="x_FA_V" class="<?= $Page->LeftColumnClass ?>"><?= $Page->FA_V->caption() ?><?= $Page->FA_V->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->FA_V->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_FA_V">
<input type="<?= $Page->FA_V->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_FA_V" name="x_FA_V" id="x_FA_V" size="30" placeholder="<?= HtmlEncode($Page->FA_V->getPlaceHolder()) ?>" value="<?= $Page->FA_V->EditValue ?>"<?= $Page->FA_V->editAttributes() ?> aria-describedby="x_FA_V_help">
...
<?php if ($Page->TASK_ID->Visible) { // TASK_ID ?>
    <div id="r_TASK_ID" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_TASK_ID" for="x_TASK_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->TASK_ID->caption() ?><?= $Page->TASK_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->TASK_ID->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_TASK_ID">
<input type="<?= $Page->TASK_ID->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_TASK_ID" name="x_TASK_ID" id="x_TASK_ID" size="30" placeholder="<?= HtmlEncode($Page->TASK_ID->getPlaceHolder()) ?>" value="<?= $Page->TASK_ID->EditValue ?>"<?= $Page->TASK_ID->editAttributes() ?> aria-describedby="x_TASK_ID_help">
...
<?php if ($Page->AMOUNT_PAID->Visible) { // AMOUNT_PAID ?>
    <div id="r_AMOUNT_PAID" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_AMOUNT_PAID" for="x_AMOUNT_PAID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->AMOUNT_PAID->caption() ?><?= $Page->AMOUNT_PAID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->AMOUNT_PAID->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_AMOUNT_PAID">
<input type="<?= $Page->AMOUNT_PAID->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_AMOUNT_PAID" name="x_AMOUNT_PAID" id="x_AMOUNT_PAID" size="30" placeholder="<?= HtmlEncode($Page->AMOUNT_PAID->getPlaceHolder()) ?>" value="<?= $Page->AMOUNT_PAID->EditValue ?>"<?= $Page->AMOUNT_PAID->editAttributes() ?> aria-describedby="x_AMOUNT_PAID_help">
...
<?php if ($Page->THENAME->Visible) { // THENAME ?>
    <div id="r_THENAME" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_THENAME" for="x_THENAME" class="<?= $Page->LeftColumnClass ?>"><?= $Page->THENAME->caption() ?><?= $Page->THENAME->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->THENAME->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_THENAME">
<input type="<?= $Page->THENAME->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_THENAME" name="x_THENAME" id="x_THENAME" size="30" maxlength="100" placeholder="<?= HtmlEncode($Page->THENAME->getPlaceHolder()) ?>" value="<?= $Page->THENAME->EditValue ?>"<?= $Page->THENAME->editAttributes() ?> aria-describedby="x_THENAME_help">
...
<?php if ($Page->THEID->Visible) { // THEID ?>
    <div id="r_THEID" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_THEID" for="x_THEID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->THEID->caption() ?><?= $Page->THEID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->THEID->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_THEID">
<input type="<?= $Page->THEID->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_THEID" name="x_THEID" id="x_THEID" size="30" maxlength="25" placeholder="<?= HtmlEncode($Page->THEID->getPlaceHolder()) ?>" value="<?= $Page->THEID->EditValue ?>"<?= $Page->THEID->editAttributes() ?> aria-describedby="x_THEID_help">
...
<?php if ($Page->SERIAL_NB->Visible) { // SERIAL_NB ?>
    <div id="r_SERIAL_NB" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_SERIAL_NB" for="x_SERIAL_NB" class="<?= $Page->LeftColumnClass ?>"><?= $Page->SERIAL_NB->caption() ?><?= $Page->SERIAL_NB->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->SERIAL_NB->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_SERIAL_NB">
<input type="<?= $Page->SERIAL_NB->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_SERIAL_NB" name="x_SERIAL_NB" id="x_SERIAL_NB" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->SERIAL_NB->getPlaceHolder()) ?>" value="<?= $Page->SERIAL_NB->EditValue ?>"<?= $Page->SERIAL_NB->editAttributes() ?> aria-describedby="x_SERIAL_NB_help">
...
<?php if ($Page->TREATMENT_PLAFOND->Visible) { // TREATMENT_PLAFOND ?>
    <div id="r_TREATMENT_PLAFOND" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_TREATMENT_PLAFOND" for="x_TREATMENT_PLAFOND" class="<?= $Page->LeftColumnClass ?>"><?= $Page->TREATMENT_PLAFOND->caption() ?><?= $Page->TREATMENT_PLAFOND->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->AMOUNT_PLAFOND->Visible) { // AMOUNT_PLAFOND ?>
    <div id="r_AMOUNT_PLAFOND" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_AMOUNT_PLAFOND" for="x_AMOUNT_PLAFOND" class="<?= $Page->LeftColumnClass ?>"><?= $Page->AMOUNT_PLAFOND->caption() ?><?= $Page->AMOUNT_PLAFOND->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->AMOUNT_PAID_PLAFOND->Visible) { // AMOUNT_PAID_PLAFOND ?>
    <div id="r_AMOUNT_PAID_PLAFOND" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_AMOUNT_PAID_PLAFOND" for="x_AMOUNT_PAID_PLAFOND" class="<?= $Page->LeftColumnClass ?>"><?= $Page->AMOUNT_PAID_PLAFOND->caption() ?><?= $Page->AMOUNT_PAID_PLAFOND->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->CLASS_ID_PLAFOND->Visible) { // CLASS_ID_PLAFOND ?>
    <div id="r_CLASS_ID_PLAFOND" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_CLASS_ID_PLAFOND" for="x_CLASS_ID_PLAFOND" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CLASS_ID_PLAFOND->caption() ?><?= $Page->CLASS_ID_PLAFOND->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->PAYOR_ID->Visible) { // PAYOR_ID ?>
    <div id="r_PAYOR_ID" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_PAYOR_ID" for="x_PAYOR_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PAYOR_ID->caption() ?><?= $Page->PAYOR_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PAYOR_ID->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_PAYOR_ID">
<input type="<?= $Page->PAYOR_ID->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_PAYOR_ID" name="x_PAYOR_ID" id="x_PAYOR_ID" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->PAYOR_ID->getPlaceHolder()) ?>" value="<?= $Page->PAYOR_ID->EditValue ?>"<?= $Page->PAYOR_ID->editAttributes() ?> aria-describedby="x_PAYOR_ID_help">
...
<?php if ($Page->PEMBULATAN->Visible) { // PEMBULATAN ?>
    <div id="r_PEMBULATAN" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_PEMBULATAN" for="x_PEMBULATAN" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PEMBULATAN->caption() ?><?= $Page->PEMBULATAN->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PEMBULATAN->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_PEMBULATAN">
<input type="<?= $Page->PEMBULATAN->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_PEMBULATAN" name="x_PEMBULATAN" id="x_PEMBULATAN" size="30" placeholder="<?= HtmlEncode($Page->PEMBULATAN->getPlaceHolder()) ?>" value="<?= $Page->PEMBULATAN->EditValue ?>"<?= $Page->PEMBULATAN->editAttributes() ?> aria-describedby="x_PEMBULATAN_help">
...
<?php if ($Page->ISRJ->Visible) { // ISRJ ?>
    <div id="r_ISRJ" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_ISRJ" for="x_ISRJ" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ISRJ->caption() ?><?= $Page->ISRJ->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ISRJ->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_ISRJ">
<input type="<?= $Page->ISRJ->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_ISRJ" name="x_ISRJ" id="x_ISRJ" size="30" maxlength="1" placeholder="<?= HtmlEncode($Page->ISRJ->getPlaceHolder()) ?>" value="<?= $Page->ISRJ->EditValue ?>"<?= $Page->ISRJ->editAttributes() ?> aria-describedby="x_ISRJ_help">
...
<?php if ($Page->AGEYEAR->Visible) { // AGEYEAR ?>
    <div id="r_AGEYEAR" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_AGEYEAR" for="x_AGEYEAR" class="<?= $Page->LeftColumnClass ?>"><?= $Page->AGEYEAR->caption() ?><?= $Page->AGEYEAR->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->AGEYEAR->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_AGEYEAR">
<input type="<?= $Page->AGEYEAR->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_AGEYEAR" name="x_AGEYEAR" id="x_AGEYEAR" size="30" placeholder="<?= HtmlEncode($Page->AGEYEAR->getPlaceHolder()) ?>" value="<?= $Page->AGEYEAR->EditValue ?>"<?= $Page->AGEYEAR->editAttributes() ?> aria-describedby="x_AGEYEAR_help">
...
<?php if ($Page->AGEMONTH->Visible) { // AGEMONTH ?>
    <div id="r_AGEMONTH" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_AGEMONTH" for="x_AGEMONTH" class="<?= $Page->LeftColumnClass ?>"><?= $Page->AGEMONTH->caption() ?><?= $Page->AGEMONTH->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->AGEMONTH->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_AGEMONTH">
<input type="<?= $Page->AGEMONTH->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_AGEMONTH" name="x_AGEMONTH" id="x_AGEMONTH" size="30" placeholder="<?= HtmlEncode($Page->AGEMONTH->getPlaceHolder()) ?>" value="<?= $Page->AGEMONTH->EditValue ?>"<?= $Page->AGEMONTH->editAttributes() ?> aria-describedby="x_AGEMONTH_help">
...
<?php if ($Page->AGEDAY->Visible) { // AGEDAY ?>
    <div id="r_AGEDAY" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_AGEDAY" for="x_AGEDAY" class="<?= $Page->LeftColumnClass ?>"><?= $Page->AGEDAY->caption() ?><?= $Page->AGEDAY->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->AGEDAY->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_AGEDAY">
<input type="<?= $Page->AGEDAY->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_AGEDAY" name="x_AGEDAY" id="x_AGEDAY" size="30" placeholder="<?= HtmlEncode($Page->AGEDAY->getPlaceHolder()) ?>" value="<?= $Page->AGEDAY->EditValue ?>"<?= $Page->AGEDAY->editAttributes() ?> aria-describedby="x_AGEDAY_help">
...
<?php if ($Page->GENDER->Visible) { // GENDER ?>
    <div id="r_GENDER" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_GENDER" for="x_GENDER" class="<?= $Page->LeftColumnClass ?>"><?= $Page->GENDER->caption() ?><?= $Page->GENDER->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->GENDER->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_GENDER">
<input type="<?= $Page->GENDER->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_GENDER" name="x_GENDER" id="x_GENDER" size="30" maxlength="1" placeholder="<?= HtmlEncode($Page->GENDER->getPlaceHolder()) ?>" value="<?= $Page->GENDER->EditValue ?>"<?= $Page->GENDER->editAttributes() ?> aria-describedby="x_GENDER_help">
...
<?php if ($Page->KAL_ID->Visible) { // KAL_ID ?>
    <div id="r_KAL_ID" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_KAL_ID" for="x_KAL_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->KAL_ID->caption() ?><?= $Page->KAL_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->KAL_ID->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_KAL_ID">
<input type="<?= $Page->KAL_ID->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_KAL_ID" name="x_KAL_ID" id="x_KAL_ID" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->KAL_ID->getPlaceHolder()) ?>" value="<?= $Page->KAL_ID->EditValue ?>"<?= $Page->KAL_ID->editAttributes() ?> aria-describedby="x_KAL_ID_help">
...
<?php if ($Page->CORRECTION_ID->Visible) { // CORRECTION_ID ?>
    <div id="r_CORRECTION_ID" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_CORRECTION_ID" for="x_CORRECTION_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CORRECTION_ID->caption() ?><?= $Page->CORRECTION_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->KARYAWAN->Visible) { // KARYAWAN ?>
    <div id="r_KARYAWAN" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_KARYAWAN" for="x_KARYAWAN" class="<?= $Page->LeftColumnClass ?>"><?= $Page->KARYAWAN->caption() ?><?= $Page->KARYAWAN->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->KARYAWAN->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_KARYAWAN">
<input type="<?= $Page->KARYAWAN->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_KARYAWAN" name="x_KARYAWAN" id="x_KARYAWAN" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->KARYAWAN->getPlaceHolder()) ?>" value="<?= $Page->KARYAWAN->EditValue ?>"<?= $Page->KARYAWAN->editAttributes() ?> aria-describedby="x_KARYAWAN_help">
...
<?php if ($Page->sell_price->Visible) { // sell_price ?>
    <div id="r_sell_price" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_sell_price" for="x_sell_price" class="<?= $Page->LeftColumnClass ?>"><?= $Page->sell_price->caption() ?><?= $Page->sell_price->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->sell_price->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_sell_price">
<input type="<?= $Page->sell_price->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_sell_price" name="x_sell_price" id="x_sell_price" size="30" placeholder="<?= HtmlEncode($Page->sell_price->getPlaceHolder()) ?>" value="<?= $Page->sell_price->EditValue ?>"<?= $Page->sell_price->editAttributes() ?> aria-describedby="x_sell_price_help">
...
<?php if ($Page->diskon->Visible) { // diskon ?>
    <div id="r_diskon" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_diskon" for="x_diskon" class="<?= $Page->LeftColumnClass ?>"><?= $Page->diskon->caption() ?><?= $Page->diskon->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->diskon->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_diskon">
<input type="<?= $Page->diskon->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_diskon" name="x_diskon" id="x_diskon" size="30" placeholder="<?= HtmlEncode($Page->diskon->getPlaceHolder()) ?>" value="<?= $Page->diskon->EditValue ?>"<?= $Page->diskon->editAttributes() ?> aria-describedby="x_diskon_help">
...
<?php if ($Page->NUMER->Visible) { // NUMER ?>
    <div id="r_NUMER" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_NUMER" for="x_NUMER" class="<?= $Page->LeftColumnClass ?>"><?= $Page->NUMER->caption() ?><?= $Page->NUMER->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->NUMER->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_NUMER">
<input type="<?= $Page->NUMER->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_NUMER" name="x_NUMER" id="x_NUMER" size="30" maxlength="15" placeholder="<?= HtmlEncode($Page->NUMER->getPlaceHolder()) ?>" value="<?= $Page->NUMER->EditValue ?>"<?= $Page->NUMER->editAttributes() ?> aria-describedby="x_NUMER_help">
...
<?php if ($Page->MEASURE_ID2->Visible) { // MEASURE_ID2 ?>
    <div id="r_MEASURE_ID2" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_MEASURE_ID2" for="x_MEASURE_ID2" class="<?= $Page->LeftColumnClass ?>"><?= $Page->MEASURE_ID2->caption() ?><?= $Page->MEASURE_ID2->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->MEASURE_ID2->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_MEASURE_ID2">
<input type="<?= $Page->MEASURE_ID2->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_MEASURE_ID2" name="x_MEASURE_ID2" id="x_MEASURE_ID2" size="30" placeholder="<?= HtmlEncode($Page->MEASURE_ID2->getPlaceHolder()) ?>" value="<?= $Page->MEASURE_ID2->EditValue ?>"<?= $Page->MEASURE_ID2->editAttributes() ?> aria-describedby="x_MEASURE_ID2_help">
...
<?php if ($Page->POTONGAN->Visible) { // POTONGAN ?>
    <div id="r_POTONGAN" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_POTONGAN" for="x_POTONGAN" class="<?= $Page->LeftColumnClass ?>"><?= $Page->POTONGAN->caption() ?><?= $Page->POTONGAN->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->POTONGAN->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_POTONGAN">
<input type="<?= $Page->POTONGAN->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_POTONGAN" name="x_POTONGAN" id="x_POTONGAN" size="30" placeholder="<?= HtmlEncode($Page->POTONGAN->getPlaceHolder()) ?>" value="<?= $Page->POTONGAN->EditValue ?>"<?= $Page->POTONGAN->editAttributes() ?> aria-describedby="x_POTONGAN_help">
...
<?php if ($Page->BAYAR->Visible) { // BAYAR ?>
    <div id="r_BAYAR" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_BAYAR" for="x_BAYAR" class="<?= $Page->LeftColumnClass ?>"><?= $Page->BAYAR->caption() ?><?= $Page->BAYAR->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->BAYAR->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_BAYAR">
<input type="<?= $Page->BAYAR->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_BAYAR" name="x_BAYAR" id="x_BAYAR" size="30" placeholder="<?= HtmlEncode($Page->BAYAR->getPlaceHolder()) ?>" value="<?= $Page->BAYAR->EditValue ?>"<?= $Page->BAYAR->editAttributes() ?> aria-describedby="x_BAYAR_help">
...
<?php if ($Page->RETUR->Visible) { // RETUR ?>
    <div id="r_RETUR" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_RETUR" for="x_RETUR" class="<?= $Page->LeftColumnClass ?>"><?= $Page->RETUR->caption() ?><?= $Page->RETUR->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->RETUR->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_RETUR">
<input type="<?= $Page->RETUR->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_RETUR" name="x_RETUR" id="x_RETUR" size="30" placeholder="<?= HtmlEncode($Page->RETUR->getPlaceHolder()) ?>" value="<?= $Page->RETUR->EditValue ?>"<?= $Page->RETUR->editAttributes() ?> aria-describedby="x_RETUR_help">
...
<?php if ($Page->PPNVALUE->Visible) { // PPNVALUE ?>
    <div id="r_PPNVALUE" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_PPNVALUE" for="x_PPNVALUE" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PPNVALUE->caption() ?><?= $Page->PPNVALUE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PPNVALUE->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_PPNVALUE">
<input type="<?= $Page->PPNVALUE->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_PPNVALUE" name="x_PPNVALUE" id="x_PPNVALUE" size="30" placeholder="<?= HtmlEncode($Page->PPNVALUE->getPlaceHolder()) ?>" value="<?= $Page->PPNVALUE->EditValue ?>"<?= $Page->PPNVALUE->editAttributes() ?> aria-describedby="x_PPNVALUE_help">
...
<?php if ($Page->TAGIHAN->Visible) { // TAGIHAN ?>
    <div id="r_TAGIHAN" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_TAGIHAN" for="x_TAGIHAN" class="<?= $Page->LeftColumnClass ?>"><?= $Page->TAGIHAN->caption() ?><?= $Page->TAGIHAN->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->TAGIHAN->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_TAGIHAN">
<input type="<?= $Page->TAGIHAN->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_TAGIHAN" name="x_TAGIHAN" id="x_TAGIHAN" size="30" placeholder="<?= HtmlEncode($Page->TAGIHAN->getPlaceHolder()) ?>" value="<?= $Page->TAGIHAN->EditValue ?>"<?= $Page->TAGIHAN->editAttributes() ?> aria-describedby="x_TAGIHAN_help">
...
<?php if ($Page->KOREKSI->Visible) { // KOREKSI ?>
    <div id="r_KOREKSI" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_KOREKSI" for="x_KOREKSI" class="<?= $Page->LeftColumnClass ?>"><?= $Page->KOREKSI->caption() ?><?= $Page->KOREKSI->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->KOREKSI->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_KOREKSI">
<input type="<?= $Page->KOREKSI->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_KOREKSI" name="x_KOREKSI" id="x_KOREKSI" size="30" placeholder="<?= HtmlEncode($Page->KOREKSI->getPlaceHolder()) ?>" value="<?= $Page->KOREKSI->EditValue ?>"<?= $Page->KOREKSI->editAttributes() ?> aria-describedby="x_KOREKSI_help">
...
<?php if ($Page->STATUS_OBAT->Visible) { // STATUS_OBAT ?>
    <div id="r_STATUS_OBAT" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_STATUS_OBAT" for="x_STATUS_OBAT" class="<?= $Page->LeftColumnClass ?>"><?= $Page->STATUS_OBAT->caption() ?><?= $Page->STATUS_OBAT->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->STATUS_OBAT->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_STATUS_OBAT">
<input type="<?= $Page->STATUS_OBAT->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_STATUS_OBAT" name="x_STATUS_OBAT" id="x_STATUS_OBAT" size="30" placeholder="<?= HtmlEncode($Page->STATUS_OBAT->getPlaceHolder()) ?>" value="<?= $Page->STATUS_OBAT->EditValue ?>"<?= $Page->STATUS_OBAT->editAttributes() ?> aria-describedby="x_STATUS_OBAT_help">
...
<?php if ($Page->SUBSIDISAT->Visible) { // SUBSIDISAT ?>
    <div id="r_SUBSIDISAT" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_SUBSIDISAT" for="x_SUBSIDISAT" class="<?= $Page->LeftColumnClass ?>"><?= $Page->SUBSIDISAT->caption() ?><?= $Page->SUBSIDISAT->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->SUBSIDISAT->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_SUBSIDISAT">
<input type="<?= $Page->SUBSIDISAT->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_SUBSIDISAT" name="x_SUBSIDISAT" id="x_SUBSIDISAT" size="30" placeholder="<?= HtmlEncode($Page->SUBSIDISAT->getPlaceHolder()) ?>" value="<?= $Page->SUBSIDISAT->EditValue ?>"<?= $Page->SUBSIDISAT->editAttributes() ?> aria-describedby="x_SUBSIDISAT_help">
...
<?php if ($Page->PRINTQ->Visible) { // PRINTQ ?>
    <div id="r_PRINTQ" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_PRINTQ" for="x_PRINTQ" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PRINTQ->caption() ?><?= $Page->PRINTQ->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PRINTQ->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_PRINTQ">
<input type="<?= $Page->PRINTQ->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_PRINTQ" name="x_PRINTQ" id="x_PRINTQ" size="30" placeholder="<?= HtmlEncode($Page->PRINTQ->getPlaceHolder()) ?>" value="<?= $Page->PRINTQ->EditValue ?>"<?= $Page->PRINTQ->editAttributes() ?> aria-describedby="x_PRINTQ_help">
...
<?php if ($Page->PRINTED_BY->Visible) { // PRINTED_BY ?>
    <div id="r_PRINTED_BY" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_PRINTED_BY" for="x_PRINTED_BY" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PRINTED_BY->caption() ?><?= $Page->PRINTED_BY->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->STOCK_AVAILABLE->Visible) { // STOCK_AVAILABLE ?>
    <div id="r_STOCK_AVAILABLE" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_STOCK_AVAILABLE" for="x_STOCK_AVAILABLE" class="<?= $Page->LeftColumnClass ?>"><?= $Page->STOCK_AVAILABLE->caption() ?><?= $Page->STOCK_AVAILABLE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->CLINIC_TYPE->Visible) { // CLINIC_TYPE ?>
    <div id="r_CLINIC_TYPE" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_CLINIC_TYPE" for="x_CLINIC_TYPE" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CLINIC_TYPE->caption() ?><?= $Page->CLINIC_TYPE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CLINIC_TYPE->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_CLINIC_TYPE">
<input type="<?= $Page->CLINIC_TYPE->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_CLINIC_TYPE" name="x_CLINIC_TYPE" id="x_CLINIC_TYPE" size="30" placeholder="<?= HtmlEncode($Page->CLINIC_TYPE->getPlaceHolder()) ?>" value="<?= $Page->CLINIC_TYPE->EditValue ?>"<?= $Page->CLINIC_TYPE->editAttributes() ?> aria-describedby="x_CLINIC_TYPE_help">
...
<?php if ($Page->MODULE_ID->Visible) { // MODULE_ID ?>
    <div id="r_MODULE_ID" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_MODULE_ID" for="x_MODULE_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->MODULE_ID->caption() ?><?= $Page->MODULE_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->MODULE_ID->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_MODULE_ID">
<input type="<?= $Page->MODULE_ID->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_MODULE_ID" name="x_MODULE_ID" id="x_MODULE_ID" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->MODULE_ID->getPlaceHolder()) ?>" value="<?= $Page->MODULE_ID->EditValue ?>"<?= $Page->MODULE_ID->editAttributes() ?> aria-describedby="x_MODULE_ID_help">
...
<?php if ($Page->profession->Visible) { // profession ?>
    <div id="r_profession" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_profession" for="x_profession" class="<?= $Page->LeftColumnClass ?>"><?= $Page->profession->caption() ?><?= $Page->profession->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->profession->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_profession">
<input type="<?= $Page->profession->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_profession" name="x_profession" id="x_profession" size="30" placeholder="<?= HtmlEncode($Page->profession->getPlaceHolder()) ?>" value="<?= $Page->profession->EditValue ?>"<?= $Page->profession->editAttributes() ?> aria-describedby="x_profession_help">
...
<?php if ($Page->THEORDER->Visible) { // THEORDER ?>
    <div id="r_THEORDER" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_THEORDER" for="x_THEORDER" class="<?= $Page->LeftColumnClass ?>"><?= $Page->THEORDER->caption() ?><?= $Page->THEORDER->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->THEORDER->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_THEORDER">
<input type="<?= $Page->THEORDER->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_THEORDER" name="x_THEORDER" id="x_THEORDER" size="30" placeholder="<?= HtmlEncode($Page->THEORDER->getPlaceHolder()) ?>" value="<?= $Page->THEORDER->EditValue ?>"<?= $Page->THEORDER->editAttributes() ?> aria-describedby="x_THEORDER_help">
...
<?php if ($Page->CASHIER->Visible) { // CASHIER ?>
    <div id="r_CASHIER" class="form-group row">
        <label id="elh_TREATMENT_BILLTRANS1_CASHIER" for="x_CASHIER" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CASHIER->caption() ?><?= $Page->CASHIER->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CASHIER->cellAttributes() ?>>
<span id="el_TREATMENT_BILLTRANS1_CASHIER">
<input type="<?= $Page->CASHIER->getInputTextType() ?>" data-table="TREATMENT_BILLTRANS1" data-field="x_CASHIER" name="x_CASHIER" id="x_CASHIER" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->CASHIER->getPlaceHolder()) ?>" value="<?= $Page->CASHIER->EditValue ?>"<?= $Page->CASHIER->editAttributes() ?> aria-describedby="x_CASHIER_help">
...
loadjs.ready("head", function() {
    ew.addEventHandlers("TREATMENT_BILLTRANS1");
});
</script>
<script>
