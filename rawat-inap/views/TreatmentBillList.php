...
<input type="hidden" name="z_TREAT_DATE" id="z_TREAT_DATE" value="=">
        ...
        <span id="el_TREATMENT_BILL_TREAT_DATE" class="ew-search-field">
...
<script>
loadjs.ready(["fTREATMENT_BILLlistsrch", "datetimepicker"], function() {
    ew.createDateTimePicker("fTREATMENT_BILLlistsrch", "x_TREAT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
