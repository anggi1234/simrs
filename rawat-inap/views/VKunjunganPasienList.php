...
<?php if ($Page->CLINIC_ID->Visible) { // CLINIC_ID ?>
        <th data-name="CLINIC_ID" class="<?= $Page->CLINIC_ID->headerCellClass() ?>"><div id="elh_V_KUNJUNGAN_PASIEN_CLINIC_ID" class="V_KUNJUNGAN_PASIEN_CLINIC_ID"><?= $Page->renderSort($Page->CLINIC_ID) ?></div></th>
<?php } ?>
<?php if ($Page->CLINIC_ID_FROM->Visible) { // CLINIC_ID_FROM ?>
        <th data-name="CLINIC_ID_FROM" class="<?= $Page->CLINIC_ID_FROM->headerCellClass() ?>"><div id="elh_V_KUNJUNGAN_PASIEN_CLINIC_ID_FROM" class="V_KUNJUNGAN_PASIEN_CLINIC_ID_FROM"><?= $Page->renderSort($Page->CLINIC_ID_FROM) ?></div></th>
<?php } ?>
<?php if ($Page->VISIT_DATE->Visible) { // VISIT_DATE ?>
        <th data-name="VISIT_DATE" class="<?= $Page->VISIT_DATE->headerCellClass() ?>"><div id="elh_V_KUNJUNGAN_PASIEN_VISIT_DATE" class="V_KUNJUNGAN_PASIEN_VISIT_DATE"><?= $Page->renderSort($Page->VISIT_DATE) ?></div></th>
<?php } ?>
<?php if ($Page->tgl_kontrol->Visible) { // tgl_kontrol ?>
        <th data-name="tgl_kontrol" class="<?= $Page->tgl_kontrol->headerCellClass() ?>"><div id="elh_V_KUNJUNGAN_PASIEN_tgl_kontrol" class="V_KUNJUNGAN_PASIEN_tgl_kontrol"><?= $Page->renderSort($Page->tgl_kontrol) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_V_KUNJUNGAN_PASIEN_CLINIC_ID">
...
<span id="el<?= $Page->RowCount ?>_V_KUNJUNGAN_PASIEN_CLINIC_ID_FROM">
...
<span id="el<?= $Page->RowCount ?>_V_KUNJUNGAN_PASIEN_VISIT_DATE">
...
<span id="el<?= $Page->RowCount ?>_V_KUNJUNGAN_PASIEN_tgl_kontrol">
