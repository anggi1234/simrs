...
loadjs.ready("head", function () {
    ...
    fUSER_PERMISSIONadd = currentForm = new ew.Form("fUSER_PERMISSIONadd", "add");
    ...
    // Validate form
    fUSER_PERMISSIONadd.validate = function () {
    ...
    fUSER_PERMISSIONadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
<script>
loadjs.ready(["fUSER_PERMISSIONadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fUSER_PERMISSIONadd", "x_MODIFIED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
