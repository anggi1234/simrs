...
// Page object
$VRegAkomodasiView = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fV_REG_AKOMODASIview;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "view";
    fV_REG_AKOMODASIview = currentForm = new ew.Form("fV_REG_AKOMODASIview", "view");
    loadjs.done("fV_REG_AKOMODASIview");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fV_REG_AKOMODASIview" id="fV_REG_AKOMODASIview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->CLINIC_ID->Visible) { // CLINIC_ID ?>
    <tr id="r_CLINIC_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_REG_AKOMODASI_CLINIC_ID"><?= $Page->CLINIC_ID->caption() ?></span></td>
...
<?php if ($Page->TREATMENT->Visible) { // TREATMENT ?>
    <tr id="r_TREATMENT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_REG_AKOMODASI_TREATMENT"><?= $Page->TREATMENT->caption() ?></span></td>
...
<?php if ($Page->TREAT_DATE->Visible) { // TREAT_DATE ?>
    <tr id="r_TREAT_DATE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_REG_AKOMODASI_TREAT_DATE"><?= $Page->TREAT_DATE->caption() ?></span></td>
...
<?php if ($Page->BED_ID->Visible) { // BED_ID ?>
    <tr id="r_BED_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_REG_AKOMODASI_BED_ID"><?= $Page->BED_ID->caption() ?></span></td>
...
<?php if ($Page->KELUAR_ID->Visible) { // KELUAR_ID ?>
    <tr id="r_KELUAR_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_REG_AKOMODASI_KELUAR_ID"><?= $Page->KELUAR_ID->caption() ?></span></td>
...
<?php if ($Page->DESCRIPTION->Visible) { // DESCRIPTION ?>
    <tr id="r_DESCRIPTION">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_REG_AKOMODASI_DESCRIPTION"><?= $Page->DESCRIPTION->caption() ?></span></td>
...
<?php if ($Page->CLASS_ROOM_ID->Visible) { // CLASS_ROOM_ID ?>
    <tr id="r_CLASS_ROOM_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_REG_AKOMODASI_CLASS_ROOM_ID"><?= $Page->CLASS_ROOM_ID->caption() ?></span></td>
...
<?php if ($Page->EMPLOYEE_ID->Visible) { // EMPLOYEE_ID ?>
    <tr id="r_EMPLOYEE_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_REG_AKOMODASI_EMPLOYEE_ID"><?= $Page->EMPLOYEE_ID->caption() ?></span></td>
...
<?php if ($Page->TRANS_ID->Visible) { // TRANS_ID ?>
    <tr id="r_TRANS_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_REG_AKOMODASI_TRANS_ID"><?= $Page->TRANS_ID->caption() ?></span></td>
        <td data-name="TRANS_ID" <?= $Page->TRANS_ID->cellAttributes() ?>>
<span id="el_V_REG_AKOMODASI_TRANS_ID">
