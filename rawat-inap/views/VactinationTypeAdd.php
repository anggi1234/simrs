...
// Page object
$VactinationTypeAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fVACTINATION_TYPEadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fVACTINATION_TYPEadd = currentForm = new ew.Form("fVACTINATION_TYPEadd", "add");
    ...
    fVACTINATION_TYPEadd.addFields([
    ...
    // Validate form
    fVACTINATION_TYPEadd.validate = function () {
    ...
    // Form_CustomValidate
    fVACTINATION_TYPEadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fVACTINATION_TYPEadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fVACTINATION_TYPEadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fVACTINATION_TYPEadd" id="fVACTINATION_TYPEadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
