...
// Page object
$TreatmentBoundAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fTREATMENT_BOUNDadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fTREATMENT_BOUNDadd = currentForm = new ew.Form("fTREATMENT_BOUNDadd", "add");
    ...
    // Validate form
    fTREATMENT_BOUNDadd.validate = function () {
    ...
    // Form_CustomValidate
    fTREATMENT_BOUNDadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fTREATMENT_BOUNDadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fTREATMENT_BOUNDadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fTREATMENT_BOUNDadd" id="fTREATMENT_BOUNDadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
