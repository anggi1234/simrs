...
// Page object
$TreatmentConditionAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fTREATMENT_CONDITIONadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fTREATMENT_CONDITIONadd = currentForm = new ew.Form("fTREATMENT_CONDITIONadd", "add");
    ...
    fTREATMENT_CONDITIONadd.addFields([
    ...
    // Validate form
    fTREATMENT_CONDITIONadd.validate = function () {
    ...
    // Form_CustomValidate
    fTREATMENT_CONDITIONadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fTREATMENT_CONDITIONadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fTREATMENT_CONDITIONadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fTREATMENT_CONDITIONadd" id="fTREATMENT_CONDITIONadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
