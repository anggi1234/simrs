...
// Page object
$VactinationStatusAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fVACTINATION_STATUSadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fVACTINATION_STATUSadd = currentForm = new ew.Form("fVACTINATION_STATUSadd", "add");
    ...
    fVACTINATION_STATUSadd.addFields([
    ...
    // Validate form
    fVACTINATION_STATUSadd.validate = function () {
    ...
    // Form_CustomValidate
    fVACTINATION_STATUSadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fVACTINATION_STATUSadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fVACTINATION_STATUSadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fVACTINATION_STATUSadd" id="fVACTINATION_STATUSadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
