...
// Page object
$TreatmentResultsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fTREATMENT_RESULTSadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fTREATMENT_RESULTSadd = currentForm = new ew.Form("fTREATMENT_RESULTSadd", "add");
    ...
    fTREATMENT_RESULTSadd.addFields([
    ...
    // Validate form
    fTREATMENT_RESULTSadd.validate = function () {
    ...
    // Form_CustomValidate
    fTREATMENT_RESULTSadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fTREATMENT_RESULTSadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fTREATMENT_RESULTSadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fTREATMENT_RESULTSadd" id="fTREATMENT_RESULTSadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
