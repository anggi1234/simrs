...
loadjs.ready("head", function () {
    ...
    fUSER_MENUadd = currentForm = new ew.Form("fUSER_MENUadd", "add");
    ...
    // Validate form
    fUSER_MENUadd.validate = function () {
    ...
    // Form_CustomValidate
    fUSER_MENUadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fUSER_MENUadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fUSER_MENUadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fUSER_MENUadd" id="fUSER_MENUadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fUSER_MENUadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fUSER_MENUadd", "x_MODIFIED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
