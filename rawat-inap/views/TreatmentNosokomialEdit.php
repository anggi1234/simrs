...
// Page object
$TreatmentNosokomialEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fTREATMENT_NOSOKOMIALedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fTREATMENT_NOSOKOMIALedit = currentForm = new ew.Form("fTREATMENT_NOSOKOMIALedit", "edit");
    ...
    fTREATMENT_NOSOKOMIALedit.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fTREATMENT_NOSOKOMIALedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fTREATMENT_NOSOKOMIALedit.validate = function () {
    ...
    // Form_CustomValidate
    fTREATMENT_NOSOKOMIALedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fTREATMENT_NOSOKOMIALedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fTREATMENT_NOSOKOMIALedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fTREATMENT_NOSOKOMIALedit" id="fTREATMENT_NOSOKOMIALedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="TREATMENT_NOSOKOMIAL" data-field="x_ORG_UNIT_CODE" data-hidden="1" name="o_ORG_UNIT_CODE" id="o_ORG_UNIT_CODE" value="<?= HtmlEncode($Page->ORG_UNIT_CODE->OldValue ?? $Page->ORG_UNIT_CODE->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<input type="hidden" data-table="TREATMENT_NOSOKOMIAL" data-field="x_BILL_ID" data-hidden="1" name="o_BILL_ID" id="o_BILL_ID" value="<?= HtmlEncode($Page->BILL_ID->OldValue ?? $Page->BILL_ID->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["fTREATMENT_NOSOKOMIALedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fTREATMENT_NOSOKOMIALedit", "x_TREAT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fTREATMENT_NOSOKOMIALedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fTREATMENT_NOSOKOMIALedit", "x_EXIT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fTREATMENT_NOSOKOMIALedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fTREATMENT_NOSOKOMIALedit", "x_MODIFIED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
