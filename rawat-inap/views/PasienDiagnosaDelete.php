...
<?php if ($Page->ORG_UNIT_CODE->Visible) { // ORG_UNIT_CODE ?>
        <th class="<?= $Page->ORG_UNIT_CODE->headerCellClass() ?>"><span id="elh_PASIEN_DIAGNOSA_ORG_UNIT_CODE" class="PASIEN_DIAGNOSA_ORG_UNIT_CODE"><?= $Page->ORG_UNIT_CODE->caption() ?></span></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_PASIEN_DIAGNOSA_ORG_UNIT_CODE" class="PASIEN_DIAGNOSA_ORG_UNIT_CODE">
