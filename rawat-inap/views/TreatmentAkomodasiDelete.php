...
<?php if ($Page->QUANTITY->Visible) { // QUANTITY ?>
        <th class="<?= $Page->QUANTITY->headerCellClass() ?>"><span id="elh_TREATMENT_AKOMODASI_QUANTITY" class="TREATMENT_AKOMODASI_QUANTITY"><?= $Page->QUANTITY->caption() ?></span></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_TREATMENT_AKOMODASI_QUANTITY" class="TREATMENT_AKOMODASI_QUANTITY">
