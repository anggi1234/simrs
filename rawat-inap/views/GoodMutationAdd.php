...
// Page object
$GoodMutationAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fGOOD_MUTATIONadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fGOOD_MUTATIONadd = currentForm = new ew.Form("fGOOD_MUTATIONadd", "add");
    ...
    // Validate form
    fGOOD_MUTATIONadd.validate = function () {
    ...
    // Form_CustomValidate
    fGOOD_MUTATIONadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fGOOD_MUTATIONadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fGOOD_MUTATIONadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fGOOD_MUTATIONadd" id="fGOOD_MUTATIONadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<span id="el_GOOD_MUTATION_ORG_UNIT_CODE">
...
<span id="el_GOOD_MUTATION_ITEM_ID">
...
<script>
loadjs.ready(["fGOOD_MUTATIONadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fGOOD_MUTATIONadd", "x_EXPIRY_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fGOOD_MUTATIONadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fGOOD_MUTATIONadd", "x_ALLOCATED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fGOOD_MUTATIONadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fGOOD_MUTATIONadd", "x_STOCKOPNAME_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fGOOD_MUTATIONadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fGOOD_MUTATIONadd", "x_MODIFIED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fGOOD_MUTATIONadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fGOOD_MUTATIONadd", "x_PRINT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fGOOD_MUTATIONadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fGOOD_MUTATIONadd", "x_CORRECTION_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
