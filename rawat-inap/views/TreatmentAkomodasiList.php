...
<?php if ($Page->QUANTITY->Visible) { // QUANTITY ?>
        <th data-name="QUANTITY" class="<?= $Page->QUANTITY->headerCellClass() ?>"><div id="elh_TREATMENT_AKOMODASI_QUANTITY" class="TREATMENT_AKOMODASI_QUANTITY"><?= $Page->renderSort($Page->QUANTITY) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_TREATMENT_AKOMODASI_QUANTITY">
