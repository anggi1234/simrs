...
<input type="hidden" name="z_NO_REGISTRATION" id="z_NO_REGISTRATION" value="LIKE">
        ...
        <span id="el_PASIEN_VISITATION_NO_REGISTRATION" class="ew-search-field">
<input type="<?= $Page->NO_REGISTRATION->getInputTextType() ?>" data-table="PASIEN_VISITATION" data-field="x_NO_REGISTRATION" name="x_NO_REGISTRATION" id="x_NO_REGISTRATION" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->NO_REGISTRATION->getPlaceHolder()) ?>" value="<?= $Page->NO_REGISTRATION->EditValue ?>"<?= $Page->NO_REGISTRATION->editAttributes() ?>>
...
<div id="xsr_<?= $Page->SearchRowCount ?>" class="ew-row d-sm-flex">
    <?php
     ...
     ?>
    <div id="xsc_DIANTAR_OLEH" class="ew-cell form-group">
        <label for="x_DIANTAR_OLEH" class="ew-search-caption ew-label"><?= $Page->DIANTAR_OLEH->caption() ?></label>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_DIANTAR_OLEH" id="z_DIANTAR_OLEH" value="LIKE">
</span>
        <span id="el_PASIEN_VISITATION_DIANTAR_OLEH" class="ew-search-field">
...
?>
<?php if ($Page->NO_REGISTRATION->Visible) { // NO_REGISTRATION ?>
        <th data-name="NO_REGISTRATION" class="<?= $Page->NO_REGISTRATION->headerCellClass() ?>"><div id="elh_PASIEN_VISITATION_NO_REGISTRATION" class="PASIEN_VISITATION_NO_REGISTRATION"><?= $Page->renderSort($Page->NO_REGISTRATION) ?></div></th>
<?php } ?>
<?php if ($Page->DIANTAR_OLEH->Visible) { // DIANTAR_OLEH ?>
        <th data-name="DIANTAR_OLEH" class="<?= $Page->DIANTAR_OLEH->headerCellClass() ?>"><div id="elh_PASIEN_VISITATION_DIANTAR_OLEH" class="PASIEN_VISITATION_DIANTAR_OLEH"><?= $Page->renderSort($Page->DIANTAR_OLEH) ?></div></th>
<?php } ?>
<?php if ($Page->STATUS_PASIEN_ID->Visible) { // STATUS_PASIEN_ID ?>
        <th data-name="STATUS_PASIEN_ID" class="<?= $Page->STATUS_PASIEN_ID->headerCellClass() ?>"><div id="elh_PASIEN_VISITATION_STATUS_PASIEN_ID" class="PASIEN_VISITATION_STATUS_PASIEN_ID"><?= $Page->renderSort($Page->STATUS_PASIEN_ID) ?></div></th>
<?php } ?>
...
<?php if ($Page->CLINIC_ID->Visible) { // CLINIC_ID ?>
        <th data-name="CLINIC_ID" class="<?= $Page->CLINIC_ID->headerCellClass() ?>"><div id="elh_PASIEN_VISITATION_CLINIC_ID" class="PASIEN_VISITATION_CLINIC_ID"><?= $Page->renderSort($Page->CLINIC_ID) ?></div></th>
<?php } ?>
<?php if ($Page->GENDER->Visible) { // GENDER ?>
        <th data-name="GENDER" class="<?= $Page->GENDER->headerCellClass() ?>"><div id="elh_PASIEN_VISITATION_GENDER" class="PASIEN_VISITATION_GENDER"><?= $Page->renderSort($Page->GENDER) ?></div></th>
<?php } ?>
<?php if ($Page->VISITOR_ADDRESS->Visible) { // VISITOR_ADDRESS ?>
        <th data-name="VISITOR_ADDRESS" class="<?= $Page->VISITOR_ADDRESS->headerCellClass() ?>"><div id="elh_PASIEN_VISITATION_VISITOR_ADDRESS" class="PASIEN_VISITATION_VISITOR_ADDRESS"><?= $Page->renderSort($Page->VISITOR_ADDRESS) ?></div></th>
<?php } ?>
<?php if ($Page->KELUAR_ID->Visible) { // KELUAR_ID ?>
        <th data-name="KELUAR_ID" class="<?= $Page->KELUAR_ID->headerCellClass() ?>"><div id="elh_PASIEN_VISITATION_KELUAR_ID" class="PASIEN_VISITATION_KELUAR_ID"><?= $Page->renderSort($Page->KELUAR_ID) ?></div></th>
<?php } ?>
<?php if ($Page->EMPLOYEE_ID->Visible) { // EMPLOYEE_ID ?>
        <th data-name="EMPLOYEE_ID" class="<?= $Page->EMPLOYEE_ID->headerCellClass() ?>"><div id="elh_PASIEN_VISITATION_EMPLOYEE_ID" class="PASIEN_VISITATION_EMPLOYEE_ID"><?= $Page->renderSort($Page->EMPLOYEE_ID) ?></div></th>
<?php } ?>
<?php if ($Page->AGEYEAR->Visible) { // AGEYEAR ?>
        <th data-name="AGEYEAR" class="<?= $Page->AGEYEAR->headerCellClass() ?>"><div id="elh_PASIEN_VISITATION_AGEYEAR" class="PASIEN_VISITATION_AGEYEAR"><?= $Page->renderSort($Page->AGEYEAR) ?></div></th>
<?php } ?>
<?php if ($Page->IDXDAFTAR->Visible) { // IDXDAFTAR ?>
        <th data-name="IDXDAFTAR" class="<?= $Page->IDXDAFTAR->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_PASIEN_VISITATION_IDXDAFTAR" class="PASIEN_VISITATION_IDXDAFTAR"><?= $Page->renderSort($Page->IDXDAFTAR) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_PASIEN_VISITATION_KELUAR_ID">
...
<span id="el<?= $Page->RowCount ?>_PASIEN_VISITATION_IDXDAFTAR">
