...
<?php if ($Page->EXIT_DATE->Visible) { // EXIT_DATE ?>
    <tr id="r_EXIT_DATE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_EXIT_DATE"><?= $Page->EXIT_DATE->caption() ?></span></td>
...
?>
<?php
    if (in_array("OBSTETRI", explode(",", $Page->getCurrentDetailTable())) && $OBSTETRI->DetailView) {
