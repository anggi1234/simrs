...
var fWEBSITE_MENUadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fWEBSITE_MENUadd = currentForm = new ew.Form("fWEBSITE_MENUadd", "add");
    ...
    // Validate form
    fWEBSITE_MENUadd.validate = function () {
    ...
    // Form_CustomValidate
    fWEBSITE_MENUadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fWEBSITE_MENUadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fWEBSITE_MENUadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fWEBSITE_MENUadd" id="fWEBSITE_MENUadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
