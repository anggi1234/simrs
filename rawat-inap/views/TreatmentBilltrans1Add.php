...
// Page object
$TreatmentBilltrans1Add = &$Page;
?>
<script>
var currentForm, currentPageID;
var fTREATMENT_BILLTRANS1add;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fTREATMENT_BILLTRANS1add = currentForm = new ew.Form("fTREATMENT_BILLTRANS1add", "add");
    ...
    fTREATMENT_BILLTRANS1add.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fTREATMENT_BILLTRANS1add,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fTREATMENT_BILLTRANS1add.validate = function () {
    ...
    // Form_CustomValidate
    fTREATMENT_BILLTRANS1add.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fTREATMENT_BILLTRANS1add.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fTREATMENT_BILLTRANS1add");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fTREATMENT_BILLTRANS1add" id="fTREATMENT_BILLTRANS1add" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fTREATMENT_BILLTRANS1add", "datetimepicker"], function() {
    ew.createDateTimePicker("fTREATMENT_BILLTRANS1add", "x_TREAT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fTREATMENT_BILLTRANS1add", "datetimepicker"], function() {
    ew.createDateTimePicker("fTREATMENT_BILLTRANS1add", "x_PAYMENT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fTREATMENT_BILLTRANS1add", "datetimepicker"], function() {
    ew.createDateTimePicker("fTREATMENT_BILLTRANS1add", "x_DUEDATE_ANGSURAN", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fTREATMENT_BILLTRANS1add", "datetimepicker"], function() {
    ew.createDateTimePicker("fTREATMENT_BILLTRANS1add", "x_PRINT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fTREATMENT_BILLTRANS1add", "datetimepicker"], function() {
    ew.createDateTimePicker("fTREATMENT_BILLTRANS1add", "x_MODIFIED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fTREATMENT_BILLTRANS1add", "datetimepicker"], function() {
    ew.createDateTimePicker("fTREATMENT_BILLTRANS1add", "x_EXIT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
