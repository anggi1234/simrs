...
// Page object
$TreatmentTypeAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fTREATMENT_TYPEadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fTREATMENT_TYPEadd = currentForm = new ew.Form("fTREATMENT_TYPEadd", "add");
    ...
    // Validate form
    fTREATMENT_TYPEadd.validate = function () {
    ...
    // Form_CustomValidate
    fTREATMENT_TYPEadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fTREATMENT_TYPEadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fTREATMENT_TYPEadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fTREATMENT_TYPEadd" id="fTREATMENT_TYPEadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
