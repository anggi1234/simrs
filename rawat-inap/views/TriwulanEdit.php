...
loadjs.ready("head", function () {
    ...
    ftriwulanedit = currentForm = new ew.Form("ftriwulanedit", "edit");
    ...
    // Form_CustomValidate
    ftriwulanedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    ftriwulanedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("ftriwulanedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="ftriwulanedit" id="ftriwulanedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="triwulan" data-field="x_triwulan" data-hidden="1" name="o_triwulan" id="o_triwulan" value="<?= HtmlEncode($Page->triwulan->OldValue ?? $Page->triwulan->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["ftriwulanedit", "datetimepicker"], function() {
    ew.createDateTimePicker("ftriwulanedit", "x_mulai", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["ftriwulanedit", "datetimepicker"], function() {
    ew.createDateTimePicker("ftriwulanedit", "x_akhir", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
