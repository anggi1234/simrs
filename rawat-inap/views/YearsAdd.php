...
loadjs.ready("head", function () {
    ...
    // Form_CustomValidate
    fYEARSadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fYEARSadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="fYEARSadd" id="fYEARSadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fYEARSadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fYEARSadd", "x_START_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fYEARSadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fYEARSadd", "x_END_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
