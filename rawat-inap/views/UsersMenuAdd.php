...
loadjs.ready("head", function () {
    ...
    fUSERS_MENUadd = currentForm = new ew.Form("fUSERS_MENUadd", "add");
    ...
    // Validate form
    fUSERS_MENUadd.validate = function () {
    ...
    // Form_CustomValidate
    fUSERS_MENUadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fUSERS_MENUadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fUSERS_MENUadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fUSERS_MENUadd" id="fUSERS_MENUadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fUSERS_MENUadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fUSERS_MENUadd", "x_MODIFIED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
