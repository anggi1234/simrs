...
<?php if ($Page->MUTATION_BY->Visible) { // MUTATION_BY ?>
    <tr id="r_MUTATION_BY">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_MUTATION_DOCS_MUTATION_BY"><?= $Page->MUTATION_BY->caption() ?></span></td>
...
<?php if ($Page->ID->Visible) { // ID ?>
    <tr id="r_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_MUTATION_DOCS_ID"><?= $Page->ID->caption() ?></span></td>
