...
loadjs.ready("head", function () {
    ...
    fVACTINATIONadd = currentForm = new ew.Form("fVACTINATIONadd", "add");
    ...
    // Validate form
    fVACTINATIONadd.validate = function () {
    ...
    // Form_CustomValidate
    fVACTINATIONadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fVACTINATIONadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fVACTINATIONadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fVACTINATIONadd" id="fVACTINATIONadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fVACTINATIONadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fVACTINATIONadd", "x_VACTINATION_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fVACTINATIONadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fVACTINATIONadd", "x_MODIFIED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
