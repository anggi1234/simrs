...
<?php } ?>
<?php if ($PASIEN_VISITATION->STATUS_PASIEN_ID->Visible) { // STATUS_PASIEN_ID ?>
        <tr id="r_STATUS_PASIEN_ID">
            <td class="<?= $PASIEN_VISITATION->TableLeftColumnClass ?>"><?= $PASIEN_VISITATION->STATUS_PASIEN_ID->caption() ?></td>
            <td <?= $PASIEN_VISITATION->STATUS_PASIEN_ID->cellAttributes() ?>>
<span id="el_PASIEN_VISITATION_STATUS_PASIEN_ID">
<span<?= $PASIEN_VISITATION->STATUS_PASIEN_ID->viewAttributes() ?>>
<?= $PASIEN_VISITATION->STATUS_PASIEN_ID->getViewValue() ?></span>
</span>
</td>
        </tr>
<?php } ?>
...
<?php } ?>
<?php if ($PASIEN_VISITATION->KELUAR_ID->Visible) { // KELUAR_ID ?>
        <tr id="r_KELUAR_ID">
            <td class="<?= $PASIEN_VISITATION->TableLeftColumnClass ?>"><?= $PASIEN_VISITATION->KELUAR_ID->caption() ?></td>
            <td <?= $PASIEN_VISITATION->KELUAR_ID->cellAttributes() ?>>
<span id="el_PASIEN_VISITATION_KELUAR_ID">
<span<?= $PASIEN_VISITATION->KELUAR_ID->viewAttributes() ?>>
<?= $PASIEN_VISITATION->KELUAR_ID->getViewValue() ?></span>
</span>
</td>
        </tr>
<?php } ?>
