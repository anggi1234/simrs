...
// Page object
$VisitReasonEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fVISIT_REASONedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fVISIT_REASONedit = currentForm = new ew.Form("fVISIT_REASONedit", "edit");
    ...
    // Validate form
    fVISIT_REASONedit.validate = function () {
    ...
    // Form_CustomValidate
    fVISIT_REASONedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fVISIT_REASONedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fVISIT_REASONedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fVISIT_REASONedit" id="fVISIT_REASONedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="VISIT_REASON" data-field="x_REASON_ID" data-hidden="1" name="o_REASON_ID" id="o_REASON_ID" value="<?= HtmlEncode($Page->REASON_ID->OldValue ?? $Page->REASON_ID->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
