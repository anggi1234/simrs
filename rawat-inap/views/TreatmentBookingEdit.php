...
// Page object
$TreatmentBookingEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fTREATMENT_BOOKINGedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fTREATMENT_BOOKINGedit = currentForm = new ew.Form("fTREATMENT_BOOKINGedit", "edit");
    ...
    fTREATMENT_BOOKINGedit.addFields([
    ...
    // Validate form
    fTREATMENT_BOOKINGedit.validate = function () {
    ...
    // Form_CustomValidate
    fTREATMENT_BOOKINGedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fTREATMENT_BOOKINGedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fTREATMENT_BOOKINGedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fTREATMENT_BOOKINGedit" id="fTREATMENT_BOOKINGedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="TREATMENT_BOOKING" data-field="x_ORG_UNIT_CODE" data-hidden="1" name="o_ORG_UNIT_CODE" id="o_ORG_UNIT_CODE" value="<?= HtmlEncode($Page->ORG_UNIT_CODE->OldValue ?? $Page->ORG_UNIT_CODE->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<input type="hidden" data-table="TREATMENT_BOOKING" data-field="x_BILL_ID" data-hidden="1" name="o_BILL_ID" id="o_BILL_ID" value="<?= HtmlEncode($Page->BILL_ID->OldValue ?? $Page->BILL_ID->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["fTREATMENT_BOOKINGedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fTREATMENT_BOOKINGedit", "x_TREAT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fTREATMENT_BOOKINGedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fTREATMENT_BOOKINGedit", "x_EXIT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fTREATMENT_BOOKINGedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fTREATMENT_BOOKINGedit", "x_MODIFIED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
