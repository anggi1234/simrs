...
loadjs.ready("head", function () {
    ...
    fVISIT_TYPEedit = currentForm = new ew.Form("fVISIT_TYPEedit", "edit");
    ...
    // Validate form
    fVISIT_TYPEedit.validate = function () {
    ...
    // Form_CustomValidate
    fVISIT_TYPEedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fVISIT_TYPEedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fVISIT_TYPEedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fVISIT_TYPEedit" id="fVISIT_TYPEedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="VISIT_TYPE" data-field="x_ISNEW" data-hidden="1" name="o_ISNEW" id="o_ISNEW" value="<?= HtmlEncode($Page->ISNEW->OldValue ?? $Page->ISNEW->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
