...
// Page object
$GoodMutationView = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fGOOD_MUTATIONview;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "view";
    fGOOD_MUTATIONview = currentForm = new ew.Form("fGOOD_MUTATIONview", "view");
    loadjs.done("fGOOD_MUTATIONview");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fGOOD_MUTATIONview" id="fGOOD_MUTATIONview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->ORG_UNIT_CODE->Visible) { // ORG_UNIT_CODE ?>
    <tr id="r_ORG_UNIT_CODE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_ORG_UNIT_CODE"><?= $Page->ORG_UNIT_CODE->caption() ?></span></td>
...
<?php if ($Page->ITEM_ID->Visible) { // ITEM_ID ?>
    <tr id="r_ITEM_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_ITEM_ID"><?= $Page->ITEM_ID->caption() ?></span></td>
...
<?php if ($Page->ORG_ID->Visible) { // ORG_ID ?>
    <tr id="r_ORG_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_ORG_ID"><?= $Page->ORG_ID->caption() ?></span></td>
...
<?php if ($Page->RETUR_ID->Visible) { // RETUR_ID ?>
    <tr id="r_RETUR_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_RETUR_ID"><?= $Page->RETUR_ID->caption() ?></span></td>
...
<?php if ($Page->ORDER_ID->Visible) { // ORDER_ID ?>
    <tr id="r_ORDER_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_ORDER_ID"><?= $Page->ORDER_ID->caption() ?></span></td>
...
<?php if ($Page->BATCH_NO->Visible) { // BATCH_NO ?>
    <tr id="r_BATCH_NO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_BATCH_NO"><?= $Page->BATCH_NO->caption() ?></span></td>
...
<?php if ($Page->BRAND_ID->Visible) { // BRAND_ID ?>
    <tr id="r_BRAND_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_BRAND_ID"><?= $Page->BRAND_ID->caption() ?></span></td>
...
<?php if ($Page->ROOMS_ID->Visible) { // ROOMS_ID ?>
    <tr id="r_ROOMS_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_ROOMS_ID"><?= $Page->ROOMS_ID->caption() ?></span></td>
...
<?php if ($Page->SHELF_NO->Visible) { // SHELF_NO ?>
    <tr id="r_SHELF_NO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_SHELF_NO"><?= $Page->SHELF_NO->caption() ?></span></td>
...
<?php if ($Page->EXPIRY_DATE->Visible) { // EXPIRY_DATE ?>
    <tr id="r_EXPIRY_DATE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_EXPIRY_DATE"><?= $Page->EXPIRY_DATE->caption() ?></span></td>
...
<?php if ($Page->SERIAL_NB->Visible) { // SERIAL_NB ?>
    <tr id="r_SERIAL_NB">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_SERIAL_NB"><?= $Page->SERIAL_NB->caption() ?></span></td>
...
<?php if ($Page->FROM_ROOMS_ID->Visible) { // FROM_ROOMS_ID ?>
    <tr id="r_FROM_ROOMS_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_FROM_ROOMS_ID"><?= $Page->FROM_ROOMS_ID->caption() ?></span></td>
...
<?php if ($Page->ISOUTLET->Visible) { // ISOUTLET ?>
    <tr id="r_ISOUTLET">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_ISOUTLET"><?= $Page->ISOUTLET->caption() ?></span></td>
...
<?php if ($Page->QUANTITY->Visible) { // QUANTITY ?>
    <tr id="r_QUANTITY">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_QUANTITY"><?= $Page->QUANTITY->caption() ?></span></td>
...
<?php if ($Page->MEASURE_ID->Visible) { // MEASURE_ID ?>
    <tr id="r_MEASURE_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_MEASURE_ID"><?= $Page->MEASURE_ID->caption() ?></span></td>
...
<?php if ($Page->DISTRIBUTION_TYPE->Visible) { // DISTRIBUTION_TYPE ?>
    <tr id="r_DISTRIBUTION_TYPE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_DISTRIBUTION_TYPE"><?= $Page->DISTRIBUTION_TYPE->caption() ?></span></td>
...
<?php if ($Page->CONDITION->Visible) { // CONDITION ?>
    <tr id="r_CONDITION">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_CONDITION"><?= $Page->CONDITION->caption() ?></span></td>
...
<?php if ($Page->ALLOCATED_DATE->Visible) { // ALLOCATED_DATE ?>
    <tr id="r_ALLOCATED_DATE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_ALLOCATED_DATE"><?= $Page->ALLOCATED_DATE->caption() ?></span></td>
...
<?php if ($Page->STOCKOPNAME_DATE->Visible) { // STOCKOPNAME_DATE ?>
    <tr id="r_STOCKOPNAME_DATE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_STOCKOPNAME_DATE"><?= $Page->STOCKOPNAME_DATE->caption() ?></span></td>
...
<?php if ($Page->INVOICE_ID->Visible) { // INVOICE_ID ?>
    <tr id="r_INVOICE_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_INVOICE_ID"><?= $Page->INVOICE_ID->caption() ?></span></td>
...
<?php if ($Page->ALLOCATED_FROM->Visible) { // ALLOCATED_FROM ?>
    <tr id="r_ALLOCATED_FROM">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_ALLOCATED_FROM"><?= $Page->ALLOCATED_FROM->caption() ?></span></td>
...
<?php if ($Page->PRICE->Visible) { // PRICE ?>
    <tr id="r_PRICE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_PRICE"><?= $Page->PRICE->caption() ?></span></td>
...
<?php if ($Page->ITEM_ID_FROM->Visible) { // ITEM_ID_FROM ?>
    <tr id="r_ITEM_ID_FROM">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_ITEM_ID_FROM"><?= $Page->ITEM_ID_FROM->caption() ?></span></td>
...
<?php if ($Page->MODIFIED_DATE->Visible) { // MODIFIED_DATE ?>
    <tr id="r_MODIFIED_DATE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_MODIFIED_DATE"><?= $Page->MODIFIED_DATE->caption() ?></span></td>
...
<?php if ($Page->MODIFIED_BY->Visible) { // MODIFIED_BY ?>
    <tr id="r_MODIFIED_BY">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_MODIFIED_BY"><?= $Page->MODIFIED_BY->caption() ?></span></td>
...
<?php if ($Page->STOCK_OPNAME->Visible) { // STOCK_OPNAME ?>
    <tr id="r_STOCK_OPNAME">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_STOCK_OPNAME"><?= $Page->STOCK_OPNAME->caption() ?></span></td>
...
<?php if ($Page->STOK_AWAL->Visible) { // STOK_AWAL ?>
    <tr id="r_STOK_AWAL">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_STOK_AWAL"><?= $Page->STOK_AWAL->caption() ?></span></td>
...
<?php if ($Page->STOCK_LALU->Visible) { // STOCK_LALU ?>
    <tr id="r_STOCK_LALU">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_STOCK_LALU"><?= $Page->STOCK_LALU->caption() ?></span></td>
...
<?php if ($Page->STOCK_KOREKSI->Visible) { // STOCK_KOREKSI ?>
    <tr id="r_STOCK_KOREKSI">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_STOCK_KOREKSI"><?= $Page->STOCK_KOREKSI->caption() ?></span></td>
...
<?php if ($Page->DITERIMA->Visible) { // DITERIMA ?>
    <tr id="r_DITERIMA">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_DITERIMA"><?= $Page->DITERIMA->caption() ?></span></td>
...
<?php if ($Page->DISTRIBUSI->Visible) { // DISTRIBUSI ?>
    <tr id="r_DISTRIBUSI">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_DISTRIBUSI"><?= $Page->DISTRIBUSI->caption() ?></span></td>
...
<?php if ($Page->DIJUAL->Visible) { // DIJUAL ?>
    <tr id="r_DIJUAL">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_DIJUAL"><?= $Page->DIJUAL->caption() ?></span></td>
...
<?php if ($Page->DIHAPUS->Visible) { // DIHAPUS ?>
    <tr id="r_DIHAPUS">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_DIHAPUS"><?= $Page->DIHAPUS->caption() ?></span></td>
...
<?php if ($Page->DIMINTA->Visible) { // DIMINTA ?>
    <tr id="r_DIMINTA">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_DIMINTA"><?= $Page->DIMINTA->caption() ?></span></td>
...
<?php if ($Page->DIRETUR->Visible) { // DIRETUR ?>
    <tr id="r_DIRETUR">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_DIRETUR"><?= $Page->DIRETUR->caption() ?></span></td>
...
<?php if ($Page->PO->Visible) { // PO ?>
    <tr id="r_PO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_PO"><?= $Page->PO->caption() ?></span></td>
...
<?php if ($Page->COMPANY_ID->Visible) { // COMPANY_ID ?>
    <tr id="r_COMPANY_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_COMPANY_ID"><?= $Page->COMPANY_ID->caption() ?></span></td>
...
<?php if ($Page->FUND_ID->Visible) { // FUND_ID ?>
    <tr id="r_FUND_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_FUND_ID"><?= $Page->FUND_ID->caption() ?></span></td>
...
<?php if ($Page->INVOICE_ID2->Visible) { // INVOICE_ID2 ?>
    <tr id="r_INVOICE_ID2">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_INVOICE_ID2"><?= $Page->INVOICE_ID2->caption() ?></span></td>
...
<?php if ($Page->MEASURE_ID3->Visible) { // MEASURE_ID3 ?>
    <tr id="r_MEASURE_ID3">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_MEASURE_ID3"><?= $Page->MEASURE_ID3->caption() ?></span></td>
...
<?php if ($Page->SIZE_KEMASAN->Visible) { // SIZE_KEMASAN ?>
    <tr id="r_SIZE_KEMASAN">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_SIZE_KEMASAN"><?= $Page->SIZE_KEMASAN->caption() ?></span></td>
...
<?php if ($Page->BRAND_NAME->Visible) { // BRAND_NAME ?>
    <tr id="r_BRAND_NAME">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_BRAND_NAME"><?= $Page->BRAND_NAME->caption() ?></span></td>
...
<?php if ($Page->MEASURE_ID2->Visible) { // MEASURE_ID2 ?>
    <tr id="r_MEASURE_ID2">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_MEASURE_ID2"><?= $Page->MEASURE_ID2->caption() ?></span></td>
...
<?php if ($Page->SIZE_GOODS->Visible) { // SIZE_GOODS ?>
    <tr id="r_SIZE_GOODS">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_SIZE_GOODS"><?= $Page->SIZE_GOODS->caption() ?></span></td>
...
<?php if ($Page->MEASURE_DOSIS->Visible) { // MEASURE_DOSIS ?>
    <tr id="r_MEASURE_DOSIS">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_MEASURE_DOSIS"><?= $Page->MEASURE_DOSIS->caption() ?></span></td>
...
<?php if ($Page->DOC_NO->Visible) { // DOC_NO ?>
    <tr id="r_DOC_NO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_DOC_NO"><?= $Page->DOC_NO->caption() ?></span></td>
...
<?php if ($Page->ORDER_PRICE->Visible) { // ORDER_PRICE ?>
    <tr id="r_ORDER_PRICE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_ORDER_PRICE"><?= $Page->ORDER_PRICE->caption() ?></span></td>
...
<?php if ($Page->ISCETAK->Visible) { // ISCETAK ?>
    <tr id="r_ISCETAK">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_ISCETAK"><?= $Page->ISCETAK->caption() ?></span></td>
...
<?php if ($Page->PRINT_DATE->Visible) { // PRINT_DATE ?>
    <tr id="r_PRINT_DATE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_PRINT_DATE"><?= $Page->PRINT_DATE->caption() ?></span></td>
...
<?php if ($Page->PRINTED_BY->Visible) { // PRINTED_BY ?>
    <tr id="r_PRINTED_BY">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_PRINTED_BY"><?= $Page->PRINTED_BY->caption() ?></span></td>
...
<?php if ($Page->PRINTQ->Visible) { // PRINTQ ?>
    <tr id="r_PRINTQ">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_PRINTQ"><?= $Page->PRINTQ->caption() ?></span></td>
...
<?php if ($Page->STOCK_AVAILABLE->Visible) { // STOCK_AVAILABLE ?>
    <tr id="r_STOCK_AVAILABLE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_STOCK_AVAILABLE"><?= $Page->STOCK_AVAILABLE->caption() ?></span></td>
...
<?php if ($Page->STATUS_PASIEN_ID->Visible) { // STATUS_PASIEN_ID ?>
    <tr id="r_STATUS_PASIEN_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_STATUS_PASIEN_ID"><?= $Page->STATUS_PASIEN_ID->caption() ?></span></td>
...
<?php if ($Page->MONTH_ID->Visible) { // MONTH_ID ?>
    <tr id="r_MONTH_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_MONTH_ID"><?= $Page->MONTH_ID->caption() ?></span></td>
...
<?php if ($Page->YEAR_ID->Visible) { // YEAR_ID ?>
    <tr id="r_YEAR_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_YEAR_ID"><?= $Page->YEAR_ID->caption() ?></span></td>
...
<?php if ($Page->CORRECTION_DOC->Visible) { // CORRECTION_DOC ?>
    <tr id="r_CORRECTION_DOC">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_CORRECTION_DOC"><?= $Page->CORRECTION_DOC->caption() ?></span></td>
...
<?php if ($Page->CORRECTIONS->Visible) { // CORRECTIONS ?>
    <tr id="r_CORRECTIONS">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_CORRECTIONS"><?= $Page->CORRECTIONS->caption() ?></span></td>
...
<?php if ($Page->CORRECTION_DATE->Visible) { // CORRECTION_DATE ?>
    <tr id="r_CORRECTION_DATE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_CORRECTION_DATE"><?= $Page->CORRECTION_DATE->caption() ?></span></td>
...
<?php if ($Page->DISCOUNT->Visible) { // DISCOUNT ?>
    <tr id="r_DISCOUNT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_DISCOUNT"><?= $Page->DISCOUNT->caption() ?></span></td>
...
<?php if ($Page->DISCOUNT2->Visible) { // DISCOUNT2 ?>
    <tr id="r_DISCOUNT2">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_DISCOUNT2"><?= $Page->DISCOUNT2->caption() ?></span></td>
...
<?php if ($Page->ORG_UNIT_FROM->Visible) { // ORG_UNIT_FROM ?>
    <tr id="r_ORG_UNIT_FROM">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_ORG_UNIT_FROM"><?= $Page->ORG_UNIT_FROM->caption() ?></span></td>
...
<?php if ($Page->DISCOUNTOFF->Visible) { // DISCOUNTOFF ?>
    <tr id="r_DISCOUNTOFF">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_DISCOUNTOFF"><?= $Page->DISCOUNTOFF->caption() ?></span></td>
...
<?php if ($Page->avgprice->Visible) { // avgprice ?>
    <tr id="r_avgprice">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_avgprice"><?= $Page->avgprice->caption() ?></span></td>
...
<?php if ($Page->idx->Visible) { // idx ?>
    <tr id="r_idx">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_GOOD_MUTATION_idx"><?= $Page->idx->caption() ?></span></td>
