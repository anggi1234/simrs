...
<?php if ($Page->ORG_UNIT_CODE->Visible) { // ORG_UNIT_CODE ?>
        <th data-name="ORG_UNIT_CODE" class="<?= $Page->ORG_UNIT_CODE->headerCellClass() ?>"><div id="elh_V_PASIENVISITATIONRJ_ORG_UNIT_CODE" class="V_PASIENVISITATIONRJ_ORG_UNIT_CODE"><?= $Page->renderSort($Page->ORG_UNIT_CODE) ?></div></th>
<?php } ?>
<?php if ($Page->date_of_birth->Visible) { // date_of_birth ?>
        <th data-name="date_of_birth" class="<?= $Page->date_of_birth->headerCellClass() ?>"><div id="elh_V_PASIENVISITATIONRJ_date_of_birth" class="V_PASIENVISITATIONRJ_date_of_birth"><?= $Page->renderSort($Page->date_of_birth) ?></div></th>
<?php } ?>
...
<?php if ($Page->PHONE_NUMBER->Visible) { // PHONE_NUMBER ?>
        <th data-name="PHONE_NUMBER" class="<?= $Page->PHONE_NUMBER->headerCellClass() ?>"><div id="elh_V_PASIENVISITATIONRJ_PHONE_NUMBER" class="V_PASIENVISITATIONRJ_PHONE_NUMBER"><?= $Page->renderSort($Page->PHONE_NUMBER) ?></div></th>
<?php } ?>
<?php if ($Page->MOBILE->Visible) { // MOBILE ?>
        <th data-name="MOBILE" class="<?= $Page->MOBILE->headerCellClass() ?>"><div id="elh_V_PASIENVISITATIONRJ_MOBILE" class="V_PASIENVISITATIONRJ_MOBILE"><?= $Page->renderSort($Page->MOBILE) ?></div></th>
<?php } ?>
<?php if ($Page->KAL_ID->Visible) { // KAL_ID ?>
        <th data-name="KAL_ID" class="<?= $Page->KAL_ID->headerCellClass() ?>"><div id="elh_V_PASIENVISITATIONRJ_KAL_ID" class="V_PASIENVISITATIONRJ_KAL_ID"><?= $Page->renderSort($Page->KAL_ID) ?></div></th>
<?php } ?>
<?php if ($Page->PLACE_OF_BIRTH->Visible) { // PLACE_OF_BIRTH ?>
        <th data-name="PLACE_OF_BIRTH" class="<?= $Page->PLACE_OF_BIRTH->headerCellClass() ?>"><div id="elh_V_PASIENVISITATIONRJ_PLACE_OF_BIRTH" class="V_PASIENVISITATIONRJ_PLACE_OF_BIRTH"><?= $Page->renderSort($Page->PLACE_OF_BIRTH) ?></div></th>
<?php } ?>
<?php if ($Page->KALURAHAN->Visible) { // KALURAHAN ?>
        <th data-name="KALURAHAN" class="<?= $Page->KALURAHAN->headerCellClass() ?>"><div id="elh_V_PASIENVISITATIONRJ_KALURAHAN" class="V_PASIENVISITATIONRJ_KALURAHAN"><?= $Page->renderSort($Page->KALURAHAN) ?></div></th>
<?php } ?>
<?php if ($Page->clinic_id->Visible) { // clinic_id ?>
        <th data-name="clinic_id" class="<?= $Page->clinic_id->headerCellClass() ?>"><div id="elh_V_PASIENVISITATIONRJ_clinic_id" class="V_PASIENVISITATIONRJ_clinic_id"><?= $Page->renderSort($Page->clinic_id) ?></div></th>
<?php } ?>
...
<?php if ($Page->clinic_id_from->Visible) { // clinic_id_from ?>
        <th data-name="clinic_id_from" class="<?= $Page->clinic_id_from->headerCellClass() ?>"><div id="elh_V_PASIENVISITATIONRJ_clinic_id_from" class="V_PASIENVISITATIONRJ_clinic_id_from"><?= $Page->renderSort($Page->clinic_id_from) ?></div></th>
<?php } ?>
...
<?php if ($Page->employee_id->Visible) { // employee_id ?>
        <th data-name="employee_id" class="<?= $Page->employee_id->headerCellClass() ?>"><div id="elh_V_PASIENVISITATIONRJ_employee_id" class="V_PASIENVISITATIONRJ_employee_id"><?= $Page->renderSort($Page->employee_id) ?></div></th>
<?php } ?>
<?php if ($Page->employee_id_from->Visible) { // employee_id_from ?>
        <th data-name="employee_id_from" class="<?= $Page->employee_id_from->headerCellClass() ?>"><div id="elh_V_PASIENVISITATIONRJ_employee_id_from" class="V_PASIENVISITATIONRJ_employee_id_from"><?= $Page->renderSort($Page->employee_id_from) ?></div></th>
<?php } ?>
<?php if ($Page->booked_Date->Visible) { // booked_Date ?>
        <th data-name="booked_Date" class="<?= $Page->booked_Date->headerCellClass() ?>"><div id="elh_V_PASIENVISITATIONRJ_booked_Date" class="V_PASIENVISITATIONRJ_booked_Date"><?= $Page->renderSort($Page->booked_Date) ?></div></th>
<?php } ?>
...
<?php if ($Page->visit_id->Visible) { // visit_id ?>
        <th data-name="visit_id" class="<?= $Page->visit_id->headerCellClass() ?>"><div id="elh_V_PASIENVISITATIONRJ_visit_id" class="V_PASIENVISITATIONRJ_visit_id"><?= $Page->renderSort($Page->visit_id) ?></div></th>
<?php } ?>
<?php if ($Page->isattended->Visible) { // isattended ?>
        <th data-name="isattended" class="<?= $Page->isattended->headerCellClass() ?>"><div id="elh_V_PASIENVISITATIONRJ_isattended" class="V_PASIENVISITATIONRJ_isattended"><?= $Page->renderSort($Page->isattended) ?></div></th>
<?php } ?>
<?php if ($Page->diantar_oleh->Visible) { // diantar_oleh ?>
        <th data-name="diantar_oleh" class="<?= $Page->diantar_oleh->headerCellClass() ?>"><div id="elh_V_PASIENVISITATIONRJ_diantar_oleh" class="V_PASIENVISITATIONRJ_diantar_oleh"><?= $Page->renderSort($Page->diantar_oleh) ?></div></th>
<?php } ?>
<?php if ($Page->visitor_address->Visible) { // visitor_address ?>
        <th data-name="visitor_address" class="<?= $Page->visitor_address->headerCellClass() ?>"><div id="elh_V_PASIENVISITATIONRJ_visitor_address" class="V_PASIENVISITATIONRJ_visitor_address"><?= $Page->renderSort($Page->visitor_address) ?></div></th>
<?php } ?>
<?php if ($Page->address_of_rujukan->Visible) { // address_of_rujukan ?>
        <th data-name="address_of_rujukan" class="<?= $Page->address_of_rujukan->headerCellClass() ?>"><div id="elh_V_PASIENVISITATIONRJ_address_of_rujukan" class="V_PASIENVISITATIONRJ_address_of_rujukan"><?= $Page->renderSort($Page->address_of_rujukan) ?></div></th>
<?php } ?>
<?php if ($Page->rujukan_id->Visible) { // rujukan_id ?>
        <th data-name="rujukan_id" class="<?= $Page->rujukan_id->headerCellClass() ?>"><div id="elh_V_PASIENVISITATIONRJ_rujukan_id" class="V_PASIENVISITATIONRJ_rujukan_id"><?= $Page->renderSort($Page->rujukan_id) ?></div></th>
<?php } ?>
<?php if ($Page->DESCRIPTION->Visible) { // DESCRIPTION ?>
        <th data-name="DESCRIPTION" class="<?= $Page->DESCRIPTION->headerCellClass() ?>"><div id="elh_V_PASIENVISITATIONRJ_DESCRIPTION" class="V_PASIENVISITATIONRJ_DESCRIPTION"><?= $Page->renderSort($Page->DESCRIPTION) ?></div></th>
<?php } ?>
<?php if ($Page->patient_category_id->Visible) { // patient_category_id ?>
        <th data-name="patient_category_id" class="<?= $Page->patient_category_id->headerCellClass() ?>"><div id="elh_V_PASIENVISITATIONRJ_patient_category_id" class="V_PASIENVISITATIONRJ_patient_category_id"><?= $Page->renderSort($Page->patient_category_id) ?></div></th>
<?php } ?>
<?php if ($Page->payor_id->Visible) { // payor_id ?>
        <th data-name="payor_id" class="<?= $Page->payor_id->headerCellClass() ?>"><div id="elh_V_PASIENVISITATIONRJ_payor_id" class="V_PASIENVISITATIONRJ_payor_id"><?= $Page->renderSort($Page->payor_id) ?></div></th>
<?php } ?>
<?php if ($Page->reason_id->Visible) { // reason_id ?>
        <th data-name="reason_id" class="<?= $Page->reason_id->headerCellClass() ?>"><div id="elh_V_PASIENVISITATIONRJ_reason_id" class="V_PASIENVISITATIONRJ_reason_id"><?= $Page->renderSort($Page->reason_id) ?></div></th>
<?php } ?>
<?php if ($Page->STATUS_PASIEN_ID->Visible) { // STATUS_PASIEN_ID ?>
        <th data-name="STATUS_PASIEN_ID" class="<?= $Page->STATUS_PASIEN_ID->headerCellClass() ?>"><div id="elh_V_PASIENVISITATIONRJ_STATUS_PASIEN_ID" class="V_PASIENVISITATIONRJ_STATUS_PASIEN_ID"><?= $Page->renderSort($Page->STATUS_PASIEN_ID) ?></div></th>
<?php } ?>
<?php if ($Page->way_id->Visible) { // way_id ?>
        <th data-name="way_id" class="<?= $Page->way_id->headerCellClass() ?>"><div id="elh_V_PASIENVISITATIONRJ_way_id" class="V_PASIENVISITATIONRJ_way_id"><?= $Page->renderSort($Page->way_id) ?></div></th>
<?php } ?>
<?php if ($Page->follow_up->Visible) { // follow_up ?>
        <th data-name="follow_up" class="<?= $Page->follow_up->headerCellClass() ?>"><div id="elh_V_PASIENVISITATIONRJ_follow_up" class="V_PASIENVISITATIONRJ_follow_up"><?= $Page->renderSort($Page->follow_up) ?></div></th>
<?php } ?>
<?php if ($Page->isnew->Visible) { // isnew ?>
        <th data-name="isnew" class="<?= $Page->isnew->headerCellClass() ?>"><div id="elh_V_PASIENVISITATIONRJ_isnew" class="V_PASIENVISITATIONRJ_isnew"><?= $Page->renderSort($Page->isnew) ?></div></th>
<?php } ?>
<?php if ($Page->family_status_id->Visible) { // family_status_id ?>
        <th data-name="family_status_id" class="<?= $Page->family_status_id->headerCellClass() ?>"><div id="elh_V_PASIENVISITATIONRJ_family_status_id" class="V_PASIENVISITATIONRJ_family_status_id"><?= $Page->renderSort($Page->family_status_id) ?></div></th>
<?php } ?>
<?php if ($Page->urutan->Visible) { // urutan ?>
        <th data-name="urutan" class="<?= $Page->urutan->headerCellClass() ?>"><div id="elh_V_PASIENVISITATIONRJ_urutan" class="V_PASIENVISITATIONRJ_urutan"><?= $Page->renderSort($Page->urutan) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_V_PASIENVISITATIONRJ_ORG_UNIT_CODE">
...
<span id="el<?= $Page->RowCount ?>_V_PASIENVISITATIONRJ_date_of_birth">
...
<span id="el<?= $Page->RowCount ?>_V_PASIENVISITATIONRJ_PHONE_NUMBER">
...
<span id="el<?= $Page->RowCount ?>_V_PASIENVISITATIONRJ_MOBILE">
...
<span id="el<?= $Page->RowCount ?>_V_PASIENVISITATIONRJ_KAL_ID">
...
<span id="el<?= $Page->RowCount ?>_V_PASIENVISITATIONRJ_PLACE_OF_BIRTH">
...
<span id="el<?= $Page->RowCount ?>_V_PASIENVISITATIONRJ_KALURAHAN">
...
<span id="el<?= $Page->RowCount ?>_V_PASIENVISITATIONRJ_clinic_id">
...
<span id="el<?= $Page->RowCount ?>_V_PASIENVISITATIONRJ_clinic_id_from">
...
<span id="el<?= $Page->RowCount ?>_V_PASIENVISITATIONRJ_employee_id">
...
<span id="el<?= $Page->RowCount ?>_V_PASIENVISITATIONRJ_employee_id_from">
...
<span id="el<?= $Page->RowCount ?>_V_PASIENVISITATIONRJ_booked_Date">
...
<span id="el<?= $Page->RowCount ?>_V_PASIENVISITATIONRJ_visit_id">
...
<span id="el<?= $Page->RowCount ?>_V_PASIENVISITATIONRJ_isattended">
...
<span id="el<?= $Page->RowCount ?>_V_PASIENVISITATIONRJ_diantar_oleh">
...
<span id="el<?= $Page->RowCount ?>_V_PASIENVISITATIONRJ_visitor_address">
...
<span id="el<?= $Page->RowCount ?>_V_PASIENVISITATIONRJ_address_of_rujukan">
...
<span id="el<?= $Page->RowCount ?>_V_PASIENVISITATIONRJ_rujukan_id">
...
<span id="el<?= $Page->RowCount ?>_V_PASIENVISITATIONRJ_DESCRIPTION">
...
<span id="el<?= $Page->RowCount ?>_V_PASIENVISITATIONRJ_patient_category_id">
...
<span id="el<?= $Page->RowCount ?>_V_PASIENVISITATIONRJ_payor_id">
...
<span id="el<?= $Page->RowCount ?>_V_PASIENVISITATIONRJ_reason_id">
...
<span id="el<?= $Page->RowCount ?>_V_PASIENVISITATIONRJ_STATUS_PASIEN_ID">
...
<span id="el<?= $Page->RowCount ?>_V_PASIENVISITATIONRJ_way_id">
...
<span id="el<?= $Page->RowCount ?>_V_PASIENVISITATIONRJ_follow_up">
...
<span id="el<?= $Page->RowCount ?>_V_PASIENVISITATIONRJ_isnew">
...
<span id="el<?= $Page->RowCount ?>_V_PASIENVISITATIONRJ_family_status_id">
...
<span id="el<?= $Page->RowCount ?>_V_PASIENVISITATIONRJ_urutan">
