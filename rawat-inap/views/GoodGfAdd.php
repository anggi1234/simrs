...
<?php } ?>
    ...
    <?php if (strval($Page->FROM_ROOMS_ID->getSessionValue()) != "") { ?>
    <input type="hidden" name="x_FROM_ROOMS_ID" id="x_FROM_ROOMS_ID" value="<?= HtmlEncode(strval($Page->FROM_ROOMS_ID->getSessionValue())) ?>">
    <?php } ?>
