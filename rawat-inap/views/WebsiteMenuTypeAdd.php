...
// Page object
$WebsiteMenuTypeAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fWEBSITE_MENU_TYPEadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fWEBSITE_MENU_TYPEadd = currentForm = new ew.Form("fWEBSITE_MENU_TYPEadd", "add");
    ...
    fWEBSITE_MENU_TYPEadd.addFields([
    ...
    // Validate form
    fWEBSITE_MENU_TYPEadd.validate = function () {
    ...
    // Form_CustomValidate
    fWEBSITE_MENU_TYPEadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fWEBSITE_MENU_TYPEadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fWEBSITE_MENU_TYPEadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fWEBSITE_MENU_TYPEadd" id="fWEBSITE_MENU_TYPEadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
