...
// Page object
$GoodMutationEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fGOOD_MUTATIONedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fGOOD_MUTATIONedit = currentForm = new ew.Form("fGOOD_MUTATIONedit", "edit");

    // Add fields
    var currentTable = <?= JsonEncode(GetClientVar("tables", "GOOD_MUTATION")) ?>,
        fields = currentTable.fields;
    if (!ew.vars.tables.GOOD_MUTATION)
        ew.vars.tables.GOOD_MUTATION = currentTable;
    fGOOD_MUTATIONedit.addFields([
        ...
        ["idx", [fields.idx.visible && fields.idx.required ? ew.Validators.required(fields.idx.caption) : null, ew.Validators.integer], fields.idx.isInvalid]
    ]);

    // Set invalid fields
    $(function() {
        var f = fGOOD_MUTATIONedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fGOOD_MUTATIONedit.validate = function () {
    ...
    // Form_CustomValidate
    fGOOD_MUTATIONedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fGOOD_MUTATIONedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fGOOD_MUTATIONedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fGOOD_MUTATIONedit" id="fGOOD_MUTATIONedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->ORG_UNIT_CODE->Visible) { // ORG_UNIT_CODE ?>
    <div id="r_ORG_UNIT_CODE" class="form-group row">
        <label id="elh_GOOD_MUTATION_ORG_UNIT_CODE" for="x_ORG_UNIT_CODE" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ORG_UNIT_CODE->caption() ?><?= $Page->ORG_UNIT_CODE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ORG_UNIT_CODE->cellAttributes() ?>>
<input type="<?= $Page->ORG_UNIT_CODE->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_ORG_UNIT_CODE" name="x_ORG_UNIT_CODE" id="x_ORG_UNIT_CODE" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->ORG_UNIT_CODE->getPlaceHolder()) ?>" value="<?= $Page->ORG_UNIT_CODE->EditValue ?>"<?= $Page->ORG_UNIT_CODE->editAttributes() ?> aria-describedby="x_ORG_UNIT_CODE_help">
<?= $Page->ORG_UNIT_CODE->getCustomMessage() ?>
<div class="invalid-feedback"><?= $Page->ORG_UNIT_CODE->getErrorMessage() ?></div>
<input type="hidden" data-table="GOOD_MUTATION" data-field="x_ORG_UNIT_CODE" data-hidden="1" name="o_ORG_UNIT_CODE" id="o_ORG_UNIT_CODE" value="<?= HtmlEncode($Page->ORG_UNIT_CODE->OldValue ?? $Page->ORG_UNIT_CODE->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->ITEM_ID->Visible) { // ITEM_ID ?>
    <div id="r_ITEM_ID" class="form-group row">
        <label id="elh_GOOD_MUTATION_ITEM_ID" for="x_ITEM_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ITEM_ID->caption() ?><?= $Page->ITEM_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ITEM_ID->cellAttributes() ?>>
<input type="<?= $Page->ITEM_ID->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_ITEM_ID" name="x_ITEM_ID" id="x_ITEM_ID" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->ITEM_ID->getPlaceHolder()) ?>" value="<?= $Page->ITEM_ID->EditValue ?>"<?= $Page->ITEM_ID->editAttributes() ?> aria-describedby="x_ITEM_ID_help">
<?= $Page->ITEM_ID->getCustomMessage() ?>
<div class="invalid-feedback"><?= $Page->ITEM_ID->getErrorMessage() ?></div>
<input type="hidden" data-table="GOOD_MUTATION" data-field="x_ITEM_ID" data-hidden="1" name="o_ITEM_ID" id="o_ITEM_ID" value="<?= HtmlEncode($Page->ITEM_ID->OldValue ?? $Page->ITEM_ID->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->ORG_ID->Visible) { // ORG_ID ?>
    <div id="r_ORG_ID" class="form-group row">
        <label id="elh_GOOD_MUTATION_ORG_ID" for="x_ORG_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ORG_ID->caption() ?><?= $Page->ORG_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ORG_ID->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_ORG_ID">
<input type="<?= $Page->ORG_ID->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_ORG_ID" name="x_ORG_ID" id="x_ORG_ID" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->ORG_ID->getPlaceHolder()) ?>" value="<?= $Page->ORG_ID->EditValue ?>"<?= $Page->ORG_ID->editAttributes() ?> aria-describedby="x_ORG_ID_help">
...
<?php if ($Page->RETUR_ID->Visible) { // RETUR_ID ?>
    <div id="r_RETUR_ID" class="form-group row">
        <label id="elh_GOOD_MUTATION_RETUR_ID" for="x_RETUR_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->RETUR_ID->caption() ?><?= $Page->RETUR_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->RETUR_ID->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_RETUR_ID">
<input type="<?= $Page->RETUR_ID->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_RETUR_ID" name="x_RETUR_ID" id="x_RETUR_ID" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->RETUR_ID->getPlaceHolder()) ?>" value="<?= $Page->RETUR_ID->EditValue ?>"<?= $Page->RETUR_ID->editAttributes() ?> aria-describedby="x_RETUR_ID_help">
...
<?php if ($Page->ORDER_ID->Visible) { // ORDER_ID ?>
    <div id="r_ORDER_ID" class="form-group row">
        <label id="elh_GOOD_MUTATION_ORDER_ID" for="x_ORDER_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ORDER_ID->caption() ?><?= $Page->ORDER_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ORDER_ID->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_ORDER_ID">
<input type="<?= $Page->ORDER_ID->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_ORDER_ID" name="x_ORDER_ID" id="x_ORDER_ID" size="30" maxlength="15" placeholder="<?= HtmlEncode($Page->ORDER_ID->getPlaceHolder()) ?>" value="<?= $Page->ORDER_ID->EditValue ?>"<?= $Page->ORDER_ID->editAttributes() ?> aria-describedby="x_ORDER_ID_help">
...
<?php if ($Page->BATCH_NO->Visible) { // BATCH_NO ?>
    <div id="r_BATCH_NO" class="form-group row">
        <label id="elh_GOOD_MUTATION_BATCH_NO" for="x_BATCH_NO" class="<?= $Page->LeftColumnClass ?>"><?= $Page->BATCH_NO->caption() ?><?= $Page->BATCH_NO->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->BATCH_NO->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_BATCH_NO">
<input type="<?= $Page->BATCH_NO->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_BATCH_NO" name="x_BATCH_NO" id="x_BATCH_NO" size="30" maxlength="75" placeholder="<?= HtmlEncode($Page->BATCH_NO->getPlaceHolder()) ?>" value="<?= $Page->BATCH_NO->EditValue ?>"<?= $Page->BATCH_NO->editAttributes() ?> aria-describedby="x_BATCH_NO_help">
...
<?php if ($Page->BRAND_ID->Visible) { // BRAND_ID ?>
    <div id="r_BRAND_ID" class="form-group row">
        <label id="elh_GOOD_MUTATION_BRAND_ID" for="x_BRAND_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->BRAND_ID->caption() ?><?= $Page->BRAND_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->BRAND_ID->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_BRAND_ID">
<input type="<?= $Page->BRAND_ID->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_BRAND_ID" name="x_BRAND_ID" id="x_BRAND_ID" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->BRAND_ID->getPlaceHolder()) ?>" value="<?= $Page->BRAND_ID->EditValue ?>"<?= $Page->BRAND_ID->editAttributes() ?> aria-describedby="x_BRAND_ID_help">
...
<?php if ($Page->ROOMS_ID->Visible) { // ROOMS_ID ?>
    <div id="r_ROOMS_ID" class="form-group row">
        <label id="elh_GOOD_MUTATION_ROOMS_ID" for="x_ROOMS_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ROOMS_ID->caption() ?><?= $Page->ROOMS_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ROOMS_ID->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_ROOMS_ID">
<input type="<?= $Page->ROOMS_ID->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_ROOMS_ID" name="x_ROOMS_ID" id="x_ROOMS_ID" size="30" maxlength="10" placeholder="<?= HtmlEncode($Page->ROOMS_ID->getPlaceHolder()) ?>" value="<?= $Page->ROOMS_ID->EditValue ?>"<?= $Page->ROOMS_ID->editAttributes() ?> aria-describedby="x_ROOMS_ID_help">
...
<?php if ($Page->SHELF_NO->Visible) { // SHELF_NO ?>
    <div id="r_SHELF_NO" class="form-group row">
        <label id="elh_GOOD_MUTATION_SHELF_NO" for="x_SHELF_NO" class="<?= $Page->LeftColumnClass ?>"><?= $Page->SHELF_NO->caption() ?><?= $Page->SHELF_NO->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->SHELF_NO->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_SHELF_NO">
<input type="<?= $Page->SHELF_NO->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_SHELF_NO" name="x_SHELF_NO" id="x_SHELF_NO" size="30" placeholder="<?= HtmlEncode($Page->SHELF_NO->getPlaceHolder()) ?>" value="<?= $Page->SHELF_NO->EditValue ?>"<?= $Page->SHELF_NO->editAttributes() ?> aria-describedby="x_SHELF_NO_help">
...
<?php if ($Page->EXPIRY_DATE->Visible) { // EXPIRY_DATE ?>
    <div id="r_EXPIRY_DATE" class="form-group row">
        <label id="elh_GOOD_MUTATION_EXPIRY_DATE" for="x_EXPIRY_DATE" class="<?= $Page->LeftColumnClass ?>"><?= $Page->EXPIRY_DATE->caption() ?><?= $Page->EXPIRY_DATE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->EXPIRY_DATE->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_EXPIRY_DATE">
<input type="<?= $Page->EXPIRY_DATE->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_EXPIRY_DATE" name="x_EXPIRY_DATE" id="x_EXPIRY_DATE" placeholder="<?= HtmlEncode($Page->EXPIRY_DATE->getPlaceHolder()) ?>" value="<?= $Page->EXPIRY_DATE->EditValue ?>"<?= $Page->EXPIRY_DATE->editAttributes() ?> aria-describedby="x_EXPIRY_DATE_help">
...
<script>
loadjs.ready(["fGOOD_MUTATIONedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fGOOD_MUTATIONedit", "x_EXPIRY_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->SERIAL_NB->Visible) { // SERIAL_NB ?>
    <div id="r_SERIAL_NB" class="form-group row">
        <label id="elh_GOOD_MUTATION_SERIAL_NB" for="x_SERIAL_NB" class="<?= $Page->LeftColumnClass ?>"><?= $Page->SERIAL_NB->caption() ?><?= $Page->SERIAL_NB->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->SERIAL_NB->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_SERIAL_NB">
<input type="<?= $Page->SERIAL_NB->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_SERIAL_NB" name="x_SERIAL_NB" id="x_SERIAL_NB" size="30" maxlength="200" placeholder="<?= HtmlEncode($Page->SERIAL_NB->getPlaceHolder()) ?>" value="<?= $Page->SERIAL_NB->EditValue ?>"<?= $Page->SERIAL_NB->editAttributes() ?> aria-describedby="x_SERIAL_NB_help">
...
<?php if ($Page->FROM_ROOMS_ID->Visible) { // FROM_ROOMS_ID ?>
    <div id="r_FROM_ROOMS_ID" class="form-group row">
        <label id="elh_GOOD_MUTATION_FROM_ROOMS_ID" for="x_FROM_ROOMS_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->FROM_ROOMS_ID->caption() ?><?= $Page->FROM_ROOMS_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->FROM_ROOMS_ID->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_FROM_ROOMS_ID">
<input type="<?= $Page->FROM_ROOMS_ID->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_FROM_ROOMS_ID" name="x_FROM_ROOMS_ID" id="x_FROM_ROOMS_ID" size="30" maxlength="10" placeholder="<?= HtmlEncode($Page->FROM_ROOMS_ID->getPlaceHolder()) ?>" value="<?= $Page->FROM_ROOMS_ID->EditValue ?>"<?= $Page->FROM_ROOMS_ID->editAttributes() ?> aria-describedby="x_FROM_ROOMS_ID_help">
...
<?php if ($Page->ISOUTLET->Visible) { // ISOUTLET ?>
    <div id="r_ISOUTLET" class="form-group row">
        <label id="elh_GOOD_MUTATION_ISOUTLET" for="x_ISOUTLET" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ISOUTLET->caption() ?><?= $Page->ISOUTLET->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ISOUTLET->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_ISOUTLET">
<input type="<?= $Page->ISOUTLET->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_ISOUTLET" name="x_ISOUTLET" id="x_ISOUTLET" size="30" maxlength="1" placeholder="<?= HtmlEncode($Page->ISOUTLET->getPlaceHolder()) ?>" value="<?= $Page->ISOUTLET->EditValue ?>"<?= $Page->ISOUTLET->editAttributes() ?> aria-describedby="x_ISOUTLET_help">
...
<?php if ($Page->QUANTITY->Visible) { // QUANTITY ?>
    <div id="r_QUANTITY" class="form-group row">
        <label id="elh_GOOD_MUTATION_QUANTITY" for="x_QUANTITY" class="<?= $Page->LeftColumnClass ?>"><?= $Page->QUANTITY->caption() ?><?= $Page->QUANTITY->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->QUANTITY->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_QUANTITY">
<input type="<?= $Page->QUANTITY->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_QUANTITY" name="x_QUANTITY" id="x_QUANTITY" size="30" placeholder="<?= HtmlEncode($Page->QUANTITY->getPlaceHolder()) ?>" value="<?= $Page->QUANTITY->EditValue ?>"<?= $Page->QUANTITY->editAttributes() ?> aria-describedby="x_QUANTITY_help">
...
<?php if ($Page->MEASURE_ID->Visible) { // MEASURE_ID ?>
    <div id="r_MEASURE_ID" class="form-group row">
        <label id="elh_GOOD_MUTATION_MEASURE_ID" for="x_MEASURE_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->MEASURE_ID->caption() ?><?= $Page->MEASURE_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->MEASURE_ID->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_MEASURE_ID">
<input type="<?= $Page->MEASURE_ID->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_MEASURE_ID" name="x_MEASURE_ID" id="x_MEASURE_ID" size="30" placeholder="<?= HtmlEncode($Page->MEASURE_ID->getPlaceHolder()) ?>" value="<?= $Page->MEASURE_ID->EditValue ?>"<?= $Page->MEASURE_ID->editAttributes() ?> aria-describedby="x_MEASURE_ID_help">
...
<?php if ($Page->CONDITION->Visible) { // CONDITION ?>
    <div id="r_CONDITION" class="form-group row">
        <label id="elh_GOOD_MUTATION_CONDITION" for="x_CONDITION" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CONDITION->caption() ?><?= $Page->CONDITION->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CONDITION->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_CONDITION">
<input type="<?= $Page->CONDITION->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_CONDITION" name="x_CONDITION" id="x_CONDITION" size="30" placeholder="<?= HtmlEncode($Page->CONDITION->getPlaceHolder()) ?>" value="<?= $Page->CONDITION->EditValue ?>"<?= $Page->CONDITION->editAttributes() ?> aria-describedby="x_CONDITION_help">
...
<?php if ($Page->ALLOCATED_DATE->Visible) { // ALLOCATED_DATE ?>
    <div id="r_ALLOCATED_DATE" class="form-group row">
        <label id="elh_GOOD_MUTATION_ALLOCATED_DATE" for="x_ALLOCATED_DATE" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ALLOCATED_DATE->caption() ?><?= $Page->ALLOCATED_DATE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ALLOCATED_DATE->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_ALLOCATED_DATE">
<input type="<?= $Page->ALLOCATED_DATE->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_ALLOCATED_DATE" name="x_ALLOCATED_DATE" id="x_ALLOCATED_DATE" placeholder="<?= HtmlEncode($Page->ALLOCATED_DATE->getPlaceHolder()) ?>" value="<?= $Page->ALLOCATED_DATE->EditValue ?>"<?= $Page->ALLOCATED_DATE->editAttributes() ?> aria-describedby="x_ALLOCATED_DATE_help">
...
<script>
loadjs.ready(["fGOOD_MUTATIONedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fGOOD_MUTATIONedit", "x_ALLOCATED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fGOOD_MUTATIONedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fGOOD_MUTATIONedit", "x_STOCKOPNAME_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->INVOICE_ID->Visible) { // INVOICE_ID ?>
    <div id="r_INVOICE_ID" class="form-group row">
        <label id="elh_GOOD_MUTATION_INVOICE_ID" for="x_INVOICE_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->INVOICE_ID->caption() ?><?= $Page->INVOICE_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->INVOICE_ID->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_INVOICE_ID">
<input type="<?= $Page->INVOICE_ID->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_INVOICE_ID" name="x_INVOICE_ID" id="x_INVOICE_ID" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->INVOICE_ID->getPlaceHolder()) ?>" value="<?= $Page->INVOICE_ID->EditValue ?>"<?= $Page->INVOICE_ID->editAttributes() ?> aria-describedby="x_INVOICE_ID_help">
...
<?php if ($Page->PRICE->Visible) { // PRICE ?>
    <div id="r_PRICE" class="form-group row">
        <label id="elh_GOOD_MUTATION_PRICE" for="x_PRICE" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PRICE->caption() ?><?= $Page->PRICE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PRICE->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_PRICE">
<input type="<?= $Page->PRICE->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_PRICE" name="x_PRICE" id="x_PRICE" size="30" placeholder="<?= HtmlEncode($Page->PRICE->getPlaceHolder()) ?>" value="<?= $Page->PRICE->EditValue ?>"<?= $Page->PRICE->editAttributes() ?> aria-describedby="x_PRICE_help">
...
<?php if ($Page->MODIFIED_DATE->Visible) { // MODIFIED_DATE ?>
    <div id="r_MODIFIED_DATE" class="form-group row">
        <label id="elh_GOOD_MUTATION_MODIFIED_DATE" for="x_MODIFIED_DATE" class="<?= $Page->LeftColumnClass ?>"><?= $Page->MODIFIED_DATE->caption() ?><?= $Page->MODIFIED_DATE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->MODIFIED_DATE->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_MODIFIED_DATE">
<input type="<?= $Page->MODIFIED_DATE->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_MODIFIED_DATE" name="x_MODIFIED_DATE" id="x_MODIFIED_DATE" placeholder="<?= HtmlEncode($Page->MODIFIED_DATE->getPlaceHolder()) ?>" value="<?= $Page->MODIFIED_DATE->EditValue ?>"<?= $Page->MODIFIED_DATE->editAttributes() ?> aria-describedby="x_MODIFIED_DATE_help">
...
<script>
loadjs.ready(["fGOOD_MUTATIONedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fGOOD_MUTATIONedit", "x_MODIFIED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->MODIFIED_BY->Visible) { // MODIFIED_BY ?>
    <div id="r_MODIFIED_BY" class="form-group row">
        <label id="elh_GOOD_MUTATION_MODIFIED_BY" for="x_MODIFIED_BY" class="<?= $Page->LeftColumnClass ?>"><?= $Page->MODIFIED_BY->caption() ?><?= $Page->MODIFIED_BY->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->MODIFIED_BY->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_MODIFIED_BY">
...
<?php if ($Page->STOCK_OPNAME->Visible) { // STOCK_OPNAME ?>
    <div id="r_STOCK_OPNAME" class="form-group row">
        <label id="elh_GOOD_MUTATION_STOCK_OPNAME" for="x_STOCK_OPNAME" class="<?= $Page->LeftColumnClass ?>"><?= $Page->STOCK_OPNAME->caption() ?><?= $Page->STOCK_OPNAME->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->STOCK_OPNAME->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_STOCK_OPNAME">
<input type="<?= $Page->STOCK_OPNAME->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_STOCK_OPNAME" name="x_STOCK_OPNAME" id="x_STOCK_OPNAME" size="30" placeholder="<?= HtmlEncode($Page->STOCK_OPNAME->getPlaceHolder()) ?>" value="<?= $Page->STOCK_OPNAME->EditValue ?>"<?= $Page->STOCK_OPNAME->editAttributes() ?> aria-describedby="x_STOCK_OPNAME_help">
...
<?php if ($Page->STOK_AWAL->Visible) { // STOK_AWAL ?>
    <div id="r_STOK_AWAL" class="form-group row">
        <label id="elh_GOOD_MUTATION_STOK_AWAL" for="x_STOK_AWAL" class="<?= $Page->LeftColumnClass ?>"><?= $Page->STOK_AWAL->caption() ?><?= $Page->STOK_AWAL->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->STOK_AWAL->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_STOK_AWAL">
<input type="<?= $Page->STOK_AWAL->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_STOK_AWAL" name="x_STOK_AWAL" id="x_STOK_AWAL" size="30" placeholder="<?= HtmlEncode($Page->STOK_AWAL->getPlaceHolder()) ?>" value="<?= $Page->STOK_AWAL->EditValue ?>"<?= $Page->STOK_AWAL->editAttributes() ?> aria-describedby="x_STOK_AWAL_help">
...
<?php if ($Page->STOCK_LALU->Visible) { // STOCK_LALU ?>
    <div id="r_STOCK_LALU" class="form-group row">
        <label id="elh_GOOD_MUTATION_STOCK_LALU" for="x_STOCK_LALU" class="<?= $Page->LeftColumnClass ?>"><?= $Page->STOCK_LALU->caption() ?><?= $Page->STOCK_LALU->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->STOCK_LALU->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_STOCK_LALU">
<input type="<?= $Page->STOCK_LALU->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_STOCK_LALU" name="x_STOCK_LALU" id="x_STOCK_LALU" size="30" placeholder="<?= HtmlEncode($Page->STOCK_LALU->getPlaceHolder()) ?>" value="<?= $Page->STOCK_LALU->EditValue ?>"<?= $Page->STOCK_LALU->editAttributes() ?> aria-describedby="x_STOCK_LALU_help">
...
<?php if ($Page->STOCK_KOREKSI->Visible) { // STOCK_KOREKSI ?>
    <div id="r_STOCK_KOREKSI" class="form-group row">
        <label id="elh_GOOD_MUTATION_STOCK_KOREKSI" for="x_STOCK_KOREKSI" class="<?= $Page->LeftColumnClass ?>"><?= $Page->STOCK_KOREKSI->caption() ?><?= $Page->STOCK_KOREKSI->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->STOCK_KOREKSI->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_STOCK_KOREKSI">
<input type="<?= $Page->STOCK_KOREKSI->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_STOCK_KOREKSI" name="x_STOCK_KOREKSI" id="x_STOCK_KOREKSI" size="30" placeholder="<?= HtmlEncode($Page->STOCK_KOREKSI->getPlaceHolder()) ?>" value="<?= $Page->STOCK_KOREKSI->EditValue ?>"<?= $Page->STOCK_KOREKSI->editAttributes() ?> aria-describedby="x_STOCK_KOREKSI_help">
...
<?php if ($Page->DITERIMA->Visible) { // DITERIMA ?>
    <div id="r_DITERIMA" class="form-group row">
        <label id="elh_GOOD_MUTATION_DITERIMA" for="x_DITERIMA" class="<?= $Page->LeftColumnClass ?>"><?= $Page->DITERIMA->caption() ?><?= $Page->DITERIMA->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->DITERIMA->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_DITERIMA">
<input type="<?= $Page->DITERIMA->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_DITERIMA" name="x_DITERIMA" id="x_DITERIMA" size="30" placeholder="<?= HtmlEncode($Page->DITERIMA->getPlaceHolder()) ?>" value="<?= $Page->DITERIMA->EditValue ?>"<?= $Page->DITERIMA->editAttributes() ?> aria-describedby="x_DITERIMA_help">
...
<?php if ($Page->DISTRIBUSI->Visible) { // DISTRIBUSI ?>
    <div id="r_DISTRIBUSI" class="form-group row">
        <label id="elh_GOOD_MUTATION_DISTRIBUSI" for="x_DISTRIBUSI" class="<?= $Page->LeftColumnClass ?>"><?= $Page->DISTRIBUSI->caption() ?><?= $Page->DISTRIBUSI->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->DISTRIBUSI->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_DISTRIBUSI">
<input type="<?= $Page->DISTRIBUSI->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_DISTRIBUSI" name="x_DISTRIBUSI" id="x_DISTRIBUSI" size="30" placeholder="<?= HtmlEncode($Page->DISTRIBUSI->getPlaceHolder()) ?>" value="<?= $Page->DISTRIBUSI->EditValue ?>"<?= $Page->DISTRIBUSI->editAttributes() ?> aria-describedby="x_DISTRIBUSI_help">
...
<?php if ($Page->DIJUAL->Visible) { // DIJUAL ?>
    <div id="r_DIJUAL" class="form-group row">
        <label id="elh_GOOD_MUTATION_DIJUAL" for="x_DIJUAL" class="<?= $Page->LeftColumnClass ?>"><?= $Page->DIJUAL->caption() ?><?= $Page->DIJUAL->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->DIJUAL->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_DIJUAL">
<input type="<?= $Page->DIJUAL->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_DIJUAL" name="x_DIJUAL" id="x_DIJUAL" size="30" placeholder="<?= HtmlEncode($Page->DIJUAL->getPlaceHolder()) ?>" value="<?= $Page->DIJUAL->EditValue ?>"<?= $Page->DIJUAL->editAttributes() ?> aria-describedby="x_DIJUAL_help">
...
<?php if ($Page->DIHAPUS->Visible) { // DIHAPUS ?>
    <div id="r_DIHAPUS" class="form-group row">
        <label id="elh_GOOD_MUTATION_DIHAPUS" for="x_DIHAPUS" class="<?= $Page->LeftColumnClass ?>"><?= $Page->DIHAPUS->caption() ?><?= $Page->DIHAPUS->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->DIHAPUS->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_DIHAPUS">
<input type="<?= $Page->DIHAPUS->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_DIHAPUS" name="x_DIHAPUS" id="x_DIHAPUS" size="30" placeholder="<?= HtmlEncode($Page->DIHAPUS->getPlaceHolder()) ?>" value="<?= $Page->DIHAPUS->EditValue ?>"<?= $Page->DIHAPUS->editAttributes() ?> aria-describedby="x_DIHAPUS_help">
...
<?php if ($Page->DIMINTA->Visible) { // DIMINTA ?>
    <div id="r_DIMINTA" class="form-group row">
        <label id="elh_GOOD_MUTATION_DIMINTA" for="x_DIMINTA" class="<?= $Page->LeftColumnClass ?>"><?= $Page->DIMINTA->caption() ?><?= $Page->DIMINTA->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->DIMINTA->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_DIMINTA">
<input type="<?= $Page->DIMINTA->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_DIMINTA" name="x_DIMINTA" id="x_DIMINTA" size="30" placeholder="<?= HtmlEncode($Page->DIMINTA->getPlaceHolder()) ?>" value="<?= $Page->DIMINTA->EditValue ?>"<?= $Page->DIMINTA->editAttributes() ?> aria-describedby="x_DIMINTA_help">
...
<?php if ($Page->DIRETUR->Visible) { // DIRETUR ?>
    <div id="r_DIRETUR" class="form-group row">
        <label id="elh_GOOD_MUTATION_DIRETUR" for="x_DIRETUR" class="<?= $Page->LeftColumnClass ?>"><?= $Page->DIRETUR->caption() ?><?= $Page->DIRETUR->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->DIRETUR->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_DIRETUR">
<input type="<?= $Page->DIRETUR->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_DIRETUR" name="x_DIRETUR" id="x_DIRETUR" size="30" placeholder="<?= HtmlEncode($Page->DIRETUR->getPlaceHolder()) ?>" value="<?= $Page->DIRETUR->EditValue ?>"<?= $Page->DIRETUR->editAttributes() ?> aria-describedby="x_DIRETUR_help">
...
<?php if ($Page->PO->Visible) { // PO ?>
    <div id="r_PO" class="form-group row">
        <label id="elh_GOOD_MUTATION_PO" for="x_PO" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PO->caption() ?><?= $Page->PO->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PO->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_PO">
<input type="<?= $Page->PO->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_PO" name="x_PO" id="x_PO" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->PO->getPlaceHolder()) ?>" value="<?= $Page->PO->EditValue ?>"<?= $Page->PO->editAttributes() ?> aria-describedby="x_PO_help">
...
<?php if ($Page->COMPANY_ID->Visible) { // COMPANY_ID ?>
    <div id="r_COMPANY_ID" class="form-group row">
        <label id="elh_GOOD_MUTATION_COMPANY_ID" for="x_COMPANY_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->COMPANY_ID->caption() ?><?= $Page->COMPANY_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->COMPANY_ID->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_COMPANY_ID">
<input type="<?= $Page->COMPANY_ID->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_COMPANY_ID" name="x_COMPANY_ID" id="x_COMPANY_ID" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->COMPANY_ID->getPlaceHolder()) ?>" value="<?= $Page->COMPANY_ID->EditValue ?>"<?= $Page->COMPANY_ID->editAttributes() ?> aria-describedby="x_COMPANY_ID_help">
...
<?php if ($Page->FUND_ID->Visible) { // FUND_ID ?>
    <div id="r_FUND_ID" class="form-group row">
        <label id="elh_GOOD_MUTATION_FUND_ID" for="x_FUND_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->FUND_ID->caption() ?><?= $Page->FUND_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->FUND_ID->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_FUND_ID">
<input type="<?= $Page->FUND_ID->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_FUND_ID" name="x_FUND_ID" id="x_FUND_ID" size="30" placeholder="<?= HtmlEncode($Page->FUND_ID->getPlaceHolder()) ?>" value="<?= $Page->FUND_ID->EditValue ?>"<?= $Page->FUND_ID->editAttributes() ?> aria-describedby="x_FUND_ID_help">
...
<?php if ($Page->INVOICE_ID2->Visible) { // INVOICE_ID2 ?>
    <div id="r_INVOICE_ID2" class="form-group row">
        <label id="elh_GOOD_MUTATION_INVOICE_ID2" for="x_INVOICE_ID2" class="<?= $Page->LeftColumnClass ?>"><?= $Page->INVOICE_ID2->caption() ?><?= $Page->INVOICE_ID2->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->INVOICE_ID2->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_INVOICE_ID2">
<input type="<?= $Page->INVOICE_ID2->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_INVOICE_ID2" name="x_INVOICE_ID2" id="x_INVOICE_ID2" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->INVOICE_ID2->getPlaceHolder()) ?>" value="<?= $Page->INVOICE_ID2->EditValue ?>"<?= $Page->INVOICE_ID2->editAttributes() ?> aria-describedby="x_INVOICE_ID2_help">
...
<?php if ($Page->MEASURE_ID3->Visible) { // MEASURE_ID3 ?>
    <div id="r_MEASURE_ID3" class="form-group row">
        <label id="elh_GOOD_MUTATION_MEASURE_ID3" for="x_MEASURE_ID3" class="<?= $Page->LeftColumnClass ?>"><?= $Page->MEASURE_ID3->caption() ?><?= $Page->MEASURE_ID3->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->MEASURE_ID3->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_MEASURE_ID3">
<input type="<?= $Page->MEASURE_ID3->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_MEASURE_ID3" name="x_MEASURE_ID3" id="x_MEASURE_ID3" size="30" placeholder="<?= HtmlEncode($Page->MEASURE_ID3->getPlaceHolder()) ?>" value="<?= $Page->MEASURE_ID3->EditValue ?>"<?= $Page->MEASURE_ID3->editAttributes() ?> aria-describedby="x_MEASURE_ID3_help">
...
<?php if ($Page->SIZE_KEMASAN->Visible) { // SIZE_KEMASAN ?>
    <div id="r_SIZE_KEMASAN" class="form-group row">
        <label id="elh_GOOD_MUTATION_SIZE_KEMASAN" for="x_SIZE_KEMASAN" class="<?= $Page->LeftColumnClass ?>"><?= $Page->SIZE_KEMASAN->caption() ?><?= $Page->SIZE_KEMASAN->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->SIZE_KEMASAN->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_SIZE_KEMASAN">
<input type="<?= $Page->SIZE_KEMASAN->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_SIZE_KEMASAN" name="x_SIZE_KEMASAN" id="x_SIZE_KEMASAN" size="30" placeholder="<?= HtmlEncode($Page->SIZE_KEMASAN->getPlaceHolder()) ?>" value="<?= $Page->SIZE_KEMASAN->EditValue ?>"<?= $Page->SIZE_KEMASAN->editAttributes() ?> aria-describedby="x_SIZE_KEMASAN_help">
...
<?php if ($Page->BRAND_NAME->Visible) { // BRAND_NAME ?>
    <div id="r_BRAND_NAME" class="form-group row">
        <label id="elh_GOOD_MUTATION_BRAND_NAME" for="x_BRAND_NAME" class="<?= $Page->LeftColumnClass ?>"><?= $Page->BRAND_NAME->caption() ?><?= $Page->BRAND_NAME->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->BRAND_NAME->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_BRAND_NAME">
<input type="<?= $Page->BRAND_NAME->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_BRAND_NAME" name="x_BRAND_NAME" id="x_BRAND_NAME" size="30" maxlength="150" placeholder="<?= HtmlEncode($Page->BRAND_NAME->getPlaceHolder()) ?>" value="<?= $Page->BRAND_NAME->EditValue ?>"<?= $Page->BRAND_NAME->editAttributes() ?> aria-describedby="x_BRAND_NAME_help">
...
<?php if ($Page->MEASURE_ID2->Visible) { // MEASURE_ID2 ?>
    <div id="r_MEASURE_ID2" class="form-group row">
        <label id="elh_GOOD_MUTATION_MEASURE_ID2" for="x_MEASURE_ID2" class="<?= $Page->LeftColumnClass ?>"><?= $Page->MEASURE_ID2->caption() ?><?= $Page->MEASURE_ID2->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->MEASURE_ID2->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_MEASURE_ID2">
<input type="<?= $Page->MEASURE_ID2->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_MEASURE_ID2" name="x_MEASURE_ID2" id="x_MEASURE_ID2" size="30" placeholder="<?= HtmlEncode($Page->MEASURE_ID2->getPlaceHolder()) ?>" value="<?= $Page->MEASURE_ID2->EditValue ?>"<?= $Page->MEASURE_ID2->editAttributes() ?> aria-describedby="x_MEASURE_ID2_help">
...
<?php if ($Page->SIZE_GOODS->Visible) { // SIZE_GOODS ?>
    <div id="r_SIZE_GOODS" class="form-group row">
        <label id="elh_GOOD_MUTATION_SIZE_GOODS" for="x_SIZE_GOODS" class="<?= $Page->LeftColumnClass ?>"><?= $Page->SIZE_GOODS->caption() ?><?= $Page->SIZE_GOODS->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->SIZE_GOODS->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_SIZE_GOODS">
<input type="<?= $Page->SIZE_GOODS->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_SIZE_GOODS" name="x_SIZE_GOODS" id="x_SIZE_GOODS" size="30" placeholder="<?= HtmlEncode($Page->SIZE_GOODS->getPlaceHolder()) ?>" value="<?= $Page->SIZE_GOODS->EditValue ?>"<?= $Page->SIZE_GOODS->editAttributes() ?> aria-describedby="x_SIZE_GOODS_help">
...
<?php if ($Page->MEASURE_DOSIS->Visible) { // MEASURE_DOSIS ?>
    <div id="r_MEASURE_DOSIS" class="form-group row">
        <label id="elh_GOOD_MUTATION_MEASURE_DOSIS" for="x_MEASURE_DOSIS" class="<?= $Page->LeftColumnClass ?>"><?= $Page->MEASURE_DOSIS->caption() ?><?= $Page->MEASURE_DOSIS->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->MEASURE_DOSIS->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_MEASURE_DOSIS">
<input type="<?= $Page->MEASURE_DOSIS->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_MEASURE_DOSIS" name="x_MEASURE_DOSIS" id="x_MEASURE_DOSIS" size="30" placeholder="<?= HtmlEncode($Page->MEASURE_DOSIS->getPlaceHolder()) ?>" value="<?= $Page->MEASURE_DOSIS->EditValue ?>"<?= $Page->MEASURE_DOSIS->editAttributes() ?> aria-describedby="x_MEASURE_DOSIS_help">
...
<?php if ($Page->DOC_NO->Visible) { // DOC_NO ?>
    <div id="r_DOC_NO" class="form-group row">
        <label id="elh_GOOD_MUTATION_DOC_NO" for="x_DOC_NO" class="<?= $Page->LeftColumnClass ?>"><?= $Page->DOC_NO->caption() ?><?= $Page->DOC_NO->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->DOC_NO->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_DOC_NO">
<input type="<?= $Page->DOC_NO->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_DOC_NO" name="x_DOC_NO" id="x_DOC_NO" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->DOC_NO->getPlaceHolder()) ?>" value="<?= $Page->DOC_NO->EditValue ?>"<?= $Page->DOC_NO->editAttributes() ?> aria-describedby="x_DOC_NO_help">
...
<?php if ($Page->ORDER_PRICE->Visible) { // ORDER_PRICE ?>
    <div id="r_ORDER_PRICE" class="form-group row">
        <label id="elh_GOOD_MUTATION_ORDER_PRICE" for="x_ORDER_PRICE" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ORDER_PRICE->caption() ?><?= $Page->ORDER_PRICE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ORDER_PRICE->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_ORDER_PRICE">
<input type="<?= $Page->ORDER_PRICE->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_ORDER_PRICE" name="x_ORDER_PRICE" id="x_ORDER_PRICE" size="30" placeholder="<?= HtmlEncode($Page->ORDER_PRICE->getPlaceHolder()) ?>" value="<?= $Page->ORDER_PRICE->EditValue ?>"<?= $Page->ORDER_PRICE->editAttributes() ?> aria-describedby="x_ORDER_PRICE_help">
...
<?php if ($Page->ISCETAK->Visible) { // ISCETAK ?>
    <div id="r_ISCETAK" class="form-group row">
        <label id="elh_GOOD_MUTATION_ISCETAK" for="x_ISCETAK" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ISCETAK->caption() ?><?= $Page->ISCETAK->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ISCETAK->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_ISCETAK">
<input type="<?= $Page->ISCETAK->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_ISCETAK" name="x_ISCETAK" id="x_ISCETAK" size="30" maxlength="1" placeholder="<?= HtmlEncode($Page->ISCETAK->getPlaceHolder()) ?>" value="<?= $Page->ISCETAK->EditValue ?>"<?= $Page->ISCETAK->editAttributes() ?> aria-describedby="x_ISCETAK_help">
...
<?php if ($Page->PRINT_DATE->Visible) { // PRINT_DATE ?>
    <div id="r_PRINT_DATE" class="form-group row">
        <label id="elh_GOOD_MUTATION_PRINT_DATE" for="x_PRINT_DATE" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PRINT_DATE->caption() ?><?= $Page->PRINT_DATE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PRINT_DATE->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_PRINT_DATE">
<input type="<?= $Page->PRINT_DATE->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_PRINT_DATE" name="x_PRINT_DATE" id="x_PRINT_DATE" placeholder="<?= HtmlEncode($Page->PRINT_DATE->getPlaceHolder()) ?>" value="<?= $Page->PRINT_DATE->EditValue ?>"<?= $Page->PRINT_DATE->editAttributes() ?> aria-describedby="x_PRINT_DATE_help">
...
<script>
loadjs.ready(["fGOOD_MUTATIONedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fGOOD_MUTATIONedit", "x_PRINT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->PRINTED_BY->Visible) { // PRINTED_BY ?>
    <div id="r_PRINTED_BY" class="form-group row">
        <label id="elh_GOOD_MUTATION_PRINTED_BY" for="x_PRINTED_BY" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PRINTED_BY->caption() ?><?= $Page->PRINTED_BY->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PRINTED_BY->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_PRINTED_BY">
<input type="<?= $Page->PRINTED_BY->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_PRINTED_BY" name="x_PRINTED_BY" id="x_PRINTED_BY" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->PRINTED_BY->getPlaceHolder()) ?>" value="<?= $Page->PRINTED_BY->EditValue ?>"<?= $Page->PRINTED_BY->editAttributes() ?> aria-describedby="x_PRINTED_BY_help">
...
<?php if ($Page->PRINTQ->Visible) { // PRINTQ ?>
    <div id="r_PRINTQ" class="form-group row">
        <label id="elh_GOOD_MUTATION_PRINTQ" for="x_PRINTQ" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PRINTQ->caption() ?><?= $Page->PRINTQ->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PRINTQ->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_PRINTQ">
<input type="<?= $Page->PRINTQ->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_PRINTQ" name="x_PRINTQ" id="x_PRINTQ" size="30" placeholder="<?= HtmlEncode($Page->PRINTQ->getPlaceHolder()) ?>" value="<?= $Page->PRINTQ->EditValue ?>"<?= $Page->PRINTQ->editAttributes() ?> aria-describedby="x_PRINTQ_help">
...
<?php if ($Page->STOCK_AVAILABLE->Visible) { // STOCK_AVAILABLE ?>
    <div id="r_STOCK_AVAILABLE" class="form-group row">
        <label id="elh_GOOD_MUTATION_STOCK_AVAILABLE" for="x_STOCK_AVAILABLE" class="<?= $Page->LeftColumnClass ?>"><?= $Page->STOCK_AVAILABLE->caption() ?><?= $Page->STOCK_AVAILABLE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->STOCK_AVAILABLE->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_STOCK_AVAILABLE">
...
<?php if ($Page->MONTH_ID->Visible) { // MONTH_ID ?>
    <div id="r_MONTH_ID" class="form-group row">
        <label id="elh_GOOD_MUTATION_MONTH_ID" for="x_MONTH_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->MONTH_ID->caption() ?><?= $Page->MONTH_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->MONTH_ID->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_MONTH_ID">
<input type="<?= $Page->MONTH_ID->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_MONTH_ID" name="x_MONTH_ID" id="x_MONTH_ID" size="30" placeholder="<?= HtmlEncode($Page->MONTH_ID->getPlaceHolder()) ?>" value="<?= $Page->MONTH_ID->EditValue ?>"<?= $Page->MONTH_ID->editAttributes() ?> aria-describedby="x_MONTH_ID_help">
...
<?php if ($Page->YEAR_ID->Visible) { // YEAR_ID ?>
    <div id="r_YEAR_ID" class="form-group row">
        <label id="elh_GOOD_MUTATION_YEAR_ID" for="x_YEAR_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->YEAR_ID->caption() ?><?= $Page->YEAR_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->YEAR_ID->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_YEAR_ID">
<input type="<?= $Page->YEAR_ID->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_YEAR_ID" name="x_YEAR_ID" id="x_YEAR_ID" size="30" placeholder="<?= HtmlEncode($Page->YEAR_ID->getPlaceHolder()) ?>" value="<?= $Page->YEAR_ID->EditValue ?>"<?= $Page->YEAR_ID->editAttributes() ?> aria-describedby="x_YEAR_ID_help">
...
<?php if ($Page->CORRECTION_DATE->Visible) { // CORRECTION_DATE ?>
    <div id="r_CORRECTION_DATE" class="form-group row">
        <label id="elh_GOOD_MUTATION_CORRECTION_DATE" for="x_CORRECTION_DATE" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CORRECTION_DATE->caption() ?><?= $Page->CORRECTION_DATE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CORRECTION_DATE->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_CORRECTION_DATE">
<input type="<?= $Page->CORRECTION_DATE->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_CORRECTION_DATE" name="x_CORRECTION_DATE" id="x_CORRECTION_DATE" placeholder="<?= HtmlEncode($Page->CORRECTION_DATE->getPlaceHolder()) ?>" value="<?= $Page->CORRECTION_DATE->EditValue ?>"<?= $Page->CORRECTION_DATE->editAttributes() ?> aria-describedby="x_CORRECTION_DATE_help">
<?= $Page->CORRECTION_DATE->getCustomMessage() ?>
<div class="invalid-feedback"><?= $Page->CORRECTION_DATE->getErrorMessage() ?></div>
<?php if (!$Page->CORRECTION_DATE->ReadOnly && !$Page->CORRECTION_DATE->Disabled && !isset($Page->CORRECTION_DATE->EditAttrs["readonly"]) && !isset($Page->CORRECTION_DATE->EditAttrs["disabled"])) { ?>
<script>
loadjs.ready(["fGOOD_MUTATIONedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fGOOD_MUTATIONedit", "x_CORRECTION_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->DISCOUNT->Visible) { // DISCOUNT ?>
    <div id="r_DISCOUNT" class="form-group row">
        <label id="elh_GOOD_MUTATION_DISCOUNT" for="x_DISCOUNT" class="<?= $Page->LeftColumnClass ?>"><?= $Page->DISCOUNT->caption() ?><?= $Page->DISCOUNT->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->DISCOUNT->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_DISCOUNT">
<input type="<?= $Page->DISCOUNT->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_DISCOUNT" name="x_DISCOUNT" id="x_DISCOUNT" size="30" placeholder="<?= HtmlEncode($Page->DISCOUNT->getPlaceHolder()) ?>" value="<?= $Page->DISCOUNT->EditValue ?>"<?= $Page->DISCOUNT->editAttributes() ?> aria-describedby="x_DISCOUNT_help">
...
<?php if ($Page->DISCOUNT2->Visible) { // DISCOUNT2 ?>
    <div id="r_DISCOUNT2" class="form-group row">
        <label id="elh_GOOD_MUTATION_DISCOUNT2" for="x_DISCOUNT2" class="<?= $Page->LeftColumnClass ?>"><?= $Page->DISCOUNT2->caption() ?><?= $Page->DISCOUNT2->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->DISCOUNT2->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_DISCOUNT2">
<input type="<?= $Page->DISCOUNT2->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_DISCOUNT2" name="x_DISCOUNT2" id="x_DISCOUNT2" size="30" placeholder="<?= HtmlEncode($Page->DISCOUNT2->getPlaceHolder()) ?>" value="<?= $Page->DISCOUNT2->EditValue ?>"<?= $Page->DISCOUNT2->editAttributes() ?> aria-describedby="x_DISCOUNT2_help">
...
<?php if ($Page->DISCOUNTOFF->Visible) { // DISCOUNTOFF ?>
    <div id="r_DISCOUNTOFF" class="form-group row">
        <label id="elh_GOOD_MUTATION_DISCOUNTOFF" for="x_DISCOUNTOFF" class="<?= $Page->LeftColumnClass ?>"><?= $Page->DISCOUNTOFF->caption() ?><?= $Page->DISCOUNTOFF->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->DISCOUNTOFF->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_DISCOUNTOFF">
<input type="<?= $Page->DISCOUNTOFF->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_DISCOUNTOFF" name="x_DISCOUNTOFF" id="x_DISCOUNTOFF" size="30" placeholder="<?= HtmlEncode($Page->DISCOUNTOFF->getPlaceHolder()) ?>" value="<?= $Page->DISCOUNTOFF->EditValue ?>"<?= $Page->DISCOUNTOFF->editAttributes() ?> aria-describedby="x_DISCOUNTOFF_help">
...
<?php if ($Page->avgprice->Visible) { // avgprice ?>
    <div id="r_avgprice" class="form-group row">
        <label id="elh_GOOD_MUTATION_avgprice" for="x_avgprice" class="<?= $Page->LeftColumnClass ?>"><?= $Page->avgprice->caption() ?><?= $Page->avgprice->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->avgprice->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_avgprice">
<input type="<?= $Page->avgprice->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_avgprice" name="x_avgprice" id="x_avgprice" size="30" placeholder="<?= HtmlEncode($Page->avgprice->getPlaceHolder()) ?>" value="<?= $Page->avgprice->EditValue ?>"<?= $Page->avgprice->editAttributes() ?> aria-describedby="x_avgprice_help">
...
<?php if ($Page->idx->Visible) { // idx ?>
    <div id="r_idx" class="form-group row">
        <label id="elh_GOOD_MUTATION_idx" for="x_idx" class="<?= $Page->LeftColumnClass ?>"><?= $Page->idx->caption() ?><?= $Page->idx->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->idx->cellAttributes() ?>>
<span id="el_GOOD_MUTATION_idx">
<input type="<?= $Page->idx->getInputTextType() ?>" data-table="GOOD_MUTATION" data-field="x_idx" name="x_idx" id="x_idx" size="30" placeholder="<?= HtmlEncode($Page->idx->getPlaceHolder()) ?>" value="<?= $Page->idx->EditValue ?>"<?= $Page->idx->editAttributes() ?> aria-describedby="x_idx_help">
