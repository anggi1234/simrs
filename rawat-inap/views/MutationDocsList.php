...
<?php if ($Page->DISTRIBUTION_TYPE->Visible) { // DISTRIBUTION_TYPE ?>
        <th data-name="DISTRIBUTION_TYPE" class="<?= $Page->DISTRIBUTION_TYPE->headerCellClass() ?>"><div id="elh_MUTATION_DOCS_DISTRIBUTION_TYPE" class="MUTATION_DOCS_DISTRIBUTION_TYPE"><?= $Page->renderSort($Page->DISTRIBUTION_TYPE) ?></div></th>
<?php } ?>
<?php if ($Page->ID->Visible) { // ID ?>
        <th data-name="ID" class="<?= $Page->ID->headerCellClass() ?>"><div id="elh_MUTATION_DOCS_ID" class="MUTATION_DOCS_ID"><?= $Page->renderSort($Page->ID) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_MUTATION_DOCS_ID">
