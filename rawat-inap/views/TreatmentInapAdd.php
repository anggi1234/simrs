...
// Page object
$TreatmentInapAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fTREATMENT_INAPadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fTREATMENT_INAPadd = currentForm = new ew.Form("fTREATMENT_INAPadd", "add");
    ...
    // Validate form
    fTREATMENT_INAPadd.validate = function () {
    ...
    // Form_CustomValidate
    fTREATMENT_INAPadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fTREATMENT_INAPadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fTREATMENT_INAPadd.lists.NO_REGISTRATION = <?= $Page->NO_REGISTRATION->toClientList($Page) ?>;
    fTREATMENT_INAPadd.lists.TARIF_ID = <?= $Page->TARIF_ID->toClientList($Page) ?>;
    loadjs.done("fTREATMENT_INAPadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fTREATMENT_INAPadd" id="fTREATMENT_INAPadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->NO_REGISTRATION->Visible) { // NO_REGISTRATION ?>
    <div id="r_NO_REGISTRATION" class="form-group row">
        <label id="elh_TREATMENT_INAP_NO_REGISTRATION" for="x_NO_REGISTRATION" class="<?= $Page->LeftColumnClass ?>"><?= $Page->NO_REGISTRATION->caption() ?><?= $Page->NO_REGISTRATION->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->NO_REGISTRATION->cellAttributes() ?>>
<?php if ($Page->NO_REGISTRATION->getSessionValue() != "") { ?>
<span id="el_TREATMENT_INAP_NO_REGISTRATION">
...
<script>
loadjs.ready(["fTREATMENT_INAPadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fTREATMENT_INAPadd", "x_PRINT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
