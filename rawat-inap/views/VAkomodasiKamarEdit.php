...
loadjs.ready("head", function () {
    ...
    fV_AKOMODASI_KAMARedit.lists.CLASS_ROOM_ID = <?= $Page->CLASS_ROOM_ID->toClientList($Page) ?>;
    fV_AKOMODASI_KAMARedit.lists.KELUAR_ID = <?= $Page->KELUAR_ID->toClientList($Page) ?>;
    fV_AKOMODASI_KAMARedit.lists.BED_ID = <?= $Page->BED_ID->toClientList($Page) ?>;
    fV_AKOMODASI_KAMARedit.lists.EMPLOYEE_ID = <?= $Page->EMPLOYEE_ID->toClientList($Page) ?>;
...
<input type="hidden" data-table="V_AKOMODASI_KAMAR" data-field="x_TREATMENT" data-hidden="1" name="x_TREATMENT" id="x_TREATMENT" value="<?= HtmlEncode($Page->TREATMENT->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<input type="hidden" data-table="V_AKOMODASI_KAMAR" data-field="x_TREAT_DATE" data-hidden="1" name="x_TREAT_DATE" id="x_TREAT_DATE" value="<?= HtmlEncode($Page->TREAT_DATE->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
