...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "SIMRSSQLSERVERRAWATINAP"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{A8247593-7AB1-4063-96EC-65D23DBC1338}"); // Project ID
