...
<?php if ($Page->PAYMENT_DATE->Visible) { // PAYMENT_DATE ?>
        <th data-name="PAYMENT_DATE" class="<?= $Page->PAYMENT_DATE->headerCellClass() ?>"><div id="elh_TREATMENT_BILL_PAYMENT_DATE" class="TREATMENT_BILL_PAYMENT_DATE"><?= $Page->renderSort($Page->PAYMENT_DATE) ?></div></th>
<?php } ?>
<?php if ($Page->ISLUNAS->Visible) { // ISLUNAS ?>
        <th data-name="ISLUNAS" class="<?= $Page->ISLUNAS->headerCellClass() ?>"><div id="elh_TREATMENT_BILL_ISLUNAS" class="TREATMENT_BILL_ISLUNAS"><?= $Page->renderSort($Page->ISLUNAS) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_TREATMENT_BILL_PAYMENT_DATE">
...
?>
    ...
    <?php } ?>
    <?php if ($Page->PAYMENT_DATE->Visible) { // PAYMENT_DATE ?>
        <td data-name="PAYMENT_DATE" class="<?= $Page->PAYMENT_DATE->footerCellClass() ?>"><span id="elf_TREATMENT_BILL_PAYMENT_DATE" class="TREATMENT_BILL_PAYMENT_DATE">
        &nbsp;
        </span></td>
    <?php } ?>
    <?php if ($Page->ISLUNAS->Visible) { // ISLUNAS ?>
