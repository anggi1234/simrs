...
$sideMenu->addMenuItem(4288, "mi_V_KUNJUNGAN_PASIEN", $MenuLanguage->MenuPhrase("4288", "MenuText"), $MenuRelativePath . "VKunjunganPasienList", 1413, "", AllowListMenu('{67E7B67B-A753-4E5E-ACF9-6EF1B38EF4E3}V_KUNJUNGAN_PASIEN'), false, false, "", "", false);
$sideMenu->addMenuItem(6287, "mi_V_RAWAT_INAP", $MenuLanguage->MenuPhrase("6287", "MenuText"), $MenuRelativePath . "VRawatInapList", 1413, "", AllowListMenu('{67E7B67B-A753-4E5E-ACF9-6EF1B38EF4E3}V_RAWAT_INAP'), false, false, "", "", false);
$sideMenu->addMenuItem(76, "mi_CLASS_ROOM", $MenuLanguage->MenuPhrase("76", "MenuText"), $MenuRelativePath . "ClassRoomList", 1413, "", AllowListMenu('{67E7B67B-A753-4E5E-ACF9-6EF1B38EF4E3}CLASS_ROOM'), false, false, "", "", false);
$sideMenu->addMenuItem(5273, "mci_Laporan", $MenuLanguage->MenuPhrase("5273", "MenuText"), "", 1413, "", IsLoggedIn(), false, true, "", "", false);
$sideMenu->addMenuItem(6285, "mi_register_ranap", $MenuLanguage->MenuPhrase("6285", "MenuText"), $MenuRelativePath . "RegisterRanap", 5273, "", AllowListMenu('{67E7B67B-A753-4E5E-ACF9-6EF1B38EF4E3}register_ranap'), false, false, "", "", false);
$sideMenu->addMenuItem(6277, "mi_V_LABORATORIUM", $MenuLanguage->MenuPhrase("6277", "MenuText"), $MenuRelativePath . "VLaboratoriumList", 3804, "", AllowListMenu('{67E7B67B-A753-4E5E-ACF9-6EF1B38EF4E3}V_LABORATORIUM'), false, false, "", "", false);
$sideMenu->addMenuItem(6278, "mi_V_RADIOLOGI", $MenuLanguage->MenuPhrase("6278", "MenuText"), $MenuRelativePath . "VRadiologiList", 4281, "", AllowListMenu('{67E7B67B-A753-4E5E-ACF9-6EF1B38EF4E3}V_RADIOLOGI'), false, false, "", "", false);
$sideMenu->addMenuItem(6274, "mi_V_FARMASI", $MenuLanguage->MenuPhrase("6274", "MenuText"), $MenuRelativePath . "VFarmasiList", 1881, "", AllowListMenu('{67E7B67B-A753-4E5E-ACF9-6EF1B38EF4E3}V_FARMASI'), false, false, "", "", false);
$sideMenu->addMenuItem(1880, "mci_Kasir", $MenuLanguage->MenuPhrase("1880", "MenuText"), "", -1, "", IsLoggedIn(), false, true, "", "", false);
$sideMenu->addMenuItem(6275, "mi_V_KASIR", $MenuLanguage->MenuPhrase("6275", "MenuText"), $MenuRelativePath . "VKasirList", 1880, "", AllowListMenu('{67E7B67B-A753-4E5E-ACF9-6EF1B38EF4E3}V_KASIR'), false, false, "", "", false);
$sideMenu->addMenuItem(6276, "mi_V_REKAM_MEDIS", $MenuLanguage->MenuPhrase("6276", "MenuText"), $MenuRelativePath . "VRekamMedisList", 2363, "", AllowListMenu('{67E7B67B-A753-4E5E-ACF9-6EF1B38EF4E3}V_REKAM_MEDIS'), false, false, "", "", false);
$sideMenu->addMenuItem(6268, "mi_V_RIWAYAT_RM", $MenuLanguage->MenuPhrase("6268", "MenuText"), $MenuRelativePath . "VRiwayatRmList", 2363, "", AllowListMenu('{67E7B67B-A753-4E5E-ACF9-6EF1B38EF4E3}V_RIWAYAT_RM'), false, false, "", "", false);
$sideMenu->addMenuItem(6261, "mci_Laporan", $MenuLanguage->MenuPhrase("6261", "MenuText"), "", 2363, "", IsLoggedIn(), false, true, "", "", false);
$sideMenu->addMenuItem(5762, "mi_penyakit_menular", $MenuLanguage->MenuPhrase("5762", "MenuText"), $MenuRelativePath . "PenyakitMenular", 6261, "", AllowListMenu('{67E7B67B-A753-4E5E-ACF9-6EF1B38EF4E3}penyakit_menular'), false, false, "", "", false);
$sideMenu->addMenuItem(6265, "mi_mata_dan_syaraf", $MenuLanguage->MenuPhrase("6265", "MenuText"), $MenuRelativePath . "MataDanSyaraf", 6261, "", AllowListMenu('{67E7B67B-A753-4E5E-ACF9-6EF1B38EF4E3}mata_dan_syaraf'), false, false, "", "", false);
$sideMenu->addMenuItem(6263, "mci_Master", $MenuLanguage->MenuPhrase("6263", "MenuText"), "", 2363, "", IsLoggedIn(), false, true, "", "", false);
$sideMenu->addMenuItem(123, "mi_DIAGNOSA", $MenuLanguage->MenuPhrase("123", "MenuText"), $MenuRelativePath . "DiagnosaList", 6263, "", AllowListMenu('{67E7B67B-A753-4E5E-ACF9-6EF1B38EF4E3}DIAGNOSA'), false, false, "", "", false);
$sideMenu->addMenuItem(4787, "mci_Master", $MenuLanguage->MenuPhrase("4787", "MenuText"), "", 1882, "", IsLoggedIn(), false, true, "", "", false);
$sideMenu->addMenuItem(4284, "mi_l_set_cssd", $MenuLanguage->MenuPhrase("4284", "MenuText"), $MenuRelativePath . "LSetCssdList", 4787, "", AllowListMenu('{67E7B67B-A753-4E5E-ACF9-6EF1B38EF4E3}l_set_cssd'), false, false, "", "", false);
$sideMenu->addMenuItem(4285, "mi_m_alat_cssd", $MenuLanguage->MenuPhrase("4285", "MenuText"), $MenuRelativePath . "MAlatCssdList", 4787, "", AllowListMenu('{67E7B67B-A753-4E5E-ACF9-6EF1B38EF4E3}m_alat_cssd'), false, false, "", "", false);
...
$sideMenu->addMenuItem(448, "mi_USER_LOGIN", $MenuLanguage->MenuPhrase("448", "MenuText"), $MenuRelativePath . "UserLoginList", 940, "", AllowListMenu('{67E7B67B-A753-4E5E-ACF9-6EF1B38EF4E3}USER_LOGIN'), false, false, "", "", false);
$sideMenu->addMenuItem(6286, "mi_V_EMPLOYE", $MenuLanguage->MenuPhrase("6286", "MenuText"), $MenuRelativePath . "VEmployeList", 940, "", AllowListMenu('{67E7B67B-A753-4E5E-ACF9-6EF1B38EF4E3}V_EMPLOYE'), false, false, "", "", false);
$sideMenu->addMenuItem(430, "mi_TREAT_TARIF", $MenuLanguage->MenuPhrase("430", "MenuText"), $MenuRelativePath . "TreatTarifList", 940, "", AllowListMenu('{67E7B67B-A753-4E5E-ACF9-6EF1B38EF4E3}TREAT_TARIF'), false, false, "", "", false);
$sideMenu->addMenuItem(433, "mi_TREATMENT_BAYAR", $MenuLanguage->MenuPhrase("433", "MenuText"), $MenuRelativePath . "TreatmentBayarList?cmd=resetall", -1, "", AllowListMenu('{67E7B67B-A753-4E5E-ACF9-6EF1B38EF4E3}TREATMENT_BAYAR'), false, false, "", "", false);
