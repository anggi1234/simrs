...
class TreatmentBillGrid extends TreatmentBill
{
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->PAYMENT_DATE->IsDetailKey) {
            ...
            $this->PAYMENT_DATE->CurrentValue = UnFormatDateTime($this->PAYMENT_DATE->CurrentValue, 11);
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->PAYMENT_DATE->EditValue = HtmlEncode(FormatDateTime($this->PAYMENT_DATE->CurrentValue, 11));
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // PAYMENT_DATE
            $this->PAYMENT_DATE->setDbValueDef($rsnew, UnFormatDateTime($this->PAYMENT_DATE->CurrentValue, 11), null, $this->PAYMENT_DATE->ReadOnly);
    ...
    protected function addRow($rsold = null)
    {
        ...
        // PAYMENT_DATE
        $this->PAYMENT_DATE->setDbValueDef($rsnew, UnFormatDateTime($this->PAYMENT_DATE->CurrentValue, 11), null, false);
