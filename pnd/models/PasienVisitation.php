...
class PasienVisitation extends DbTable
{
    ...
    public function __construct()
    {
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->NO_REGISTRATION->Lookup = new Lookup('NO_REGISTRATION', 'PASIEN', false, 'NO_REGISTRATION', ["NO_REGISTRATION","NAME_OF_PASIEN","",""], [], [], [], [], ["NAME_OF_PASIEN","GENDER","CONTACT_ADDRESS","FAMILY_STATUS_ID","PAYOR_ID","CLASS_ID","KAL_ID","CARD_ID","COVERAGE_ID"], ["x_DIANTAR_OLEH","x_GENDER","x_VISITOR_ADDRESS","x_FAMILY_STATUS_ID","x_PAYOR_ID","x_CLASS_ID","x_KAL_ID","x_PASIEN_ID","x_COVERAGE_ID"], '[REGISTRATION_DATE] DESC', '');
                break;
            default:
                $this->NO_REGISTRATION->Lookup = new Lookup('NO_REGISTRATION', 'PASIEN', false, 'NO_REGISTRATION', ["NO_REGISTRATION","NAME_OF_PASIEN","",""], [], [], [], [], ["NAME_OF_PASIEN","GENDER","CONTACT_ADDRESS","FAMILY_STATUS_ID","PAYOR_ID","CLASS_ID","KAL_ID","CARD_ID","COVERAGE_ID"], ["x_DIANTAR_OLEH","x_GENDER","x_VISITOR_ADDRESS","x_FAMILY_STATUS_ID","x_PAYOR_ID","x_CLASS_ID","x_KAL_ID","x_PASIEN_ID","x_COVERAGE_ID"], '[REGISTRATION_DATE] DESC', '');
                break;
    ...
    public function getDetailUrl()
    {
        ...
        if ($this->getCurrentDetailTable() == "CV_PASIEN") {
            $detailUrl = Container("CV_PASIEN")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("*, '' AS [SEP]");
    }
