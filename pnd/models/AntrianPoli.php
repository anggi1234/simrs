...
class AntrianPoli extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // tanggal_daftar
        $this->tanggal_daftar = new DbField('ANTRIAN_POLI', 'ANTRIAN_POLI', 'x_tanggal_daftar', 'tanggal_daftar', '[tanggal_daftar]', CastDateFieldForLike("[tanggal_daftar]", 17, "DB"), 135, 8, 17, false, '[tanggal_daftar]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->tanggal_daftar->Sortable = true; // Allow sort
        $this->tanggal_daftar->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_SEPARATOR"], $Language->phrase("IncorrectShortDateDMY"));
        ...
        // tanggal_panggil
        $this->tanggal_panggil = new DbField('ANTRIAN_POLI', 'ANTRIAN_POLI', 'x_tanggal_panggil', 'tanggal_panggil', '[tanggal_panggil]', CastDateFieldForLike("[tanggal_panggil]", 11, "DB"), 135, 8, 11, false, '[tanggal_panggil]', false, false, false, 'FORMATTED TEXT', 'TEXT');
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->tanggal_daftar->EditValue = FormatDateTime($this->tanggal_daftar->CurrentValue, 17);
