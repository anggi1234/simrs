...
class AntrianPoliAdd extends AntrianPoli
{
    ...
    protected function addRow($rsold = null)
    {
        ...
        // tanggal_daftar
        $this->tanggal_daftar->setDbValueDef($rsnew, UnFormatDateTime($this->tanggal_daftar->CurrentValue, 17), null, false);

        // tanggal_panggil
        $this->tanggal_panggil->setDbValueDef($rsnew, UnFormatDateTime($this->tanggal_panggil->CurrentValue, 11), null, false);
