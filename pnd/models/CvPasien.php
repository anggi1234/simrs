...
class CvPasien extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // DATE_OF_BIRTH
        $this->DATE_OF_BIRTH = new DbField('CV_PASIEN', 'CV_PASIEN', 'x_DATE_OF_BIRTH', 'DATE_OF_BIRTH', '[DATE_OF_BIRTH]', CastDateFieldForLike("[DATE_OF_BIRTH]", 7, "DB"), 135, 8, 7, false, '[DATE_OF_BIRTH]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MARITALSTATUSID
        $this->MARITALSTATUSID = new DbField('CV_PASIEN', 'CV_PASIEN', 'x_MARITALSTATUSID', 'MARITALSTATUSID', '[MARITALSTATUSID]', 'CAST([MARITALSTATUSID] AS NVARCHAR)', 17, 1, -1, false, '[MARITALSTATUSID]', false, false, false, 'FORMATTED TEXT', 'RADIO');
        ...
        // KODE_AGAMA
        $this->KODE_AGAMA = new DbField('CV_PASIEN', 'CV_PASIEN', 'x_KODE_AGAMA', 'KODE_AGAMA', '[KODE_AGAMA]', 'CAST([KODE_AGAMA] AS NVARCHAR)', 17, 1, -1, false, '[KODE_AGAMA]', false, false, false, 'FORMATTED TEXT', 'RADIO');
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("dbo.PASIEN.*");
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->DATE_OF_BIRTH->EditValue = FormatDateTime($this->DATE_OF_BIRTH->CurrentValue, 7);
        ...
        $this->REGISTRATION_DATE->EditValue = FormatDateTime($this->REGISTRATION_DATE->CurrentValue, 11);
