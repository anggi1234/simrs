...
class AntrianPoliEdit extends AntrianPoli
{
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->tanggal_daftar->IsDetailKey) {
            ...
            $this->tanggal_daftar->CurrentValue = UnFormatDateTime($this->tanggal_daftar->CurrentValue, 17);
        }
        ...
        if (!$this->tanggal_panggil->IsDetailKey) {
            ...
            $this->tanggal_panggil->CurrentValue = UnFormatDateTime($this->tanggal_panggil->CurrentValue, 11);
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->tanggal_daftar->ViewValue = FormatDateTime($this->tanggal_daftar->ViewValue, 17);
            ...
            $this->tanggal_daftar->EditValue = HtmlEncode(FormatDateTime($this->tanggal_daftar->CurrentValue, 17));
            ...
            $this->tanggal_panggil->EditValue = HtmlEncode(FormatDateTime($this->tanggal_panggil->CurrentValue, 11));
    ...
    protected function validateForm()
    {
        ...
        if (!CheckShortEuroDate($this->tanggal_daftar->FormValue)) {
        ...
        if (!CheckEuroDate($this->tanggal_panggil->FormValue)) {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // tanggal_daftar
            $this->tanggal_daftar->setDbValueDef($rsnew, UnFormatDateTime($this->tanggal_daftar->CurrentValue, 17), null, $this->tanggal_daftar->ReadOnly);

            // tanggal_panggil
            $this->tanggal_panggil->setDbValueDef($rsnew, UnFormatDateTime($this->tanggal_panggil->CurrentValue, 11), null, $this->tanggal_panggil->ReadOnly);
