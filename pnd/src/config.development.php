...
return [
    "Databases" => [
        "DB" => ["id" => "DB", "type" => "MSSQL", "qs" => "[", "qe" => "]", "host" => "localhost", "port" => "50201", "user" => "sa", "password" => "Agussalim7", "dbname" => "RSUD_BESEMAH_VCLAIM_V11"]
    ],
    "SMTP" => [
    ...
    "JWT" => [
        "SECRET_KEY" => "H2Ftd2Devw5gSyld", // API Secret Key
