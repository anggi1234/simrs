...
<input type="hidden" name="fk_IDXDAFTAR" value="<?= HtmlEncode($Page->IDXDAFTAR->getSessionValue()) ?>">
...
<?php } ?>
    ...
    <input type="hidden" data-table="TREATMENT_BILL" data-field="x_IDXDAFTAR" data-hidden="1" name="x_IDXDAFTAR" id="x_IDXDAFTAR" value="<?= HtmlEncode($Page->IDXDAFTAR->CurrentValue) ?>">
<?php
