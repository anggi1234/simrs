...
<?php } ?>
    ...
    <input type="hidden" data-table="TREATMENT_AKOMODASI" data-field="x_BILL_ID" data-hidden="1" name="x_BILL_ID" id="x_BILL_ID" value="<?= HtmlEncode($Page->BILL_ID->CurrentValue) ?>">
<?php if (!$Page->IsModal) { ?>
