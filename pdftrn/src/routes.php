...
return function (App $app) {
    ...
    // PASIEN
    $app->any('/PasienList[/{ORG_UNIT_CODE}/{NO_REGISTRATION}]', PasienController::class . ':list')->add(PermissionMiddleware::class)->setName('PasienList-PASIEN-list'); // list
    $app->any('/PasienAdd[/{ORG_UNIT_CODE}/{NO_REGISTRATION}]', PasienController::class . ':add')->add(PermissionMiddleware::class)->setName('PasienAdd-PASIEN-add'); // add
    $app->any('/PasienView[/{ORG_UNIT_CODE}/{NO_REGISTRATION}]', PasienController::class . ':view')->add(PermissionMiddleware::class)->setName('PasienView-PASIEN-view'); // view
    $app->any('/PasienEdit[/{ORG_UNIT_CODE}/{NO_REGISTRATION}]', PasienController::class . ':edit')->add(PermissionMiddleware::class)->setName('PasienEdit-PASIEN-edit'); // edit
    $app->group(
        '/PASIEN',
        function (RouteCollectorProxy $group) {
            $group->any('/' . Config("LIST_ACTION") . '[/{ORG_UNIT_CODE}/{NO_REGISTRATION}]', PasienController::class . ':list')->add(PermissionMiddleware::class)->setName('PASIEN/list-PASIEN-list-2'); // list
            $group->any('/' . Config("ADD_ACTION") . '[/{ORG_UNIT_CODE}/{NO_REGISTRATION}]', PasienController::class . ':add')->add(PermissionMiddleware::class)->setName('PASIEN/add-PASIEN-add-2'); // add
            $group->any('/' . Config("VIEW_ACTION") . '[/{ORG_UNIT_CODE}/{NO_REGISTRATION}]', PasienController::class . ':view')->add(PermissionMiddleware::class)->setName('PASIEN/view-PASIEN-view-2'); // view
            $group->any('/' . Config("EDIT_ACTION") . '[/{ORG_UNIT_CODE}/{NO_REGISTRATION}]', PasienController::class . ':edit')->add(PermissionMiddleware::class)->setName('PASIEN/edit-PASIEN-edit-2'); // edit
        }
    );
    ...
    // TREATMENT_AKOMODASI
    $app->any('/TreatmentAkomodasiList[/{ORG_UNIT_CODE}/{BILL_ID}]', TreatmentAkomodasiController::class . ':list')->add(PermissionMiddleware::class)->setName('TreatmentAkomodasiList-TREATMENT_AKOMODASI-list'); // list
    $app->any('/TreatmentAkomodasiAdd[/{ORG_UNIT_CODE}/{BILL_ID}]', TreatmentAkomodasiController::class . ':add')->add(PermissionMiddleware::class)->setName('TreatmentAkomodasiAdd-TREATMENT_AKOMODASI-add'); // add
    $app->any('/TreatmentAkomodasiView[/{ORG_UNIT_CODE}/{BILL_ID}]', TreatmentAkomodasiController::class . ':view')->add(PermissionMiddleware::class)->setName('TreatmentAkomodasiView-TREATMENT_AKOMODASI-view'); // view
    $app->any('/TreatmentAkomodasiEdit[/{ORG_UNIT_CODE}/{BILL_ID}]', TreatmentAkomodasiController::class . ':edit')->add(PermissionMiddleware::class)->setName('TreatmentAkomodasiEdit-TREATMENT_AKOMODASI-edit'); // edit
    $app->any('/TreatmentAkomodasiDelete[/{ORG_UNIT_CODE}/{BILL_ID}]', TreatmentAkomodasiController::class . ':delete')->add(PermissionMiddleware::class)->setName('TreatmentAkomodasiDelete-TREATMENT_AKOMODASI-delete'); // delete
    $app->group(
        '/TREATMENT_AKOMODASI',
        function (RouteCollectorProxy $group) {
            $group->any('/' . Config("LIST_ACTION") . '[/{ORG_UNIT_CODE}/{BILL_ID}]', TreatmentAkomodasiController::class . ':list')->add(PermissionMiddleware::class)->setName('TREATMENT_AKOMODASI/list-TREATMENT_AKOMODASI-list-2'); // list
            $group->any('/' . Config("ADD_ACTION") . '[/{ORG_UNIT_CODE}/{BILL_ID}]', TreatmentAkomodasiController::class . ':add')->add(PermissionMiddleware::class)->setName('TREATMENT_AKOMODASI/add-TREATMENT_AKOMODASI-add-2'); // add
            $group->any('/' . Config("VIEW_ACTION") . '[/{ORG_UNIT_CODE}/{BILL_ID}]', TreatmentAkomodasiController::class . ':view')->add(PermissionMiddleware::class)->setName('TREATMENT_AKOMODASI/view-TREATMENT_AKOMODASI-view-2'); // view
            $group->any('/' . Config("EDIT_ACTION") . '[/{ORG_UNIT_CODE}/{BILL_ID}]', TreatmentAkomodasiController::class . ':edit')->add(PermissionMiddleware::class)->setName('TREATMENT_AKOMODASI/edit-TREATMENT_AKOMODASI-edit-2'); // edit
            $group->any('/' . Config("DELETE_ACTION") . '[/{ORG_UNIT_CODE}/{BILL_ID}]', TreatmentAkomodasiController::class . ':delete')->add(PermissionMiddleware::class)->setName('TREATMENT_AKOMODASI/delete-TREATMENT_AKOMODASI-delete-2'); // delete
        }
    );

    // TREATMENT_BILL
    $app->any('/TreatmentBillList[/{IDXDAFTAR}]', TreatmentBillController::class . ':list')->add(PermissionMiddleware::class)->setName('TreatmentBillList-TREATMENT_BILL-list'); // list
    $app->any('/TreatmentBillAdd[/{IDXDAFTAR}]', TreatmentBillController::class . ':add')->add(PermissionMiddleware::class)->setName('TreatmentBillAdd-TREATMENT_BILL-add'); // add
    $app->any('/TreatmentBillView[/{IDXDAFTAR}]', TreatmentBillController::class . ':view')->add(PermissionMiddleware::class)->setName('TreatmentBillView-TREATMENT_BILL-view'); // view
    $app->any('/TreatmentBillEdit[/{IDXDAFTAR}]', TreatmentBillController::class . ':edit')->add(PermissionMiddleware::class)->setName('TreatmentBillEdit-TREATMENT_BILL-edit'); // edit
    $app->any('/TreatmentBillDelete[/{IDXDAFTAR}]', TreatmentBillController::class . ':delete')->add(PermissionMiddleware::class)->setName('TreatmentBillDelete-TREATMENT_BILL-delete'); // delete
    $app->group(
        '/TREATMENT_BILL',
        function (RouteCollectorProxy $group) {
            $group->any('/' . Config("LIST_ACTION") . '[/{IDXDAFTAR}]', TreatmentBillController::class . ':list')->add(PermissionMiddleware::class)->setName('TREATMENT_BILL/list-TREATMENT_BILL-list-2'); // list
            $group->any('/' . Config("ADD_ACTION") . '[/{IDXDAFTAR}]', TreatmentBillController::class . ':add')->add(PermissionMiddleware::class)->setName('TREATMENT_BILL/add-TREATMENT_BILL-add-2'); // add
            $group->any('/' . Config("VIEW_ACTION") . '[/{IDXDAFTAR}]', TreatmentBillController::class . ':view')->add(PermissionMiddleware::class)->setName('TREATMENT_BILL/view-TREATMENT_BILL-view-2'); // view
            $group->any('/' . Config("EDIT_ACTION") . '[/{IDXDAFTAR}]', TreatmentBillController::class . ':edit')->add(PermissionMiddleware::class)->setName('TREATMENT_BILL/edit-TREATMENT_BILL-edit-2'); // edit
            $group->any('/' . Config("DELETE_ACTION") . '[/{IDXDAFTAR}]', TreatmentBillController::class . ':delete')->add(PermissionMiddleware::class)->setName('TREATMENT_BILL/delete-TREATMENT_BILL-delete-2'); // delete
        }
    );

    // TREATMENT_OBAT
    $app->any('/TreatmentObatList[/{ORG_UNIT_CODE}/{BILL_ID}]', TreatmentObatController::class . ':list')->add(PermissionMiddleware::class)->setName('TreatmentObatList-TREATMENT_OBAT-list'); // list
    $app->any('/TreatmentObatAdd[/{ORG_UNIT_CODE}/{BILL_ID}]', TreatmentObatController::class . ':add')->add(PermissionMiddleware::class)->setName('TreatmentObatAdd-TREATMENT_OBAT-add'); // add
    $app->any('/TreatmentObatView[/{ORG_UNIT_CODE}/{BILL_ID}]', TreatmentObatController::class . ':view')->add(PermissionMiddleware::class)->setName('TreatmentObatView-TREATMENT_OBAT-view'); // view
    $app->any('/TreatmentObatEdit[/{ORG_UNIT_CODE}/{BILL_ID}]', TreatmentObatController::class . ':edit')->add(PermissionMiddleware::class)->setName('TreatmentObatEdit-TREATMENT_OBAT-edit'); // edit
    $app->any('/TreatmentObatDelete[/{ORG_UNIT_CODE}/{BILL_ID}]', TreatmentObatController::class . ':delete')->add(PermissionMiddleware::class)->setName('TreatmentObatDelete-TREATMENT_OBAT-delete'); // delete
    $app->group(
        '/TREATMENT_OBAT',
        function (RouteCollectorProxy $group) {
            $group->any('/' . Config("LIST_ACTION") . '[/{ORG_UNIT_CODE}/{BILL_ID}]', TreatmentObatController::class . ':list')->add(PermissionMiddleware::class)->setName('TREATMENT_OBAT/list-TREATMENT_OBAT-list-2'); // list
            $group->any('/' . Config("ADD_ACTION") . '[/{ORG_UNIT_CODE}/{BILL_ID}]', TreatmentObatController::class . ':add')->add(PermissionMiddleware::class)->setName('TREATMENT_OBAT/add-TREATMENT_OBAT-add-2'); // add
            $group->any('/' . Config("VIEW_ACTION") . '[/{ORG_UNIT_CODE}/{BILL_ID}]', TreatmentObatController::class . ':view')->add(PermissionMiddleware::class)->setName('TREATMENT_OBAT/view-TREATMENT_OBAT-view-2'); // view
            $group->any('/' . Config("EDIT_ACTION") . '[/{ORG_UNIT_CODE}/{BILL_ID}]', TreatmentObatController::class . ':edit')->add(PermissionMiddleware::class)->setName('TREATMENT_OBAT/edit-TREATMENT_OBAT-edit-2'); // edit
            $group->any('/' . Config("DELETE_ACTION") . '[/{ORG_UNIT_CODE}/{BILL_ID}]', TreatmentObatController::class . ':delete')->add(PermissionMiddleware::class)->setName('TREATMENT_OBAT/delete-TREATMENT_OBAT-delete-2'); // delete
        }
    );
