...
class PasienVisitationAdd extends PasienVisitation
{
    ...
    protected function addRow($rsold = null)
    {
        ...
        // VISIT_ID
        $this->VISIT_ID->CurrentValue = VisitId();
        $this->VISIT_ID->setDbValueDef($rsnew, $this->VISIT_ID->CurrentValue, null);
        ...
        // COB
        $this->COB->setDbValueDef($rsnew, $this->COB->CurrentValue, null, strval($this->COB->CurrentValue) == "");
        ...
        if ($addRow) {
            ...
            if (in_array("PASIEN_DIAGNOSA", $detailTblVar) && $detailPage->DetailAdd) {
                ...
                $detailPage->IDXDAFTAR->setSessionValue($this->IDXDAFTAR->CurrentValue); // Set master key
                ...
                $detailPage->IDXDAFTAR->setSessionValue(""); // Clear master key if insert failed
                }
            }
            $detailPage = Container("TreatmentObatGrid");
            if (in_array("TREATMENT_OBAT", $detailTblVar) && $detailPage->DetailAdd) {
