...
class PasienDiagnosaAdd extends PasienDiagnosa
{
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->IDXDAFTAR->getSessionValue() != "") {
            $rsnew['IDXDAFTAR'] = $this->IDXDAFTAR->getSessionValue();
        }
    ...
    protected function setupMasterParms()
    {
        ...
        if (($master = Get(Config("TABLE_SHOW_MASTER"), Get(Config("TABLE_MASTER")))) !== null) {
            ...
            if ($masterTblVar == "PASIEN_VISITATION") {
                ...
                if (($parm = Get("fk_IDXDAFTAR", Get("IDXDAFTAR"))) !== null) {
                    $masterTbl->IDXDAFTAR->setQueryStringValue($parm);
                    $this->IDXDAFTAR->setQueryStringValue($masterTbl->IDXDAFTAR->QueryStringValue);
                    $this->IDXDAFTAR->setSessionValue($this->IDXDAFTAR->QueryStringValue);
                    if (!is_numeric($masterTbl->IDXDAFTAR->QueryStringValue)) {
                        $validMaster = false;
                    }
                } else {
                    $validMaster = false;
            ...
            if ($masterTblVar == "PASIEN_VISITATION") {
                ...
                if (($parm = Post("fk_IDXDAFTAR", Post("IDXDAFTAR"))) !== null) {
                    $masterTbl->IDXDAFTAR->setFormValue($parm);
                    $this->IDXDAFTAR->setFormValue($masterTbl->IDXDAFTAR->FormValue);
                    $this->IDXDAFTAR->setSessionValue($this->IDXDAFTAR->FormValue);
                    if (!is_numeric($masterTbl->IDXDAFTAR->FormValue)) {
                        $validMaster = false;
                    }
                } else {
                    $validMaster = false;
        ...
        if ($validMaster) {
            ...
            if ($masterTblVar != "PASIEN_VISITATION") {
                ...
                if ($this->IDXDAFTAR->CurrentValue == "") {
                    $this->IDXDAFTAR->setSessionValue("");
                }
            }
            if ($masterTblVar != "V_REKAM_MEDIS") {
                if ($this->IDXDAFTAR->CurrentValue == "") {
