...
class PasienDiagnosa extends DbTable
{
    ...
    public function getMasterFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "V_REKAM_MEDIS") {
            if ($this->IDXDAFTAR->getSessionValue() != "") {
                $masterFilter .= "" . GetForeignKeySql("[IDXDAFTAR]", $this->IDXDAFTAR->getSessionValue(), DATATYPE_NUMBER, "DB");
            } else {
                return "";
            }
    ...
    public function getDetailFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "V_REKAM_MEDIS") {
            if ($this->IDXDAFTAR->getSessionValue() != "") {
                $detailFilter .= "" . GetForeignKeySql("[IDXDAFTAR]", $this->IDXDAFTAR->getSessionValue(), DATATYPE_NUMBER, "DB");
            } else {
                return "";
            }
            if ($this->NO_REGISTRATION->getSessionValue() != "") {
    ...
    {
        return "[VISIT_ID]='@VISIT_ID@' AND [IDXDAFTAR]=@IDXDAFTAR@";
    }
    // Detail filter
    ...
    {
        return "[IDXDAFTAR]=@IDXDAFTAR@ AND [NO_REGISTRATION]='@NO_REGISTRATION@' AND [VISIT_ID]='@VISIT_ID@' AND [DIANTAR_OLEH]='@DIANTAR_OLEH@'";
    }
    // Detail filter
    public function sqlDetailFilter_V_REKAM_MEDIS()
    {
        return "[IDXDAFTAR]=@IDXDAFTAR@ AND [NO_REGISTRATION]='@NO_REGISTRATION@' AND [VISIT_ID]='@VISIT_ID@' AND [THENAME]='@THENAME@'";
    }

    // Master filter
    public function sqlMasterFilter_V_KUNJUNGAN_PASIEN()
    {
        return "dbo.PASIEN_VISITATION.VISIT_ID='@VISIT_ID@' AND dbo.PASIEN_VISITATION.IDXDAFTAR=@IDXDAFTAR@ AND dbo.PASIEN_VISITATION.NO_REGISTRATION='@NO_REGISTRATION@'";
    }
    // Detail filter
    public function sqlDetailFilter_V_KUNJUNGAN_PASIEN()
    {
        return "[VISIT_ID]='@VISIT_ID@' AND [IDXDAFTAR]=@IDXDAFTAR@ AND [NO_REGISTRATION]='@NO_REGISTRATION@'";
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        if ($this->IDXDAFTAR->getSessionValue() != "") {
            $this->IDXDAFTAR->CurrentValue = GetForeignKeyValue($this->IDXDAFTAR->getSessionValue());
            $this->IDXDAFTAR->ViewValue = $this->IDXDAFTAR->CurrentValue;
            $this->IDXDAFTAR->ViewValue = FormatNumber($this->IDXDAFTAR->ViewValue, 0, -2, -2, -2);
            $this->IDXDAFTAR->ViewCustomAttributes = "";
        } else {
