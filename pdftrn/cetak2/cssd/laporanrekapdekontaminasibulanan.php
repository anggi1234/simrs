...
header("Content-Disposition: attachment; filename=laporan_dekontaminasi_bulanan.xls");
...
$sqlitem="SELECT
  a.instrumen,
  a.ruang,
  year( a.created_sterilisasi_at) AS tahun,
  month( a.created_sterilisasi_at) AS bulan,
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '01' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  AND t_cssd.jenis != '3'
  ) AS satu,
  (
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '02' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '03' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '04' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '05' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '06' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '07' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '08' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '09' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '10' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '11' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '12' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '13' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '14' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '15' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '16' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '17' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '18' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '19' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '20' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '21' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '22' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '23' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '24' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '25' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '26' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '27' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '28' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '29' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '30' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
  ...
  WHERE
    ...
    AND year( t_cssd.created_sterilisasi_at)  = year( a.created_sterilisasi_at) 
    AND month(t_cssd.created_sterilisasi_at) = month( a.created_sterilisasi_at) 
    AND day(t_cssd.created_sterilisasi_at) = '31' 
    AND instrumen = a.instrumen 
    AND ruang = a.ruang 
    AND (t_cssd.petugas_dekontaminasi != '' OR t_cssd.petugas_dekontaminasi IS NOT NULL)
    AND t_cssd.jenis != '2'
...
WHERE
  ...
  AND (a.petugas_dekontaminasi != '' OR a.petugas_dekontaminasi IS NOT NULL)
  AND a.jenis != '2'
  AND a.jenis != '3'
GROUP BY
  a.jenis,
...
<body>
  <table width="100%" style="border:0;" cellpadding="0">
                    <tbody>
                        <tr>
                            <td width="100%" align="center"><span class="header"><strong><b>REKAP DEKONTAMINASI HARIAN,  BULAN : <?php echo $bulan; ?> TAHUN : <?php echo $tahun; ?>
