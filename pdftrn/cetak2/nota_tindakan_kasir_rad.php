...
WHERE
    d.id_bill_detail_tarif =$id_bill_detail_tarif and d.userlevelid=17";
 ...
 if(mysql_num_rows($queryidentitas)==0){
		echo '<center>Tidak ada pemeriksaan radiologi</center>';
	}
	else{
		$no=1;
...
<center>
  <span style="font-size: 14px">RINCIAN BIAYA PEMERIKSAAN RADIOLOGI</span>
</center>
...
WHERE
    a.id_bill_detail_tarif_detail = ".$rows["id_bill_detail_tarif_detail"]." and b.userlevelid=17";
...
$dompdf->render();
$dompdf->stream('nota_radiologi.pdf',array('Attachment' => 0));
?>
