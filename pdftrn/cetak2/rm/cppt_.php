...
$sqlitemanamnesa="SELECT 
    ...
    CONCAT('<strong>S</strong> : ',
            ...
            CASE
                ...
                THEN
                    ''
                WHEN mata_visus_dasar_od IS NOT NULL THEN CONCAT(mata_visus_dasar_od, ',')
            END,
            CASE
                WHEN
                ...
                THEN
                    ''
                WHEN mata_visus_koreksi_od IS NOT NULL THEN CONCAT(mata_visus_koreksi_od, ',')
            END,
            CASE
                WHEN
                ...
                THEN
                    ''
                WHEN mata_tekanan_intraokuler_od IS NOT NULL THEN CONCAT(mata_tekanan_intraokuler_od, ',')
            END,
            CASE
                WHEN
                ...
                THEN
                    ''
                WHEN mata_palpebra_od IS NOT NULL THEN CONCAT(mata_palpebra_od, ',')
            END,
            CASE
                WHEN
                ...
                THEN
                    ''
                WHEN mata_konjungtiva_od IS NOT NULL THEN CONCAT(mata_konjungtiva_od, ',')
            END,
            CASE
                WHEN
                ...
                THEN
                    ''
                WHEN mata_kornea_od IS NOT NULL THEN CONCAT(mata_kornea_od, ',')
            END,
            CASE
                WHEN mata_coa_od IS NULL OR mata_coa_od = '-' THEN ''
                WHEN mata_coa_od IS NOT NULL THEN CONCAT(mata_coa_od, ',')
            END,
            CASE
                WHEN
                ...
                THEN
                    ''
                WHEN mata_pupil_od IS NOT NULL THEN CONCAT(mata_pupil_od, ',')
            END,
            CASE
                WHEN
                ...
                THEN
                    ''
                WHEN mata_iris_od IS NOT NULL THEN CONCAT(mata_iris_od, ',')
            END,
            CASE
                WHEN
                ...
                THEN
                    ''
                WHEN mata_lensa_od IS NOT NULL THEN CONCAT(mata_lensa_od, ',')
            END,
            CASE
                WHEN
                ...
                THEN
                    ''
                WHEN mata_fundus_od IS NOT NULL THEN CONCAT(mata_fundus_od, ',')
            END,
            CASE
                WHEN
            ...
            CASE
                ...
                THEN
                    ''
                WHEN mata_funduskopi_od IS NOT NULL THEN CONCAT(mata_funduskopi_od, ',')
            END,
            CASE
                WHEN
                ...
                THEN
                    ''
                WHEN mata_visus_dasar_os IS NOT NULL THEN CONCAT(mata_visus_dasar_os, ',')
            END,
            CASE
                WHEN
                ...
                THEN
                    ''
                WHEN mata_visus_koreksi_os IS NOT NULL THEN CONCAT(mata_visus_koreksi_os, ',')
            END,
            CASE
                WHEN
                ...
                THEN
                    ''
                WHEN mata_tekanan_intraokuler_os IS NOT NULL THEN CONCAT(mata_tekanan_intraokuler_os, ',')
            END,
            CASE
                WHEN
                ...
                THEN
                    ''
                WHEN mata_palpebra_os IS NOT NULL THEN CONCAT(mata_palpebra_os, ',')
            END,
            CASE
                WHEN
                ...
                THEN
                    ''
                WHEN mata_konjungtiva_os IS NOT NULL THEN CONCAT(mata_konjungtiva_os, ',')
            END,
            CASE
                WHEN
                ...
                THEN
                    ''
                WHEN mata_kornea_os IS NOT NULL THEN CONCAT(mata_kornea_os, ',')
            END,
            CASE
                WHEN mata_coa_os IS NULL OR mata_coa_os = '-' THEN ''
                WHEN mata_coa_os IS NOT NULL THEN CONCAT(mata_coa_os, ',')
            END,
            CASE
                WHEN
                ...
                THEN
                    ''
                WHEN mata_pupil_os IS NOT NULL THEN CONCAT(mata_pupil_os, ',')
            END,
            CASE
                WHEN
                ...
                THEN
                    ''
                WHEN mata_iris_os IS NOT NULL THEN CONCAT(mata_iris_os, ',')
            END,
            CASE
                WHEN
                ...
                THEN
                    ''
                WHEN mata_lensa_os IS NOT NULL THEN CONCAT(mata_lensa_os, ',')
            END,
            CASE
                WHEN
                ...
                THEN
                    ''
                WHEN mata_fundus_os IS NOT NULL THEN CONCAT(mata_fundus_os, ',')
            END,
            CASE
                WHEN
                ...
                THEN
                    ''
                WHEN mata_funduskopi_os IS NOT NULL THEN CONCAT(mata_funduskopi_os, ',')
            END,
            CASE
                WHEN
            ...
            ' Diagnosa : ',
            IFNULL((SELECT 
                            GROUP_CONCAT(CONCAT(ifnull(o.keterangan,''),', ',d.code, ':', d.str)
    ...
    CONCAT((ifnull((SELECT 
            ...
            ' | ',
            (SELECT 
                    ifnull(GROUP_CONCAT(CONCAT(lower(c.nama_obat), '(', o.qty, ')')
                            SEPARATOR ', '),'') AS obat
                FROM
...
<table width="100%" border="0" class="tabel">
  <tbody>
    <tr>
      ...
      <td width="37%" align="center" style="font-size: 11px; padding-bottom:20px;" valign="top"><strong>HASIL ASSASEMENT <br>PENATALAKSANAAN PASIEN</strong><br>(Tulis dengan format SOAP, disertai Sasaran, Tulis Nama, beri Paraf pada akhir catatan)</td>
