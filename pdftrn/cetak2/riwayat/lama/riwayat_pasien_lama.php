...
$NOMR = $_GET['nomr'];
 ...
 $sqlitem="select * from a_riwayat_pasien_lama WHERE NOMR=$NOMR";
...
<table width="100%" height="52" border="0">
  <tr>
    <td width="100%" class="header"><div align="center"><strong>RIWAYAT PASIEN DI SIMRS LAMA</strong></div></td>
  </tr>
</table>
...
<table width="100%" class="tabelfix" border="1">
    <tr>
      <td width="2%" class="a"><div align="center"><strong>No.</strong></div></td>
      <td width="5%" class="a"><div align="center"><strong>TGL KUNJUNG</strong></div></td>
      <td width="5%" class="a"><div align="center"><strong>UNIT</strong></div></td>
      <td width="10%" class="a"><div align="center"><strong>ANAMNESA</strong></div></td>
      <td width="10%" class="a"><div align="center"><strong>DIAGNOSA</strong></div></td>
      <td width="10%" class="a"><div align="center"><strong>TERAPI/TIND</strong></div></td>
      <td width="5%" class="a"><div align="center"><strong>TEKANAN DARAH</strong></div></td>
      <td width="5%" class="a"><div align="center"><strong>DOKTER</strong></div></td>
  </tr>
	<?php
	if(mysql_num_rows($queryitem)==0){
	  ...
	  echo '<td class="a"><div align="center">'.$data['JAMREG'].'</div></td>';
	  echo '<td class="a"><div align="center">'.$data['NAMAPOLI'].'</div></td>';
      echo '<td class="a"><div align="center">'.$data['ANAMNESA'].'</div></td>';
	  echo '<td class="a"><div align="center">'.$data['DIAGNOSA'].'</div></td>';
      echo '<td class="a"><div align="center">'.$data['TERAPI']. '</div></td>';
	  echo '<td class="a"><div align="center">'.$data['TEKANAN_DARAH'].'</div></td>';
	  echo '<td class="a"><div align="center">'.$data['NAMADOKTER'].'</div></td>';
			echo '</tr>';
			$no++;
		}
	}
