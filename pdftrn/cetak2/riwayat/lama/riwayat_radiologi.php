...
$NOMR = $_GET['nomr'];
 ...
 $sqlitem="select a.IDXDAFTAR,TGLREG,b.NAMA_TMNO_RADIOLOGI from y_tindakan_radiologi a 
left join y_tmno_radiologi b on a.ID_TMNO=b.ID_TMNO_RADIOLOGI
...
<table width="100%" height="52" border="0">
  <tr>
    <td width="100%" class="header"><div align="center"><strong>RIWAYAT PEMERIKSAAN RADIOLOGI</strong></div></td>
  </tr>
</table>
...
<table width="100%" class="tabelfix" border="1">
	...
	if(mysql_num_rows($queryitem)==0){
	  ...
	  echo '<td class="a"><div align="left">'.$data['NAMA_TMNO_RADIOLOGI'].'</div></td>';
			echo '</tr>';
			$no++;
		}
	}
