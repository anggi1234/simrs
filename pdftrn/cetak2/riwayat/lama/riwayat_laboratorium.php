...
$NOMR = $_GET['nomr'];
 ...
 $sqlitem="select a.IDXDAFTAR,TGLREG,b.NAMA_TMNO_LABORATORIUM from y_tindakan_laboratorium a 
left join y_tmno_laboratorium b on a.ID_TMNO=b.ID_TMNO_LABORATORIUM
left join t_pendaftaran c on a.IDXDAFTAR=c.IDXDAFTAR where c.NOMR=$NOMR";
...
<table width="100%" height="52" border="0">
  <tr>
    <td width="100%" class="header"><div align="center"><strong>RIWAYAT PEMERIKSAAN LABORATORIUM</strong></div></td>
  </tr>
</table>
...
<table width="100%" class="tabelfix" border="1">
    <tr>
      <td width="1" class="a"><div align="center"><strong>No.</strong></div></td>
      <td width="5" class="a"><div align="center">Tgl Pemeriksaan</div></td>
      <td width="200" class="a"><div align="center">Nama Pemeriksaan</div></td>
	...
	if(mysql_num_rows($queryitem)==0){
	  ...
	  echo '<td class="a"><div align="left">'.$data['NAMA_TMNO_LABORATORIUM'].'</div></td>';
			echo '</tr>';
			$no++;
		}
	}
