...
$NOMR = $_GET['nomr'];
 ...
 $sqlitem="SELECT date_format(c.TGLREG, '%d-%m-%Y') AS TGLREG ,b.NAMA_BARANG,a.QTY,d.aturan 
FROM z_detail_penjualan_rajal a 
left join z_barang b on a.ID_BARANG=b.ID_BARANG 
left join t_pendaftaran c on a.IDXDAFTAR=c.IDXDAFTAR
left join z_aturan d on a.id_aturan=d.id_aturan
WHERE c.NOMR=$NOMR and b.NAMA_BARANG NOT LIKE '%JASA%';";
...
<table width="100%" height="52" border="0">
  <tr>
    <td width="100%" class="header"><div align="center"><strong>RIWAYAT OBAT PASIEN RSUD AJIBARANG</strong></div></td>
  </tr>
</table>
...
<table width="100%" class="tabelfix" border="1">
    <tr>
      ...
      <td width="10%" class="a"><div align="center"><strong>TGL KUNJUNG</strong></div></td>
      <td width="40%" class="a"><div align="center"><strong>NAMA OBAT</strong></div></td>
      <td width="5" class="a"><div align="center"><strong>JUMLAH</strong></div></td>
	  <td width="50%" class="a"><div align="center"><strong>DOSIS</strong></div></td>
  </tr>
	<?php
	if(mysql_num_rows($queryitem)==0){
	  ...
	  echo '<td class="a"><div align="center">'.$data['TGLREG'].'</div></td>';
	  echo '<td class="a"><div align="left">'.$data['NAMA_BARANG'].'</div></td>';
      echo '<td class="a"><div align="center">'.$data['QTY'].'</div></td>';
	  echo '<td class="a"><div align="left">'.$data['aturan'].'</div></td>';
			echo '</tr>';
			$no++;
		}
	}
