...
<head>
<meta charset="utf-8">
<title>Sensus By Cara Bayar</title>
<style type="text/css">
	@page {
            margin-top: 0.1 cm;
            margin-left: 0.1 cm;
...
<table width="100%" border="0" cellpadding="-3px" cellspacing="0px">
  ...
  <hr>
    ...
    <div align="center"><strong>LAPORAN HARIAN JUMLAH PASIEN PER CARA BAYAR UNIT PENUNJANG</strong></div>

<table width="100%" class="tabel" border="1">
  <tbody>
    <tr>
      <td width="5%">No.</td>
      <td width="55%" align="center">TANGGAL REGISTER</td>
      <td width="10%" align="center">UMUM</td>
      <td width="10%" align="center">BPJS</td>
      <td width="10%" align="center">KBS</td>
      <td width="10%" align="center">JKN</td>
      <td width="10%" align="center">JAMKESDA</td>
