...
$sqlitemstok="SELECT
	s.unit,
	s.tanggal,
	s.stok_akhir - ( s.stok_masuk - s.stok_keluar ) AS stok_awal,
	s.stok_masuk,
	s.stok_keluar,
	s.stok_akhir 
FROM
	...
	FROM
		...
		LEFT JOIN simrs.gudang_pembelian b ON a.id_gudang_pembelian = b.id_gudang_pembelian
	...
	WHERE
		...
		AND date( a.tanggal ) <= '$sampai_tanggal' UNION ALL
	SELECT
	...
	FROM
		...
		CROSS JOIN ( SELECT @sum := 0 ) params
		LEFT JOIN simrs.gudang_pengiriman b ON a.id_pengiriman_barang = b.id_pengiriman_barang
