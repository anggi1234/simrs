...
$sqlitem="SELECT 
    ...
    IFNULL(q.sedang, 0) AS sedang,
    IFNULL(r.kecil, 0) AS kecil,
    IFNULL(s.besar, 0) AS besar,
    IFNULL(t.sederhana, 0) AS sederhana,
    IFNULL(u.khusus, 0) AS khusus
FROM
    simrs.bill_detail_tarif a
        LEFT JOIN
    (SELECT 
        DATE(tanggal) AS tgl, SUM(qty) AS visit_bpjs
    FROM
    ...
    GROUP BY DATE(tanggal_visit)) b ON DATE(a.tanggal) = b.tgl
        LEFT JOIN
    (SELECT 
        DATE(tanggal) AS tgl, SUM(qty) AS visit_umum
    FROM
        bill_detail_visit_dokter
    WHERE
        (DATE(tanggal_visit) >= '$dari_tanggal'
    ...
    GROUP BY DATE(tanggal_visit)) c ON DATE(a.tanggal) = c.tgl
        LEFT JOIN
    (SELECT 
        DATE(tanggal) AS tgl, SUM(qty) AS visit_kbs
    FROM
        bill_detail_visit_dokter
    WHERE
        (DATE(tanggal_visit) >= '$dari_tanggal'
    ...
    GROUP BY DATE(tanggal_visit)) d ON DATE(a.tanggal) = d.tgl
        LEFT JOIN
    (SELECT 
        DATE(tanggal) AS tgl, SUM(qty) AS kecila
    FROM
    ...
    GROUP BY DATE(tanggal)) e ON DATE(a.tanggal) = e.tgl
        LEFT JOIN
    (SELECT 
        DATE(tanggal) AS tgl, SUM(qty) AS kecilb
    FROM
        bill_detail_tindakan
    WHERE
        (DATE(tanggal) >= '$dari_tanggal'
    ...
    GROUP BY DATE(tanggal)) f ON DATE(a.tanggal) = f.tgl
        LEFT JOIN
    (SELECT 
        DATE(tanggal) AS tgl, SUM(qty) AS kecilc
    FROM
        bill_detail_tindakan
    WHERE
        (DATE(tanggal) >= '$dari_tanggal'
    ...
    GROUP BY DATE(tanggal)) g ON DATE(a.tanggal) = g.tgl
        LEFT JOIN
    (SELECT 
        DATE(tanggal) AS tgl, SUM(qty) AS besara
    FROM
        bill_detail_tindakan
    WHERE
        (DATE(tanggal) >= '$dari_tanggal'
    ...
    GROUP BY DATE(tanggal)) h ON DATE(a.tanggal) = h.tgl
        LEFT JOIN
    (SELECT 
        DATE(tanggal) AS tgl, SUM(qty) AS besarb
    FROM
        bill_detail_tindakan
    WHERE
        (DATE(tanggal) >= '$dari_tanggal'
    ...
    GROUP BY DATE(tanggal)) i ON DATE(a.tanggal) = i.tgl
        LEFT JOIN
    (SELECT 
        DATE(tanggal) AS tgl, SUM(qty) AS besarc
    FROM
        bill_detail_tindakan
    WHERE
        (DATE(tanggal) >= '$dari_tanggal'
    ...
    GROUP BY DATE(tanggal)) j ON DATE(a.tanggal) = j.tgl
        LEFT JOIN
    (SELECT 
        DATE(tanggal) AS tgl, SUM(qty) AS sedanga
    FROM
        bill_detail_tindakan
    WHERE
        (DATE(tanggal) >= '$dari_tanggal'
    ...
    GROUP BY DATE(tanggal)) k ON DATE(a.tanggal) = k.tgl
        LEFT JOIN
    (SELECT 
        DATE(tanggal) AS tgl, SUM(qty) AS sedangb
    FROM
        bill_detail_tindakan
    WHERE
        (DATE(tanggal) >= '$dari_tanggal'
    ...
    GROUP BY DATE(tanggal)) l ON DATE(a.tanggal) = l.tgl
        LEFT JOIN
    (SELECT 
        DATE(tanggal) AS tgl, SUM(qty) AS sedangc
    FROM
        bill_detail_tindakan
    WHERE
        (DATE(tanggal) >= '$dari_tanggal'
    ...
    GROUP BY DATE(tanggal)) m ON DATE(a.tanggal) = m.tgl
        LEFT JOIN
    (SELECT 
        DATE(tanggal) AS tgl, SUM(qty) AS khususa
    FROM
        bill_detail_tindakan
    WHERE
        (DATE(tanggal) >= '$dari_tanggal'
    ...
    GROUP BY DATE(tanggal)) n ON DATE(a.tanggal) = n.tgl
        LEFT JOIN
    (SELECT 
        DATE(tanggal) AS tgl, SUM(qty) AS khususb
    FROM
        bill_detail_tindakan
    WHERE
        (DATE(tanggal) >= '$dari_tanggal'
    ...
    GROUP BY DATE(tanggal)) o ON DATE(a.tanggal) = o.tgl
        LEFT JOIN
    (SELECT 
        DATE(tanggal) AS tgl, SUM(qty) AS khususc
    FROM
        bill_detail_tindakan
    WHERE
        (DATE(tanggal) >= '$dari_tanggal'
    ...
    GROUP BY DATE(tanggal)) p ON DATE(a.tanggal) = p.tgl
        LEFT JOIN
    (SELECT 
        DATE(tanggal) AS tgl, SUM(qty) AS sedang
    FROM
        bill_detail_tindakan
    WHERE
        (DATE(tanggal) >= '$dari_tanggal'
    ...
    GROUP BY DATE(tanggal)) q ON DATE(a.tanggal) = q.tgl
        LEFT JOIN
    (SELECT 
        DATE(tanggal) AS tgl, SUM(qty) AS kecil
    FROM
        bill_detail_tindakan
    WHERE
        (DATE(tanggal) >= '$dari_tanggal'
    ...
    GROUP BY DATE(tanggal)) r ON DATE(a.tanggal) = r.tgl
        LEFT JOIN
    (SELECT 
        DATE(tanggal) AS tgl, SUM(qty) AS besar
    FROM
        bill_detail_tindakan
    WHERE
        (DATE(tanggal) >= '$dari_tanggal'
    ...
    GROUP BY DATE(tanggal)) s ON DATE(a.tanggal) = s.tgl
        LEFT JOIN
    (SELECT 
        DATE(tanggal) AS tgl, SUM(qty) AS sederhana
    FROM
        bill_detail_tindakan
    WHERE
        (DATE(tanggal) >= '$dari_tanggal'
    ...
    GROUP BY DATE(tanggal)) t ON DATE(a.tanggal) = t.tgl
        LEFT JOIN
    (SELECT 
        DATE(tanggal) AS tgl, SUM(qty) AS khusus
    FROM
        bill_detail_tindakan
    WHERE
        (DATE(tanggal) >= '$dari_tanggal'
    ...
    GROUP BY DATE(tanggal)) u ON DATE(a.tanggal) = u.tgl
WHERE
...
<div align="center"><strong>LAPORAN HARIAN JASA PELAYANAN DOKTER PENUNJANG</strong></div>
<table width="100%" class="tabel" border="1">
  <tbody>
    <tr>
      <td width="1%" rowspan="2" align="center">No</td>
      <td width="3%" rowspan="2" align="center">Tanggal</td>
      <td colspan="3" align="center">Visit</td>
      <td colspan="17" align="center">TMNO</td>
      <td width="5%" rowspan="2" align="center">Keterangan</td>
    </tr>
    <tr>
      <td width="3%" align="center">BPJS</td>
      <td width="3%" align="center">KBS</td>
      <td width="3%" align="center">UMUM</td>
      <td width="3%" align="center">KECIL A</td>
      <td width="3%" align="center">KECIL B</td>
      <td width="3%" align="center">KECIL C</td>
      <td width="4%" align="center">SEDANG A</td>
      <td width="4%" align="center">SEDANG B</td>
      <td width="4%" align="center">SEDANG C</td>
      <td width="3%" align="center">BESAR A</td>
      <td width="3%" align="center">BESAR B</td>
      <td width="3%" align="center">BESAR C</td>
      <td width="3%" align="center">KHUSUS A</td>
      <td width="3%" align="center">KHUSUS B</td>
      <td width="3%" align="center">KHUSUS C</td>
      <td width="3%" align="center">SEDANG</td>
      <td width="3%" align="center">KECIL</td>
      <td width="3%" align="center">SEDERH</td>
      <td width="3%" align="center">BESAR</td>
		<td width="3%" align="center">KHUSUS</td>
    </tr>
    <?php
	  $no=1;
