...
$sqllapoperasi="SELECT b.id_bill_detail_tarif_ibs FROM simrs.bill_detail_tarif_ibs b where b.idxdaftar=$idxdaftar";
$querylapoperasi = mysql_query($sqllapoperasi);
$DATA_OP = mysql_fetch_array($querylapoperasi);

$id_bill_detail_tarif_ibs = $DATA_OP['id_bill_detail_tarif_ibs'];
...
FROM
	...
	WHERE b.userlevelid = 40 AND b.id_jenis_tindakan =2 AND a.id_bill_detail_tarif_detail=$id_bill_detail_tarif_ibs) d ON a.id_bill_detail_tarif_ibs = d.id_bill_detail_tarif_detail
        LEFT JOIN
    (SELECT 
...
?>
 <table width="100%" class="tabel" border="1">
  <tbody>
    ...
    <tr>
      <td colspan="4" class="spasi">JENIS OPERASI/TINDAKAN : 	  <?php 
		if($DATA_DIAGNOSA['tindakan_manual'] == ""){
			echo $DATA_DIAGNOSA['tindakan']; 
		}else{
			echo $DATA_DIAGNOSA['tindakan_manual'];
		}
