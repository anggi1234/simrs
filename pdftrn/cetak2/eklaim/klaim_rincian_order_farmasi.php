...
$sqlitem="SELECT 
    ...
    d.satuan,
    sum(a.qty) as qty,
    sum(IFNULL(c.qty, 0)) AS qty_retur,
    a.tarif_obat,
...
WHERE
	...
	group by a.id_master_obat_detail";
...
<table width="100%" class="tabel" border="1">
    ...
    <tr>
      ...
      <td align="right" class="total" style="font-size: 16px"><strong>Rp.<?php echo number_format($DATA_TOTAL['total'], 0,",","."); ?></strong></td>
    </tr>
        </tbody>
      </table></td>
    </tr>
...
$dompdf->render();
$dompdf->stream('42_rincian_obat.pdf',array('Attachment' => 0));
?>