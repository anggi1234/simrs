...
$r  = mysql_fetch_array($q);
 ...
 $sqlsignature="select signature from simrs2012.t_sep where idx='$idxdaftar'";
 $querysignature = mysql_query($sqlsignature);
 $DATA_SIGNATURE = mysql_fetch_array($querysignature);
...
<table width="100%" border="0" cellpadding="-3px" cellspacing="0px">
  ...
  <hr>
    ...
    <tr>
      ...
      <td align="center"><img src="../gambar/od.png" height="100px" width="150px" /><br>
      ...
      <td align="center"><img src="../gambar/os.png" height="100px" width="150px" /><br>
    ...
    <tbody>
        ...
        <tr>
		  <td colspan="2" align="center">
		  	...
		  	<img height="80px" src="<?php echo $DATA_SIGNATURE['signature'] ?>"/>
		  	
		  </td>          
          <td></td>
          <td align="center"><img height="50px" src="../../uploads/<?php echo $r['sign'];?>"/></td>
        </tr>
        <tr>
          <td align="center">          
          <td>&nbsp;</td>
