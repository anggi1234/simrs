...
$sqlidentitas="SELECT 
	...
	a.biaya_obat-ifnull(a.biaya_obat_retur,0) as obat,
    a.total_keseluruhan
FROM
...
<table width="100%" class="header" border="0">
    <tr>
      ...
      <td width="17%">Status Pembayaran </td>
      <td width="24%">: <?php echo $DATA_IDENTITAS['carabayar']; ?></td>
    </tr>
    <tr>
      <td>Nama Pasien</td>
...
<table width="100%" border="1" class="tabel">
  ...
  <tr bgcolor="#ABABAB">
    ...
    <td align="right" bgcolor="#FFFFFF"><?php echo number_format($DATA_IDENTITAS['obat'], 0,",","."); ?></td>
  </tr>
  <tr>
    <td align="center" bgcolor="#FFFFFF">&nbsp;</td>
...
$dompdf->render();
$dompdf->stream('nota_pelayanan_ibs.pdf',array('Attachment' => 0));
?>