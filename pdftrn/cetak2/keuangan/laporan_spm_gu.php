...
FROM
 ...
 $queryppn = mysql_query($sqlppn);
 $DATA_PPN = mysql_fetch_array($queryppn);
...
<table width="100%" border="0">
  <tbody>
    ...
    <tr>
      <td colspan="7">Jumlah yang dicairkan dari rekening Kas BLUD RSUD Ajibarang atas pajak terutang dan selanjutnya disetor ke Bank Jateng sebagai bank persepsi pajak sebesar Rp. </td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td colspan="2">&nbsp;</td>
