...
$sqlpejabat="SELECT nama_pejabat,nip FROM simrs.master_jabatan where id_jabatan=1;";

 $querypejabat = mysql_query($sqlpejabat);
 $DATA_PEJABAT = mysql_fetch_array($querypejabat);
...
<body>
	...
	<table width="100%" border="0">
		<tr>
			...
			<td width="1%">:</td>
			<td width="80%">Bank Jateng Cabang Pembantu Ajibarang</td>
		</tr>
		<tr>
...
<table width="100%" border="0">
  <tbody>
    ...
    <tr>
      <td colspan="7">Jumlah yang dicairkan dari rekening Kas BLUD RSUD Ajibarang atas pajak terutang dan selanjutnya disetor ke Bank Jateng sebagai bank persepsi pajak sebesar Rp. <?php echo number_format($DATA_IDENTITAS['total_pajak'],0,",","."); ?></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td colspan="2">&nbsp;</td>
    ...
    <tr>
      ...
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td colspan="2" align="center">Ajibarang, <?php echo date("d-m-Y"); ?></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
