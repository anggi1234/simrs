...
FROM
    ...
    master_obat g ON f.id_obat = g.id_obat
        LEFT JOIN
    master_resep h ON a.id_master_resep = h.id_master_resep where a.id_bill_detail_permintaan_obat_master=$id_bill_detail_permintaan_obat_master and a.id_jenis_etiket=2 and (a.id_waktu_etiket = 3 OR a.id_waktu_etiket = 5
