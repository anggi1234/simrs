<?php namespace PHPMaker2021\Online; ?>
<?php
...
loadjs.ready("load", function () {
    // Startup script
    $(".login-box-msg").html("<b>Antrian Online</b>"),$(".card").prepend('<img class="card-img-top" src="Logo.jpg" alt="Card image cap">'),$(".card").addClass("cardlogin");
});
</script>
