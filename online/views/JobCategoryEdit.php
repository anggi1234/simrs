...
// Page object
$JobCategoryEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fJOB_CATEGORYedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fJOB_CATEGORYedit = currentForm = new ew.Form("fJOB_CATEGORYedit", "edit");
    ...
    // Validate form
    fJOB_CATEGORYedit.validate = function () {
    ...
    // Form_CustomValidate
    fJOB_CATEGORYedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fJOB_CATEGORYedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fJOB_CATEGORYedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fJOB_CATEGORYedit" id="fJOB_CATEGORYedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="JOB_CATEGORY" data-field="x_JOB_ID" data-hidden="1" name="o_JOB_ID" id="o_JOB_ID" value="<?= HtmlEncode($Page->JOB_ID->OldValue ?? $Page->JOB_ID->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
