...
var fV_daftardisview;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "view";
    fV_daftardisview = currentForm = new ew.Form("fV_daftardisview", "view");
    loadjs.done("fV_daftardisview");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fV_daftardisview" id="fV_daftardisview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->no_urut->Visible) { // no_urut ?>
    <tr id="r_no_urut">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_daftardis_no_urut"><?= $Page->no_urut->caption() ?></span></td>
        <td data-name="no_urut" <?= $Page->no_urut->cellAttributes() ?>>
<span id="el_V_daftardis_no_urut">
...
<?php if ($Page->tanggal_daftar->Visible) { // tanggal_daftar ?>
    <tr id="r_tanggal_daftar">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_daftardis_tanggal_daftar"><?= $Page->tanggal_daftar->caption() ?></span></td>
...
<?php if ($Page->kdpoli->Visible) { // kdpoli ?>
    <tr id="r_kdpoli">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_daftardis_kdpoli"><?= $Page->kdpoli->caption() ?></span></td>
...
<?php if ($Page->tujuan->Visible) { // tujuan ?>
    <tr id="r_tujuan">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_daftardis_tujuan"><?= $Page->tujuan->caption() ?></span></td>
...
<?php if ($Page->cetak->Visible) { // cetak ?>
    <tr id="r_cetak">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_daftardis_cetak"><?= $Page->cetak->caption() ?></span></td>
        <td data-name="cetak" <?= $Page->cetak->cellAttributes() ?>>
<span id="el_V_daftardis_cetak">
