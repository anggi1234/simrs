...
loadjs.ready("head", function () {
    ...
    fPASIENedit.addFields([
        ...
        ["TMT", [fields.TMT.visible && fields.TMT.required ? ew.Validators.required(fields.TMT.caption) : null, ew.Validators.datetime(0)], fields.TMT.isInvalid],
        ["TAT", [fields.TAT.visible && fields.TAT.required ? ew.Validators.required(fields.TAT.caption) : null, ew.Validators.datetime(0)], fields.TAT.isInvalid],
...
<input type="hidden" name="fk_NO_REGISTRATION" value="<?= HtmlEncode($Page->NAME_OF_PASIEN->getSessionValue()) ?>">
<?php } ?>
...
<?php if ($Page->NAME_OF_PASIEN->getSessionValue() != "") { ?>
<span id="el_PASIEN_NAME_OF_PASIEN">
<span<?= $Page->NAME_OF_PASIEN->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->NAME_OF_PASIEN->getDisplayValue($Page->NAME_OF_PASIEN->ViewValue))) ?>"></span>
</span>
<input type="hidden" id="x_NAME_OF_PASIEN" name="x_NAME_OF_PASIEN" value="<?= HtmlEncode($Page->NAME_OF_PASIEN->CurrentValue) ?>" data-hidden="1">
<?php } else { ?>
<span id="el_PASIEN_NAME_OF_PASIEN">
...
<input type="<?= $Page->DATE_OF_BIRTH->getInputTextType() ?>" data-table="PASIEN" data-field="x_DATE_OF_BIRTH" name="x_DATE_OF_BIRTH" id="x_DATE_OF_BIRTH" placeholder="<?= HtmlEncode($Page->DATE_OF_BIRTH->getPlaceHolder()) ?>" value="<?= $Page->DATE_OF_BIRTH->EditValue ?>"<?= $Page->DATE_OF_BIRTH->editAttributes() ?> aria-describedby="x_DATE_OF_BIRTH_help">
...
loadjs.ready(["fPASIENedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fPASIENedit", "x_DATE_OF_BIRTH", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<input type="<?= $Page->TMT->getInputTextType() ?>" data-table="PASIEN" data-field="x_TMT" name="x_TMT" id="x_TMT" placeholder="<?= HtmlEncode($Page->TMT->getPlaceHolder()) ?>" value="<?= $Page->TMT->EditValue ?>"<?= $Page->TMT->editAttributes() ?> aria-describedby="x_TMT_help">
...
<script>
loadjs.ready(["fPASIENedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fPASIENedit", "x_TMT", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<input type="<?= $Page->TAT->getInputTextType() ?>" data-table="PASIEN" data-field="x_TAT" name="x_TAT" id="x_TAT" placeholder="<?= HtmlEncode($Page->TAT->getPlaceHolder()) ?>" value="<?= $Page->TAT->EditValue ?>"<?= $Page->TAT->editAttributes() ?> aria-describedby="x_TAT_help">
...
<script>
loadjs.ready(["fPASIENedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fPASIENedit", "x_TAT", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<input type="<?= $Page->_PASSWORD->getInputTextType() ?>" data-table="PASIEN" data-field="x__PASSWORD" name="x__PASSWORD" id="x__PASSWORD" size="30" maxlength="100" placeholder="<?= HtmlEncode($Page->_PASSWORD->getPlaceHolder()) ?>" value="<?= $Page->_PASSWORD->EditValue ?>"<?= $Page->_PASSWORD->editAttributes() ?> aria-describedby="x__PASSWORD_help">
