...
loadjs.ready("head", function () {
    ...
    fANTRIAN_PENDAFTARANadd.lists.user = <?= $Page->user->toClientList($Page) ?>;
    fANTRIAN_PENDAFTARANadd.lists.kdpoli = <?= $Page->kdpoli->toClientList($Page) ?>;
...
loadjs.ready(["fANTRIAN_PENDAFTARANadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fANTRIAN_PENDAFTARANadd", "x_tanggal_daftar", {"ignoreReadonly":true,"useCurrent":false,"format":7});
});
</script>
<?php } ?>
</span>
...
<?php } ?>
    ...
    <input type="hidden" data-table="ANTRIAN_PENDAFTARAN" data-field="x_status_panggil" data-hidden="1" name="x_status_panggil" id="x_status_panggil" value="<?= HtmlEncode($Page->status_panggil->CurrentValue) ?>">
    </span>
...
<span id="el_ANTRIAN_PENDAFTARAN_kdpoli">
    <select
        ...
        data-select2-id="ANTRIAN_PENDAFTARAN_x_kdpoli"
        data-table="ANTRIAN_PENDAFTARAN"
        data-field="x_kdpoli"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='ANTRIAN_PENDAFTARAN_x_kdpoli']"),
        options = { name: "x_kdpoli", selectId: "ANTRIAN_PENDAFTARAN_x_kdpoli", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.ANTRIAN_PENDAFTARAN.fields.kdpoli.selectOptions);
...
<?php } ?>
    ...
    <input type="hidden" data-table="ANTRIAN_PENDAFTARAN" data-field="x_disabilitas" data-hidden="1" name="x_disabilitas" id="x_disabilitas" value="<?= HtmlEncode($Page->disabilitas->CurrentValue) ?>">
    </span>
</div><!-- /page* -->
<?php if (!$Page->IsModal) { ?>
