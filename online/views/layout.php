...
<link rel="shortcut icon" type="image/x-icon" href="<?= BasePath() ?>/LOGO KOTA PAGAR ALAM.ico">
<link rel="icon" type="image/x-icon" href="<?= BasePath() ?>/LOGO KOTA PAGAR ALAM.ico">
    ...
    <nav class="<?= Config("NAVBAR_CLASS") ?>">
        ...
        <ul id="ew-navbar" class="navbar-nav">
            ...
            <a class="navbar-brand d-none" href="#"  onclick="return false;">
                <span class="brand-text"><strong>Pendaftaran Online</strong></span>
            </a>
        </ul>
        <!-- Right navbar links -->
    ...
    <script type="text/html" class="ew-js-template" data-name="myDropdown" data-method="prependTo" data-target="#ew-navbar-right" data-seq="10">
        <li class="nav-item dropdown">
             <a class="nav-link" data-toggle="dropdown" href="javascript:;">
                 <?php $UserName = CurrentUserInfo("NAMA"); echo "$UserName";?>
          </a>
             <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                 <a href="AntrianLoginView/<?php $Userid = CurrentUserID();echo "$Userid";?>" class="dropdown-item">
                     <i class="fas fa-eye mr-2"></i> Lihat Profile
                 </a>
                 <div class="dropdown-divider"></div>
                 <a href="AntrianLoginEdit/<?php $Userid = CurrentUserID();echo "$Userid";?>" class="dropdown-item">
