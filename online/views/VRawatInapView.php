...
<?php if ($Page->STATUS_PASIEN_ID->Visible) { // STATUS_PASIEN_ID ?>
    <tr id="r_STATUS_PASIEN_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_STATUS_PASIEN_ID"><?= $Page->STATUS_PASIEN_ID->caption() ?></span></td>
...
<?php if ($Page->RUJUKAN_ID->Visible) { // RUJUKAN_ID ?>
    <tr id="r_RUJUKAN_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_RUJUKAN_ID"><?= $Page->RUJUKAN_ID->caption() ?></span></td>
...
<?php if ($Page->REASON_ID->Visible) { // REASON_ID ?>
    <tr id="r_REASON_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_REASON_ID"><?= $Page->REASON_ID->caption() ?></span></td>
...
<?php if ($Page->WAY_ID->Visible) { // WAY_ID ?>
    <tr id="r_WAY_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_WAY_ID"><?= $Page->WAY_ID->caption() ?></span></td>
...
<?php if ($Page->BOOKED_DATE->Visible) { // BOOKED_DATE ?>
    <tr id="r_BOOKED_DATE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_BOOKED_DATE"><?= $Page->BOOKED_DATE->caption() ?></span></td>
        <td data-name="BOOKED_DATE" <?= $Page->BOOKED_DATE->cellAttributes() ?>>
<span id="el_V_RAWAT_INAP_BOOKED_DATE">
...
<?php if ($Page->VISIT_DATE->Visible) { // VISIT_DATE ?>
    <tr id="r_VISIT_DATE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_VISIT_DATE"><?= $Page->VISIT_DATE->caption() ?></span></td>
...
<?php if ($Page->GENDER->Visible) { // GENDER ?>
    <tr id="r_GENDER">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_GENDER"><?= $Page->GENDER->caption() ?></span></td>
...
<?php if ($Page->PAYOR_ID->Visible) { // PAYOR_ID ?>
    <tr id="r_PAYOR_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_PAYOR_ID"><?= $Page->PAYOR_ID->caption() ?></span></td>
...
<?php if ($Page->CLASS_ID->Visible) { // CLASS_ID ?>
    <tr id="r_CLASS_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_CLASS_ID"><?= $Page->CLASS_ID->caption() ?></span></td>
...
<?php if ($Page->COVERAGE_ID->Visible) { // COVERAGE_ID ?>
    <tr id="r_COVERAGE_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_COVERAGE_ID"><?= $Page->COVERAGE_ID->caption() ?></span></td>
...
<?php if ($Page->NO_SKP->Visible) { // NO_SKP ?>
    <tr id="r_NO_SKP">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_NO_SKP"><?= $Page->NO_SKP->caption() ?></span></td>
...
<?php if ($Page->NO_SKPINAP->Visible) { // NO_SKPINAP ?>
    <tr id="r_NO_SKPINAP">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_NO_SKPINAP"><?= $Page->NO_SKPINAP->caption() ?></span></td>
...
<?php if ($Page->DIAGNOSA_ID->Visible) { // DIAGNOSA_ID ?>
    <tr id="r_DIAGNOSA_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_DIAGNOSA_ID"><?= $Page->DIAGNOSA_ID->caption() ?></span></td>
...
<?php if ($Page->NORUJUKAN->Visible) { // NORUJUKAN ?>
    <tr id="r_NORUJUKAN">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_NORUJUKAN"><?= $Page->NORUJUKAN->caption() ?></span></td>
...
<?php if ($Page->PPKRUJUKAN->Visible) { // PPKRUJUKAN ?>
    <tr id="r_PPKRUJUKAN">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_PPKRUJUKAN"><?= $Page->PPKRUJUKAN->caption() ?></span></td>
...
<?php if ($Page->EDIT_SEP->Visible) { // EDIT_SEP ?>
    <tr id="r_EDIT_SEP">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_EDIT_SEP"><?= $Page->EDIT_SEP->caption() ?></span></td>
...
<?php if ($Page->DIAG_AWAL->Visible) { // DIAG_AWAL ?>
    <tr id="r_DIAG_AWAL">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_DIAG_AWAL"><?= $Page->DIAG_AWAL->caption() ?></span></td>
...
<?php if ($Page->COB->Visible) { // COB ?>
    <tr id="r_COB">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_COB"><?= $Page->COB->caption() ?></span></td>
...
<?php if ($Page->ASALRUJUKAN->Visible) { // ASALRUJUKAN ?>
    <tr id="r_ASALRUJUKAN">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_ASALRUJUKAN"><?= $Page->ASALRUJUKAN->caption() ?></span></td>
