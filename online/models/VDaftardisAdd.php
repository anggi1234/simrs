 ...
 * Page class
 */
class VDaftardisAdd extends VDaftardis
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VDaftardisAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("VDaftardisList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    $returnUrl = "VDaftardisList";
                    if (GetPageName($returnUrl) == "VDaftardisList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "VDaftardisView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->disabilitas->CurrentValue = 1;
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("VDaftardisList"), "", $this->TableVar, true);
