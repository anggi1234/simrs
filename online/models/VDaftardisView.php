 ...
 * Page class
 */
class VDaftardisView extends VDaftardis
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VDaftardisView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("Id") ?? Route("Id")) !== null) {
                ...
                $returnUrl = "VDaftardisList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "VDaftardisList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "VDaftardisList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
