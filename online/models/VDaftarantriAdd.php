 ...
 * Page class
 */
class VDaftarantriAdd extends VDaftarantri
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VDaftarantriAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("VDaftarantriList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    $returnUrl = "VDaftarantriList";
                    if (GetPageName($returnUrl) == "VDaftarantriList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "VDaftarantriView") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("VDaftarantriList"), "", $this->TableVar, true);
