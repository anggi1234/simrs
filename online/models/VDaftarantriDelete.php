 ...
 * Page class
 */
class VDaftarantriDelete extends VDaftarantri
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VDaftarantriDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("VDaftarantriList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("VDaftarantriList"); // Return to list
            return;
        }
