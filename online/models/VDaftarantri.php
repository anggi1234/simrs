...
/**
 * Table class for V_daftarantri
 */
class VDaftarantri extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'V_daftarantri';
        $this->TableName = 'V_daftarantri';
        ...
        // Id
        $this->Id = new DbField('V_daftarantri', 'V_daftarantri', 'x_Id', 'Id', '[Id]', 'CAST([Id] AS NVARCHAR)', 20, 8, -1, false, '[Id]', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // no_urut
        $this->no_urut = new DbField('V_daftarantri', 'V_daftarantri', 'x_no_urut', 'no_urut', '[no_urut]', 'CAST([no_urut] AS NVARCHAR)', 20, 8, -1, false, '[no_urut]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tanggal_daftar
        $this->tanggal_daftar = new DbField('V_daftarantri', 'V_daftarantri', 'x_tanggal_daftar', 'tanggal_daftar', '[tanggal_daftar]', CastDateFieldForLike("[tanggal_daftar]", 7, "DB"), 135, 8, 7, false, '[tanggal_daftar]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tanggal_panggil
        $this->tanggal_panggil = new DbField('V_daftarantri', 'V_daftarantri', 'x_tanggal_panggil', 'tanggal_panggil', '[tanggal_panggil]', CastDateFieldForLike("[tanggal_panggil]", 0, "DB"), 135, 8, 0, false, '[tanggal_panggil]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // loket
        $this->loket = new DbField('V_daftarantri', 'V_daftarantri', 'x_loket', 'loket', '[loket]', '[loket]', 200, 10, -1, false, '[loket]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status_panggil
        $this->status_panggil = new DbField('V_daftarantri', 'V_daftarantri', 'x_status_panggil', 'status_panggil', '[status_panggil]', 'CAST([status_panggil] AS NVARCHAR)', 3, 4, -1, false, '[status_panggil]', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // user
        $this->user = new DbField('V_daftarantri', 'V_daftarantri', 'x_user', 'user', '[user]', 'CAST([user] AS NVARCHAR)', 20, 8, -1, false, '[user]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // newapp
        $this->newapp = new DbField('V_daftarantri', 'V_daftarantri', 'x_newapp', 'newapp', 'dbo.ANTRIAN_PENDAFTARAN.newapp', 'CAST(dbo.ANTRIAN_PENDAFTARAN.newapp AS NVARCHAR)', 3, 4, -1, false, 'dbo.ANTRIAN_PENDAFTARAN.newapp', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // kdpoli
        $this->kdpoli = new DbField('V_daftarantri', 'V_daftarantri', 'x_kdpoli', 'kdpoli', '[kdpoli]', '[kdpoli]', 200, 10, -1, false, '[kdpoli]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // tanggal_pesan
        $this->tanggal_pesan = new DbField('V_daftarantri', 'V_daftarantri', 'x_tanggal_pesan', 'tanggal_pesan', '[tanggal_pesan]', CastDateFieldForLike("[tanggal_pesan]", 0, "DB"), 135, 8, 0, false, '[tanggal_pesan]', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // tujuan
        $this->tujuan = new DbField('V_daftarantri', 'V_daftarantri', 'x_tujuan', 'tujuan', '[tujuan]', '[tujuan]', 200, 255, -1, false, '[tujuan]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // disabilitas
        $this->disabilitas = new DbField('V_daftarantri', 'V_daftarantri', 'x_disabilitas', 'disabilitas', 'dbo.ANTRIAN_PENDAFTARAN.disabilitas', 'CAST(dbo.ANTRIAN_PENDAFTARAN.disabilitas AS NVARCHAR)', 3, 4, -1, false, 'dbo.ANTRIAN_PENDAFTARAN.disabilitas', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // cetak
        $this->cetak = new DbField('V_daftarantri', 'V_daftarantri', 'x_cetak', 'cetak', '\'\'', '\'\'', 200, 1, -1, false, '\'\'', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("dbo.ANTRIAN_PENDAFTARAN.*, '' AS [cetak]");
    }
    ...
    {
        $where = ($this->SqlWhere != "") ? $this->SqlWhere : "dbo.ANTRIAN_PENDAFTARAN.newapp = 1 AND dbo.ANTRIAN_PENDAFTARAN.disabilitas = 0";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VDaftarantriList");
    }
    ...
    {
        global $Language;
        if ($pageName == "VDaftarantriView") {
            return $Language->phrase("View");
        } elseif ($pageName == "VDaftarantriEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VDaftarantriAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "VDaftarantriView";
            case Config("API_ADD_ACTION"):
                return "VDaftarantriAdd";
            case Config("API_EDIT_ACTION"):
                return "VDaftarantriEdit";
            case Config("API_DELETE_ACTION"):
                return "VDaftarantriDelete";
            case Config("API_LIST_ACTION"):
                return "VDaftarantriList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VDaftarantriView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VDaftarantriView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VDaftarantriAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VDaftarantriAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("VDaftarantriEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VDaftarantriAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VDaftarantriDelete", $this->getUrlParm());
    }
