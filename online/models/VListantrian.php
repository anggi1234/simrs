...
/**
 * Table class for V_Listantrian
 */
class VListantrian extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'V_Listantrian';
        $this->TableName = 'V_Listantrian';
        ...
        // no_urut
        $this->no_urut = new DbField('V_Listantrian', 'V_Listantrian', 'x_no_urut', 'no_urut', 'dbo.ANTRIAN_PENDAFTARAN.no_urut', 'CAST(dbo.ANTRIAN_PENDAFTARAN.no_urut AS NVARCHAR)', 20, 8, -1, false, 'dbo.ANTRIAN_PENDAFTARAN.no_urut', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // user
        $this->user = new DbField('V_Listantrian', 'V_Listantrian', 'x_user', 'user', 'dbo.ANTRIAN_PENDAFTARAN.[user]', 'CAST(dbo.ANTRIAN_PENDAFTARAN.[user] AS NVARCHAR)', 20, 8, -1, false, 'dbo.ANTRIAN_PENDAFTARAN.[user]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tanggal_daftar
        $this->tanggal_daftar = new DbField('V_Listantrian', 'V_Listantrian', 'x_tanggal_daftar', 'tanggal_daftar', 'dbo.ANTRIAN_PENDAFTARAN.tanggal_daftar', CastDateFieldForLike("dbo.ANTRIAN_PENDAFTARAN.tanggal_daftar", 7, "DB"), 135, 8, 7, false, 'dbo.ANTRIAN_PENDAFTARAN.tanggal_daftar', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tanggal_panggil
        $this->tanggal_panggil = new DbField('V_Listantrian', 'V_Listantrian', 'x_tanggal_panggil', 'tanggal_panggil', 'dbo.ANTRIAN_PENDAFTARAN.tanggal_panggil', CastDateFieldForLike("dbo.ANTRIAN_PENDAFTARAN.tanggal_panggil", 0, "DB"), 135, 8, 0, false, 'dbo.ANTRIAN_PENDAFTARAN.tanggal_panggil', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // loket
        $this->loket = new DbField('V_Listantrian', 'V_Listantrian', 'x_loket', 'loket', 'dbo.ANTRIAN_PENDAFTARAN.loket', 'dbo.ANTRIAN_PENDAFTARAN.loket', 200, 10, -1, false, 'dbo.ANTRIAN_PENDAFTARAN.loket', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status_panggil
        $this->status_panggil = new DbField('V_Listantrian', 'V_Listantrian', 'x_status_panggil', 'status_panggil', 'dbo.ANTRIAN_PENDAFTARAN.status_panggil', 'CAST(dbo.ANTRIAN_PENDAFTARAN.status_panggil AS NVARCHAR)', 3, 4, -1, false, 'dbo.ANTRIAN_PENDAFTARAN.status_panggil', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // newapp
        $this->newapp = new DbField('V_Listantrian', 'V_Listantrian', 'x_newapp', 'newapp', 'dbo.ANTRIAN_PENDAFTARAN.newapp', 'CAST(dbo.ANTRIAN_PENDAFTARAN.newapp AS NVARCHAR)', 3, 4, -1, false, 'dbo.ANTRIAN_PENDAFTARAN.newapp', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // kdpoli
        $this->kdpoli = new DbField('V_Listantrian', 'V_Listantrian', 'x_kdpoli', 'kdpoli', 'dbo.ANTRIAN_PENDAFTARAN.kdpoli', 'dbo.ANTRIAN_PENDAFTARAN.kdpoli', 200, 10, -1, false, 'dbo.ANTRIAN_PENDAFTARAN.kdpoli', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // tanggal_pesan
        $this->tanggal_pesan = new DbField('V_Listantrian', 'V_Listantrian', 'x_tanggal_pesan', 'tanggal_pesan', 'dbo.ANTRIAN_PENDAFTARAN.tanggal_pesan', CastDateFieldForLike("dbo.ANTRIAN_PENDAFTARAN.tanggal_pesan", 0, "DB"), 135, 8, 0, false, 'dbo.ANTRIAN_PENDAFTARAN.tanggal_pesan', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // tujuan
        $this->tujuan = new DbField('V_Listantrian', 'V_Listantrian', 'x_tujuan', 'tujuan', 'dbo.ANTRIAN_PENDAFTARAN.tujuan', 'dbo.ANTRIAN_PENDAFTARAN.tujuan', 200, 255, -1, false, 'dbo.ANTRIAN_PENDAFTARAN.tujuan', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // disabilitas
        $this->disabilitas = new DbField('V_Listantrian', 'V_Listantrian', 'x_disabilitas', 'disabilitas', 'dbo.ANTRIAN_PENDAFTARAN.disabilitas', 'CAST(dbo.ANTRIAN_PENDAFTARAN.disabilitas AS NVARCHAR)', 3, 4, -1, false, 'dbo.ANTRIAN_PENDAFTARAN.disabilitas', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // FOTO
        $this->FOTO = new DbField('V_Listantrian', 'V_Listantrian', 'x_FOTO', 'FOTO', 'dbo.ANTRIAN_LOGIN.FOTO', 'dbo.ANTRIAN_LOGIN.FOTO', 200, 50, -1, false, 'dbo.ANTRIAN_LOGIN.FOTO', false, false, false, 'IMAGE', 'TEXT');
        ...
        // NOMR
        $this->NOMR = new DbField('V_Listantrian', 'V_Listantrian', 'x_NOMR', 'NOMR', 'dbo.ANTRIAN_LOGIN.NOMR', 'dbo.ANTRIAN_LOGIN.NOMR', 200, 25, -1, false, 'dbo.ANTRIAN_LOGIN.NOMR', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NO_BPJS
        $this->NO_BPJS = new DbField('V_Listantrian', 'V_Listantrian', 'x_NO_BPJS', 'NO_BPJS', 'dbo.ANTRIAN_LOGIN.NO_BPJS', 'dbo.ANTRIAN_LOGIN.NO_BPJS', 200, 30, -1, false, 'dbo.ANTRIAN_LOGIN.NO_BPJS', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NAMA
        $this->NAMA = new DbField('V_Listantrian', 'V_Listantrian', 'x_NAMA', 'NAMA', 'dbo.ANTRIAN_LOGIN.NAMA', 'dbo.ANTRIAN_LOGIN.NAMA', 200, 100, -1, false, 'dbo.ANTRIAN_LOGIN.NAMA', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->NAMA->Sortable = false; // Allow sort
        $this->NAMA->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->NAMA->Param, "CustomMsg");
        $this->Fields['NAMA'] = &$this->NAMA;

        // TEMPAT_LAHIR
        $this->TEMPAT_LAHIR = new DbField('V_Listantrian', 'V_Listantrian', 'x_TEMPAT_LAHIR', 'TEMPAT_LAHIR', 'dbo.ANTRIAN_LOGIN.TEMPAT_LAHIR', 'dbo.ANTRIAN_LOGIN.TEMPAT_LAHIR', 200, 50, -1, false, 'dbo.ANTRIAN_LOGIN.TEMPAT_LAHIR', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TANGGAL_LAHIR
        $this->TANGGAL_LAHIR = new DbField('V_Listantrian', 'V_Listantrian', 'x_TANGGAL_LAHIR', 'TANGGAL_LAHIR', 'dbo.ANTRIAN_LOGIN.TANGGAL_LAHIR', CastDateFieldForLike("dbo.ANTRIAN_LOGIN.TANGGAL_LAHIR", 0, "DB"), 135, 8, 0, false, 'dbo.ANTRIAN_LOGIN.TANGGAL_LAHIR', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // JENIS_KELAMIN
        $this->JENIS_KELAMIN = new DbField('V_Listantrian', 'V_Listantrian', 'x_JENIS_KELAMIN', 'JENIS_KELAMIN', 'dbo.ANTRIAN_LOGIN.JENIS_KELAMIN', 'dbo.ANTRIAN_LOGIN.JENIS_KELAMIN', 129, 1, -1, false, 'dbo.ANTRIAN_LOGIN.JENIS_KELAMIN', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AGAMA
        $this->AGAMA = new DbField('V_Listantrian', 'V_Listantrian', 'x_AGAMA', 'AGAMA', 'dbo.ANTRIAN_LOGIN.AGAMA', 'CAST(dbo.ANTRIAN_LOGIN.AGAMA AS NVARCHAR)', 17, 1, -1, false, 'dbo.ANTRIAN_LOGIN.AGAMA', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PEKERJAAN
        $this->PEKERJAAN = new DbField('V_Listantrian', 'V_Listantrian', 'x_PEKERJAAN', 'PEKERJAAN', 'dbo.ANTRIAN_LOGIN.PEKERJAAN', 'CAST(dbo.ANTRIAN_LOGIN.PEKERJAAN AS NVARCHAR)', 17, 1, -1, false, 'dbo.ANTRIAN_LOGIN.PEKERJAAN', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ALAMAT
        $this->ALAMAT = new DbField('V_Listantrian', 'V_Listantrian', 'x_ALAMAT', 'ALAMAT', 'dbo.ANTRIAN_LOGIN.ALAMAT', 'dbo.ANTRIAN_LOGIN.ALAMAT', 200, 100, -1, false, 'dbo.ANTRIAN_LOGIN.ALAMAT', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // NO_TELP
        $this->NO_TELP = new DbField('V_Listantrian', 'V_Listantrian', 'x_NO_TELP', 'NO_TELP', 'dbo.ANTRIAN_LOGIN.NO_TELP', 'dbo.ANTRIAN_LOGIN.NO_TELP', 200, 20, -1, false, 'dbo.ANTRIAN_LOGIN.NO_TELP', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NO_HP
        $this->NO_HP = new DbField('V_Listantrian', 'V_Listantrian', 'x_NO_HP', 'NO_HP', 'dbo.ANTRIAN_LOGIN.NO_HP', 'dbo.ANTRIAN_LOGIN.NO_HP', 200, 20, -1, false, 'dbo.ANTRIAN_LOGIN.NO_HP', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EMAIL
        $this->_EMAIL = new DbField('V_Listantrian', 'V_Listantrian', 'x__EMAIL', 'EMAIL', 'dbo.ANTRIAN_LOGIN.EMAIL', 'dbo.ANTRIAN_LOGIN.EMAIL', 200, 50, -1, false, 'dbo.ANTRIAN_LOGIN.EMAIL', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TANGGAL_REGIS
        $this->TANGGAL_REGIS = new DbField('V_Listantrian', 'V_Listantrian', 'x_TANGGAL_REGIS', 'TANGGAL_REGIS', 'dbo.ANTRIAN_LOGIN.TANGGAL_REGIS', CastDateFieldForLike("dbo.ANTRIAN_LOGIN.TANGGAL_REGIS", 0, "DB"), 135, 8, 0, false, 'dbo.ANTRIAN_LOGIN.TANGGAL_REGIS', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NAMA_IBU
        $this->NAMA_IBU = new DbField('V_Listantrian', 'V_Listantrian', 'x_NAMA_IBU', 'NAMA_IBU', 'dbo.ANTRIAN_LOGIN.NAMA_IBU', 'dbo.ANTRIAN_LOGIN.NAMA_IBU', 200, 150, -1, false, 'dbo.ANTRIAN_LOGIN.NAMA_IBU', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NAMA_AYAH
        $this->NAMA_AYAH = new DbField('V_Listantrian', 'V_Listantrian', 'x_NAMA_AYAH', 'NAMA_AYAH', 'dbo.ANTRIAN_LOGIN.NAMA_AYAH', 'dbo.ANTRIAN_LOGIN.NAMA_AYAH', 200, 150, -1, false, 'dbo.ANTRIAN_LOGIN.NAMA_AYAH', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NAMA_PASANGAN
        $this->NAMA_PASANGAN = new DbField('V_Listantrian', 'V_Listantrian', 'x_NAMA_PASANGAN', 'NAMA_PASANGAN', 'dbo.ANTRIAN_LOGIN.NAMA_PASANGAN', 'dbo.ANTRIAN_LOGIN.NAMA_PASANGAN', 200, 150, -1, false, 'dbo.ANTRIAN_LOGIN.NAMA_PASANGAN', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // A
        $this->A = new DbField('V_Listantrian', 'V_Listantrian', 'x_A', 'A', 'dbo.ANTRIAN_PENDAFTARAN.Id', 'CAST(dbo.ANTRIAN_PENDAFTARAN.Id AS NVARCHAR)', 20, 8, -1, false, 'dbo.ANTRIAN_PENDAFTARAN.Id', false, false, false, 'FORMATTED TEXT', 'NO');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VListantrianList");
    }
    ...
    {
        global $Language;
        if ($pageName == "VListantrianView") {
            return $Language->phrase("View");
        } elseif ($pageName == "VListantrianEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VListantrianAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "VListantrianView";
            case Config("API_ADD_ACTION"):
                return "VListantrianAdd";
            case Config("API_EDIT_ACTION"):
                return "VListantrianEdit";
            case Config("API_DELETE_ACTION"):
                return "VListantrianDelete";
            case Config("API_LIST_ACTION"):
                return "VListantrianList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VListantrianView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VListantrianView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VListantrianAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VListantrianAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("VListantrianEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VListantrianAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VListantrianDelete", $this->getUrlParm());
    }
