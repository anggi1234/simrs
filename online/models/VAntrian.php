...
/**
 * Table class for V_antrian
 */
class VAntrian extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'V_antrian';
        $this->TableName = 'V_antrian';
        $this->TableType = 'CUSTOMVIEW';

        // Update Table
        $this->UpdateTable = "ANTRIAN_PENDAFTARAN LEFT JOIN ANTRIAN_LOGIN ON ANTRIAN_PENDAFTARAN.[user] = ANTRIAN_LOGIN.[ID]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // FOTO
        $this->FOTO = new DbField('V_antrian', 'V_antrian', 'x_FOTO', 'FOTO', 'ANTRIAN_LOGIN.FOTO', 'ANTRIAN_LOGIN.FOTO', 200, 50, -1, false, 'ANTRIAN_LOGIN.FOTO', false, false, false, 'IMAGE', 'TEXT');
        ...
        // no_urut
        $this->no_urut = new DbField('V_antrian', 'V_antrian', 'x_no_urut', 'no_urut', 'ANTRIAN_PENDAFTARAN.no_urut', 'CAST(ANTRIAN_PENDAFTARAN.no_urut AS NVARCHAR)', 20, 8, -1, false, 'ANTRIAN_PENDAFTARAN.no_urut', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tanggal_daftar
        $this->tanggal_daftar = new DbField('V_antrian', 'V_antrian', 'x_tanggal_daftar', 'tanggal_daftar', 'ANTRIAN_PENDAFTARAN.tanggal_daftar', CastDateFieldForLike("ANTRIAN_PENDAFTARAN.tanggal_daftar", 7, "DB"), 135, 8, 7, false, 'ANTRIAN_PENDAFTARAN.tanggal_daftar', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tanggal_panggil
        $this->tanggal_panggil = new DbField('V_antrian', 'V_antrian', 'x_tanggal_panggil', 'tanggal_panggil', 'ANTRIAN_PENDAFTARAN.tanggal_panggil', CastDateFieldForLike("ANTRIAN_PENDAFTARAN.tanggal_panggil", 0, "DB"), 135, 8, 0, false, 'ANTRIAN_PENDAFTARAN.tanggal_panggil', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // loket
        $this->loket = new DbField('V_antrian', 'V_antrian', 'x_loket', 'loket', 'ANTRIAN_PENDAFTARAN.loket', 'ANTRIAN_PENDAFTARAN.loket', 200, 10, -1, false, 'ANTRIAN_PENDAFTARAN.loket', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status_panggil
        $this->status_panggil = new DbField('V_antrian', 'V_antrian', 'x_status_panggil', 'status_panggil', 'ANTRIAN_PENDAFTARAN.status_panggil', 'CAST(ANTRIAN_PENDAFTARAN.status_panggil AS NVARCHAR)', 3, 4, -1, false, 'ANTRIAN_PENDAFTARAN.status_panggil', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // user
        $this->user = new DbField('V_antrian', 'V_antrian', 'x_user', 'user', 'ANTRIAN_PENDAFTARAN.[user]', 'CAST(ANTRIAN_PENDAFTARAN.[user] AS NVARCHAR)', 20, 8, -1, false, 'ANTRIAN_PENDAFTARAN.[user]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // newapp
        $this->newapp = new DbField('V_antrian', 'V_antrian', 'x_newapp', 'newapp', 'ANTRIAN_PENDAFTARAN.newapp', 'CAST(ANTRIAN_PENDAFTARAN.newapp AS NVARCHAR)', 3, 4, -1, false, 'ANTRIAN_PENDAFTARAN.newapp', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // kdpoli
        $this->kdpoli = new DbField('V_antrian', 'V_antrian', 'x_kdpoli', 'kdpoli', 'ANTRIAN_PENDAFTARAN.kdpoli', 'ANTRIAN_PENDAFTARAN.kdpoli', 200, 10, -1, false, 'ANTRIAN_PENDAFTARAN.kdpoli', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // tanggal_pesan
        $this->tanggal_pesan = new DbField('V_antrian', 'V_antrian', 'x_tanggal_pesan', 'tanggal_pesan', 'ANTRIAN_PENDAFTARAN.tanggal_pesan', CastDateFieldForLike("ANTRIAN_PENDAFTARAN.tanggal_pesan", 0, "DB"), 135, 8, 0, false, 'ANTRIAN_PENDAFTARAN.tanggal_pesan', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // tujuan
        $this->tujuan = new DbField('V_antrian', 'V_antrian', 'x_tujuan', 'tujuan', 'ANTRIAN_PENDAFTARAN.tujuan', 'ANTRIAN_PENDAFTARAN.tujuan', 200, 255, -1, false, 'ANTRIAN_PENDAFTARAN.tujuan', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // disabilitas
        $this->disabilitas = new DbField('V_antrian', 'V_antrian', 'x_disabilitas', 'disabilitas', 'ANTRIAN_PENDAFTARAN.disabilitas', 'CAST(ANTRIAN_PENDAFTARAN.disabilitas AS NVARCHAR)', 3, 4, -1, false, 'ANTRIAN_PENDAFTARAN.disabilitas', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // NOMR
        $this->NOMR = new DbField('V_antrian', 'V_antrian', 'x_NOMR', 'NOMR', 'ANTRIAN_LOGIN.NOMR', 'ANTRIAN_LOGIN.NOMR', 200, 25, -1, false, 'ANTRIAN_LOGIN.NOMR', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NO_BPJS
        $this->NO_BPJS = new DbField('V_antrian', 'V_antrian', 'x_NO_BPJS', 'NO_BPJS', 'ANTRIAN_LOGIN.NO_BPJS', 'ANTRIAN_LOGIN.NO_BPJS', 200, 30, -1, false, 'ANTRIAN_LOGIN.NO_BPJS', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NAMA
        $this->NAMA = new DbField('V_antrian', 'V_antrian', 'x_NAMA', 'NAMA', 'ANTRIAN_LOGIN.NAMA', 'ANTRIAN_LOGIN.NAMA', 200, 100, -1, false, 'ANTRIAN_LOGIN.NAMA', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->NAMA->Sortable = true; // Allow sort
        $this->NAMA->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->NAMA->Param, "CustomMsg");
        $this->Fields['NAMA'] = &$this->NAMA;

        // TEMPAT_LAHIR
        $this->TEMPAT_LAHIR = new DbField('V_antrian', 'V_antrian', 'x_TEMPAT_LAHIR', 'TEMPAT_LAHIR', 'ANTRIAN_LOGIN.TEMPAT_LAHIR', 'ANTRIAN_LOGIN.TEMPAT_LAHIR', 200, 50, -1, false, 'ANTRIAN_LOGIN.TEMPAT_LAHIR', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TANGGAL_LAHIR
        $this->TANGGAL_LAHIR = new DbField('V_antrian', 'V_antrian', 'x_TANGGAL_LAHIR', 'TANGGAL_LAHIR', 'ANTRIAN_LOGIN.TANGGAL_LAHIR', CastDateFieldForLike("ANTRIAN_LOGIN.TANGGAL_LAHIR", 0, "DB"), 135, 8, 0, false, 'ANTRIAN_LOGIN.TANGGAL_LAHIR', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // JENIS_KELAMIN
        $this->JENIS_KELAMIN = new DbField('V_antrian', 'V_antrian', 'x_JENIS_KELAMIN', 'JENIS_KELAMIN', 'ANTRIAN_LOGIN.JENIS_KELAMIN', 'ANTRIAN_LOGIN.JENIS_KELAMIN', 129, 1, -1, false, 'ANTRIAN_LOGIN.JENIS_KELAMIN', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AGAMA
        $this->AGAMA = new DbField('V_antrian', 'V_antrian', 'x_AGAMA', 'AGAMA', 'ANTRIAN_LOGIN.AGAMA', 'CAST(ANTRIAN_LOGIN.AGAMA AS NVARCHAR)', 17, 1, -1, false, 'ANTRIAN_LOGIN.AGAMA', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PEKERJAAN
        $this->PEKERJAAN = new DbField('V_antrian', 'V_antrian', 'x_PEKERJAAN', 'PEKERJAAN', 'ANTRIAN_LOGIN.PEKERJAAN', 'CAST(ANTRIAN_LOGIN.PEKERJAAN AS NVARCHAR)', 17, 1, -1, false, 'ANTRIAN_LOGIN.PEKERJAAN', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ALAMAT
        $this->ALAMAT = new DbField('V_antrian', 'V_antrian', 'x_ALAMAT', 'ALAMAT', 'ANTRIAN_LOGIN.ALAMAT', 'ANTRIAN_LOGIN.ALAMAT', 200, 100, -1, false, 'ANTRIAN_LOGIN.ALAMAT', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->ALAMAT->Sortable = true; // Allow sort
        $this->ALAMAT->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ALAMAT->Param, "CustomMsg");
        $this->Fields['ALAMAT'] = &$this->ALAMAT;

        // NO_TELP
        $this->NO_TELP = new DbField('V_antrian', 'V_antrian', 'x_NO_TELP', 'NO_TELP', 'ANTRIAN_LOGIN.NO_TELP', 'ANTRIAN_LOGIN.NO_TELP', 200, 20, -1, false, 'ANTRIAN_LOGIN.NO_TELP', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NO_HP
        $this->NO_HP = new DbField('V_antrian', 'V_antrian', 'x_NO_HP', 'NO_HP', 'ANTRIAN_LOGIN.NO_HP', 'ANTRIAN_LOGIN.NO_HP', 200, 20, -1, false, 'ANTRIAN_LOGIN.NO_HP', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EMAIL
        $this->_EMAIL = new DbField('V_antrian', 'V_antrian', 'x__EMAIL', 'EMAIL', 'ANTRIAN_LOGIN.EMAIL', 'ANTRIAN_LOGIN.EMAIL', 200, 50, -1, false, 'ANTRIAN_LOGIN.EMAIL', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->_EMAIL->Sortable = true; // Allow sort
        $this->_EMAIL->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->_EMAIL->Param, "CustomMsg");
        $this->Fields['EMAIL'] = &$this->_EMAIL;

        // TANGGAL_REGIS
        $this->TANGGAL_REGIS = new DbField('V_antrian', 'V_antrian', 'x_TANGGAL_REGIS', 'TANGGAL_REGIS', 'ANTRIAN_LOGIN.TANGGAL_REGIS', CastDateFieldForLike("ANTRIAN_LOGIN.TANGGAL_REGIS", 0, "DB"), 135, 8, 0, false, 'ANTRIAN_LOGIN.TANGGAL_REGIS', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NAMA_IBU
        $this->NAMA_IBU = new DbField('V_antrian', 'V_antrian', 'x_NAMA_IBU', 'NAMA_IBU', 'ANTRIAN_LOGIN.NAMA_IBU', 'ANTRIAN_LOGIN.NAMA_IBU', 200, 150, -1, false, 'ANTRIAN_LOGIN.NAMA_IBU', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NAMA_AYAH
        $this->NAMA_AYAH = new DbField('V_antrian', 'V_antrian', 'x_NAMA_AYAH', 'NAMA_AYAH', 'ANTRIAN_LOGIN.NAMA_AYAH', 'ANTRIAN_LOGIN.NAMA_AYAH', 200, 150, -1, false, 'ANTRIAN_LOGIN.NAMA_AYAH', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NAMA_PASANGAN
        $this->NAMA_PASANGAN = new DbField('V_antrian', 'V_antrian', 'x_NAMA_PASANGAN', 'NAMA_PASANGAN', 'ANTRIAN_LOGIN.NAMA_PASANGAN', 'ANTRIAN_LOGIN.NAMA_PASANGAN', 200, 150, -1, false, 'ANTRIAN_LOGIN.NAMA_PASANGAN', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // B
        $this->B = new DbField('V_antrian', 'V_antrian', 'x_B', 'B', 'ANTRIAN_PENDAFTARAN.Id', 'CAST(ANTRIAN_PENDAFTARAN.Id AS NVARCHAR)', 20, 8, -1, false, 'ANTRIAN_PENDAFTARAN.Id', false, false, false, 'FORMATTED TEXT', 'NO');
        $this->B->IsAutoIncrement = true; // Autoincrement field
        $this->B->IsPrimaryKey = true; // Primary key field
        $this->B->Nullable = false; // NOT NULL field
        $this->B->Sortable = true; // Allow sort
        $this->B->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->B->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->B->Param, "CustomMsg");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "ANTRIAN_PENDAFTARAN LEFT JOIN ANTRIAN_LOGIN ON ANTRIAN_PENDAFTARAN.[user] = ANTRIAN_LOGIN.[ID]";
    }
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("ANTRIAN_PENDAFTARAN.[Id] AS B, ANTRIAN_PENDAFTARAN.no_urut, ANTRIAN_PENDAFTARAN.tanggal_daftar, ANTRIAN_PENDAFTARAN.tanggal_panggil, ANTRIAN_PENDAFTARAN.loket, ANTRIAN_PENDAFTARAN.status_panggil, ANTRIAN_PENDAFTARAN.[user], ANTRIAN_PENDAFTARAN.newapp, ANTRIAN_PENDAFTARAN.kdpoli, ANTRIAN_PENDAFTARAN.tanggal_pesan, ANTRIAN_PENDAFTARAN.tujuan, ANTRIAN_PENDAFTARAN.disabilitas, ANTRIAN_LOGIN.NOMR, ANTRIAN_LOGIN.NO_BPJS, ANTRIAN_LOGIN.NAMA, ANTRIAN_LOGIN.TEMPAT_LAHIR, ANTRIAN_LOGIN.TANGGAL_LAHIR, ANTRIAN_LOGIN.JENIS_KELAMIN, ANTRIAN_LOGIN.AGAMA, ANTRIAN_LOGIN.PEKERJAAN, ANTRIAN_LOGIN.ALAMAT, ANTRIAN_LOGIN.NO_TELP, ANTRIAN_LOGIN.NO_HP, ANTRIAN_LOGIN.EMAIL, ANTRIAN_LOGIN.FOTO, ANTRIAN_LOGIN.TANGGAL_REGIS, ANTRIAN_LOGIN.NAMA_IBU, ANTRIAN_LOGIN.NAMA_AYAH, ANTRIAN_LOGIN.NAMA_PASANGAN");
    }
    ...
    public function getSqlWhere() // Where
    {
        ...
        $this->DefaultFilter = "[newapp] = 1 and [disabilitas] = 0";
    ...
    public function insert(&$rs)
    {
        ...
        if ($success) {
            ...
            $this->B->setDbValue($conn->lastInsertId());
            $rs['B'] = $this->B->DbValue;
        }
        return $success;
    }
    ...
    protected function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('B', $rs)) {
                AddFilter($where, QuotedName('B', $this->Dbid) . '=' . QuotedValue($rs['B'], $this->B->DataType, $this->Dbid));
            }
        }
        $filter = ($curfilter) ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    {
        return "ANTRIAN_PENDAFTARAN.Id = @B@";
    }
    ...
    {
        $keys = [];
        $val = $current ? $this->B->CurrentValue : $this->B->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->B->CurrentValue = $keys[0];
            } else {
                $this->B->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('B', $row) ? $row['B'] : null;
        } else {
            $val = $this->B->OldValue !== null ? $this->B->OldValue : $this->B->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@B@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VAntrianList");
    }
    ...
    {
        global $Language;
        if ($pageName == "VAntrianView") {
            return $Language->phrase("View");
        } elseif ($pageName == "VAntrianEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VAntrianAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VAntrianView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VAntrianView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VAntrianAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VAntrianAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("VAntrianEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VAntrianAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VAntrianDelete", $this->getUrlParm());
    }
    ...
    {
        $json = "";
        $json .= "B:" . JsonEncode($this->B->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->B->CurrentValue !== null) {
            $url .= "/" . rawurlencode($this->B->CurrentValue);
        } else {
...
SORTHTML;
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            if (($keyValue = Param("B") ?? Route("B")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function addUserIDFilter($filter = "")
    {
        ...
        if (!$this->userIDAllow($id) && !$Security->isAdmin()) {
            ...
            if ($filterWrk != "") {
                $filterWrk = 'ANTRIAN_PENDAFTARAN.[user] IN (' . $filterWrk . ')';
            }
        }
    ...
    public function getUserIDSubquery(&$fld, &$masterfld)
    {
        global $UserTable;
        $wrk = "";
        $sql = "SELECT " . $masterfld->Expression . " FROM ANTRIAN_PENDAFTARAN LEFT JOIN ANTRIAN_LOGIN ON ANTRIAN_PENDAFTARAN.[user] = ANTRIAN_LOGIN.[ID]";
