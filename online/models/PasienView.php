...
class PasienView extends Pasien
{
    ...
    protected function setupOtherOptions()
    {
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("PasienVisitationList?" . Config("TABLE_SHOW_MASTER") . "=PASIEN&" . GetForeignKeyUrl("fk_NO_REGISTRATION", $this->NO_REGISTRATION->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
