 ...
 * Page class
 */
class VPendaftaranDelete extends VPendaftaran
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VPendaftaranDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("VPendaftaranList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("VPendaftaranList"); // Return to list
                return;
            }
        }
