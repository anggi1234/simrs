 ...
 * Page class
 */
class VDaftarantriView extends VDaftarantri
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VDaftarantriView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("Id") ?? Route("Id")) !== null) {
                ...
                $returnUrl = "VDaftarantriList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "VDaftarantriList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "VDaftarantriList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
