...
class MAlatCssd extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id_set
        $this->id_set = new DbField('m_alat_cssd', 'm_alat_cssd', 'x_id_set', 'id_set', '[id_set]', 'CAST([id_set] AS NVARCHAR)', 3, 4, -1, false, '[id_set]', false, false, false, 'FORMATTED TEXT', 'TEXT');
