 ...
 * Page class
 */
class VDaftardisDelete extends VDaftardis
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VDaftardisDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("VDaftardisList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("VDaftardisList"); // Return to list
            return;
        }
