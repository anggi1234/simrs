...
/**
 * Table class for v_pendaftaran
 */
class VPendaftaran extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'v_pendaftaran';
        $this->TableName = 'v_pendaftaran';
        $this->TableType = 'CUSTOMVIEW';

        // Update Table
        $this->UpdateTable = "dbo.ANTRIAN_PENDAFTARAN INNER JOIN dbo.ANTRIAN_LOGIN ON dbo.ANTRIAN_PENDAFTARAN.[user] = dbo.ANTRIAN_LOGIN.ID";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // Id
        $this->Id = new DbField('v_pendaftaran', 'v_pendaftaran', 'x_Id', 'Id', '[Id]', 'CAST([Id] AS NVARCHAR)', 20, 8, -1, false, '[Id]', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // no_urut
        $this->no_urut = new DbField('v_pendaftaran', 'v_pendaftaran', 'x_no_urut', 'no_urut', '[no_urut]', 'CAST([no_urut] AS NVARCHAR)', 20, 8, -1, false, '[no_urut]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NAMA
        $this->NAMA = new DbField('v_pendaftaran', 'v_pendaftaran', 'x_NAMA', 'NAMA', 'dbo.ANTRIAN_LOGIN.NAMA', 'dbo.ANTRIAN_LOGIN.NAMA', 200, 100, -1, false, 'dbo.ANTRIAN_LOGIN.NAMA', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->NAMA->Sortable = true; // Allow sort
        $this->NAMA->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->NAMA->Param, "CustomMsg");
        $this->Fields['NAMA'] = &$this->NAMA;

        // tanggal_daftar
        $this->tanggal_daftar = new DbField('v_pendaftaran', 'v_pendaftaran', 'x_tanggal_daftar', 'tanggal_daftar', '[tanggal_daftar]', CastDateFieldForLike("[tanggal_daftar]", 7, "DB"), 135, 8, 7, false, '[tanggal_daftar]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tanggal_panggil
        $this->tanggal_panggil = new DbField('v_pendaftaran', 'v_pendaftaran', 'x_tanggal_panggil', 'tanggal_panggil', '[tanggal_panggil]', CastDateFieldForLike("[tanggal_panggil]", 0, "DB"), 135, 8, 0, false, '[tanggal_panggil]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // loket
        $this->loket = new DbField('v_pendaftaran', 'v_pendaftaran', 'x_loket', 'loket', '[loket]', '[loket]', 200, 10, -1, false, '[loket]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status_panggil
        $this->status_panggil = new DbField('v_pendaftaran', 'v_pendaftaran', 'x_status_panggil', 'status_panggil', '[status_panggil]', 'CAST([status_panggil] AS NVARCHAR)', 3, 4, -1, false, '[status_panggil]', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // user
        $this->user = new DbField('v_pendaftaran', 'v_pendaftaran', 'x_user', 'user', '[user]', 'CAST([user] AS NVARCHAR)', 20, 8, -1, false, '[user]', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // newapp
        $this->newapp = new DbField('v_pendaftaran', 'v_pendaftaran', 'x_newapp', 'newapp', '[newapp]', 'CAST([newapp] AS NVARCHAR)', 3, 4, -1, false, '[newapp]', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // kdpoli
        $this->kdpoli = new DbField('v_pendaftaran', 'v_pendaftaran', 'x_kdpoli', 'kdpoli', '[kdpoli]', '[kdpoli]', 200, 10, -1, false, '[kdpoli]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // tanggal_pesan
        $this->tanggal_pesan = new DbField('v_pendaftaran', 'v_pendaftaran', 'x_tanggal_pesan', 'tanggal_pesan', '[tanggal_pesan]', CastDateFieldForLike("[tanggal_pesan]", 0, "DB"), 135, 8, 0, false, '[tanggal_pesan]', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // tujuan
        $this->tujuan = new DbField('v_pendaftaran', 'v_pendaftaran', 'x_tujuan', 'tujuan', '[tujuan]', '[tujuan]', 200, 255, -1, false, '[tujuan]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // disabilitas
        $this->disabilitas = new DbField('v_pendaftaran', 'v_pendaftaran', 'x_disabilitas', 'disabilitas', '[disabilitas]', 'CAST([disabilitas] AS NVARCHAR)', 3, 4, -1, false, '[disabilitas]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "dbo.ANTRIAN_PENDAFTARAN INNER JOIN dbo.ANTRIAN_LOGIN ON dbo.ANTRIAN_PENDAFTARAN.[user] = dbo.ANTRIAN_LOGIN.ID";
    }
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("dbo.ANTRIAN_PENDAFTARAN.*, dbo.ANTRIAN_LOGIN.NAMA");
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VPendaftaranList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "VPendaftaranEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VPendaftaranAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "VPendaftaranView";
            case Config("API_ADD_ACTION"):
                return "VPendaftaranAdd";
            case Config("API_EDIT_ACTION"):
                return "VPendaftaranEdit";
            case Config("API_DELETE_ACTION"):
                return "VPendaftaranDelete";
            case Config("API_LIST_ACTION"):
                return "VPendaftaranList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VPendaftaranView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VPendaftaranView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VPendaftaranAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VPendaftaranAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("VPendaftaranEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VPendaftaranAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VPendaftaranDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->NAMA->EditCustomAttributes = 'readonly';
        if (!$this->NAMA->Raw) {
