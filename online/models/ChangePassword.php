 ...
 * Page class
 */
class ChangePassword extends AntrianLogin
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        $this->OldPassword = new DbField("ANTRIAN_LOGIN", "ANTRIAN_LOGIN", "opwd", "opwd", "opwd", "", 202, 255, 0, false, "", false, false, false);
        $this->OldPassword->EditAttrs->appendClass("form-control ew-control");
        $this->NewPassword = new DbField("ANTRIAN_LOGIN", "ANTRIAN_LOGIN", "npwd", "npwd", "npwd", "", 202, 255, 0, false, "", false, false, false);
        $this->NewPassword->EditAttrs->appendClass("form-control ew-control");
        $this->ConfirmPassword = new DbField("ANTRIAN_LOGIN", "ANTRIAN_LOGIN", "cpwd", "cpwd", "cpwd", "", 202, 255, 0, false, "", false, false, false);
