...
class AntrianLogin extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // FOTO
        $this->FOTO = new DbField('ANTRIAN_LOGIN', 'ANTRIAN_LOGIN', 'x_FOTO', 'FOTO', '[FOTO]', '[FOTO]', 200, 50, -1, true, '[FOTO]', false, false, false, 'IMAGE', 'FILE');
        ...
        // JENIS_KELAMIN
        $this->JENIS_KELAMIN = new DbField('ANTRIAN_LOGIN', 'ANTRIAN_LOGIN', 'x_JENIS_KELAMIN', 'JENIS_KELAMIN', '[JENIS_KELAMIN]', '[JENIS_KELAMIN]', 129, 1, -1, false, '[JENIS_KELAMIN]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // AGAMA
        $this->AGAMA = new DbField('ANTRIAN_LOGIN', 'ANTRIAN_LOGIN', 'x_AGAMA', 'AGAMA', '[AGAMA]', 'CAST([AGAMA] AS NVARCHAR)', 17, 1, -1, false, '[AGAMA]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // PEKERJAAN
        $this->PEKERJAAN = new DbField('ANTRIAN_LOGIN', 'ANTRIAN_LOGIN', 'x_PEKERJAAN', 'PEKERJAAN', '[PEKERJAAN]', 'CAST([PEKERJAAN] AS NVARCHAR)', 17, 1, -1, false, '[PEKERJAAN]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->PEKERJAAN->Sortable = true; // Allow sort
        $this->PEKERJAAN->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->PEKERJAAN->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        switch ($CurrentLanguage) {
            case "en":
        ...
        // ALAMAT
        $this->ALAMAT = new DbField('ANTRIAN_LOGIN', 'ANTRIAN_LOGIN', 'x_ALAMAT', 'ALAMAT', '[ALAMAT]', '[ALAMAT]', 200, 100, -1, false, '[ALAMAT]', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // TANGGAL_REGIS
        $this->TANGGAL_REGIS = new DbField('ANTRIAN_LOGIN', 'ANTRIAN_LOGIN', 'x_TANGGAL_REGIS', 'TANGGAL_REGIS', '[TANGGAL_REGIS]', CastDateFieldForLike("[TANGGAL_REGIS]", 0, "DB"), 135, 8, 0, false, '[TANGGAL_REGIS]', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // PASSWORD
        $this->_PASSWORD = new DbField('ANTRIAN_LOGIN', 'ANTRIAN_LOGIN', 'x__PASSWORD', 'PASSWORD', '[PASSWORD]', '[PASSWORD]', 200, 100, -1, false, '[PASSWORD]', false, false, false, 'FORMATTED TEXT', 'PASSWORD');
...
SORTHTML;
    ...
    public function getUserIDSubquery(&$fld, &$masterfld)
    {
        global $UserTable;
        $wrk = "";
        $sql = "SELECT " . $masterfld->Expression . " FROM [dbo].[ANTRIAN_LOGIN]";
