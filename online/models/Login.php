 ...
 * Page class
 */
class Login extends AntrianLogin
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        $this->Username = new DbField("ANTRIAN_LOGIN", "ANTRIAN_LOGIN", "username", "username", "username", "", 202, 255, 0, false, "", false, false, false);
        $this->Username->EditAttrs->appendClass("form-control ew-control");
        $this->Password = new DbField("ANTRIAN_LOGIN", "ANTRIAN_LOGIN", "password", "password", "password", "", 202, 255, 0, false, "", false, false, false);
        $this->Password->EditAttrs->appendClass("form-control ew-control");
        if (Config("ENCRYPTED_PASSWORD")) {
            $this->Password->Raw = true;
        }
        $this->LoginType = new DbField("ANTRIAN_LOGIN", "ANTRIAN_LOGIN", "type", "logintype", "logintype", "", 202, 255, 0, false, "", false, false, false);
