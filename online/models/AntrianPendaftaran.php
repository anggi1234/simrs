...
class AntrianPendaftaran extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // tanggal_daftar
        $this->tanggal_daftar = new DbField('ANTRIAN_PENDAFTARAN', 'ANTRIAN_PENDAFTARAN', 'x_tanggal_daftar', 'tanggal_daftar', '[tanggal_daftar]', CastDateFieldForLike("[tanggal_daftar]", 7, "DB"), 135, 8, 7, false, '[tanggal_daftar]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status_panggil
        $this->status_panggil = new DbField('ANTRIAN_PENDAFTARAN', 'ANTRIAN_PENDAFTARAN', 'x_status_panggil', 'status_panggil', '[status_panggil]', 'CAST([status_panggil] AS NVARCHAR)', 3, 4, -1, false, '[status_panggil]', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // newapp
        $this->newapp = new DbField('ANTRIAN_PENDAFTARAN', 'ANTRIAN_PENDAFTARAN', 'x_newapp', 'newapp', '[newapp]', 'CAST([newapp] AS NVARCHAR)', 3, 4, -1, false, '[newapp]', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // kdpoli
        $this->kdpoli = new DbField('ANTRIAN_PENDAFTARAN', 'ANTRIAN_PENDAFTARAN', 'x_kdpoli', 'kdpoli', '[kdpoli]', '[kdpoli]', 200, 10, -1, false, '[kdpoli]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // tanggal_pesan
        $this->tanggal_pesan = new DbField('ANTRIAN_PENDAFTARAN', 'ANTRIAN_PENDAFTARAN', 'x_tanggal_pesan', 'tanggal_pesan', '[tanggal_pesan]', CastDateFieldForLike("[tanggal_pesan]", 0, "DB"), 135, 8, 0, false, '[tanggal_pesan]', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // disabilitas
        $this->disabilitas = new DbField('ANTRIAN_PENDAFTARAN', 'ANTRIAN_PENDAFTARAN', 'x_disabilitas', 'disabilitas', '[disabilitas]', 'CAST([disabilitas] AS NVARCHAR)', 3, 4, -1, false, '[disabilitas]', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // cetak
        $this->cetak = new DbField('ANTRIAN_PENDAFTARAN', 'ANTRIAN_PENDAFTARAN', 'x_cetak', 'cetak', '\'\'', '\'\'', 200, 1, -1, false, '\'\'', false, false, false, 'FORMATTED TEXT', 'TEXT');
...
SORTHTML;
    ...
    public function renderListRow()
    {
        ...
        // no_urut
        $this->no_urut->CellCssStyle = "min-width: 50px;";

        // user

        // tanggal_daftar
        $this->tanggal_daftar->CellCssStyle = "min-width: 50px;";
        ...
        // kdpoli
        $this->kdpoli->CellCssStyle = "min-width: 70px;";

        // tanggal_pesan

        // tujuan
        $this->tujuan->CellCssStyle = "min-width: 100px;";
