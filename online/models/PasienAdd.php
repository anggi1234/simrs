...
class PasienAdd extends Pasien
{
    ...
    protected function addRow($rsold = null)
    {
        ...
        // TMT
        $this->TMT->setDbValueDef($rsnew, UnFormatDateTime($this->TMT->CurrentValue, 0), null, false);

        // TAT
        $this->TAT->setDbValueDef($rsnew, UnFormatDateTime($this->TAT->CurrentValue, 0), null, false);
