...
{
        if ($menu->Id == "menu") { 
        $menu->addMenuItem(10000, "wa",'<i class="fab fa-whatsapp text-success"></i> Lewat WhatsApp', "https://wa.me/message/43XKEFO2VVE3E1", -1, "", IsLoggedIn());
        $menu->addMenuItem(10001, "te",'<i class="fab fa-telegram text-blue"></i> Lewat Telegram', "https://t.me/rsudbesemahbot", -1, "", IsLoggedIn());
        $menu->addMenuItem(10001, "te",'<i class="fas fa-portrait text-red"></i> Tutorial', "/online/tutorial.pdf", -1, "", IsLoggedIn());
