...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'E7Ni9NTv03kYLgaD', // Random key for encryption
    "ENCRYPTION_KEY" => '', // Encryption key for data protection
    "PROJECT_STYLESHEET_FILENAME" => "css/Online.css", // Project stylesheet file name
    ...
    "USER_TABLE_NAME" => "ANTRIAN_LOGIN",
    "LOGIN_USERNAME_FIELD_NAME" => "NO_HP",
    ...
    // User table filters
    "USER_TABLE_DBID" => "DB",
    "USER_TABLE" => "[dbo].[ANTRIAN_LOGIN]",
    "USER_NAME_FILTER" => "([NO_HP] = '%u')",
    "USER_ID_FILTER" => "([ID] = %u)",
    ...
    "USER_PROFILE_MAX_RETRY" => 10,
    "USER_PROFILE_RETRY_LOCKOUT" => 1,
    ...
    // Email
    "SENDER_EMAIL" => "https://www.hostinger.co.id/tutorial/server-smtp-google-gratis-untuk-mengirim-email#Langkah-1-8211-Masuk-ke-Pengaturan-Server-SMTP-Google", // Sender email address
    "RECIPIENT_EMAIL" => "https://www.hostinger.co.id/tutorial/server-smtp-google-gratis-untuk-mengirim-email#Langkah-1-8211-Masuk-ke-Pengaturan-Server-SMTP-Google", // Recipient email address
