...
class VRadiologi extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('V_RADIOLOGI', 'V_RADIOLOGI', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        $this->ORG_UNIT_CODE->Sortable = true; // Allow sort
        $this->ORG_UNIT_CODE->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ORG_UNIT_CODE->Param, "CustomMsg");
        $this->Fields['ORG_UNIT_CODE'] = &$this->ORG_UNIT_CODE;

        // VISIT_ID
        $this->VISIT_ID = new DbField('V_RADIOLOGI', 'V_RADIOLOGI', 'x_VISIT_ID', 'VISIT_ID', '[VISIT_ID]', '[VISIT_ID]', 200, 50, -1, false, '[VISIT_ID]', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // TRANS_ID
        $this->TRANS_ID = new DbField('V_RADIOLOGI', 'V_RADIOLOGI', 'x_TRANS_ID', 'TRANS_ID', '[TRANS_ID]', '[TRANS_ID]', 200, 50, -1, false, '[TRANS_ID]', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->IN_DATE->EditValue = FormatDateTime($this->IN_DATE->EditValue, 0);
        $this->IN_DATE->ViewCustomAttributes = "";
        ...
        $this->RESPONSIBLE_ID->EditValue = FormatNumber($this->RESPONSIBLE_ID->EditValue, 0, -2, -2, -2);
        $this->RESPONSIBLE_ID->ViewCustomAttributes = "";
        ...
        $this->tgl_kontrol->EditValue = $this->tgl_kontrol->CurrentValue;
        $this->tgl_kontrol->EditValue = FormatDateTime($this->tgl_kontrol->EditValue, 0);
        $this->tgl_kontrol->ViewCustomAttributes = "";
