...
$Page->showMessage();
?>
<form name="fGOOD_GFadd" id="fGOOD_GFadd" class="<?= $Page->FormClassName ?>" action="<?= HtmlEncode(GetUrl(CurrentPageName())) ?>" method="post">
...
<script>
loadjs.ready(["fGOOD_GFadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fGOOD_GFadd", "x_MODIFIED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fGOOD_GFadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fGOOD_GFadd", "x_CORRECTION_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fGOOD_GFadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fGOOD_GFadd", "x_PRINT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
