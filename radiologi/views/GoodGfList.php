...
<form name="fGOOD_GFlistsrch" id="fGOOD_GFlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= HtmlEncode(GetUrl(CurrentPageName())) ?>">
...
<?php } ?>
<form name="fGOOD_GFlist" id="fGOOD_GFlist" class="form-inline ew-form ew-list-form" action="<?= HtmlEncode(GetUrl(CurrentPageName())) ?>" method="post">
...
<?php if ($Page->ITEM_ID->Visible) { // ITEM_ID ?>
        <th data-name="ITEM_ID" class="<?= $Page->ITEM_ID->headerCellClass() ?>"><div id="elh_GOOD_GF_ITEM_ID" class="GOOD_GF_ITEM_ID"><?= $Page->renderSort($Page->ITEM_ID) ?></div></th>
<?php } ?>
...
<?php if ($Page->BATCH_NO->Visible) { // BATCH_NO ?>
        <th data-name="BATCH_NO" class="<?= $Page->BATCH_NO->headerCellClass() ?>"><div id="elh_GOOD_GF_BATCH_NO" class="GOOD_GF_BATCH_NO"><?= $Page->renderSort($Page->BATCH_NO) ?></div></th>
<?php } ?>
...
<?php if ($Page->SHELF_NO->Visible) { // SHELF_NO ?>
        <th data-name="SHELF_NO" class="<?= $Page->SHELF_NO->headerCellClass() ?>"><div id="elh_GOOD_GF_SHELF_NO" class="GOOD_GF_SHELF_NO"><?= $Page->renderSort($Page->SHELF_NO) ?></div></th>
<?php } ?>
...
<?php if ($Page->SERIAL_NB->Visible) { // SERIAL_NB ?>
        <th data-name="SERIAL_NB" class="<?= $Page->SERIAL_NB->headerCellClass() ?>"><div id="elh_GOOD_GF_SERIAL_NB" class="GOOD_GF_SERIAL_NB"><?= $Page->renderSort($Page->SERIAL_NB) ?></div></th>
<?php } ?>
...
<?php if ($Page->DISCOUNT->Visible) { // DISCOUNT ?>
        <th data-name="DISCOUNT" class="<?= $Page->DISCOUNT->headerCellClass() ?>"><div id="elh_GOOD_GF_DISCOUNT" class="GOOD_GF_DISCOUNT"><?= $Page->renderSort($Page->DISCOUNT) ?></div></th>
<?php } ?>
<?php if ($Page->DISCOUNT2->Visible) { // DISCOUNT2 ?>
        <th data-name="DISCOUNT2" class="<?= $Page->DISCOUNT2->headerCellClass() ?>"><div id="elh_GOOD_GF_DISCOUNT2" class="GOOD_GF_DISCOUNT2"><?= $Page->renderSort($Page->DISCOUNT2) ?></div></th>
<?php } ?>
<?php if ($Page->DISCOUNTOFF->Visible) { // DISCOUNTOFF ?>
        <th data-name="DISCOUNTOFF" class="<?= $Page->DISCOUNTOFF->headerCellClass() ?>"><div id="elh_GOOD_GF_DISCOUNTOFF" class="GOOD_GF_DISCOUNTOFF"><?= $Page->renderSort($Page->DISCOUNTOFF) ?></div></th>
<?php } ?>
...
<?php if ($Page->STOCK_LALU->Visible) { // STOCK_LALU ?>
        <th data-name="STOCK_LALU" class="<?= $Page->STOCK_LALU->headerCellClass() ?>"><div id="elh_GOOD_GF_STOCK_LALU" class="GOOD_GF_STOCK_LALU"><?= $Page->renderSort($Page->STOCK_LALU) ?></div></th>
<?php } ?>
...
<?php if ($Page->DITERIMA->Visible) { // DITERIMA ?>
        <th data-name="DITERIMA" class="<?= $Page->DITERIMA->headerCellClass() ?>"><div id="elh_GOOD_GF_DITERIMA" class="GOOD_GF_DITERIMA"><?= $Page->renderSort($Page->DITERIMA) ?></div></th>
<?php } ?>
<?php if ($Page->DISTRIBUSI->Visible) { // DISTRIBUSI ?>
        <th data-name="DISTRIBUSI" class="<?= $Page->DISTRIBUSI->headerCellClass() ?>"><div id="elh_GOOD_GF_DISTRIBUSI" class="GOOD_GF_DISTRIBUSI"><?= $Page->renderSort($Page->DISTRIBUSI) ?></div></th>
<?php } ?>
...
<?php if ($Page->DIHAPUS->Visible) { // DIHAPUS ?>
        <th data-name="DIHAPUS" class="<?= $Page->DIHAPUS->headerCellClass() ?>"><div id="elh_GOOD_GF_DIHAPUS" class="GOOD_GF_DIHAPUS"><?= $Page->renderSort($Page->DIHAPUS) ?></div></th>
<?php } ?>
<?php if ($Page->DIMINTA->Visible) { // DIMINTA ?>
        <th data-name="DIMINTA" class="<?= $Page->DIMINTA->headerCellClass() ?>"><div id="elh_GOOD_GF_DIMINTA" class="GOOD_GF_DIMINTA"><?= $Page->renderSort($Page->DIMINTA) ?></div></th>
<?php } ?>
<?php if ($Page->DIRETUR->Visible) { // DIRETUR ?>
        <th data-name="DIRETUR" class="<?= $Page->DIRETUR->headerCellClass() ?>"><div id="elh_GOOD_GF_DIRETUR" class="GOOD_GF_DIRETUR"><?= $Page->renderSort($Page->DIRETUR) ?></div></th>
<?php } ?>
<?php if ($Page->PO->Visible) { // PO ?>
        <th data-name="PO" class="<?= $Page->PO->headerCellClass() ?>"><div id="elh_GOOD_GF_PO" class="GOOD_GF_PO"><?= $Page->renderSort($Page->PO) ?></div></th>
<?php } ?>
<?php if ($Page->COMPANY_ID->Visible) { // COMPANY_ID ?>
        <th data-name="COMPANY_ID" class="<?= $Page->COMPANY_ID->headerCellClass() ?>"><div id="elh_GOOD_GF_COMPANY_ID" class="GOOD_GF_COMPANY_ID"><?= $Page->renderSort($Page->COMPANY_ID) ?></div></th>
<?php } ?>
<?php if ($Page->FUND_ID->Visible) { // FUND_ID ?>
        <th data-name="FUND_ID" class="<?= $Page->FUND_ID->headerCellClass() ?>"><div id="elh_GOOD_GF_FUND_ID" class="GOOD_GF_FUND_ID"><?= $Page->renderSort($Page->FUND_ID) ?></div></th>
<?php } ?>
<?php if ($Page->INVOICE_ID2->Visible) { // INVOICE_ID2 ?>
        <th data-name="INVOICE_ID2" class="<?= $Page->INVOICE_ID2->headerCellClass() ?>"><div id="elh_GOOD_GF_INVOICE_ID2" class="GOOD_GF_INVOICE_ID2"><?= $Page->renderSort($Page->INVOICE_ID2) ?></div></th>
<?php } ?>
<?php if ($Page->MEASURE_ID3->Visible) { // MEASURE_ID3 ?>
        <th data-name="MEASURE_ID3" class="<?= $Page->MEASURE_ID3->headerCellClass() ?>"><div id="elh_GOOD_GF_MEASURE_ID3" class="GOOD_GF_MEASURE_ID3"><?= $Page->renderSort($Page->MEASURE_ID3) ?></div></th>
<?php } ?>
<?php if ($Page->SIZE_KEMASAN->Visible) { // SIZE_KEMASAN ?>
        <th data-name="SIZE_KEMASAN" class="<?= $Page->SIZE_KEMASAN->headerCellClass() ?>"><div id="elh_GOOD_GF_SIZE_KEMASAN" class="GOOD_GF_SIZE_KEMASAN"><?= $Page->renderSort($Page->SIZE_KEMASAN) ?></div></th>
<?php } ?>
...
<?php if ($Page->MEASURE_ID2->Visible) { // MEASURE_ID2 ?>
        <th data-name="MEASURE_ID2" class="<?= $Page->MEASURE_ID2->headerCellClass() ?>"><div id="elh_GOOD_GF_MEASURE_ID2" class="GOOD_GF_MEASURE_ID2"><?= $Page->renderSort($Page->MEASURE_ID2) ?></div></th>
<?php } ?>
<?php if ($Page->RETUR_ID->Visible) { // RETUR_ID ?>
        <th data-name="RETUR_ID" class="<?= $Page->RETUR_ID->headerCellClass() ?>"><div id="elh_GOOD_GF_RETUR_ID" class="GOOD_GF_RETUR_ID"><?= $Page->renderSort($Page->RETUR_ID) ?></div></th>
<?php } ?>
<?php if ($Page->SIZE_GOODS->Visible) { // SIZE_GOODS ?>
        <th data-name="SIZE_GOODS" class="<?= $Page->SIZE_GOODS->headerCellClass() ?>"><div id="elh_GOOD_GF_SIZE_GOODS" class="GOOD_GF_SIZE_GOODS"><?= $Page->renderSort($Page->SIZE_GOODS) ?></div></th>
<?php } ?>
<?php if ($Page->MEASURE_DOSIS->Visible) { // MEASURE_DOSIS ?>
        <th data-name="MEASURE_DOSIS" class="<?= $Page->MEASURE_DOSIS->headerCellClass() ?>"><div id="elh_GOOD_GF_MEASURE_DOSIS" class="GOOD_GF_MEASURE_DOSIS"><?= $Page->renderSort($Page->MEASURE_DOSIS) ?></div></th>
<?php } ?>
<?php if ($Page->ORDER_PRICE->Visible) { // ORDER_PRICE ?>
        <th data-name="ORDER_PRICE" class="<?= $Page->ORDER_PRICE->headerCellClass() ?>"><div id="elh_GOOD_GF_ORDER_PRICE" class="GOOD_GF_ORDER_PRICE"><?= $Page->renderSort($Page->ORDER_PRICE) ?></div></th>
<?php } ?>
<?php if ($Page->STOCK_AVAILABLE->Visible) { // STOCK_AVAILABLE ?>
        <th data-name="STOCK_AVAILABLE" class="<?= $Page->STOCK_AVAILABLE->headerCellClass() ?>"><div id="elh_GOOD_GF_STOCK_AVAILABLE" class="GOOD_GF_STOCK_AVAILABLE"><?= $Page->renderSort($Page->STOCK_AVAILABLE) ?></div></th>
<?php } ?>
<?php if ($Page->STATUS_PASIEN_ID->Visible) { // STATUS_PASIEN_ID ?>
        <th data-name="STATUS_PASIEN_ID" class="<?= $Page->STATUS_PASIEN_ID->headerCellClass() ?>"><div id="elh_GOOD_GF_STATUS_PASIEN_ID" class="GOOD_GF_STATUS_PASIEN_ID"><?= $Page->renderSort($Page->STATUS_PASIEN_ID) ?></div></th>
<?php } ?>
...
<?php if ($Page->CORRECTION_DOC->Visible) { // CORRECTION_DOC ?>
        <th data-name="CORRECTION_DOC" class="<?= $Page->CORRECTION_DOC->headerCellClass() ?>"><div id="elh_GOOD_GF_CORRECTION_DOC" class="GOOD_GF_CORRECTION_DOC"><?= $Page->renderSort($Page->CORRECTION_DOC) ?></div></th>
<?php } ?>
<?php if ($Page->CORRECTIONS->Visible) { // CORRECTIONS ?>
        <th data-name="CORRECTIONS" class="<?= $Page->CORRECTIONS->headerCellClass() ?>"><div id="elh_GOOD_GF_CORRECTIONS" class="GOOD_GF_CORRECTIONS"><?= $Page->renderSort($Page->CORRECTIONS) ?></div></th>
<?php } ?>
<?php if ($Page->CORRECTION_DATE->Visible) { // CORRECTION_DATE ?>
        <th data-name="CORRECTION_DATE" class="<?= $Page->CORRECTION_DATE->headerCellClass() ?>"><div id="elh_GOOD_GF_CORRECTION_DATE" class="GOOD_GF_CORRECTION_DATE"><?= $Page->renderSort($Page->CORRECTION_DATE) ?></div></th>
<?php } ?>
...
<?php if ($Page->PRINTQ->Visible) { // PRINTQ ?>
        <th data-name="PRINTQ" class="<?= $Page->PRINTQ->headerCellClass() ?>"><div id="elh_GOOD_GF_PRINTQ" class="GOOD_GF_PRINTQ"><?= $Page->renderSort($Page->PRINTQ) ?></div></th>
<?php } ?>
<?php if ($Page->avgprice->Visible) { // avgprice ?>
        <th data-name="avgprice" class="<?= $Page->avgprice->headerCellClass() ?>"><div id="elh_GOOD_GF_avgprice" class="GOOD_GF_avgprice"><?= $Page->renderSort($Page->avgprice) ?></div></th>
<?php } ?>
<?php if ($Page->idx->Visible) { // idx ?>
        <th data-name="idx" class="<?= $Page->idx->headerCellClass() ?>"><div id="elh_GOOD_GF_idx" class="GOOD_GF_idx"><?= $Page->renderSort($Page->idx) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_ITEM_ID">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_BATCH_NO">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_SHELF_NO">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_SERIAL_NB">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_DISCOUNT">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_DISCOUNT2">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_DISCOUNTOFF">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_STOCK_LALU">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_DITERIMA">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_DISTRIBUSI">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_DIHAPUS">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_DIMINTA">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_DIRETUR">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_PO">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_COMPANY_ID">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_FUND_ID">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_INVOICE_ID2">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_MEASURE_ID3">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_SIZE_KEMASAN">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_MEASURE_ID2">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_RETUR_ID">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_SIZE_GOODS">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_MEASURE_DOSIS">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_ORDER_PRICE">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_STOCK_AVAILABLE">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_STATUS_PASIEN_ID">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_CORRECTION_DOC">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_CORRECTIONS">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_CORRECTION_DATE">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_PRINTQ">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_avgprice">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_idx">
