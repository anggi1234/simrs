...
<?php if ($Grid->NO_REGISTRATION->Visible) { // NO_REGISTRATION ?>
        <th data-name="NO_REGISTRATION" class="<?= $Grid->NO_REGISTRATION->headerCellClass() ?>"><div id="elh_TREATMENT_BILL_NO_REGISTRATION" class="TREATMENT_BILL_NO_REGISTRATION"><?= $Grid->renderSort($Grid->NO_REGISTRATION) ?></div></th>
<?php } ?>
<?php if ($Grid->VISIT_ID->Visible) { // VISIT_ID ?>
        <th data-name="VISIT_ID" class="<?= $Grid->VISIT_ID->headerCellClass() ?>" style="min-width: 0px;"><div id="elh_TREATMENT_BILL_VISIT_ID" class="TREATMENT_BILL_VISIT_ID"><?= $Grid->renderSort($Grid->VISIT_ID) ?></div></th>
<?php } ?>
...
<?php if ($Grid->DOCTOR->Visible) { // DOCTOR ?>
        <th data-name="DOCTOR" class="<?= $Grid->DOCTOR->headerCellClass() ?>"><div id="elh_TREATMENT_BILL_DOCTOR" class="TREATMENT_BILL_DOCTOR"><?= $Grid->renderSort($Grid->DOCTOR) ?></div></th>
<?php } ?>
...
<?php if ($Grid->THENAME->Visible) { // THENAME ?>
        <th data-name="THENAME" class="<?= $Grid->THENAME->headerCellClass() ?>"><div id="elh_TREATMENT_BILL_THENAME" class="TREATMENT_BILL_THENAME"><?= $Grid->renderSort($Grid->THENAME) ?></div></th>
<?php } ?>
<?php if ($Grid->THEADDRESS->Visible) { // THEADDRESS ?>
        <th data-name="THEADDRESS" class="<?= $Grid->THEADDRESS->headerCellClass() ?>"><div id="elh_TREATMENT_BILL_THEADDRESS" class="TREATMENT_BILL_THEADDRESS"><?= $Grid->renderSort($Grid->THEADDRESS) ?></div></th>
<?php } ?>
<?php if ($Grid->ISRJ->Visible) { // ISRJ ?>
        <th data-name="ISRJ" class="<?= $Grid->ISRJ->headerCellClass() ?>"><div id="elh_TREATMENT_BILL_ISRJ" class="TREATMENT_BILL_ISRJ"><?= $Grid->renderSort($Grid->ISRJ) ?></div></th>
<?php } ?>
<?php if ($Grid->TAGIHAN->Visible) { // TAGIHAN ?>
        <th data-name="TAGIHAN" class="<?= $Grid->TAGIHAN->headerCellClass() ?>"><div id="elh_TREATMENT_BILL_TAGIHAN" class="TREATMENT_BILL_TAGIHAN"><?= $Grid->renderSort($Grid->TAGIHAN) ?></div></th>
<?php } ?>
...
<input type="hidden" data-table="TREATMENT_BILL" data-field="x_NO_REGISTRATION" data-hidden="1" name="x<?= $Grid->RowIndex ?>_NO_REGISTRATION" id="x<?= $Grid->RowIndex ?>_NO_REGISTRATION" value="<?= HtmlEncode($Grid->NO_REGISTRATION->CurrentValue) ?>">
<?php } ?>
