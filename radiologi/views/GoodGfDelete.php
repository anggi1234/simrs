...
$Page->showMessage();
?>
<form name="fGOOD_GFdelete" id="fGOOD_GFdelete" class="form-inline ew-form ew-delete-form" action="<?= HtmlEncode(GetUrl(CurrentPageName())) ?>" method="post">
...
<?php if ($Page->ITEM_ID->Visible) { // ITEM_ID ?>
        <th class="<?= $Page->ITEM_ID->headerCellClass() ?>"><span id="elh_GOOD_GF_ITEM_ID" class="GOOD_GF_ITEM_ID"><?= $Page->ITEM_ID->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->BATCH_NO->Visible) { // BATCH_NO ?>
        <th class="<?= $Page->BATCH_NO->headerCellClass() ?>"><span id="elh_GOOD_GF_BATCH_NO" class="GOOD_GF_BATCH_NO"><?= $Page->BATCH_NO->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->SHELF_NO->Visible) { // SHELF_NO ?>
        <th class="<?= $Page->SHELF_NO->headerCellClass() ?>"><span id="elh_GOOD_GF_SHELF_NO" class="GOOD_GF_SHELF_NO"><?= $Page->SHELF_NO->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->SERIAL_NB->Visible) { // SERIAL_NB ?>
        <th class="<?= $Page->SERIAL_NB->headerCellClass() ?>"><span id="elh_GOOD_GF_SERIAL_NB" class="GOOD_GF_SERIAL_NB"><?= $Page->SERIAL_NB->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->DISCOUNT->Visible) { // DISCOUNT ?>
        <th class="<?= $Page->DISCOUNT->headerCellClass() ?>"><span id="elh_GOOD_GF_DISCOUNT" class="GOOD_GF_DISCOUNT"><?= $Page->DISCOUNT->caption() ?></span></th>
<?php } ?>
<?php if ($Page->DISCOUNT2->Visible) { // DISCOUNT2 ?>
        <th class="<?= $Page->DISCOUNT2->headerCellClass() ?>"><span id="elh_GOOD_GF_DISCOUNT2" class="GOOD_GF_DISCOUNT2"><?= $Page->DISCOUNT2->caption() ?></span></th>
<?php } ?>
<?php if ($Page->DISCOUNTOFF->Visible) { // DISCOUNTOFF ?>
        <th class="<?= $Page->DISCOUNTOFF->headerCellClass() ?>"><span id="elh_GOOD_GF_DISCOUNTOFF" class="GOOD_GF_DISCOUNTOFF"><?= $Page->DISCOUNTOFF->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->STOCK_LALU->Visible) { // STOCK_LALU ?>
        <th class="<?= $Page->STOCK_LALU->headerCellClass() ?>"><span id="elh_GOOD_GF_STOCK_LALU" class="GOOD_GF_STOCK_LALU"><?= $Page->STOCK_LALU->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->DITERIMA->Visible) { // DITERIMA ?>
        <th class="<?= $Page->DITERIMA->headerCellClass() ?>"><span id="elh_GOOD_GF_DITERIMA" class="GOOD_GF_DITERIMA"><?= $Page->DITERIMA->caption() ?></span></th>
<?php } ?>
<?php if ($Page->DISTRIBUSI->Visible) { // DISTRIBUSI ?>
        <th class="<?= $Page->DISTRIBUSI->headerCellClass() ?>"><span id="elh_GOOD_GF_DISTRIBUSI" class="GOOD_GF_DISTRIBUSI"><?= $Page->DISTRIBUSI->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->DIHAPUS->Visible) { // DIHAPUS ?>
        <th class="<?= $Page->DIHAPUS->headerCellClass() ?>"><span id="elh_GOOD_GF_DIHAPUS" class="GOOD_GF_DIHAPUS"><?= $Page->DIHAPUS->caption() ?></span></th>
<?php } ?>
<?php if ($Page->DIMINTA->Visible) { // DIMINTA ?>
        <th class="<?= $Page->DIMINTA->headerCellClass() ?>"><span id="elh_GOOD_GF_DIMINTA" class="GOOD_GF_DIMINTA"><?= $Page->DIMINTA->caption() ?></span></th>
<?php } ?>
<?php if ($Page->DIRETUR->Visible) { // DIRETUR ?>
        <th class="<?= $Page->DIRETUR->headerCellClass() ?>"><span id="elh_GOOD_GF_DIRETUR" class="GOOD_GF_DIRETUR"><?= $Page->DIRETUR->caption() ?></span></th>
<?php } ?>
<?php if ($Page->PO->Visible) { // PO ?>
        <th class="<?= $Page->PO->headerCellClass() ?>"><span id="elh_GOOD_GF_PO" class="GOOD_GF_PO"><?= $Page->PO->caption() ?></span></th>
<?php } ?>
<?php if ($Page->COMPANY_ID->Visible) { // COMPANY_ID ?>
        <th class="<?= $Page->COMPANY_ID->headerCellClass() ?>"><span id="elh_GOOD_GF_COMPANY_ID" class="GOOD_GF_COMPANY_ID"><?= $Page->COMPANY_ID->caption() ?></span></th>
<?php } ?>
<?php if ($Page->FUND_ID->Visible) { // FUND_ID ?>
        <th class="<?= $Page->FUND_ID->headerCellClass() ?>"><span id="elh_GOOD_GF_FUND_ID" class="GOOD_GF_FUND_ID"><?= $Page->FUND_ID->caption() ?></span></th>
<?php } ?>
<?php if ($Page->INVOICE_ID2->Visible) { // INVOICE_ID2 ?>
        <th class="<?= $Page->INVOICE_ID2->headerCellClass() ?>"><span id="elh_GOOD_GF_INVOICE_ID2" class="GOOD_GF_INVOICE_ID2"><?= $Page->INVOICE_ID2->caption() ?></span></th>
<?php } ?>
<?php if ($Page->MEASURE_ID3->Visible) { // MEASURE_ID3 ?>
        <th class="<?= $Page->MEASURE_ID3->headerCellClass() ?>"><span id="elh_GOOD_GF_MEASURE_ID3" class="GOOD_GF_MEASURE_ID3"><?= $Page->MEASURE_ID3->caption() ?></span></th>
<?php } ?>
<?php if ($Page->SIZE_KEMASAN->Visible) { // SIZE_KEMASAN ?>
        <th class="<?= $Page->SIZE_KEMASAN->headerCellClass() ?>"><span id="elh_GOOD_GF_SIZE_KEMASAN" class="GOOD_GF_SIZE_KEMASAN"><?= $Page->SIZE_KEMASAN->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->MEASURE_ID2->Visible) { // MEASURE_ID2 ?>
        <th class="<?= $Page->MEASURE_ID2->headerCellClass() ?>"><span id="elh_GOOD_GF_MEASURE_ID2" class="GOOD_GF_MEASURE_ID2"><?= $Page->MEASURE_ID2->caption() ?></span></th>
<?php } ?>
<?php if ($Page->RETUR_ID->Visible) { // RETUR_ID ?>
        <th class="<?= $Page->RETUR_ID->headerCellClass() ?>"><span id="elh_GOOD_GF_RETUR_ID" class="GOOD_GF_RETUR_ID"><?= $Page->RETUR_ID->caption() ?></span></th>
<?php } ?>
<?php if ($Page->SIZE_GOODS->Visible) { // SIZE_GOODS ?>
        <th class="<?= $Page->SIZE_GOODS->headerCellClass() ?>"><span id="elh_GOOD_GF_SIZE_GOODS" class="GOOD_GF_SIZE_GOODS"><?= $Page->SIZE_GOODS->caption() ?></span></th>
<?php } ?>
<?php if ($Page->MEASURE_DOSIS->Visible) { // MEASURE_DOSIS ?>
        <th class="<?= $Page->MEASURE_DOSIS->headerCellClass() ?>"><span id="elh_GOOD_GF_MEASURE_DOSIS" class="GOOD_GF_MEASURE_DOSIS"><?= $Page->MEASURE_DOSIS->caption() ?></span></th>
<?php } ?>
<?php if ($Page->ORDER_PRICE->Visible) { // ORDER_PRICE ?>
        <th class="<?= $Page->ORDER_PRICE->headerCellClass() ?>"><span id="elh_GOOD_GF_ORDER_PRICE" class="GOOD_GF_ORDER_PRICE"><?= $Page->ORDER_PRICE->caption() ?></span></th>
<?php } ?>
<?php if ($Page->STOCK_AVAILABLE->Visible) { // STOCK_AVAILABLE ?>
        <th class="<?= $Page->STOCK_AVAILABLE->headerCellClass() ?>"><span id="elh_GOOD_GF_STOCK_AVAILABLE" class="GOOD_GF_STOCK_AVAILABLE"><?= $Page->STOCK_AVAILABLE->caption() ?></span></th>
<?php } ?>
<?php if ($Page->STATUS_PASIEN_ID->Visible) { // STATUS_PASIEN_ID ?>
        <th class="<?= $Page->STATUS_PASIEN_ID->headerCellClass() ?>"><span id="elh_GOOD_GF_STATUS_PASIEN_ID" class="GOOD_GF_STATUS_PASIEN_ID"><?= $Page->STATUS_PASIEN_ID->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->CORRECTION_DOC->Visible) { // CORRECTION_DOC ?>
        <th class="<?= $Page->CORRECTION_DOC->headerCellClass() ?>"><span id="elh_GOOD_GF_CORRECTION_DOC" class="GOOD_GF_CORRECTION_DOC"><?= $Page->CORRECTION_DOC->caption() ?></span></th>
<?php } ?>
<?php if ($Page->CORRECTIONS->Visible) { // CORRECTIONS ?>
        <th class="<?= $Page->CORRECTIONS->headerCellClass() ?>"><span id="elh_GOOD_GF_CORRECTIONS" class="GOOD_GF_CORRECTIONS"><?= $Page->CORRECTIONS->caption() ?></span></th>
<?php } ?>
<?php if ($Page->CORRECTION_DATE->Visible) { // CORRECTION_DATE ?>
        <th class="<?= $Page->CORRECTION_DATE->headerCellClass() ?>"><span id="elh_GOOD_GF_CORRECTION_DATE" class="GOOD_GF_CORRECTION_DATE"><?= $Page->CORRECTION_DATE->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->PRINTQ->Visible) { // PRINTQ ?>
        <th class="<?= $Page->PRINTQ->headerCellClass() ?>"><span id="elh_GOOD_GF_PRINTQ" class="GOOD_GF_PRINTQ"><?= $Page->PRINTQ->caption() ?></span></th>
<?php } ?>
<?php if ($Page->avgprice->Visible) { // avgprice ?>
        <th class="<?= $Page->avgprice->headerCellClass() ?>"><span id="elh_GOOD_GF_avgprice" class="GOOD_GF_avgprice"><?= $Page->avgprice->caption() ?></span></th>
<?php } ?>
<?php if ($Page->idx->Visible) { // idx ?>
        <th class="<?= $Page->idx->headerCellClass() ?>"><span id="elh_GOOD_GF_idx" class="GOOD_GF_idx"><?= $Page->idx->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_ITEM_ID" class="GOOD_GF_ITEM_ID">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_BATCH_NO" class="GOOD_GF_BATCH_NO">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_SHELF_NO" class="GOOD_GF_SHELF_NO">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_SERIAL_NB" class="GOOD_GF_SERIAL_NB">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_DISCOUNT" class="GOOD_GF_DISCOUNT">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_DISCOUNT2" class="GOOD_GF_DISCOUNT2">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_DISCOUNTOFF" class="GOOD_GF_DISCOUNTOFF">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_STOCK_LALU" class="GOOD_GF_STOCK_LALU">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_DITERIMA" class="GOOD_GF_DITERIMA">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_DISTRIBUSI" class="GOOD_GF_DISTRIBUSI">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_DIHAPUS" class="GOOD_GF_DIHAPUS">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_DIMINTA" class="GOOD_GF_DIMINTA">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_DIRETUR" class="GOOD_GF_DIRETUR">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_PO" class="GOOD_GF_PO">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_COMPANY_ID" class="GOOD_GF_COMPANY_ID">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_FUND_ID" class="GOOD_GF_FUND_ID">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_INVOICE_ID2" class="GOOD_GF_INVOICE_ID2">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_MEASURE_ID3" class="GOOD_GF_MEASURE_ID3">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_SIZE_KEMASAN" class="GOOD_GF_SIZE_KEMASAN">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_MEASURE_ID2" class="GOOD_GF_MEASURE_ID2">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_RETUR_ID" class="GOOD_GF_RETUR_ID">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_SIZE_GOODS" class="GOOD_GF_SIZE_GOODS">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_MEASURE_DOSIS" class="GOOD_GF_MEASURE_DOSIS">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_ORDER_PRICE" class="GOOD_GF_ORDER_PRICE">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_STOCK_AVAILABLE" class="GOOD_GF_STOCK_AVAILABLE">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_STATUS_PASIEN_ID" class="GOOD_GF_STATUS_PASIEN_ID">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_CORRECTION_DOC" class="GOOD_GF_CORRECTION_DOC">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_CORRECTIONS" class="GOOD_GF_CORRECTIONS">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_CORRECTION_DATE" class="GOOD_GF_CORRECTION_DATE">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_PRINTQ" class="GOOD_GF_PRINTQ">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_avgprice" class="GOOD_GF_avgprice">
...
<span id="el<?= $Page->RowCount ?>_GOOD_GF_idx" class="GOOD_GF_idx">
